...
Français is a broad category encompassing popular music sung in the French language, spanning from traditional chanson to modern pop, rock, and indie styles. Rooted in France&#39;s rich storytelling tradition, it emphasizes lyrical poetry, melodic sophistication, and emotional expressiveness. The genre reflects French cultural identity while embracing diverse contemporary influences from folk to electronic music.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Piglet&#39;s Big Movie Original Soundtrack (French Version)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/hard-rock" | relative_url }}">hard rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-alternativo" | relative_url }}">rock alternativo</a> # 29</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Loons</td>
      <td>supermarket (ER-1051)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/francais" | relative_url }}">francais</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/french-pop" | relative_url }}">french pop</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/indie-folk" | relative_url }}">indie folk</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/france" | relative_url }}">france</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2004-09</td>
      <td>Trust</td>
      <td>Antisocial - Le Meilleur Des Années CBS</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/francais" | relative_url }}">francais</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/france" | relative_url }}">france</a></li>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>RiT</td>
      <td>sans tambour ni trompette</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/francais" | relative_url }}">francais</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010-09-21</td>
      <td>Agora Fidelio</td>
      <td>Les illusions d&#39;une route, vol. 1 : Barcelone</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Fatals Picards Country Club</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/francais" | relative_url }}">francais</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Ludivine Sagnier &amp; Louis Garrel</td>
      <td>Les Chansons D&#39;amour (B.O)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/francais" | relative_url }}">francais</a></li>
