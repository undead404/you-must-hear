...
Last updated: <time datetime="2025-12-06T05:53:27.230Z">Sat Dec 06 2025 07:53:27 GMT+0200 (Eastern European Standard Time)</time>

### Description

Alternative rap, also known as underground hip hop or indie hip hop, is a subgenre of hip hop music that emerged in the 1980s and 1990s as a response to the mainstream commercialization of hip hop. Alternative rap artists often focus on social and political issues and use more experimental and diverse musical elements, such as jazz, funk, and rock. They tend to have a more poetic and introspective lyrical style and often challenge traditional hip hop stereotypes and conventions. Some notable alternative rap artists include Aesop Rock, MF Doom, Atmosphere, and Common.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Riders Of The Storm: The Underwater Album</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rap" | relative_url }}">alternative rap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
    ...
    <tr>
      ...
      <td>2003-01</td>
      <td>Klub des Loosers</td>
      <td>Baise les gens</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rap" | relative_url }}">alternative rap</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/crunkcore" | relative_url }}">crunkcore</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/remixes" | relative_url }}">remixes</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/russian-rap" | relative_url }}">russian rap</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/napoli" | relative_url }}">napoli</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rap-rock" | relative_url }}">rap rock</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/brooklyn" | relative_url }}">brooklyn</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bass" | relative_url }}">bass</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>37</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/f61a679bef06b66ef67c8ef1eb282e74.png" alt="Cover for Attempted Lover" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-07-19</td>
      <td>Sueco</td>
      <td>Attempted Lover</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rap" | relative_url }}">alternative rap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo-rap" | relative_url }}">emo rap</a></li>
    ...
    <tr>
      ...
      <td>grandma got run over by a lawnmower</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rap" | relative_url }}">alternative rap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
