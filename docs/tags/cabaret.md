...
Cabaret is a theatrical music genre combining dramatic vocals, piano-driven melodies, and elements of punk, vaudeville, and dark comedy. It emerged from European performance art traditions and underground club scenes, emphasizing emotional storytelling and avant-garde aesthetics. The sound is intentionally provocative, blending vintage instrumentation with contemporary rebellious energy.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Burlesque Original Motion Picture Soundtrack</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2003-12-04</td>
      <td>Clare Fader &amp; The Vaudevillains</td>
      <td>Seventh &amp; Trade</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
    ...
    <tr>
      ...
      <td>2006-03-28</td>
      <td>Bodo Wartke</td>
      <td>Achillesverse - live in Berlin</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
    ...
    <tr>
      ...
      <td>An Entire Wardrobe of Doubt An</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2006-04-14</td>
      <td>The Deadfly Ensemble</td>
      <td>An Entire Wardrobe Of Doubt And Uncertainty</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2006-04-17</td>
      <td>Little Annie</td>
      <td>Songs From The Coal Mine Canary</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-09-11</td>
      <td>The World&#x2F;Inferno Friendship Society</td>
      <td>Addicted to Bad Ideas: Peter Lorre&#39;s Twentieth Century</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Zoe Boekbinder</td>
      <td>Artichoke Perfume</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
    ...
    <tr>
      ...
      <td>La mixture pour le voyage</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
    ...
    <tr>
      ...
      <td>2011-01-21</td>
      <td>Amanda Palmer</td>
      <td>Amanda Palmer Goes Down Under</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
    ...
    <tr>
      ...
      <td>2023-06-09</td>
      <td>Kaizers Orchestra</td>
      <td>Violeta Violeta Volume III</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
