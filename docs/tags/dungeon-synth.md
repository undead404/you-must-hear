...
Last updated: <time datetime="2025-12-06T16:34:32.235Z">Sat Dec 06 2025 18:34:32 GMT+0200 (Eastern European Standard Time)</time>

### Description

Dungeon synth is an atmospheric electronic music genre characterized by lo-fi synthesizers, medieval-inspired melodies, and fantasy themes evoking dungeons, castles, and mystical landscapes. Emerging from the ambient interludes of 1990s black metal, it creates immersive soundscapes that feel like soundtracks to imaginary role-playing games. The genre emphasizes mood and atmosphere over technical complexity, often featuring sparse, haunting compositions.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1993-06</td>
      <td>Mortiis</td>
      <td>The Song of a Long Forgotten Ghost</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1994</td>
      <td>Cernunnos Woods</td>
      <td>Tears of the Weeping Willow</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 51</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Cintecele Diavolui</td>
      <td>The Devil&#39;s Songs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/epic-black-metal" | relative_url }}">epic black metal</a> # 16</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 37</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Erang</td>
      <td>Within The Land Of My Imagination I Am The Only God</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Burzum</td>
      <td>The Reincarnation of Ódinn</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
    ...
    <tr>
      ...
      <td>2015-10-02</td>
      <td>Vindkaldr</td>
      <td>Enchantments Of Old Lore</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      <td>4</td>
      <td>
          <img src="https://i.discogs.com/KO4YwmdHi_JIOVg6AIJ6V9COacA6obNOc38dFwVIfy0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTgwNTY3/OTktMTQ1NDI5ODAy/Mi05MTM5LmpwZWc.jpeg" alt="Cover for Platinum Tears" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-02-01</td>
      <td>Babyfather</td>
      <td>Platinum Tears</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2016-11-15</td>
      <td>Murgrind</td>
      <td>Journey Through The Mountain</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>Neverlur</td>
      <td>Op under Fjeldet toner en Lur</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2017-01-06</td>
      <td>Old Tower</td>
      <td>The Rise Of The Spectral Horizons</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
    ...
    <tr>
      ...
      <td>2017-06-10</td>
      <td>Quest Master</td>
      <td>Lost Songs of Distant Realms, Vol. One</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2017-10-31</td>
      <td>Old Sorcery</td>
      <td>Realms of Magickal Sorrow</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2018-02-09</td>
      <td>Alex Crispin</td>
      <td>Escape the Dark Castle (Original Game Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fantasy-ambient" | relative_url }}">fantasy ambient</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2018-10-24</td>
      <td>Iagon</td>
      <td>Tome of the Crystal Wizard</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2019-08-10</td>
      <td>dungeontroll</td>
      <td>Labyrinth of the Golden Princess</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://i.discogs.com/i9UizTxGjd1iSB2YBfFvfFThbRUInIkgsPf3fNHcaNA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1MzU2/OTQyLTE1OTAyNDQy/NjktODE3MC5qcGVn.jpeg" alt="Cover for Sword of Gondar" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-11-06</td>
      <td>GOnDaR</td>
      <td>Sword of Gondar</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2021-03-05</td>
      <td>Old Nick</td>
      <td>A New Generation Of Vampiric Conspiracies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
    ...
    <tr>
      ...
      <td>2023-03-03</td>
      <td>Hole Dweller</td>
      <td>With Dreams of Hereafter</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2023-11-01</td>
      <td>trhä</td>
      <td>av◊ëlajnt◊ë£ hinnem nihre</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
        </ul>
