...
Harmolodic refers to a revolutionary approach to jazz improvisation developed in the 1970s that eliminates fixed harmonic hierarchies, allowing all instruments to function as equal melodic voices. The music features free-flowing interplay where traditional roles of rhythm, harmony, and melody dissolve into collective spontaneous composition. This creates a sound characterized by angular phrases, shifting tonalities, and democratic instrumental conversation that challenges conventional jazz structure.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1981</td>
      <td>Anthony Braxton</td>
      <td>Eight (+3) Tristano Compositions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harmolodic" | relative_url }}">harmolodic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/new-thing" | relative_url }}">new thing</a></li>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>Pat Metheny&#x2F;Ornette Coleman</td>
      <td>Song X</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harmolodic" | relative_url }}">harmolodic</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Ornette Coleman</td>
      <td>The Music Of Ornette Coleman: Something Else!!!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Misha Mengelberg Quartet</td>
      <td>Four in One</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harmolodic" | relative_url }}">harmolodic</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>The Nu Band</td>
      <td>The Dope and The Ghost - Live in Vienna</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harmolodic" | relative_url }}">harmolodic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>2015-11-03</td>
      <td>Nate Wooley Quintet</td>
      <td>(Dance To) The Early Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harmolodic" | relative_url }}">harmolodic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>2016</td>
      <td>Ornette Coleman</td>
      <td>The Complete Science Fiction Sessions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
        </ul>
