...
Melodic punk combines the aggressive energy and fast tempos of punk rock with catchy, singable melodies and harmonic vocal lines that make the music more accessible without sacrificing its edge. Emerging from the punk scenes of the 1980s and 1990s, it emphasizes songcraft and memorable hooks while maintaining punk&#39;s DIY ethos and socially conscious lyrics. The sound balances raw power with tuneful guitar work and often anthemic choruses that invite audience participation.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1986</td>
      <td>vandals</td>
      <td>Shingo Japanese Remix Album</td>
      <td>
        <ul>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://i.discogs.com/KFlaeWOKZrEOVRu0tQ-UNJohMOWCkh700Spnenukin0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM2MDI1/MjktMTMzNjk3MTkz/MC04MTEwLmpwZWc.jpeg" alt="Cover for Hitler Bad Vandals Good" style="max-width:120px; height:auto;" />
      </td>
      <td>1986</td>
      <td>Vandals</td>
      <td>Hitler Bad Vandals Good</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop-punk" | relative_url }}">pop punk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chicago" | relative_url }}">chicago</a> # 30</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fast-melodic-punk" | relative_url }}">fast melodic punk</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>49</td>
      <td>
          <img src="https://i.discogs.com/rijcUbyPZtyd9VHPYmzaCX2a9TmlxgIa3ZyEfH2gJas/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE4NjQ1/MjEtMTMyODI0Mjcz/OC5qcGVn.jpeg" alt="Cover for Quickening" style="max-width:120px; height:auto;" />
      </td>
      <td>1996</td>
      <td>The Vandals</td>
      <td>Quickening</td>
    ...
    <tr>
      ...
      <td>America&#39;s Favorite Pastime</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fast-melodic-punk" | relative_url }}">fast melodic punk</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>A Guided Tour of Chicago</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fast-melodic-punk" | relative_url }}">fast melodic punk</a> # 95</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Latterman</td>
      <td>We Are Still Alive</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/pop-punk" | relative_url }}">pop punk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2008-02-19</td>
      <td>Secret Lives Of The Freemasons</td>
      <td>Weekend Warriors</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emocore" | relative_url }}">emocore</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hungarian" | relative_url }}">hungarian</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2008-08-25</td>
      <td>Rise Against</td>
      <td>Re-Education (Through Labor) - Single</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-hardcore" | relative_url }}">melodic hardcore</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Bedtime For Charlie</td>
      <td>It Ain&#39;t About The Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2009-03-24</td>
      <td>Pulley</td>
      <td>Time-Insensitive Material</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
        </ul>
    ...
    <tr>
      <td>2</td>
      <td>
          <img src="https://i.discogs.com/Ip6KoLFoIK4X6CKYF7KUc69NHU2JcoEC5jkg6QyRGew/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzOTMw/MzgwLTE1NjQzMTU5/MzEtNjQ0OC5qcGVn.jpeg" alt="Cover for relation" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-06-23</td>
      <td>Airport</td>
      <td>relation</td>
    ...
    <tr>
      ...
      <td>2009-08-21</td>
      <td>Uncommonmenfrommars</td>
      <td>Functional Dysfunctionality</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
    ...
    <tr>
      ...
      <td>Raising Ruins For The Future</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-hardcore" | relative_url }}">melodic hardcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/skacore" | relative_url }}">skacore</a> # 79</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Daylight</td>
      <td>The Difference In Good and Bad Dreams</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      <td>99</td>
      <td>
          <img src="https://i.discogs.com/NfsQ_Prc_uWys_v23H5EGHf7d1efnQtGdkxtKNt-0wc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTg3NzE4/MzEtMTQ2ODQzNTg0/OC0yNDI4LmpwZWc.jpeg" alt="Cover for Hitler Bad Vandals Good" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-07-15</td>
      <td>vandals</td>
      <td>Hitler Bad Vandals Good</td>
    ...
    <tr>
      ...
      <td>2019</td>
      <td>The Vandals</td>
      <td>Oi! To The World (Christmas With The Vandals)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop-punk" | relative_url }}">pop punk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/scotland" | relative_url }}">scotland</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2021-05</td>
      <td>Операция Пластилин</td>
      <td>Грустные песни для уставших людей</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-punk" | relative_url }}">melodic punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
