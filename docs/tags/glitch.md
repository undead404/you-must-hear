...
Last updated: <time datetime="2025-11-23T11:24:45.954Z">Sun Nov 23 2025 13:24:45 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2009-02-04</td>
      <td>Ametsub</td>
      <td>The Nothings of The North</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/idm" | relative_url }}">idm</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/glitch" | relative_url }}">glitch</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/idm" | relative_url }}">idm</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dubstep" | relative_url }}">dubstep</a> # 56</li>
        </ul>
      </td>
    </tr>
    <tr>
