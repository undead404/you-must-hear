...
Svenskt, meaning &quot;Swedish&quot; in Swedish, encompasses music sung in the Swedish language across various genres from pop and rock to folk and hip-hop. The tag connects diverse musical styles through their shared linguistic and cultural identity, reflecting Sweden&#39;s rich musical heritage and contemporary scene. This category celebrates Swedish-language expression in music, from poetic troubadour traditions to modern urban sounds.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Cornelis Vreeswijk</td>
      <td>Narrgnistor 2 En halv böj blues och andra ballader</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/male-singer-songwriter" | relative_url }}">male singer songwriter</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/svenskt" | relative_url }}">svenskt</a></li>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>Cornelis Vreeswijk</td>
      <td>Narrgnistor och Transkriptioner</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/male-singer-songwriter" | relative_url }}">male singer songwriter</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/svenskt" | relative_url }}">svenskt</a></li>
    ...
    <tr>
      ...
      <td>1998-11-30</td>
      <td>bob hund</td>
      <td>Jag rear ut min själ! Allt skall bort!!!</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Lisa Ekdahl</td>
      <td>Lisa Ekdahl Sings Salvadore Poe</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2002-02</td>
      <td>Kungers</td>
      <td>Vi vill inte ha era kanonkulor</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/svenskt" | relative_url }}">svenskt</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Kungers</td>
      <td>Så länge det finns Kungers finns det hopp</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Björn Afzelius &amp; Mikael Wiehe</td>
      <td>Olympiska nätter</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/male-singer-songwriter" | relative_url }}">male singer songwriter</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/svenskt" | relative_url }}">svenskt</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Caj Karlsson</td>
      <td>Gud straffar somliga med en gång</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/svenskt" | relative_url }}">svenskt</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Martin Randau, Josef Underdal och Hunden Arne</td>
      <td>Sambaskivan</td>
      <td>
        <ul>
        </ul>
