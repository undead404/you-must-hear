...
A requiem is a solemn musical composition originally created for Catholic funeral masses, characterized by dramatic orchestration, choral arrangements, and deeply emotional expressions of mourning and hope. These works blend sacred Latin texts with powerful symphonic elements, ranging from quiet reflection to thunderous passages that contemplate death and eternal rest. The form has evolved from strictly liturgical pieces to concert hall performances that explore profound themes of loss, remembrance, and spiritual transcendence.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>VERDI: Messa da Requiem (Schwarzkopf, Di Stefano, De Sabata) (1954)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1970</td>
      <td>György Ligeti</td>
      <td>Requiem; Lontano; Continuum</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>Zelenka: De Profundis, Misere &amp; Requiem</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1974</td>
      <td>Wolfgang Amadeus Mozart</td>
      <td>Requiem in D minor, K.626 (Wiener Philharmoniker feat. conductor: Herbert von Karajan)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1976</td>
      <td>Wolfgang Amadeus Mozart</td>
      <td>Requiem &#x2F; Christopher Hogwood</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1978</td>
      <td>Wolfgang Amadeus Mozart</td>
      <td>Requiem in D minor, KV 626 (Berliner Philharmoniker feat. conductor: Herbert von Karajan)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>BRAHMS: German Requiem (Toscanini)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/conductor" | relative_url }}">conductor</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>CHERUBINI: Requiem &#x2F; Marche funebre</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>Giuseppe Verdi</td>
      <td>VERDI: Requiem (Gigli) (1939)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>1983</td>
      <td>Giuseppe Verdi</td>
      <td>VERDI: Requiem &#x2F; Quattro Pezzi Sacri</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>1984</td>
      <td>Michel Corboz</td>
      <td>Mozart: Requiem&#x2F;Faure: Requiem</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/conductor" | relative_url }}">conductor</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>1985</td>
      <td>Wolfgang Amadeus Mozart</td>
      <td>MOZART: Requiem &#x2F; Exultate, Jubilate &#x2F; Laudate Dominum</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>Franz Liszt</td>
      <td>Liszt: Requiem, &quot;Messe Des Morts&quot;</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1987</td>
      <td>Krzysztof Penderecki</td>
      <td>Polnisches Requiem (Disc 1 of 2)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Gabriel Fauré</td>
      <td>Fauré: Requiem; Messe des pêcheurs de Villerville</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Wolfgang Amadeus Mozart</td>
      <td>Requiem, KV 626 (BBC Symp. Orch, Sir Colin Davis)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1991</td>
      <td>Wolfgang Amadeus Mozart</td>
      <td>Requiem K-626 Maurerische Trauermusik K 477</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/conductor" | relative_url }}">conductor</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>Mozart Festival Orchestra</td>
      <td>Mozart: Requiem, KV 626 in D Minor</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>Johannes Brahms</td>
      <td>BRAHMS: A German Requiem, Op. 45</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Mozart: Requiem; Kyrie in D minor</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/conductor" | relative_url }}">conductor</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>Ockeghem - Requiem (Missa Pro Defunctis) &amp; Missa Mi Mi (Missa Quarti Toni)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Aesma Daeva</td>
      <td>here lies one whose name was written in water 2009 10 year anniversary</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Berliner Philharmoniker</td>
      <td>Brahms : Ein Deutsches Requiem</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Emile Naoumoff</td>
      <td>Gabriel Fauré - Requiem, Nocturnes, Trois Melodies</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Jan Dismas Zelenka</td>
      <td>Zelenka: Requiem in C Minor, Miserere in C Minor, Lamentatio Pro Die Veneris Sancto</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2007-07-15</td>
      <td>Giuseppe Verdi</td>
      <td>Verdi: Messa da Requiem &amp; Te Deum</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>The Sixteen &#x2F; Academy of St Martin in the Fields</td>
      <td>Fauré Requiem</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2008-11-07</td>
      <td>Anna Netrebko</td>
      <td>Souvenirs (Simplified Metadata)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Neil Davidge</td>
      <td>Halo 4: Original Soundtrack (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
    ...
    <tr>
      ...
      <td>Mozart: Requiem Mass In D Minor, K.626</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2013</td>
      <td>Chamber Choir Hymnia, Flemming Windekilde</td>
      <td>Alfred Schnittke: Requiem</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2014-12-11</td>
      <td>Chor &amp; Orchester der Universität Wien</td>
      <td>Brahms: Ein Deutsches Requiem</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2016-09-26</td>
      <td>Cristobal de Morales</td>
      <td>Morales: Requiem - Music for Philip II</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Requiems for a Submerged City</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Campra : Requiem [Messe des morts]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Exultate</td>
      <td>A German Requiem (sung In English)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Elke Janssens</td>
      <td>Bruckner: Requiem, Duruflé: Requiem - A History of Requiem, Part III</td>
      <td>
        <ul>
        </ul>
      </td>
