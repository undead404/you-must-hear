...
&quot;Aussie&quot; captures the distinctive sound and spirit of Australian popular music, characterized by laid-back grooves, sun-soaked melodies, and a blend of rock, folk, and electronic influences that reflect the country&#39;s coastal culture. The tag encompasses everything from indie rock and roots music to psychedelic pop, unified by an easygoing yet authentic approach to songwriting. This sound often features organic instrumentation mixed with modern production, embodying Australia&#39;s creative independence and outdoor lifestyle.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1984</td>
      <td>INXS</td>
      <td>KICK (25 Anniversary Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
    ...
    <tr>
      <td>52</td>
      <td>
          <img src="https://i.discogs.com/Sq-5f8RpHJQMyfy0bxWec_xMGCAmy5jEo_IQi0noG_o/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE3NzQ0/NTctMTI0MjQ5MjMx/Mi5qcGVn.jpeg" alt="Cover for Original Sin - The Collection" style="max-width:120px; height:auto;" />
      </td>
      <td>1984</td>
      <td>INXS</td>
      <td>Original Sin - The Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td>1985</td>
      <td>INXS</td>
      <td>Time (Australian Tour Souvenir EP)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/australia" | relative_url }}">australia</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1985-11</td>
      <td>INXS</td>
      <td>Empty Sun Under Clean Minds</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td>1986-08</td>
      <td>INXS</td>
      <td>Mann Music Centre, Philadelphia,USA. 13 August 1983</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1987</td>
      <td>INXS</td>
      <td>Live in Santa Monica, California 1993 [CD 1]</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>INXS</td>
      <td>St. Gallen, Switzerland June 28, 1997</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>INXS</td>
      <td>27 June 1984 WMMS Coffee Break Concert FM</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td>1996-10</td>
      <td>Things Of Stone And Wood</td>
      <td>Live at The Espy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/australia" | relative_url }}">australia</a> # 53</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turntablism" | relative_url }}">turntablism</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>47</td>
      <td>
          <img src="https://i.discogs.com/XqNn-fmK4sS8Jfq49sp2WpsYnAEikGDovXaw90YLqqk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQzNDIz/NTItMTM2MjI4MjU3/OC04OTIxLmpwZWc.jpeg" alt="Cover for Jiir" style="max-width:120px; height:auto;" />
      </td>
      <td>2001</td>
      <td>Pigram Brothers</td>
      <td>Jiir</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>INXS</td>
      <td>Stay Young 1979-1982 (The Complete &#39;Deluxe Years&#39;)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td>2002-06-18</td>
      <td>Reaching Quiet</td>
      <td>In The Shadow Of The Living Room</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
    ...
    <tr>
      <td>51</td>
      <td>
          <img src="https://i.discogs.com/xvSQIqvZcZmGIwzNOzAQDoYFI1TB370FJn3OhCiyNUk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExNTQ5/MzczLTE1MTgzMTI4/MjEtNTc1NC5qcGVn.jpeg" alt="Cover for Night Walker Soundtrack" style="max-width:120px; height:auto;" />
      </td>
      <td>2003</td>
      <td>Jason Ferris</td>
      <td>Night Walker Soundtrack</td>
      <td>
        <ul>
    ...
    <tr>
      <td>48</td>
      <td>
          <img src="https://i.discogs.com/32A_lc_EryH8c3KxR8r0Hc3a1qtGlLf0pCh90KHOXqU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTY0MzQ0/MjgtMTQxOTEzOTgx/NS02MDczLmpwZWc.jpeg" alt="Cover for Beautiful Forest" style="max-width:120px; height:auto;" />
      </td>
      <td>2003-11-26</td>
      <td>The Tigers</td>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Gentle Assassins</td>
      <td>They Knew Too Much</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
    ...
    <tr>
      ...
      <td>2007-12-14</td>
      <td>Sceptic &amp; Dseeva</td>
      <td>Hip Hop Psykosis</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
    ...
    <tr>
      <td>31</td>
      <td>
          <img src="https://i.discogs.com/0JhA6TAQ6QSaL_e1VzeCvKmxagNQK7VmWwtpNzF4ULA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExNTk4/NDAyLTE1MTkxNjE3/NjUtMTQzMy5qcGVn.jpeg" alt="Cover for EP Papoose" style="max-width:120px; height:auto;" />
      </td>
      <td>2008</td>
      <td>Mama Kin</td>
      <td>EP Papoose</td>
    ...
    <tr>
      ...
      <td>2008-09-27</td>
      <td>Shannon Noll</td>
      <td>No Turning Back: The Story So Far</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/male-vocalists" | relative_url }}">male vocalists</a></li>
    ...
    <tr>
      ...
      <td>Conditions (Bonus Track Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>INXS</td>
      <td>Live at the Wireless SYDNEY 1982-08-12</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/australia" | relative_url }}">australia</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>35</td>
      <td>
          <img src="https://i.discogs.com/eSIXAkGQVNVrQDyhiej4U-TPduYclFoGZR_cIqWsDEc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM1NDMx/MDUtMTMzNDU5NzM3/Mi5qcGVn.jpeg" alt="Cover for Looking For Mr God" style="max-width:120px; height:auto;" />
      </td>
      <td>2012</td>
      <td>Louise Hoffsten</td>
      <td>Looking For Mr God</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
    ...
    <tr>
      <td>49</td>
      <td>
          <img src="https://i.discogs.com/l76bSrh0WIsoKey1eYZdH6bwUP279UDu1AgHe-Vxiy8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTczNzE2/OTUtMTQ0MDA0NDQ4/Ni04NDI5LmpwZWc.jpeg" alt="Cover for Dead Pets EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2014-01-24</td>
      <td>Mangelwurzel</td>
      <td>Dead Pets EP</td>
    ...
    <tr>
      ...
      <td>2016-11-04</td>
      <td>Frenzal Rhomb</td>
      <td>We Lived Like Kings (We Did Anything We Wanted)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australian" | relative_url }}">australian</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/melbourne" | relative_url }}">melbourne</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td></td>
      <td>David Jackmanson</td>
      <td>The TISM Rip-Off Single Without a B-Side</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Gridland</td>
      <td>The Coordinate Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australian" | relative_url }}">australian</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Elektronik Girl Epic</td>
      <td>I Love Stealing From Woolies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/australia" | relative_url }}">australia</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>victor xray</td>
      <td>Victor Xray Haunts The Loop</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aussie" | relative_url }}">aussie</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>Blood, Sweat and Boxed Wine.</td>
      <td>
        <ul>
        </ul>
      </td>
