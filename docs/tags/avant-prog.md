...
Avant-prog pushes progressive rock into experimental territory, embracing dissonance, complex time signatures, and unconventional song structures that challenge listeners. It merges art rock&#39;s intellectualism with avant-garde&#39;s fearless innovation, drawing from jazz, contemporary classical, and global music traditions. The result is cerebral yet visceral music that prioritizes artistic vision over commercial accessibility.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>9</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a8b4094668d9e43eb290ec3e5728958f.png" alt="Cover for In Praise of Learning" style="max-width:120px; height:auto;" />
      </td>
      <td>1975-05-09</td>
      <td>Henry Cow</td>
      <td>In Praise of Learning</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1976</td>
      <td>Art Zoyd</td>
      <td>Symphonie pour le jour où brûleront les cités</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1980-01-15</td>
      <td>Aksak Maboul</td>
      <td>Un peu de l&#39;âme des bandits</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1981</td>
      <td>Art Zoyd</td>
      <td>Symphonie Pour Le Joir Ou Bruleront Les Cites</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>Lindsay Cooper</td>
      <td>Music For Other Occasions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
    ...
    <tr>
      <td>10</td>
      <td>
          <img src="https://i.discogs.com/I5tI9NkwZILQ7WvWf7ElOxBV5StI06OdMydbfMCzE9A/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTUwNTQ3/Ny0xNDYyODkyMDI3/LTg3OTQuanBlZw.jpeg" alt="Cover for Burnt Weenie Sandwich" style="max-width:120px; height:auto;" />
      </td>
      <td>1993</td>
      <td>Frank Zappa</td>
      <td>Burnt Weenie Sandwich</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/psychedelic-rock" | relative_url }}">psychedelic rock</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Сергей Курёхин</td>
      <td>Воробьиная оратория</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Fulano</td>
      <td>El Infierno de los Payasos</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-fusion" | relative_url }}">jazz fusion</a></li>
    ...
    <tr>
      <td>4</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/9dfdda8fd236035197deeddb1003d94e.png" alt="Cover for Weasels Ripped My Flesh" style="max-width:120px; height:auto;" />
      </td>
      <td>1995</td>
      <td>Frank Zappa</td>
      <td>Weasels Ripped My Flesh</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
    ...
    <tr>
      <td>15</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/e0374854d1223187b55b8517e87d1de9.png" alt="Cover for Un Peu de L&#39;Ame des Bandits" style="max-width:120px; height:auto;" />
      </td>
      <td>1995</td>
      <td>Aksak Maboul</td>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Don Salsa</td>
      <td>Koolaide Moustache in Jonestown</td>
      <td>
        <ul>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://i.discogs.com/0nhBAaFWjf3W495f9NKhiKXzjFLINhRcib-AtrmufLM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTY0NTM0/MjItMTQ2NzAxMDEx/OS0xMjg4LmpwZWc.jpeg" alt="Cover for Na Żywo W Pstrągu" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
      <td>Kury</td>
      <td>Na Żywo W Pstrągu</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
        </ul>
    ...
    <tr>
      <td>7</td>
      <td>
          <img src="https://i.discogs.com/Vr3ToBUJw5Hnf2LOCHEpvh83rP2awzgzAlHh9_tzHSU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExMDI4/Mjc5LTE1MDg1MjY3/NTUtMjM1OS5qcGVn.jpeg" alt="Cover for Burnt Weeny Sandwich" style="max-width:120px; height:auto;" />
      </td>
      <td>2003</td>
      <td>Frank Zappa</td>
      <td>Burnt Weeny Sandwich</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/psychedelic-rock" | relative_url }}">psychedelic rock</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>The Deserts of Träun</td>
      <td>Part III: The Lilac Moon</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-garde-metal" | relative_url }}">avant-garde metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/0bab7927889a6137005ff2741583f176.png" alt="Cover for Of Natural History" style="max-width:120px; height:auto;" />
      </td>
      <td>2004-11-02</td>
      <td>Sleepytime Gorilla Museum</td>
      <td>Of Natural History</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
        </ul>
    ...
    <tr>
      <td>12</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/28e9562b0180a3048f836dd54064102b.png" alt="Cover for Perils" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-04-19</td>
    ...
    <tr>
      ...
      <td>2005-08-11</td>
      <td>Zu &amp; Mats Gustafsson</td>
      <td>How To Raise An Ox</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-12-07</td>
      <td>Møster!</td>
      <td>When You Cut Into the Present</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/extreme-progressive-metal" | relative_url }}">extreme progressive metal</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>13</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6641ad52fb0850377bc44610213989d6.png" alt="Cover for Plastic House on Base of Sky" style="max-width:120px; height:auto;" />
      </td>
      <td>2016</td>
      <td>Kayo Dot</td>
      <td>Plastic House on Base of Sky</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
    ...
    <tr>
      ...
      <td>2022-06-17</td>
      <td>High Castle Teleorkestra</td>
      <td>The Egg That Never Opened</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-prog" | relative_url }}">avant-prog</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-rock" | relative_url }}">experimental rock</a></li>
