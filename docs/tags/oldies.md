...
Last updated: <time datetime="2025-11-23T08:50:37.882Z">Sun Nov 23 2025 10:50:37 GMT+0200 (Eastern European Standard Time)</time>

### Description

Oldies music typically refers to popular music from the 1950s, 1960s, and 1970s, particularly in the genres of rock and roll, doo-wop, soul, and pop. The term &quot;oldies&quot; can vary depending on the context and the person using it, but it generally refers to music that was popular during a particular era, and has a nostalgic or classic feel to it. Some examples of oldies artists include Elvis Presley, The Beatles, The Supremes, The Beach Boys, and many others.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>If You Can Believe Your Eyes And Ears</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/surf-rock" | relative_url }}">surf rock</a> # 56</li>
    ...
    <tr>
      ...
      <td>1968</td>
      <td>Tony Bennett</td>
      <td>Snowfall - The Tony Bennett Christmas Album</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1968-12</td>
      <td>Arthur Conley</td>
      <td>Rhino Hi-Five: Arthur Conley</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/motown" | relative_url }}">motown</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>The Hollies</td>
      <td>The Hollies&#39; Greatest Hits</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classic-rock" | relative_url }}">classic rock</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/western" | relative_url }}">western</a> # 37</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/soft-rock" | relative_url }}">soft rock</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>5</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/33e0a6c3f12cb39bbae4d6a4ee7cc08d.png" alt="Cover for The Wonderful World of Sam Cooke" style="max-width:120px; height:auto;" />
      </td>
      <td>1988</td>
      <td>Sam Cooke</td>
      <td>The Wonderful World of Sam Cooke</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
    ...
    <tr>
      <td>12</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/709236117b7ebc8d9e64821212b530e9.png" alt="Cover for The Best Of The Ronettes" style="max-width:120px; height:auto;" />
      </td>
      <td>1992</td>
      <td>The Ronettes</td>
      <td>The Best Of The Ronettes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/soul" | relative_url }}">soul</a></li>
    ...
    <tr>
      <td>18</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/9b5a06ba860cf9b0be6bb2b8fc8068ea.png" alt="Cover for The Best Of Manfred Mann" style="max-width:120px; height:auto;" />
      </td>
      <td>1992-06-02</td>
      <td>Manfred Mann</td>
      <td>The Best Of Manfred Mann</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bubblegum-pop" | relative_url }}">bubblegum pop</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Roy Orbison</td>
      <td>The Very Best of Roy Orbison</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
    ...
    <tr>
      <td>14</td>
      <td>
          <img src="https://i.discogs.com/SCGkJ-QWVQYxpXWM_HfcxnilnHPxNS1GO62XwgnBWJ8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTY5NTAz/NjctMTU3MDYxMzI0/Mi03NjM2LmpwZWc.jpeg" alt="Cover for Ella &amp; Friends" style="max-width:120px; height:auto;" />
      </td>
      <td>1996-06-04</td>
    ...
    <tr>
      ...
      <td>The Best Of The Shangri-Las</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Nancy Sinatra</td>
      <td>The Very Best of - 24 Great Songs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1997-08-19</td>
      <td>Little Richard</td>
      <td>The Best Of Little Richard</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      <td>7</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/420bd7155a9941aea9ce7ee8a17cbaa7.png" alt="Cover for High Profile" style="max-width:120px; height:auto;" />
      </td>
      <td>1998</td>
      <td>The Platters</td>
      <td>High Profile</td>
    ...
    <tr>
      <td>8</td>
      <td>
          <img src="https://i.discogs.com/3DUq_1zIxddetOT1Ukw4zw70lofzZtyO8jAoLA8mHEs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM2NzA1/MTMtMTM0NTQyNzc3/NS02MzIzLmpwZWc.jpeg" alt="Cover for Greatest Hits" style="max-width:120px; height:auto;" />
      </td>
      <td>1998</td>
      <td>Johnny Rivers</td>
      <td>Greatest Hits</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/western" | relative_url }}">western</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>4</td>
      <td>
          <img src="https://i.discogs.com/JERTTwawuxCOFBBxcsknXLSnB8eVOzkCD5-sSSk8o1Q/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTczMzAz/MC0xNTE1NTEzMjQ5/LTI3NTEuanBlZw.jpeg" alt="Cover for The Definitive Monkees" style="max-width:120px; height:auto;" />
      </td>
      <td>2001-02-26</td>
      <td>The Monkees</td>
      <td>The Definitive Monkees</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
    ...
    <tr>
      <td>42</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/421130d60bc849779d9cd677be9907d7.png" alt="Cover for The Definitive 60&#39;s (sixties)" style="max-width:120px; height:auto;" />
      </td>
      <td>2006</td>
      <td>Tony Bennett</td>
      <td>The Definitive 60&#39;s (sixties)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/easy-listening" | relative_url }}">easy listening</a> # 30</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Tony Bennett</td>
      <td>A Swingin&#39; Christmas Featuring The Count Basie Big Band</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
    ...
    <tr>
      <td>21</td>
      <td>
          <img src="https://i.discogs.com/D-Nw6YB-e1YR6YwCmF0-UtPN9KwWaiNfc2HDapPR8po/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MTQ2/MzItMTIyMzI0NDcx/Ny5qcGVn.jpeg" alt="Cover for Sounds of Summer" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-07-25</td>
      <td>The Beach Boys</td>
      <td>Sounds of Summer</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a></li>
        </ul>
    ...
    <tr>
      <td>6</td>
      <td>
          <img src="https://i.discogs.com/vXz6p1UarJnpfTpyDYy8Egnd94BwVwxEmJn_9qGPyRg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTcyODA4/OTgtMTQ2OTA0MzI4/OS01OTczLmpwZWc.jpeg" alt="Cover for The Coasters" style="max-width:120px; height:auto;" />
      </td>
      <td>2014</td>
      <td>The Coasters</td>
      <td>The Coasters</td>
