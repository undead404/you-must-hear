...
Synth rock blends the energy and structure of rock music with prominent synthesizers and electronic textures, creating a sound that bridges organic and digital worlds. Emerging from new wave and post-punk movements, it emphasizes atmospheric layers and melodic hooks while maintaining guitar-driven intensity. The style ranges from darkly theatrical to brightly anthemic, united by its fusion of electronic production with rock&#39;s emotional directness.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/science-fiction" | relative_url }}">science fiction</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/science-fiction" | relative_url }}">science fiction</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/old-school-heavy-metal" | relative_url }}">old-school heavy metal</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1987</td>
      <td>Cock Robin</td>
      <td>After Here Through Midland</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/science-fiction" | relative_url }}">science fiction</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2003-04-25: Minneapolis, MN, USA</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2010-02-10</td>
      <td>Him</td>
      <td>Screamworks: Love in Theory and Practice, Chapters 1–13</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/denmark" | relative_url }}">denmark</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ireland" | relative_url }}">ireland</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2014-12-30</td>
      <td>Aviators</td>
      <td>Haunted House - And Other Stories</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      <td>71</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/9b58eea4b481420f97da4e22bf9eedf7.png" alt="Cover for Michael esta vivo" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-10-17</td>
      <td>Piyama Party</td>
      <td>Michael esta vivo</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/american" | relative_url }}">american</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/folktronica" | relative_url }}">folktronica</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/indie-rock" | relative_url }}">indie rock</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/indietronica" | relative_url }}">indietronica</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/synth-rock" | relative_url }}">synth rock</a></li>
