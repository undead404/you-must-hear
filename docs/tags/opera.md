...
Opera is a dramatic theatrical art form combining classical singing, orchestral music, and stagecraft to tell stories through powerful vocal performances. Originating in Renaissance Italy, it emphasizes trained voices performing in multiple languages without amplification. The genre ranges from tragic historical epics to comedic tales, often featuring elaborate costumes and sets.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1969</td>
      <td>Giuseppe Verdi</td>
      <td>VERDI: Rigoletto (Warren, Berger) (1950)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>MASCAGNI: Cavalleria Rusticana</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/classic-rock" | relative_url }}">classic rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Luciano Pavarotti</td>
      <td>Nessun Dorma - None Shall Sleep</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Richard Wagner</td>
      <td>The Last Night Of The Proms with BBC Symphony Orchestra, Sir Colin Davis</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Georges Bizet</td>
      <td>Bizet (The Best Of)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Tchaikovsky: Eugene Onegin</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
        </ul>
