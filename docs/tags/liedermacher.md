...
Liedermacher is a German singer-songwriter tradition emphasizing poetic, socially conscious lyrics delivered with acoustic instrumentation and intimate vocal performance. Rooted in 1960s folk movements, it blends political commentary, personal storytelling, and literary craftsmanship with influences from chanson and cabaret. The style values authenticity and lyrical depth over production polish, creating direct connections between artist and audience.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Spiel nicht mit den Schmuddelkindern</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1977</td>
      <td>Hannes Wader</td>
      <td>Hannes Wader singt Arbeiterlieder</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1987</td>
      <td>Hans Söllner</td>
      <td>Wos reimt se scho auf Nicki...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1989</td>
      <td>Fredl Fesl</td>
      <td>Eine Stunde mit Fredl Fesl</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Ich will Gesang, will Spiel und Tanz</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a> # 83</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/deutschpunk" | relative_url }}">deutschpunk</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1997-03-20</td>
      <td>Klaus Hoffmann</td>
      <td>Klaus Hoffmann Singt Brel</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004-06</td>
      <td>Gerhard Schöne</td>
      <td>Jule wäscht sich nie</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006-07</td>
      <td>Senore Matze Rossi</td>
      <td>und wann kommst du aus deinem Versteck...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-10-19</td>
      <td>Eure Mütter</td>
      <td>Platz 8 der deutschen Albumcharts</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>2007-10-26</td>
      <td>Wenzel</td>
      <td>Glaubt nie, was ich singe</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Gisbert zu Knyphausen</td>
      <td>Gisbert zu Knyphausen (25.april 2008)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2010-05-06</td>
      <td>Konny</td>
      <td>Wenn das Wort vielleicht nicht wär, dann gäb es keine Zweifel mehr!</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2010-06-04</td>
      <td>Felix Meyer</td>
      <td>Von Engeln und Schweinen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012-09-07</td>
      <td>Konny</td>
      <td>Herr Vernünftig benimmt sich daneben</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Robert Rausch &amp; seine Zustände</td>
      <td>Staatl. geprüfter Erzieher mit Fachhochschulreife</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
        </ul>
