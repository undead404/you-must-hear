...
UK funky is a fast-paced electronic dance style that emerged from London&#39;s underground clubs in the late 2000s, blending house, garage, and African rhythms with syncopated percussion and bouncy basslines. The sound features skippy, off-kilter drum patterns typically around 130 BPM, creating an infectious energy that bridges the gap between UK garage&#39;s shuffle and house music&#39;s directness. It emphasizes groove and dancefloor momentum while incorporating soulful vocals and warping synthesizers.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Shackleton</td>
      <td>Soundboy&#39;s Nuts Get Ground Up Proper E.P.</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2011-01</td>
      <td>Julio Bashmore</td>
      <td>Everyone Needs A Theme Tune</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/house" | relative_url }}">house</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/uk-funky" | relative_url }}">uk funky</a></li>
    ...
    <tr>
      ...
      <td>2011-10-17</td>
      <td>Bert On Beats</td>
      <td>Antenna Of Tallinn Remixed</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dubstep" | relative_url }}">dubstep</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/uk-funky" | relative_url }}">uk funky</a></li>
    ...
    <tr>
      ...
      <td>2011-12-01</td>
      <td>Dubbel Dutch</td>
      <td>SEKTA FT. SPOEK MATHAMBO PETERPAN REMIXES</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2012-08-27</td>
      <td>Tuff Wheelz</td>
      <td>So Strong &#x2F; Come Together EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deep-house" | relative_url }}">deep house</a></li>
    ...
    <tr>
      ...
      <td>2016-01-07</td>
      <td>Scratcha DVA</td>
      <td>Just Vybe (Soule:Power Mix) &#x2F; Step 2 Funk</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/uk-funky" | relative_url }}">uk funky</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Vlad Pronin</td>
      <td>100 Camels Of Mr. Bowles EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
