...
Big band is a jazz-based genre featuring large orchestras of 10-25 musicians arranged in brass, woodwind, and rhythm sections. It dominated American popular music from the 1930s-1940s, providing danceable swing rhythms that defined the era&#39;s social scene. The sound is characterized by powerful brass fanfares, complex arrangements, and a driving beat.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1958-03</td>
      <td>Count Basie</td>
      <td>The Complete Atomic Basie</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>1965</td>
      <td>Glenn Miller</td>
      <td>100 Success De Glenn Miller</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1966</td>
      <td>Frank Sinatra</td>
      <td>Sinatra at the Sands</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1974</td>
      <td>Louis Prima</td>
      <td>Just A Gigolo The Best Of Louis Prima</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
    ...
    <tr>
      ...
      <td>1981-07</td>
      <td>Woody Herman</td>
      <td>Woody Herman Presents, Volume 2... Four Others</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1984</td>
      <td>Duke Ellington</td>
      <td>Recollections of the Big Band Era</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>1992-11-03</td>
      <td>Frank Sinatra</td>
      <td>The Best of the Capitol Years</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Artie Shaw</td>
      <td>The Essence of Artie Shaw</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Charlie Parker Memorial, Vol. 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009-10-13</td>
      <td>The Brian Setzer Orchestra</td>
      <td>Songs From Lonely Avenue</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock-n-roll" | relative_url }}">rock n roll</a></li>
    ...
    <tr>
      ...
      <td>2010-06-28</td>
      <td>Duke Ellington &amp; Count Basie</td>
      <td>First Time! The Count Meets the Duke</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>2017-12</td>
      <td>Sun Ra</td>
      <td>A Fireside Chat With Lucifer</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
    ...
    <tr>
      ...
      <td>2023-05-05</td>
      <td>Monika Roscher Bigband</td>
      <td>Witchy Activities and the Maple Death</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
