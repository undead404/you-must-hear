...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>O Giorgos Dalaras Tragouda Marko Vamvakari</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>The Very Best of 1989 - 1998</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>Οι περιπέτειες ενός προσκυνητή</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-04-11</td>
      <td>Nicos</td>
      <td>Nikos Plays Mikis Theodorakis &#x2F; Zephyros</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
        </ul>
