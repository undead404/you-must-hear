...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1974</td>
      <td>Various Artists</td>
      <td>Music From South of Yangtze</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/china" | relative_url }}">china</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1980-08</td>
      <td>Various Artists</td>
      <td>An Anthology of Chinese Experimental Music 1992-2008</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/asia" | relative_url }}">asia</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/china" | relative_url }}">china</a></li>
    ...
    <tr>
      ...
      <td>1989</td>
      <td>Jiang Cairu</td>
      <td>Gold Finger: Chinese Erhu</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/china" | relative_url }}">china</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Hideo Osaka</td>
      <td>The Art of the Japanese Bamboo flute</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/asia" | relative_url }}">asia</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/china" | relative_url }}">china</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Joel Elizalde</td>
      <td>GTO.MEX.EGOISMO_2010_JOEL ELIZALDE</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/africa" | relative_url }}">africa</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Various Artists</td>
      <td>Anthology Of Chinese Traditional and Folk Music: Dizi Vol. 7</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2016</td>
      <td>Various Artists</td>
      <td>Ancient Chinese Music: Shadows Of Apricot Blossoms</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/china" | relative_url }}">china</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>GRUPO LABERINTO DE CD. OBREGON SONORA MEX. BY DISCOS MUSART</td>
      <td>Totalmente Ranchero</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/africa" | relative_url }}">africa</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
