...
Cantautori refers to the Italian singer-songwriter tradition where artists compose and perform deeply personal, poetic songs that blend literary sophistication with melodic accessibility. Emerging prominently in the 1960s and 70s, this movement emphasizes storytelling, social commentary, and emotional introspection through a distinctly Italian cultural lens. The music ranges from folk-influenced ballads to jazz-tinged compositions, unified by an emphasis on lyrical craftsmanship and authentic artistic expression.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Le più belle canzoni di Ornella Vanoni</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1965-12-09</td>
      <td>Nanni Svampa</td>
      <td>Nanni Svampa Canta Brassens</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Fabrizio De André</td>
      <td>Non al denaro non all&#39;amore nè al cielo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
    ...
    <tr>
      ...
      <td>All&#39;una e trentacinque circa</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italiana" | relative_url }}">italiana</a></li>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Renato Zero</td>
      <td>Amore Dopo Amore Tour Dopo Tour</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
    ...
    <tr>
      ...
      <td>1999-10-25</td>
      <td>Massimo Bubola</td>
      <td>Diavoli e farfalle</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>CHE&#x2F;COSA&#x2F;TE&#x2F;NE&#x2F;FAI&#x2F;DI&#x2F;UN&#x2F;TITOLO</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Various Artists</td>
      <td>L&#39;Italia Cantata dai Cantautori (Songwriters Collection 80s, 90s and 2000s)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Vittorio Merlo</td>
      <td>Ho sognato Bruno Vespa</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
    ...
    <tr>
      ...
      <td>2007-02-16</td>
      <td>Pino Daniele</td>
      <td>Il mio nome e&#39; Pino Daniele e vivo qui</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues" | relative_url }}">blues</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Federico Salvatore</td>
      <td>Fare il napoletano...stanca!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
    ...
    <tr>
      ...
      <td>2022-04-14</td>
      <td>Various Artists</td>
      <td>I grandi cantautori - Vol. 3</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Various Artists</td>
      <td>La scuola Genovese dei cantautori</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
