...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/traditional-country" | relative_url }}">traditional country</a> # 69</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/traditional-country" | relative_url }}">traditional country</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/traditional-country" | relative_url }}">traditional country</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/country-christmas" | relative_url }}">country christmas</a> # 63</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>Johnny Cash</td>
      <td>At San Quentin: The Complete 1969 Concert</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/country" | relative_url }}">country</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/honky-tonk" | relative_url }}">honky tonk</a> # 27</li>
        </ul>
      </td>
    </tr>
    <tr>
