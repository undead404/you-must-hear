...
Ambient black metal merges the raw aggression and tremolo-picked guitars of black metal with spacious, atmospheric soundscapes that emphasize mood over intensity. The genre strips away much of black metal&#39;s fury, replacing it with hypnotic repetition, synthesizer textures, and a meditative quality that evokes isolation and natural grandeur. Born from the Norwegian scene&#39;s experimental edge, it transforms black metal&#39;s darkness into something vast and contemplative.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Paysage d&#39;Hiver</td>
      <td>Paysage D&#39;Hiver &#x2F; Lunar Aurora</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>All The Cold</td>
      <td>Dark Sorrows Of My Microcosm (demo)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
    ...
    <tr>
      ...
      <td>2007-12-24</td>
      <td>Zuriaake</td>
      <td>Afterimage of Autumn</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009-09-30</td>
      <td>Lustre</td>
      <td>Neath the black veil (Demo)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-03-26</td>
      <td>Nargaroth</td>
      <td>Spectral Visions of Mental Warfare</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
    ...
    <tr>
      ...
      <td>2012-05-20</td>
      <td>Basarabian Hills</td>
      <td>Spirit of the Native Land</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012-11-30</td>
      <td>Basarabian Hills</td>
      <td>A Breath Of The Wide Valley</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-10-30</td>
      <td>Midnight Odyssey</td>
      <td>Converge, Rivers Of Hell</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>Darchon</td>
      <td>The Stygian Black Beyond</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/epic-black-metal" | relative_url }}">epic black metal</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Im Ra Distare Summum Soveris Seris Vas innoble</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
    ...
    <tr>
      ...
      <td>2020-04-28</td>
      <td>Lustre</td>
      <td>They Awoke the Scent of Winter</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
        </ul>
