...
Groove lounge blends jazz, funk, and electronic elements into sophisticated, laid-back soundscapes designed for upscale social settings. Born from 1990s lounge revival culture, it features downtempo beats, smooth instrumentation, and atmospheric production. The genre creates an effortlessly cool ambiance that bridges retro and contemporary styles.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/uutta-jazzia" | relative_url }}">uutta jazzia</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/uutta-jazzia" | relative_url }}">uutta jazzia</a> # 81</li>
