...
Boston represents the distinctive musical output of Massachusetts&#39; largest city, spanning from arena rock bombast to hardcore punk&#39;s aggressive minimalism and underground indie experimentation. The tag captures a working-class grit and DIY ethos that permeates across genres, reflecting the city&#39;s neighborhoods and youth culture. It encompasses both polished mainstream success and raw underground sounds unified by regional identity.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1977</td>
      <td>Michael Kenny</td>
      <td>Unsuccessful Attempt at Failure Demo</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>Lyres</td>
      <td>The Early Years (1979-1983)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boston" | relative_url }}">boston</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drone-rock" | relative_url }}">drone rock</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drone-rock" | relative_url }}">drone rock</a> # 97</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/skacore" | relative_url }}">skacore</a> # 64</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005-03-02</td>
      <td>Soloplexus</td>
      <td>Illusive Avenues of 6 Intrinsic Musicians</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boston" | relative_url }}">boston</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-rap" | relative_url }}">east coast rap</a></li>
    ...
    <tr>
      ...
      <td>Boston Drops the Gloves: A Tribute to Slapshot</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boston" | relative_url }}">boston</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mass" | relative_url }}">mass</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/desert-rock" | relative_url }}">desert rock</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drone-rock" | relative_url }}">drone rock</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drone-rock" | relative_url }}">drone rock</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2011</td>
      <td>Bloodshot Hooligans</td>
      <td>Bring Back The Spirit</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boston" | relative_url }}">boston</a></li>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>For The Worse</td>
      <td>For the Good, For the the Bad, For The Worse</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Guerilla Toss</td>
      <td>Guerilla Toss on Audiotree Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boston" | relative_url }}">boston</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/diy" | relative_url }}">diy</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
