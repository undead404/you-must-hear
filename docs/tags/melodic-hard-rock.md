...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 76 / 100)"> <a href="{{ "/tags/classic-rock" | relative_url }}">classic rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/arena-rock" | relative_url }}">arena rock</a> # 27</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/melodic-rock" | relative_url }}">melodic rock</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/melodic-rock" | relative_url }}">melodic rock</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2001-03-20</td>
      <td>Alice Cooper</td>
      <td>The Definitive Alice Cooper</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hard-rock" | relative_url }}">hard rock</a></li>
        </ul>
    ...
    <tr>
      <td>33</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/90bd7b93197246e588e0ebcc94ce97d7.png" alt="Cover for Vital Signs" style="max-width:120px; height:auto;" />
      </td>
      <td>2002</td>
      <td>Vital Signs</td>
      <td>Vital Signs</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/melodic-rock" | relative_url }}">melodic rock</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/melodic-rock" | relative_url }}">melodic rock</a> # 84</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Mysticity</td>
      <td>Ambassadors of the Hidden Sun</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-hard-rock" | relative_url }}">melodic hard rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012-11-14</td>
      <td>Lover Under Cover</td>
      <td>Set The Night On Fire</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hard-rock" | relative_url }}">hard rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-hard-rock" | relative_url }}">melodic hard rock</a></li>
    ...
    <tr>
      ...
      <td>2013-04-26</td>
      <td>Redrum</td>
      <td>Victims of Our Circumstances</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-hard-rock" | relative_url }}">melodic hard rock</a></li>
        </ul>
    ...
    <tr>
      <td>32</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6650385657f281a7b547c3e17d9d4258.png" alt="Cover for The Defiants" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-04-15</td>
      <td>The Defiants</td>
      <td>The Defiants</td>
    ...
    <tr>
      <td>21</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/85017740ed3549fac9b619d7989b6ddf.png" alt="Cover for We Are the Stars" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-05-01</td>
      <td>China</td>
      <td>We Are the Stars</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hard-rock" | relative_url }}">hard rock</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/melodic-hard-rock" | relative_url }}">melodic hard rock</a></li>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/3a59d20ac93c3659d62d29af4e38bd66.png" alt="Cover for Grit Your Teeth" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-12-04</td>
      <td>Vega</td>
    ...
    <tr>
      <td>13</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/fc67a4f1d2cc3140e9f3b65deac55416.png" alt="Cover for Overload" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-08-06</td>
      <td>Spektra</td>
      <td>Overload</td>
