...
Last updated: <time datetime="2025-11-11T10:21:32.385Z">Tue Nov 11 2025 12:21:32 GMT+0200 (Eastern European Standard Time)</time>

### Description

Baroque pop is a subgenre of pop music that emerged in the mid-1960s, characterized by a fusion of classical music elements and rock music. It typically features ornate arrangements, intricate melodies, and the use of instruments commonly found in classical music, such as harpsichords, cellos, and violins. The lyrics often have a poetic or literary quality, drawing on themes from literature, mythology, or history. Some of the most notable artists associated with baroque pop include The Beatles, The Beach Boys, The Left Banke, and Scott Walker.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>21</td>
      <td>
          <img src="https://i.discogs.com/_FgjquhM9Vhzwub_EXUHsBdXZbjVILV35X6Ca1mvHBg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MzY3/NjQtMTQ3NDM0MDIw/Mi0xMzQzLmpwZWc.jpeg" alt="Cover for Walk Away Renée&#x2F;Pretty Ballerina" style="max-width:120px; height:auto;" />
      </td>
      <td>1967-02</td>
      <td>The Left Banke</td>
      <td>Walk Away Renée&#x2F;Pretty Ballerina</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
        </ul>
    ...
    <tr>
      <td>14</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/cac702d0c3fe4616eab5281d0eb8fcb7.png" alt="Cover for Pleasures Of The Harbor" style="max-width:120px; height:auto;" />
      </td>
      <td>1967-10-31</td>
      <td>Phil Ochs</td>
      <td>Pleasures Of The Harbor</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
    ...
    <tr>
      ...
      <td>1968</td>
      <td>The Turtles</td>
      <td>The Turtles Present the Battle of the Bands</td>
      <td>
        <ul>
    ...
    <tr>
      <td>26</td>
      <td>
          <img src="https://i.discogs.com/TeCZ4TKjdqe7oICdKjal9ekpp242f0EQUZbJVLN3BGw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI1MDA2/NTgtMTI4NzQyNjA2/MS5qcGVn.jpeg" alt="Cover for Mediterráneo" style="max-width:120px; height:auto;" />
      </td>
      <td>1971</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-wave" | relative_url }}">new wave</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1986-06-16</td>
      <td>Mecano</td>
      <td>Entre el cielo y el suelo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
        </ul>
    ...
    <tr>
      <td>25</td>
      <td>
          <img src="https://i.discogs.com/_p3DPdmmrD25MpqdbdeyICfYicnGMPBjnYKBXJafYQ8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM3NDM0/My0xNjgwOTA0Mzky/LTE4NTIuanBlZw.jpeg" alt="Cover for A Short Album About Love" style="max-width:120px; height:auto;" />
      </td>
      <td>1997-02-10</td>
      <td>The Divine Comedy</td>
      <td>A Short Album About Love</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano-rock" | relative_url }}">piano rock</a> # 33</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop-rock" | relative_url }}">pop rock</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/indie-rock" | relative_url }}">indie rock</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>90</td>
      <td>
          <img src="https://i.discogs.com/frfR8fEy11EsF2ZkqJ0QTzbkauma-WcIyomBFaLP3u0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwNjU0/MjA5LTE2MzU2MzU1/MjQtMTM0Ni5qcGVn.jpeg" alt="Cover for Blue Banisters" style="max-width:120px; height:auto;" />
      </td>
      <td>2012</td>
      <td>Lana Del Rey</td>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/2b007b4344235bf2657c4cbfa18d1921.png" alt="Cover for Born to Die" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-01-24</td>
      <td>Lana Del Rey</td>
      <td>Born to Die</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/trip-hop" | relative_url }}">trip-hop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/funk" | relative_url }}">funk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Act IV: Rebirth In Reprise</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/indie-rock" | relative_url }}">indie rock</a></li>
    ...
    <tr>
      ...
      <td>Everything You&#39;ve Come To Expect (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2016-04-01</td>
      <td>The Last Shadow Puppets</td>
      <td>Everything You&#39;ve Come To Expect</td>
      <td>
        <ul>
    ...
    <tr>
      <td>13</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a1114f10c4abf8b5b9f3cde7a90f57ad.png" alt="Cover for Songs for the General Public" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-08-21</td>
      <td>The Lemon Twigs</td>
      <td>Songs for the General Public</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-rock" | relative_url }}">glam rock</a></li>
    ...
    <tr>
      <td>10</td>
      <td>
          <img src="https://i.discogs.com/JrhQNTyEmRq8NT8SdPCvdh503nJXvwkl5srNmlYOEfk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIxNDcx/NjgtMTcwNzEyOTU4/OS0yOTU1LmpwZWc.jpeg" alt="Cover for The Emitt Rhodes Recordings (1969-1973)" style="max-width:120px; height:auto;" />
      </td>
      <td>2023-04-21</td>
      <td>Emitt Rhodes</td>
      <td>The Emitt Rhodes Recordings (1969-1973)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque-pop" | relative_url }}">baroque pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop-rock" | relative_url }}">pop rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/art-rock" | relative_url }}">art rock</a> # 47</li>
        </ul>
      </td>
    </tr>
    <tr>
