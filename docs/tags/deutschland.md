...
The &quot;deutschland&quot; tag encompasses music from German-speaking artists across diverse genres, unified by linguistic and cultural identity rather than a specific sound. It ranges from industrial metal and alternative rock to electronic music and hip-hop, reflecting Germany&#39;s rich musical landscape. The tag captures both mainstream and underground expressions of contemporary German culture through music.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Fischer-Z</td>
      <td>Going Deaf for a Living</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/new-wave" | relative_url }}">new wave</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/germany" | relative_url }}">germany</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Sacred Spirit</td>
      <td>Sacred Spirit: Chants And Dances Of The Native Americans</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hamburg" | relative_url }}">hamburg</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/germany" | relative_url }}">germany</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Sestatee</td>
      <td>EINSTEIN Compilation 2005</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>2006-06-23</td>
      <td>Nathalie Tineo</td>
      <td>Licht &amp; Schatten</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-04-18</td>
      <td>Suffocate Bastard</td>
      <td>Acts Of Contemporary Violence</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/dancehall" | relative_url }}">dancehall</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Rhythms Del Mundo feat. Reamonn - Tonight</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Various Artists</td>
      <td>Discovering Jens Buchert (compiled and mixed by Side Liner)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chillout" | relative_url }}">chillout</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-metal" | relative_url }}">german metal</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2009-02-06</td>
      <td>Jens Buchert</td>
      <td>Electronic Space Odyssey: Transcending Lounge Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/europe" | relative_url }}">europe</a></li>
    ...
    <tr>
      ...
      <td>2010-12-01</td>
      <td>Various Artists</td>
      <td>Countdown Grand Prix Eurovision 2000</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/germany" | relative_url }}">germany</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/germany" | relative_url }}">germany</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2024-05-29</td>
      <td>Sestatee</td>
      <td>Phonoploid Maxi LC 12640</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Das-Kollektiv.net</td>
      <td>Das, Was Bleibt, Hat Keinen Namen</td>
      <td>
        <ul>
        </ul>
      </td>
