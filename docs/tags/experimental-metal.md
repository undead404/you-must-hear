...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>Sol Niger Within Version 3.33</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
    ...
    <tr>
      ...
      <td>2001-11-19</td>
      <td>Lux Occulta</td>
      <td>The Mother and the Enemy</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/jazz-metal" | relative_url }}">jazz metal</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2007-04-16</td>
      <td>Mithras</td>
      <td>Behind the Shadows Lie Madness</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>It Will Come</td>
      <td>Truth is nothing but deceit</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-fronted-metal" | relative_url }}">female fronted metal</a></li>
    ...
    <tr>
      ...
      <td>2009-05-16</td>
      <td>Current 93</td>
      <td>MonoHallucinatory Mountain</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/psychedelic-rock" | relative_url }}">psychedelic rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/instrumental-metal" | relative_url }}">instrumental metal</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a></li>
    ...
    <tr>
      ...
      <td>2014-08-27</td>
      <td>Troldhaugen</td>
      <td>Obzkure Anekdotez For Maniakal Massez</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-garde-metal" | relative_url }}">avant-garde metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a></li>
    ...
    <tr>
      ...
      <td>2017-02-03</td>
      <td>Pryapisme</td>
      <td>Diabolicus Felinae Pandemonium</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-garde-metal" | relative_url }}">avant-garde metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a></li>
    ...
    <tr>
      ...
      <td>Heptaedium Versus Cartoon Theory</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
    ...
    <tr>
      <td>86</td>
      <td>
          <img src="https://i.discogs.com/dv6KJzEl3zJMYb-jcHrI-1raP0TkpqRvi9Y6X4UDtIM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExODg3/MDEwLTE1MjQxNzc2/MjYtMzk4NC5qcGVn.jpeg" alt="Cover for Direct Memory Access" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-04-20</td>
      <td>master boot record</td>
    ...
    <tr>
      <td>82</td>
      <td>
          <img src="https://i.discogs.com/7vdB29ch2Imq7or03kVdFNQgAYosElQjoFxBqlJ6SFM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM3ODgy/ODAtMTM3Mzc2NzM0/Ny01NzA0LmpwZWc.jpeg" alt="Cover for The House Primordial" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-05-01</td>
      <td>Thou</td>
    ...
    <tr>
      ...
      <td>2022-03-31</td>
      <td>Pagefire</td>
      <td>Best of Pagefire, Collection 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>84</td>
      <td>
          <img src="https://i.discogs.com/7BwpDw38G9_jFa735L815QAo8s7k6tNoFidyRLSmCD4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzMjE2/NDQ3LTE2NjU0MjM2/ODItODk4My5qcGVn.jpeg" alt="Cover for PERSONAL COMPUTER" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-05-13</td>
      <td>master boot record</td>
