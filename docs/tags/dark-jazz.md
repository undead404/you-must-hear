...
Last updated: <time datetime="2025-12-05T12:33:41.037Z">Fri Dec 05 2025 14:33:41 GMT+0200 (Eastern European Standard Time)</time>

### Description

Dark jazz is a brooding, atmospheric subgenre that fuses traditional jazz elements with noir aesthetics, downtempo rhythms, and ambient or industrial textures. Emerging in the 1990s, it evokes cinematic soundscapes reminiscent of film noir and psychological thrillers, often incorporating slow tempos, minor keys, and haunting instrumentation. The genre creates an immersive, shadowy mood that appeals to listeners drawn to experimental and melancholic soundscapes.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>33</td>
      <td>
          <img src="https://i.discogs.com/NSphTKSpsSPXQKwAElPN-xivx0Ce1fc1eT2TqK_pZQg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMxOTgy/Ny0xMTY0MTk1NTQy/LmpwZWc.jpeg" alt="Cover for Incommunicado" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
    ...
    <tr>
      ...
      <td>Where Psyche Meets Cupid</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Marek Zebrowski &amp; David Lynch</td>
      <td>Polish Night Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
    ...
    <tr>
      ...
      <td>Stories from Midnight Streets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>38</td>
      <td>
          <img src="https://i.discogs.com/ddE8WiAl3RzbO-K0t1T4rnp24LT3xwWXN95TRLpTD3E/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE4MzI0/NjM3LTE2MTg1OTAz/MjEtNjE1NC5qcGVn.jpeg" alt="Cover for Doom Jazz" style="max-width:120px; height:auto;" />
      </td>
      <td>2008</td>
      <td>Swami LatePlate</td>
      <td>Doom Jazz</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-noise" | relative_url }}">ambient noise</a> # 44</li>
    ...
    <tr>
      ...
      <td>2010-02-04</td>
      <td>Homestuck</td>
      <td>Midnight Crew: Drawing Dead</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-03-29</td>
      <td>Somewhere off Jazz Street</td>
      <td>Whispers of Empty Spaces II</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-fusion" | relative_url }}">jazz fusion</a></li>
    ...
    <tr>
      ...
      <td>2010-03-30</td>
      <td>Somewhere off Jazz Street</td>
      <td>Whispers of Empty Spaces</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-fusion" | relative_url }}">jazz fusion</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2011-12-16</td>
      <td>The Kilimanjaro Darkjazz Ensemble</td>
      <td>I Forsee The Dark Ahead, If I Stay</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2012-04-06</td>
      <td>Kaiti Kink Ensemble</td>
      <td>Under the Iron Sky</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
    ...
    <tr>
      <td>28</td>
      <td>
          <img src="https://i.discogs.com/FZU92K6bOdNjJPDXvPQBlSAYde3u7uCd6lMaB3AEO3g/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ3NDY1/ODMtMTM3NDE5MDE4/Mi05NDc1LmpwZWc.jpeg" alt="Cover for Legacy of the Witty" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-05-21</td>
      <td>Trigg &amp; Gusset</td>
      <td>Legacy of the Witty</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-07-01</td>
      <td>Marsen Jules Trio</td>
      <td>Présence Acousmatique</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-09-27</td>
      <td>Dale Cooper Quartet &amp; The Dictaphones</td>
      <td>Quatorze Pièces de Menace</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-10</td>
      <td>Dale Cooper Quartet &amp; The Dictaphones</td>
      <td>Quatorze Pieces De Menace</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Current 93</td>
      <td>I Am the Last of All the Field That Fell (A Channel)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
    ...
    <tr>
      ...
      <td>2018-01-15</td>
      <td>The Thing With Five Eyes</td>
      <td>Noirabesque</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/blackgaze" | relative_url }}">blackgaze</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2020-06-26</td>
      <td>Junkyard Shaman</td>
      <td>Silence, Then Pause</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>27</td>
      <td>
          <img src="https://i.discogs.com/97uUmcv63nAxVc1fcrUtkXpIr2jpS5aCpjR7yoxGZEo/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwNzE5/OTgxLTE2MzUxMjg0/MDQtMjc5OC5qcGVn.jpeg" alt="Cover for Black Ocean" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-10-01</td>
      <td>Trigg &amp; Gusset</td>
      <td>Black Ocean</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/avant-garde-jazz" | relative_url }}">avant-garde jazz</a> # 56</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Joel Fausto &amp; Illusion Orchestra</td>
      <td>Illusion Orchestra At The Gloomy Club</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-jazz" | relative_url }}">dark jazz</a></li>
        </ul>
