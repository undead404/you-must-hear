...
Last updated: <time datetime="2025-12-06T16:18:39.807Z">Sat Dec 06 2025 18:18:39 GMT+0200 (Eastern European Standard Time)</time>

### Description

Bitcore fuses the raw energy of hardcore punk and metal with the nostalgic, pixelated sounds of 8-bit video game music and chiptune synthesizers. The tag embraces a deliberately chaotic and maximalist approach, combining aggressive guitar riffs, breakneck tempos, and electronic bleeps into a hyperactive, often humorous sonic assault. It captures the irreverent spirit of internet culture and gaming nostalgia filtered through an intense, high-energy punk aesthetic.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/alternative-electronic" | relative_url }}">alternative electronic</a> # 50</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/alternative-electronic" | relative_url }}">alternative electronic</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Various Artists</td>
      <td>Big Money Cybergrind - Compilation, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Math the Band</td>
      <td>Math the Band and the Secret of Mystery Island</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/8-bit" | relative_url }}">8-bit</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bitcore" | relative_url }}">bitcore</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Math the Band</td>
      <td>All Good Things, All In Good Time</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/alternative-electronic" | relative_url }}">alternative electronic</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/alternative-electronic" | relative_url }}">alternative electronic</a> # 16</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/alternative-electronic" | relative_url }}">alternative electronic</a> # 15</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bitpop" | relative_url }}">bitpop</a> # 23</li>
    ...
    <tr>
      ...
      <td>2008-12-04</td>
      <td>Anamanaguchi</td>
      <td>Dawn Metropolis Preview EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/8-bit" | relative_url }}">8-bit</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bitcore" | relative_url }}">bitcore</a></li>
    ...
    <tr>
      ...
      <td>2012-03-02</td>
      <td>Math the Band</td>
      <td>Best Swishes! Thanks a Dunks!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/8-bit" | relative_url }}">8-bit</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bitcore" | relative_url }}">bitcore</a></li>
    ...
    <tr>
      ...
      <td>2020-05-29</td>
      <td>Alestorm</td>
      <td>Curse of the Crystal Coconut (Deluxe Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bitcore" | relative_url }}">bitcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chiptune" | relative_url }}">chiptune</a></li>
    ...
    <tr>
      ...
      <td>2020-07-03</td>
      <td>Tape Girl</td>
      <td>Half-Pipe (The Art of Vocal Feminization)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/8-bit" | relative_url }}">8-bit</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bitcore" | relative_url }}">bitcore</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/alternative-electronic" | relative_url }}">alternative electronic</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>i feel like i deserve to feel like this forever and i will</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/8-bit" | relative_url }}">8-bit</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bitcore" | relative_url }}">bitcore</a></li>
