...
Electropunk fuses the raw energy and rebellious attitude of punk rock with electronic instruments like synthesizers, drum machines, and digital effects. Emerging from late 1970s underground scenes, it strips away traditional guitar-driven sounds in favor of aggressive, confrontational electronic textures. The genre emphasizes DIY ethics, chaotic performances, and an abrasive sonic aesthetic that challenges conventional rock music.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Suicide</td>
      <td>Suicide (The Second Album)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic-rock" | relative_url }}">electronic rock</a></li>
    ...
    <tr>
      ...
      <td>1994-05-10</td>
      <td>Devo</td>
      <td>Duty Now for the Future &#x2F; New Traditionalists</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Mindless Self Indulgence</td>
      <td>Alienating Our Audience: Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-04-12</td>
      <td>Mindless Self Indulgence</td>
      <td>You&#39;ll Rebel To Anything (Expanded and Remastered)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2006-05-05</td>
      <td>Mediengruppe Telekommander</td>
      <td>Näher Am Menschen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-03-19</td>
      <td>Bratze</td>
      <td>Korrektur Nach Unten &amp; Die Notwendigkeit einer Übersetzung</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
    ...
    <tr>
      ...
      <td>2013-05-14</td>
      <td>Mindless Self Indulgence</td>
      <td>How I Learned To Stop Giving A Shit And Love Mindless Self Indulgence (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2015-11-13</td>
      <td>Grossstadtgeflüster</td>
      <td>Fickt-Euch-Allee (Episode 1)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electroclash" | relative_url }}">electroclash</a></li>
    ...
    <tr>
      ...
      <td>2021-12-10</td>
      <td>Grossstadtgeflüster</td>
      <td>Bis Einer Heult !!!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2022-09-23</td>
      <td>Kochkraft durch KMA</td>
      <td>Alle Kinder sind tot</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electropunk" | relative_url }}">electropunk</a></li>
        </ul>
