...
Last updated: <time datetime="2025-11-08T19:38:57.188Z">Sat Nov 08 2025 21:38:57 GMT+0200 (Eastern European Standard Time)</time>

### Description

Gothic pop merges the dark aesthetics and melancholic themes of gothic subculture with accessible pop structures and electronic production. The sound balances shadowy atmospheres, dramatic vocals, and brooding lyrics against catchy melodies and modern beats, creating an emotionally intense yet radio-friendly style. It appeals to listeners drawn to theatrical, moody music that explores themes of death, romance, and psychological darkness without sacrificing mainstream appeal.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>77</td>
      <td>
          <img src="https://i.discogs.com/i0rDsl0bcOMndJQ_QP1FdgI3LkV2_EkKvg2omTgypQ0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE5OTY0/My0xNTkwMTAxODk3/LTYxMjkuanBlZw.jpeg" alt="Cover for Chologoth" style="max-width:120px; height:auto;" />
      </td>
      <td>1990</td>
      <td>Prayers</td>
      <td>Chologoth</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chicano-rap" | relative_url }}">chicano rap</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>34</td>
      <td>
          <img src="https://i.discogs.com/iy88UpDLJcd0-KsYPFGEGlYra014DJTDeZ25jk5WWaY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0NjE1/MC0xNTE0MzgxMzUw/LTI5MDQuanBlZw.jpeg" alt="Cover for The Wheel" style="max-width:120px; height:auto;" />
      </td>
      <td>1991</td>
      <td>Coil</td>
      <td>The Wheel</td>
    ...
    <tr>
      <td>15</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/3a66850ce1aa84cadfc98910d0220e5f.png" alt="Cover for The Rapture" style="max-width:120px; height:auto;" />
      </td>
      <td>1995-01</td>
      <td>Siouxsie and the Banshees</td>
      <td>The Rapture</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>7</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/4a11775d0f4d4917bb51657b604b5903.png" alt="Cover for Closed for Business" style="max-width:120px; height:auto;" />
      </td>
      <td>1997-10-06</td>
      <td>Mansun</td>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 84 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/italian" | relative_url }}">italian</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/italian-pop" | relative_url }}">italian pop</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>86</td>
      <td>
          <img src="https://i.discogs.com/_xoHu6MXFA1m1kEKw0w1T2PaAzTYHXF8cwUfZ11E0CQ/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI5MDI3/ODUtMTMwNjQ3ODIw/Mi5qcGVn.jpeg" alt="Cover for intruder" style="max-width:120px; height:auto;" />
      </td>
      <td>2000</td>
      <td>Gary Numan</td>
      <td>intruder</td>
    ...
    <tr>
      ...
      <td>2000-10-31</td>
      <td>Collide</td>
      <td>Chasing the Ghost</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/dream-folk" | relative_url }}">dream folk</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/world-fusion" | relative_url }}">world fusion</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
            ...
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/dream-pop" | relative_url }}">dream pop</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Cécile Corbel</td>
      <td>Best of SongBooks</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 86.66666666666667 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 86.66666666666667 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 86.66666666666667 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            ...
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>26</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/1d4b8f0ef76f180ded7fd2f5a8cac31d.png" alt="Cover for Unter dem Eis (Re Release)" style="max-width:120px; height:auto;" />
      </td>
      <td>2008</td>
      <td>Eisblume</td>
      <td>Unter dem Eis (Re Release)</td>
      <td>
        <ul>
    ...
    <tr>
      <td>29</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/679a961b6ddb4bb2b3f7bdb3bb258799.png" alt="Cover for Love Is Dead" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-01-01</td>
      <td>Kerli</td>
      <td>Love Is Dead</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/soprano" | relative_url }}">soprano</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>A Story Of Hurt (2010 Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            ...
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/poetry" | relative_url }}">poetry</a></li>
            ...
            <li style="font-size: calc(1rem * 68 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
            <li style="font-size: calc(1rem * 68 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/dream-folk" | relative_url }}">dream folk</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/new-age" | relative_url }}">new age</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/dream-folk" | relative_url }}">dream folk</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/freak-folk" | relative_url }}">freak folk</a></li>
            ...
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/neoclassical-darkwave" | relative_url }}">neoclassical darkwave</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Ceremonials (Original Deluxe Version)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a> # 35</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/epic-metal" | relative_url }}">epic metal</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/symphonic-power-metal" | relative_url }}">symphonic power metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2015-06-16</td>
      <td>Richard Benson</td>
      <td>L&#39;inferno dei vivi</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 84 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 84 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 84 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
            ...
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/epic-metal" | relative_url }}">epic metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>35</td>
      <td>
          <img src="https://i.discogs.com/6FTOTTNlNPtXBzoVus0cq2DJIUzVkIATX_L0sSKjA-M/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExNjAw/MTQwLTE1MTkyMDYw/NzAtNDAxNy5qcGVn.jpeg" alt="Cover for The Magic Lullaby" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-12-05</td>
      <td>Eurielle</td>
      <td>The Magic Lullaby</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/soprano" | relative_url }}">soprano</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>90</td>
      <td>
          <img src="https://i.discogs.com/bzUKfdtleF9MVWgaAOwCiXBkwboDVG7Nb41dUYBNCzU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE3NTQ1/ODUtMTI0MTIxMDk4/NC5qcGVn.jpeg" alt="Cover for Everything Is Burning (Metanoia Addendum)" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-09-02</td>
      <td>IAMX</td>
      <td>Everything Is Burning (Metanoia Addendum)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/new-age" | relative_url }}">new age</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            ...
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/easy-listening" | relative_url }}">easy listening</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/neoclassical-darkwave" | relative_url }}">neoclassical darkwave</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/soprano" | relative_url }}">soprano</a></li>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/easy-listening" | relative_url }}">easy listening</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/neoclassical-darkwave" | relative_url }}">neoclassical darkwave</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/new-age" | relative_url }}">new age</a></li>
    ...
    <tr>
      <td>76</td>
      <td>
          <img src="https://i.discogs.com/UJMWaBMTNRX90UmuooRnAV4V0RCoHz32NiO6nVAN2c0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0NjUw/NzEtMTQ4NDQyNTAx/Ny0xODgwLmpwZWc.jpeg" alt="Cover for Savage (Songs from a Broken World) [Expanded Edition]" style="max-width:120px; height:auto;" />
      </td>
      <td>2017-09-15</td>
      <td>Gary Numan</td>
      <td>Savage (Songs from a Broken World) [Expanded Edition]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro-industrial" | relative_url }}">electro-industrial</a></li>
    ...
    <tr>
      <td>64</td>
      <td>
          <img src="https://i.discogs.com/0yV7UWyVz2wxcX1o7rFT7h4iSNs8__pjyPpG4FOFz20/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1NTc5/MzA3LTE1OTM5NTcy/OTktOTUxNi5qcGVn.jpeg" alt="Cover for Chapter 1" style="max-width:120px; height:auto;" />
      </td>
      <td>2018</td>
      <td>SKYND</td>
      <td>Chapter 1</td>
    ...
    <tr>
      <td>97</td>
      <td>
          <img src="https://i.discogs.com/0yV7UWyVz2wxcX1o7rFT7h4iSNs8__pjyPpG4FOFz20/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1NTc5/MzA3LTE1OTM5NTcy/OTktOTUxNi5qcGVn.jpeg" alt="Cover for Chapter I" style="max-width:120px; height:auto;" />
      </td>
      <td>2018</td>
      <td>SKYND</td>
      <td>Chapter I</td>
    ...
    <tr>
      <td>89</td>
      <td>
          <img src="https://i.discogs.com/FstbmwpewLK5CSSSZs2hcN2xISpJOLe3UN-lgDHvj-I/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyNDI4/NzQ5LTE1MzUxMTI4/MDItNTY3OC5qcGVn.jpeg" alt="Cover for The Victorian Wallflowers" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-08-24</td>
      <td>Ashbury Heights</td>
      <td>The Victorian Wallflowers</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
    ...
    <tr>
      <td>98</td>
      <td>
          <img src="https://i.discogs.com/VM98MjHWqhclQMKzDfGpIM0Lvlx1YQsuVmJ80Ns7WIs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1MDY3/OTU3LTE1ODYyNjIw/MDUtMzI4Mi5qcGVn.jpeg" alt="Cover for Chapter II" style="max-width:120px; height:auto;" />
      </td>
      <td>2019</td>
      <td>SKYND</td>
      <td>Chapter II</td>
    ...
    <tr>
      <td>94</td>
      <td>
          <img src="https://i.discogs.com/S7PATgqTFwKLJxo2K9uzKbOqAuXzID84p6hcOF2ONfI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1ODk3/NzA0LTE1OTk4MDgy/NDctNTI1Ny5wbmc.jpeg" alt="Cover for Vicious Pastimes" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-09-04</td>
      <td>House of Harm</td>
      <td>Vicious Pastimes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/coldwave" | relative_url }}">coldwave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
    ...
    <tr>
      <td>75</td>
      <td>
          <img src="https://i.discogs.com/Eaiy_AxO-cjrxIpA4yGbg0DXMsYcYHPFKOzMWy-dGh4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE2OTE3/ODAxLTE2MTA1OTQ0/MjctMTcyNy5qcGVn.jpeg" alt="Cover for Beneath The Black Palms" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-01-08</td>
      <td>Blaqk Audio</td>
      <td>Beneath The Black Palms</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
    ...
    <tr>
      <td>25</td>
      <td>
          <img src="https://i.discogs.com/OAnfaWcNf_9724nYFFm8__PmimInEAc52Gws1Nei-sg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE3NTMy/NjA3LTE2MTM5OTA5/OTItNTAzMS5qcGVn.jpeg" alt="Cover for The Brides of the Black Room" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-01-29</td>
      <td>The Brides of the Black Room</td>
      <td>The Brides of the Black Room</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
    ...
    <tr>
      <td>47</td>
      <td>
          <img src="https://i.discogs.com/9cvFJgT4qfkrCnkOVCVe4hy4VKXn9Cc6Q2R3mep56kY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE4NzU5/MDcwLTE2MjEyMDU3/NTEtNzk5Mi5qcGVn.jpeg" alt="Cover for Have Courage Dear Heart" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-05-06</td>
      <td>Liv Kristine</td>
      <td>Have Courage Dear Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://i.discogs.com/cFAFH1FieVuqHZuIzKlL9SzJxIpxxdSgA7Ud-b2l2DU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE5NDc1/MTQwLTE2NzY3MDUx/NDYtMTA1OS5qcGVn.jpeg" alt="Cover for New Earth" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-06-30</td>
    ...
    <tr>
      <td>80</td>
      <td>
          <img src="https://i.discogs.com/5eSlTwTqcm_2oMNB8839b-sxzz5rXW7v-aOhDmfPY_g/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwMDA1/OTgxLTE2MzAwMTA3/MzktNDY4MC5qcGVn.jpeg" alt="Cover for Love Made Me Do It" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-08-27</td>
      <td>Kat Von D</td>
    ...
    <tr>
      <td>55</td>
      <td>
          <img src="https://i.discogs.com/1JW1IwmdIVF16QK9CiO485oJnQau7iTofAQOV0VIUKM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwMzE2/NDkzLTE2MzIyNDA0/NDktMzAxOS5qcGVn.jpeg" alt="Cover for Cutting Room Floor" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-09-03</td>
      <td>Wingtips</td>
    ...
    <tr>
      <td>39</td>
      <td>
          <img src="https://i.discogs.com/xN9sPjinsifNKOyvck98_upHrYHwF62W0kzlIspVRKM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwNDQ0/NTE4LTE2Mzc1NDE2/NjktNTEwMy5qcGVn.jpeg" alt="Cover for Blood and Fire" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-10-01</td>
      <td>The Brides of the Black Room</td>
    ...
    <tr>
      <td>83</td>
      <td>
          <img src="https://i.discogs.com/PH488k9wDZcgjRyf96EZ-zkgGRYG2Qef2XqxnaoYZA8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyMzUw/NTA4LTE2NDYxNjUx/MDYtODQ3MC5qcGVn.jpeg" alt="Cover for Dazed" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-11-05</td>
      <td>Dlina Volny</td>
      <td>Dazed</td>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/retrowave" | relative_url }}">retrowave</a> # 51</li>
    ...
    <tr>
      <td>68</td>
      <td>
          <img src="https://i.discogs.com/vh7kJuy2eaWYljskFMWBxZyiqJr8Xq_EiOf7zfbZfNQ/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyMDA0/NjgzLTE2NDM4NzY2/MjYtNjkwNi5qcGVn.jpeg" alt="Cover for New Earth Remixes" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-11-19</td>
      <td>Nuovo Testamento</td>
      <td>New Earth Remixes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/freestyle" | relative_url }}">freestyle</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-romantic" | relative_url }}">new romantic</a> # 47</li>
    ...
    <tr>
      <td>49</td>
      <td>
          <img src="https://i.discogs.com/-E8-AIehvk2mpD0mFaFg2hwKON3RjOoPsI4_N9KUREQ/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIxOTAx/ODIyLTE2NDMyMjU1/NjEtNDc1NC5qcGVn.jpeg" alt="Cover for New Flesh" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-12-03</td>
      <td>Love object</td>
      <td>New Flesh</td>
    ...
    <tr>
      <td>51</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/9b03ce35c4b8243db76e7f73a14fe269.png" alt="Cover for Iv0x10v5" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-02-04</td>
      <td>Josie Pace</td>
      <td>Iv0x10v5</td>
    ...
    <tr>
      <td>70</td>
      <td>
          <img src="https://i.discogs.com/UY4DVDKe5YVY2Zn7Fi-LqB6B4UHQGuea6SFROIE9tCc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzMzg3/MjU1LTE2NTM3NjMw/MzQtMTYzMi5qcGVn.jpeg" alt="Cover for The Decline of Pleasure" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-05-27</td>
      <td>Sacred Skin</td>
      <td>The Decline of Pleasure</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-romantic" | relative_url }}">new romantic</a> # 50</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>58</td>
      <td>
          <img src="https://i.discogs.com/YrstRY8Qc5GkPAmRrCRhdT4kpmp3r9LSOHB-k7LngEM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI0MTA2/MTQ1LTE2NTk2ODUx/OTgtNTQ0OC5qcGVn.jpeg" alt="Cover for This is My Battle Cry" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-08-05</td>
      <td>Ayria</td>
      <td>This is My Battle Cry</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dance-pop" | relative_url }}">dance-pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a></li>
    ...
    <tr>
      <td>37</td>
      <td>
          <img src="https://i.discogs.com/seIdmpubMIeBThn4RDerk8g8X29BY2ek-ekB76QCgS8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzNjE0/MTA3LTE2MjY3OTM4/NDAtNDg5My5qcGVn.jpeg" alt="Cover for Brennen" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-10-28</td>
      <td>Lyschko</td>
      <td>Brennen</td>
    ...
    <tr>
      <td>66</td>
      <td>
          <img src="https://i.discogs.com/wR30WeyA0qDSxklj2boKk6PlYYEo53x-UUaC-55bxQI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI1Nzk4/MjQzLTE2NzcyNjM2/MjUtOTAxMS5qcGVn.jpeg" alt="Cover for Oceanflower" style="max-width:120px; height:auto;" />
      </td>
      <td>2023</td>
      <td>Kraków Loves Adana</td>
      <td>Oceanflower</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/coldwave" | relative_url }}">coldwave</a></li>
    ...
    <tr>
      <td>23</td>
      <td>
          <img src="https://i.discogs.com/puZNDHxajZHjW34yfDz3yFE9wOgG9elqElmnYLfZLQY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI2MTk1/NzIzLTE2NzcxMzYy/OTQtODU2OC5qcGVn.jpeg" alt="Cover for Midnight Proposals" style="max-width:120px; height:auto;" />
      </td>
      <td>2023-02-17</td>
      <td>Jennifer Touch</td>
      <td>Midnight Proposals</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/coldwave" | relative_url }}">coldwave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
    ...
    <tr>
      <td>99</td>
      <td>
          <img src="https://i.discogs.com/R_71tNTy0LKlj4dbmcnpg24nnh_g-AUIegWDfrDSt30/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTcyNTgx/NDktMTQ3NTY1NzM0/My0yODkwLmpwZWc.jpeg" alt="Cover for Gingerbread Man" style="max-width:120px; height:auto;" />
      </td>
      <td>2023-03-17</td>
      <td>Melanie Martinez</td>
    ...
    <tr>
      <td>62</td>
      <td>
          <img src="https://i.discogs.com/J8yXTwIjDq2qAeXPf4EBJTyRKSammqJ9u-WYmOxGCXs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI2ODQ0/Mjg3LTE2ODIxNzMz/OTAtNTU0Ny5qcGVn.jpeg" alt="Cover for River of Diamonds" style="max-width:120px; height:auto;" />
      </td>
      <td>2023-04-21</td>
      <td>Liv Kristine</td>
      <td>River of Diamonds</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-pop" | relative_url }}">dark pop</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>32</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/aea54f7d1bb91f6e45bcc924fc856ec0.png" alt="Cover for Cry Baby (Deluxe Version)" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-05-17</td>
      <td>Melanie Martinez</td>
      <td>Cry Baby (Deluxe Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/riot-grrrl" | relative_url }}">riot grrrl</a> # 42</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-punk-revival" | relative_url }}">post-punk revival</a> # 64</li>
    ...
    <tr>
      ...
      <td></td>
      <td>Un&#39;autre Espoire</td>
      <td>The birth of fallen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Un&#39;autre Espoire</td>
      <td>The birth of fallen (not disc tracks)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
