...
&quot;Polskie&quot; refers to music sung in the Polish language, encompassing diverse styles from rock and punk to pop and poetry-driven ballads rooted in Polish cultural traditions. The tag captures Poland&#39;s rich musical heritage, blending folk influences with contemporary genres and often featuring introspective, poetic lyrics. It represents the sound of Polish identity across generations, from emotional singer-songwriters to rebellious rock bands.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The Best of Czerwone Gitary</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polish" | relative_url }}">polish</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polskie" | relative_url }}">polskie</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/polish" | relative_url }}">polish</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Pidżama Porno</td>
      <td>Ulice Jak Stygmaty - absolutne rarytasy</td>
      <td>
        <ul>
    ...
    <tr>
      <td>50</td>
      <td>
          <img src="https://i.discogs.com/iOR6zx1sjWE09x4VDsqg27hIEejnzx_x56fNwwunVm4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyOTky/NDctMTIyNDc2OTg3/Mi5qcGVn.jpeg" alt="Cover for Intymnie" style="max-width:120px; height:auto;" />
      </td>
      <td>2001</td>
      <td>Ryszard Rynkowski</td>
      <td>Intymnie</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 69.86301369863014 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2005-11-21</td>
      <td>Verba</td>
      <td>Dwudziesty Pierwszy Listopada</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polish" | relative_url }}">polish</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Brodka</td>
      <td>Moje piosenki edycja zwykla</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polskie" | relative_url }}">polskie</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 72.72727272727273 / 100)"> <a href="{{ "/tags/polish" | relative_url }}">polish</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2008-02-25</td>
      <td>Rasmentalism</td>
      <td>&#39;dobra muzyka, ładne życie&#39;</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2009-10-02</td>
      <td>Stanisław Soyka</td>
      <td>Koledy Polskie</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polskie" | relative_url }}">polskie</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Magda Wang</td>
      <td>I follow You ( wherever You go... )</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Gintrowski, Kaczmarski, Łapiński</td>
      <td>mury</td>
      <td>
        <ul>
        </ul>
