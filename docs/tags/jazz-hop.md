...
Last updated: <time datetime="2025-11-11T04:08:29.607Z">Tue Nov 11 2025 06:08:29 GMT+0200 (Eastern European Standard Time)</time>

### Description

Jazz hop is a fusion genre blending hip-hop beats with live jazz instrumentation, including horns, keyboards, and upright bass. Emerging in the 1990s, it bridges the gap between jazz&#39;s improvisational heritage and hip-hop&#39;s rhythmic foundation. The style emphasizes musical sophistication while maintaining the groove and energy of contemporary urban music.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1990-03-12</td>
      <td>A Tribe Called Quest</td>
      <td>Peoples&#39; Instinctive Travels &amp; the Paths of Rhythm</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Mecca and the Soul Brother</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>De La Soul</td>
      <td>Art Official Intelligence</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
    ...
    <tr>
      ...
      <td>2000-04-01</td>
      <td>Don Johnson Big Band</td>
      <td>Support de Microphones</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Yesterday&#39;s New Quintet</td>
      <td>Angles Without Edges</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 83.5820895522388 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2005-01-01</td>
      <td>Digable Planets</td>
      <td>Beyond the Spectrum: The Creamy Spy Chronicles</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
        </ul>
    ...
    <tr>
      <td>70</td>
      <td>
          <img src="https://i.discogs.com/3OCzEG7XG1XCmmFW-8VrMHjfGZGWJg7GrNRprUSu73Q/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEwMTg0/NDQtMTUwNDg3Njg3/NC03Mzc0LmpwZWc.jpeg" alt="Cover for Endangered Species (Bonus Edition)" style="max-width:120px; height:auto;" />
      </td>
      <td>2006</td>
      <td>Nickodemus</td>
      <td>Endangered Species (Bonus Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/funk" | relative_url }}">funk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
    ...
    <tr>
      ...
      <td>2006-07-05</td>
      <td>ShinSight Trio</td>
      <td>Shallow Nights Blurry Moon</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-04-02</td>
      <td>ArtOfficial</td>
      <td>Fist Fights and Foot Races</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-10-21</td>
      <td>Shawn Lee &amp; Clutchy Hopkins</td>
      <td>Clutch Of The Tiger</td>
      <td>
        <ul>
    ...
    <tr>
      <td>77</td>
      <td>
          <img src="https://i.discogs.com/fZRCZI9KeePH2irHApVccAmPxVx_gfEAtmVuAsGiKCI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIxMDU3/MTgtMTI2NDMyMjU0/My5qcGVn.jpeg" alt="Cover for Sound Surroundings" style="max-width:120px; height:auto;" />
      </td>
      <td>2009</td>
      <td>The Q4</td>
      <td>Sound Surroundings</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/trip-hop" | relative_url }}">trip-hop</a></li>
    ...
    <tr>
      ...
      <td>2012-03-05</td>
      <td>Big K.R.I.T.</td>
      <td>Big K.R.I.T. - 4Eva N A Day</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rap" | relative_url }}">rap</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turntablism" | relative_url }}">turntablism</a> # 65</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-jazz" | relative_url }}">contemporary jazz</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turntablism" | relative_url }}">turntablism</a> # 59</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Surreal &amp; The Sound Providers</td>
      <td>Place To Be - Single</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
