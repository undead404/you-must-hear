...
Doomcore is a subgenre of electronic music that combines elements of doom metal and hardcore techno. It is characterized by a slow and heavy beat, distorted and aggressive soundscapes, and intense, often menacing vocals. The music often features dark and foreboding themes, drawing inspiration from horror movies and dystopian literature. Doomcore emerged in the early 1990s and has since developed a small but dedicated following among fans of experimental and underground electronic music.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/terrorcore" | relative_url }}">terrorcore</a> # 29</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 37</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2002-01</td>
      <td>Subversion</td>
      <td>Beatin&#39; The Shit Out Of It</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/metal" | relative_url }}">metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006-04</td>
      <td>Joshua</td>
      <td>Dark Temple - This Is Real Darkcore</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 40</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2007-03-05</td>
      <td>The Man Unknown</td>
      <td>Generic Prototype EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-techno" | relative_url }}">hardcore techno</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 82</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 64</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2011-01-01</td>
      <td>Hibou</td>
      <td>Hibou - (2000-2010) 10 Coffins</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-techno" | relative_url }}">hardcore techno</a></li>
    ...
    <tr>
      ...
      <td>2013-07-22</td>
      <td>Bong-Ra vs. Igorrr</td>
      <td>Tombs &#x2F; Pallbearer</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2013-08-11</td>
      <td>Low Entropy</td>
      <td>Journey To A Different Galaxy</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2013-10-30</td>
      <td>Succubus Helna</td>
      <td>Our Ladies Of Sorrow</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
    ...
    <tr>
      ...
      <td>2014-01-01</td>
      <td>Fifth Era</td>
      <td>Behemoths From The Zoo Of Abortions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
    ...
    <tr>
      ...
      <td>2014-12-19</td>
      <td>Knightvision vs Wedlock</td>
      <td>Wayz Of The Core</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
    ...
    <tr>
      ...
      <td>2015-04-30</td>
      <td>AnTraxid</td>
      <td>Statements Of Social Decay</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/norsk" | relative_url }}">norsk</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/svensk" | relative_url }}">svensk</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2016-04-16</td>
      <td>Huck Farper</td>
      <td>Adorned By Thee</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noise" | relative_url }}">noise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/techno" | relative_url }}">techno</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/hardcore-techno" | relative_url }}">hardcore techno</a></li>
    ...
    <tr>
      ...
      <td>2016-05-31</td>
      <td>ATILLA THE HVN</td>
      <td>Absorb &amp; Charge Ep</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/svensk" | relative_url }}">svensk</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2016-08-07</td>
      <td>AnTraxid</td>
      <td>Cryptcore From The Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkcore" | relative_url }}">darkcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
    ...
    <tr>
      ...
      <td>2017-05-19</td>
      <td>Symbolic death</td>
      <td>Negative Leader</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-techno" | relative_url }}">hardcore techno</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2017-10-17</td>
      <td>Current 909</td>
      <td>Something With Black In The Name</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
    ...
    <tr>
      ...
      <td>2020-04-20</td>
      <td>The Relic</td>
      <td>Ark I: Return of the Exiled</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gabber" | relative_url }}">gabber</a></li>
    ...
    <tr>
      ...
      <td>2020-05-09</td>
      <td>Low Entropy</td>
      <td>25 Years Of Low Entropy 1997-2022</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
    ...
    <tr>
      ...
      <td>2023-03-27</td>
      <td>The Relic</td>
      <td>ARK II: Sin And Salvation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gabber" | relative_url }}">gabber</a></li>
