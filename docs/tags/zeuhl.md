...
Last updated: <time datetime="2025-12-07T02:33:26.143Z">Sun Dec 07 2025 04:33:26 GMT+0200 (Eastern European Standard Time)</time>

### Description

Zeuhl is an avant-garde fusion of progressive rock, jazz, and classical music characterized by militaristic rhythms, operatic vocals, and dystopian themes. Pioneered in 1970s France, it often features invented languages and creates an intense, ritualistic atmosphere through repetitive bass patterns and dramatic choral arrangements. The style evokes cosmic mythology and science fiction through its bombastic, otherworldly sound.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>Magma</td>
      <td>Mekanik destruktiw kommandoh</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>Magma</td>
      <td>Mekanïk Destruktïw Kommandöh</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a></li>
    ...
    <tr>
      <td>14</td>
      <td>
          <img src="https://i.discogs.com/RqB12JqyD8YdPJ8kNu9mognszE4__KTxNYD7r6PGcmg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc2NTQz/NDYtMTQ0NjAzMzQ2/NC0zNTAzLmpwZWc.jpeg" alt="Cover for Mekanik Destruktïw Kommandöh" style="max-width:120px; height:auto;" />
      </td>
      <td>1973</td>
      <td>Magma</td>
      <td>Mekanik Destruktïw Kommandöh</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a></li>
    ...
    <tr>
      <td>7</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/4bf2de40d1dc9a8ceb396b7180f08931.png" alt="Cover for Köhntarkösz" style="max-width:120px; height:auto;" />
      </td>
      <td>1974-06</td>
      <td>Magma</td>
      <td>Köhntarkösz</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>11</td>
      <td>
          <img src="https://i.discogs.com/s3Bianwj1kW9-6FMAe34_oIaQ76sy2bIwkRAcpqiBiY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTU1MDg5/Mi0xNjMwOTQ1NjU1/LTQwMTIuanBlZw.jpeg" alt="Cover for Kohntarkosz" style="max-width:120px; height:auto;" />
      </td>
      <td>1974-06</td>
      <td>Magma</td>
      <td>Kohntarkosz</td>
    ...
    <tr>
      <td>6</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a1291ec2a6ffec59351d5f7b6477c4bc.png" alt="Cover for Üdü Wüdü" style="max-width:120px; height:auto;" />
      </td>
      <td>1976</td>
      <td>Magma</td>
      <td>Üdü Wüdü</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>Honeyelk</td>
      <td>En quête d&#39;un monde meilleur...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2000-07-31</td>
      <td>Guapo</td>
      <td>Great Sage, Equal of Heaven</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Koenjihyakkei</td>
      <td>Hundred Sights Of Koenji</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/zeuhl" | relative_url }}">zeuhl</a></li>
