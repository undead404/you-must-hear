...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1980-08</td>
      <td>Various Artists</td>
      <td>Street Parade 2009 - Trance (Mixed By Aly &amp; Fila)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/switzerland" | relative_url }}">switzerland</a></li>
    ...
    <tr>
      <td>38</td>
      <td>
          <img src="https://i.discogs.com/qTH0SlZMDRY_wcQqttAX962a2PvE0Vi22NFkMBzhiOY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTczMDgy/NS0xMTUyODY2MDM1/LmpwZWc.jpeg" alt="Cover for Dou3le" style="max-width:120px; height:auto;" />
      </td>
      <td>1987</td>
      <td>Double</td>
      <td>Dou3le</td>
    ...
    <tr>
      <td>49</td>
      <td>
          <img src="https://i.discogs.com/f3hxltcA2i8BSc_dW2zBoDaBbL2FaVhJQW_k4Stgzt8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTUxNTI2/MTgtMTUwOTkyMTYy/Ni0yNjY4LmpwZWc.jpeg" alt="Cover for Morbid Tales &#x2F; Emperor&#39;s Return (2006 Japan Press)" style="max-width:120px; height:auto;" />
      </td>
      <td>1988</td>
      <td>Celtic Frost</td>
      <td>Morbid Tales &#x2F; Emperor&#39;s Return (2006 Japan Press)</td>
      <td>
        <ul>
    ...
    <tr>
      <td>86</td>
      <td>
          <img src="https://i.discogs.com/3bbOOlKa-3YnjAsgbFLxElInFsoUZhp8FiIwLRMNJYg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTcxMzA4/LTEzOTU3NDIwMzEt/NjcwNy5qcGVn.jpeg" alt="Cover for Only Heaven" style="max-width:120px; height:auto;" />
      </td>
      <td>1995-06-12</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ragtime" | relative_url }}">ragtime</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Honey For Petzi</td>
      <td>Heal all monsters</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2003-04-29</td>
      <td>The Sad Riders</td>
      <td>Lay Your Head on the Soft Rock</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/switzerland" | relative_url }}">switzerland</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/alternative-pop" | relative_url }}">alternative pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/switzerland" | relative_url }}">switzerland</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/alternative-pop" | relative_url }}">alternative pop</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/indie-pop" | relative_url }}">indie pop</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/unplugged" | relative_url }}">unplugged</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/indie-pop" | relative_url }}">indie pop</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>We Got Every Right To Get Loud</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
    ...
    <tr>
      ...
      <td>2006-06-23</td>
      <td>Lovebugs</td>
      <td>In Every Waking Moment</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-pop" | relative_url }}">alternative pop</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/switzerland" | relative_url }}">switzerland</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Sarah Reeve</td>
      <td>From The Mind Of A Dreamer</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007-11-23</td>
      <td>Favez</td>
      <td>Bigger Mountains Higher Flags</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/switzerland" | relative_url }}">switzerland</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/alternative-pop" | relative_url }}">alternative pop</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/new-wave" | relative_url }}">new wave</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/indie-pop" | relative_url }}">indie pop</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/switzerland" | relative_url }}">switzerland</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>31</td>
      <td>
          <img src="https://i.discogs.com/LjvJ4kEjHTb9NUCGZntpEhTrh8EHrYiXwJCDqVkpFA8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE2MzE5/MDItMTIzMzQwNzg2/MC5qcGVn.jpeg" alt="Cover for How Much Peanut Butter" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-01-23</td>
      <td>Electric Blanket</td>
      <td>How Much Peanut Butter</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
    ...
    <tr>
      <td>81</td>
      <td>
          <img src="https://i.discogs.com/kQ_Liz-TxMvLbuYODJPaNDLFC_lTW_axa7-isrMybjc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTk2NTky/ODQtMTQ4NDM0NjY0/OS0xNzc2LmpwZWc.jpeg" alt="Cover for On My Own" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-12-09</td>
      <td>Dreamshade</td>
      <td>On My Own</td>
    ...
    <tr>
      ...
      <td>2018</td>
      <td>Yello</td>
      <td>1980-1985: The New Mix In One Go</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
        </ul>
    ...
    <tr>
      <td>99</td>
      <td>
          <img src="https://i.discogs.com/vI6mhq3tPa9488RVk-YXnbjvOnp0LkHMeS8R0wJDLLs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyMjg2/NzAxLTE2NDU3MTAw/MTEtNzU4OC5qcGVn.jpeg" alt="Cover for I Am My Mother" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-02-25</td>
    ...
    <tr>
      <td>89</td>
      <td>
          <img src="https://i.discogs.com/Yr_w2qmuKFWpkl1X2sO9BzPFTDDNl73M6DbEJ-uxHDw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI1NDA1/NTk0LTE2NzA1MTU3/MjEtODAyMy5qcGVn.jpeg" alt="Cover for Orbit" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-11-11</td>
      <td>Black Sea Dahu</td>
      <td>Orbit</td>
