...
Last updated: <time datetime="2025-12-07T23:26:07.805Z">Mon Dec 08 2025 01:26:07 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/no-wave" | relative_url }}">no wave</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-rock" | relative_url }}">experimental rock</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/no-wave" | relative_url }}">no wave</a> # 63</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/real-post-hardcore" | relative_url }}">real post-hardcore</a> # 3</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/real-post-hardcore" | relative_url }}">real post-hardcore</a> # 35</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/real-post-hardcore" | relative_url }}">real post-hardcore</a> # 2</li>
    ...
    <tr>
      <td>94</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ae33339f509b6f352466d42d793aa865.png" alt="Cover for Bonsai Superstar" style="max-width:120px; height:auto;" />
      </td>
      <td>1994-11-24</td>
      <td>Brainiac</td>
      <td>Bonsai Superstar</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noise-rock" | relative_url }}">noise rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/real-post-hardcore" | relative_url }}">real post-hardcore</a> # 24</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mathcore" | relative_url }}">mathcore</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/noise" | relative_url }}">noise</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/sasscore" | relative_url }}">sasscore</a> # 13</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/noise-punk" | relative_url }}">noise punk</a> # 61</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/noise-punk" | relative_url }}">noise punk</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>98</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/8d0f33c2d99c4477c40a0dcfc12c3cc5.png" alt="Cover for Travels With Myself and Another" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-06-22</td>
      <td>Future of the Left</td>
      <td>Travels With Myself and Another</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/shoegaze" | relative_url }}">shoegaze</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/powerviolence" | relative_url }}">powerviolence</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/grunge" | relative_url }}">grunge</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/math-rock" | relative_url }}">math rock</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/no-wave" | relative_url }}">no wave</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/shoegaze" | relative_url }}">shoegaze</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/blackgaze" | relative_url }}">blackgaze</a> # 16</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://i.discogs.com/nE9-XOzcAlv5QsiXvXiHAsb9SmdsG4MiW3J-m0nllhU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI0OTc2/NDk1LTE2NjY5Nzg0/NDQtNjg5NS5qcGVn.jpeg" alt="Cover for Trouble The Water" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-10-28</td>
