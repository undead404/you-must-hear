...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Zodiac</td>
      <td>Disco Alliance&#x2F;Music In Universe</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Bronius Kutavičius</td>
      <td>last pagan rites</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2002-05-26</td>
      <td>Edgars Liepiņš</td>
      <td>Skaista bij&#39; jaunība</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latvian" | relative_url }}">latvian</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004-03-10</td>
      <td>Bērnības Milicija</td>
      <td>Brīva vieta jūsu reklāmai</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/indie-rock" | relative_url }}">indie rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latvian" | relative_url }}">latvian</a></li>
    ...
    <tr>
      ...
      <td>2004-11-18</td>
      <td>Dzelzs Vilks</td>
      <td>Manās mājās sieviešu nav</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Tornis: 20 gadi, 20 dziesmas</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2014-09-12</td>
      <td>Elina Garanca</td>
      <td>Aria Cantilena</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/death-n-roll" | relative_url }}">death n roll</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>Kā samierināties ar savu nenozīmību</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2016-11-12</td>
      <td>Židrūns</td>
      <td>Židrūns Un Tas, KO Nevar Nest</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2017-07-24</td>
      <td>Nova Koma</td>
      <td>Mīlēt var tikai cilvēkus</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2017-10-16</td>
      <td>NSRD</td>
      <td>Workshop For The Restoration Of Unfelt Feelings</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latvian" | relative_url }}">latvian</a></li>
    ...
    <tr>
      ...
      <td>2019-07-30</td>
      <td>Lupa</td>
      <td>Sequences And Consequences</td>
      <td>
        <ul>
