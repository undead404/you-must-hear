...
Last updated: <time datetime="2025-12-06T11:02:55.862Z">Sat Dec 06 2025 13:02:55 GMT+0200 (Eastern European Standard Time)</time>

### Description

Ska music is a genre of music that originated in Jamaica in the late 1950s and early 1960s. It is characterized by a syncopated rhythm played by a horn section (usually trumpets, trombones, and saxophones), along with bass, drums, and guitar. The music often features upbeat and danceable tempos, with lyrics that touch on topics such as social issues, love, and daily life. Ska has influenced many other genres of music, including reggae, punk, and rock. Some notable ska artists include The Skatalites, Prince Buster, Toots and the Maytals, and The Specials.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/roots-reggae" | relative_url }}">roots reggae</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/skacore" | relative_url }}">skacore</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ska-punk" | relative_url }}">ska punk</a> # 24</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ska-punk" | relative_url }}">ska punk</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ska-punk" | relative_url }}">ska punk</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jamaican" | relative_url }}">jamaican</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rocksteady" | relative_url }}">rocksteady</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2000-06-06</td>
      <td>Mad Caddies</td>
      <td>The Holiday Has Been Cancelled</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ska" | relative_url }}">ska</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ska-punk" | relative_url }}">ska punk</a> # 23</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/polish" | relative_url }}">polish</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>31</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/fa9bb20c3a904dfdcd081d7f037cd464.png" alt="Cover for The Cat Empire" style="max-width:120px; height:auto;" />
      </td>
      <td>2003-10-27</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ska" | relative_url }}">ska</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ska-punk" | relative_url }}">ska punk</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>28</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/b7f00f99c2f14827b3630ccd3e6d0dda.png" alt="Cover for So Many Nights" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-12-08</td>
      <td>The Cat Empire</td>
    ...
    <tr>
      ...
      <td>2008-03-31</td>
      <td>The Specials</td>
      <td>The Best of The Specials</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ska" | relative_url }}">ska</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ska-punk" | relative_url }}">ska punk</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ska-punk" | relative_url }}">ska punk</a> # 6</li>
        </ul>
      </td>
    </tr>
  </tbody>
