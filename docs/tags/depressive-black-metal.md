...
Depressive black metal combines the raw aggression of black metal with slower tempos, melancholic melodies, and lyrics exploring despair, isolation, and mental anguish. Emerging in the 1990s from Scandinavia&#39;s underground scene, it emphasizes atmospheric bleakness over traditional black metal&#39;s anti-religious themes. The music features anguished vocals, repetitive riffs, and lo-fi production that creates an intensely somber listening experience.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2003-04</td>
      <td>Luror</td>
      <td>The Iron Hand of Blackest Terror</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/suicidal-black-metal" | relative_url }}">suicidal black metal</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006-01-20</td>
      <td>ColdWorld</td>
      <td>The Stars Are Dead Now</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
            <li style="font-size: calc(1rem * 93 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a> # 50</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/suicidal-black-metal" | relative_url }}">suicidal black metal</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/suicidal-black-metal" | relative_url }}">suicidal black metal</a> # 64</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-metal" | relative_url }}">dark metal</a> # 23</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2007-07</td>
      <td>Austere</td>
      <td>Withering Illusions and Desolation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
    ...
    <tr>
      ...
      <td>2008-02</td>
      <td>Sombres Forêts</td>
      <td>Royaume De Glace</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-10-01</td>
      <td>I&#39;m in a Coffin</td>
      <td>One Final Action</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-11-24</td>
      <td>Nocturnal Depression</td>
      <td>Reflections Of A Sad Soul</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-metal" | relative_url }}">dark metal</a> # 12</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/blackgaze" | relative_url }}">blackgaze</a> # 33</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/french-black-metal" | relative_url }}">french black metal</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2011-02-21</td>
      <td>Totalselfhatred</td>
      <td>Apocalypse In Your Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/blackgaze" | relative_url }}">blackgaze</a> # 13</li>
    ...
    <tr>
      ...
      <td>Goodbye Love... Hello Heartache...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012-10-03</td>
      <td>Photophobia</td>
      <td>The Seven States of Mourning</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-black-metal" | relative_url }}">progressive black metal</a> # 27</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/suicidal-black-metal" | relative_url }}">suicidal black metal</a> # 35</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2015-04-14</td>
      <td>Lifeless</td>
      <td>Inner Shouts From A Sad Soul</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2015-06-09</td>
      <td>Ethereal Shroud</td>
      <td>They Became the Falling Ash</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a> # 23</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2018-04-11</td>
      <td>None</td>
      <td>Life has gone on long enough</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2022-05-20</td>
      <td>Beyond Melancholy</td>
      <td>The Pleasure Of Suicide...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/depressive-black-metal" | relative_url }}">depressive black metal</a></li>
        </ul>
