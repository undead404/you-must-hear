...
Peruvian music is a rich blend of Andean, Spanish, and African roots. It is characterized by the use of traditional instruments like the charango, and styles vary across regions, with the highlands known for huayno, the north for marinera, and the coast for waltz, festejo, and tondero. The music often reflects Peru’s diverse cultural heritage, with melodies echoing Andean influences, rhythms showcasing African elements, and harmonies revealing European touches.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/peruvian" | relative_url }}">peruvian</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Traditional Music of Peru</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>Various Artists</td>
      <td>Mountain Music of Peru, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1991</td>
      <td>Nosequien y los Nosecuantos</td>
      <td>Con el Respeto que se Merecen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/peruvian" | relative_url }}">peruvian</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Nosequien y los Nosecuantos</td>
      <td>11 Porotazos Super Bailables</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/peruvian" | relative_url }}">peruvian</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>Richie Zellon</td>
      <td>Beatles Afro Peruvian Jazz Tribute</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-fusion" | relative_url }}">jazz fusion</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/peruvian" | relative_url }}">peruvian</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>SIGNOS</td>
      <td>SIGNOS - Panflutes Melodies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/peruvian" | relative_url }}">peruvian</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-rock" | relative_url }}">spanish rock</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/peru" | relative_url }}">peru</a> # 33</li>
    ...
    <tr>
      ...
      <td>2010-10</td>
      <td>Francois Peglau</td>
      <td>The Imminent Failure of Francois Peglau</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/peruvian" | relative_url }}">peruvian</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/peru" | relative_url }}">peru</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>Alejandro y Maria Laura</td>
      <td>La Casa No Existe</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2019-03-20</td>
      <td>Chocolate</td>
      <td>Peru&#39;s Master Percussionist</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/peru" | relative_url }}">peru</a> # 24</li>
        </ul>
      </td>
    </tr>
    <tr>
