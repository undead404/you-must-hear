...
&quot;Mexico&quot; encompasses the diverse popular music traditions of Mexican culture, blending indigenous sounds with Spanish influences and modern styles. The genre spans romantic ballads, rock en español, cumbia, and orchestral pop that dominated Latin American charts. It represents Mexico&#39;s rich musical heritage through passionate vocals, traditional rhythms, and cross-generational appeal.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1977</td>
      <td>Vicente Fernández</td>
      <td>Historia de un Idolo, Volume 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mariachi" | relative_url }}">mariachi</a> # 67</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mariachi" | relative_url }}">mariachi</a> # 92</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Juan Gabriel</td>
      <td>Celebrando 25 Años De Juan Gabriel En El Palacio De Bellas Artes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mariachi" | relative_url }}">mariachi</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ska" | relative_url }}">ska</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Selena</td>
      <td>Ven Conmigo - Selena 20 Years Of Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ranchera" | relative_url }}">ranchera</a> # 82</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005-05-31</td>
      <td>Jaguares</td>
      <td>Cronicas De Un Laberinto</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ranchera" | relative_url }}">ranchera</a> # 79</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2006</td>
      <td>Ely Guerra</td>
      <td>Ely Guerra Teatro Metropolitan</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mariachi" | relative_url }}">mariachi</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Aleks Syntek</td>
      <td>Sexo, Pudor Y Lagrimas: Remixes</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>98</td>
      <td>
          <img src="https://i.discogs.com/LWD-tj_VDi_lJipkNnZqbfxZzcBRythd69Kq6m8X9ac/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMyMDk3/NDc3LTE3Mjk4MjIx/MzEtNTY4NS5qcGVn.jpeg" alt="Cover for Cruisin&#39; with Junior H" style="max-width:120px; height:auto;" />
      </td>
      <td>2020</td>
      <td>Junior H</td>
