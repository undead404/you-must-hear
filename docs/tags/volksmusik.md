...
Volksmusik is a traditional style of folk music that originated in German-speaking regions of Europe, including Germany, Austria, and Switzerland. It is characterized by a simple, straightforward melody, often accompanied by accordion, guitar, and other instruments. The lyrics typically reflect rural life and the natural beauty of the countryside, with themes of love, nature, and daily life. Volksmusik has a long history and continues to be popular in these regions, with festivals, radio programs, and TV shows dedicated to the genre.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1929</td>
      <td>Bacova&#39;s Ceska Kapela</td>
      <td>Texas-Czech, Bohemian - Moravian Bands</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/deutsche-schlager" | relative_url }}">deutsche schlager</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1964</td>
      <td>Orchester Erich Becht</td>
      <td>Grand Prix der Volksmusik 2001 - Endausscheidung</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutsche-schlager" | relative_url }}">deutsche schlager</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/western" | relative_url }}">western</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1967</td>
      <td>Karel Gott</td>
      <td>Schön, dass Du geboren bist</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Heintje</td>
      <td>Seine großen Erfolge</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/deutsche-schlager" | relative_url }}">deutsche schlager</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1991</td>
      <td>Zillertaler Schürzenjager</td>
      <td>Schürzenjägerzeit</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Ohne Zärtlichkeit Geht Gar Nix</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutsche-schlager" | relative_url }}">deutsche schlager</a></li>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Zellberg Buam</td>
      <td>Wenn A Zillertaler Tanzt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1998-04-20</td>
      <td>Die Alpenrammler</td>
      <td>Lieschen, Lieschen</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Axel Becker</td>
      <td>Ich kann nicht leben ohne Dich</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Stefanie Hertel</td>
      <td>Lieder, die Von Herzen Kommen</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2000-09-25</td>
      <td>Die Flippers</td>
      <td>Der Floh in meinem Herzen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutsche-schlager" | relative_url }}">deutsche schlager</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
    ...
    <tr>
      ...
      <td>2001-03-19</td>
      <td>Francine Jordi</td>
      <td>Verliebt in das Leben</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2002-08-26</td>
      <td>Geschwister Hofmann</td>
      <td>Ihre erfolgreichsten Lieder - Super 20</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2004-01-24</td>
      <td>Francine Jordi</td>
      <td>Alles Steht Und Fällt Mit Dir</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004-09-20</td>
      <td>De Randfichten</td>
      <td>De Lustigen Holzhackerleit</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ostrock" | relative_url }}">ostrock</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006-05-26</td>
      <td>De Randfichten</td>
      <td>Wer Heute Noch An Engel Glaubt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-08-31</td>
      <td>Andreas Fulterer</td>
      <td>Im Zug nach Süden</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutsche-schlager" | relative_url }}">deutsche schlager</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Troglauer Buam</td>
      <td>Heavy Volxmusic</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/metal" | relative_url }}">metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/austrian" | relative_url }}">austrian</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2009-11-06</td>
      <td>Francine Jordi</td>
      <td>Meine kleine grosse Welt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/austria" | relative_url }}">austria</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Stefanie Hertel</td>
      <td>Die Kraft Der Träume</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/volksmusik" | relative_url }}">volksmusik</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
        </ul>
      </td>
      <td>
        <ul>
