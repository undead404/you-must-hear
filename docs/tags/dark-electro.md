...
Last updated: <time datetime="2025-12-05T12:31:22.269Z">Fri Dec 05 2025 14:31:22 GMT+0200 (Eastern European Standard Time)</time>

### Description

Dark electro is an aggressive electronic music genre that emerged from EBM and industrial scenes in the 1990s, characterized by distorted vocals, harsh synthesizers, and pounding beats. The sound evokes themes of darkness, dystopia, and transgression. It&#39;s popular in gothic and industrial club cultures.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Eulogy For The Sick Child</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electro" | relative_url }}">dark electro</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ebm" | relative_url }}">ebm</a></li>
    ...
    <tr>
      ...
      <td>Wenn Der Letzte Schatten Fällt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/darksynth" | relative_url }}">darksynth</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/techno-industrial" | relative_url }}">techno-industrial</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Adversus</td>
      <td>Winter, so unsagbar Winter...</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/aggrotech" | relative_url }}">aggrotech</a> # 95</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/aggrotech" | relative_url }}">aggrotech</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/harsh-ebm" | relative_url }}">harsh ebm</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2007-10-19</td>
      <td>Heimataerde</td>
      <td>Leben geben Leben nehmen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/harsh-ebm" | relative_url }}">harsh ebm</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electro" | relative_url }}">dark electro</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/ebm" | relative_url }}">ebm</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/harsh-ebm" | relative_url }}">harsh ebm</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/harsh-ebm" | relative_url }}">harsh ebm</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2008-09-30</td>
      <td>C-Lekktor</td>
      <td>The silence Procession</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aggrotech" | relative_url }}">aggrotech</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/dark-electro" | relative_url }}">dark electro</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a> # 64</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/harsh-ebm" | relative_url }}">harsh ebm</a> # 8</li>
    ...
    <tr>
      ...
      <td>2009-10-27</td>
      <td>Velvet Acid Christ</td>
      <td>The Art Of Breaking Apart</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/techno-industrial" | relative_url }}">techno-industrial</a> # 23</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2010-01-01</td>
      <td>ESC</td>
      <td>Eight Thousand Square Feet</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electro" | relative_url }}">dark electro</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ebm" | relative_url }}">ebm</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/harsh-ebm" | relative_url }}">harsh ebm</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/aggrotech" | relative_url }}">aggrotech</a> # 60</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/harsh-ebm" | relative_url }}">harsh ebm</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/old-school-ebm" | relative_url }}">old school ebm</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/aggrotech" | relative_url }}">aggrotech</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a> # 24</li>
    ...
    <tr>
      ...
      <td>2019-12-04</td>
      <td>Hocico</td>
      <td>Aqui Y Ahora En El Silencio</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electro" | relative_url }}">dark electro</a></li>
