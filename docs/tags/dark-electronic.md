...
Dark electronic music is a genre of electronic music that typically features dark or ominous tones and themes. It often incorporates elements of industrial, techno, and other electronic genres, as well as elements of darker styles such as gothic or horror. This type of music often makes use of electronic instruments such as synthesizers, drum machines, and samplers to create complex soundscapes and driving rhythms. Some examples of dark electronic music artists include Nine Inch Nails, Skinny Puppy, and Front Line Assembly.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Arsenal</td>
      <td>Factory Smog Is a Sign of Progress</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/american" | relative_url }}">american</a></li>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Patient</td>
      <td>Alice&#39;s Adventures through the Windshield Glass</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001-12-24</td>
      <td>Cyrusgbg</td>
      <td>Stealing Peoples&#39; Opinions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>vortex of malice</td>
      <td>The Euphoria We Sought Has Eluded Us</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>2005-05-07</td>
      <td>The Mercy Cage</td>
      <td>scree:transmissions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro-industrial" | relative_url }}">electro-industrial</a></li>
    ...
    <tr>
      ...
      <td>2006-12-12</td>
      <td>Urceus Exit</td>
      <td>Contra [Bonus Tracks and Remixes]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>2007-04-10</td>
      <td>It-Clings Vs Pneumatic Detach</td>
      <td>The All Too Logical Descent Into Madness</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-industrial" | relative_url }}">post-industrial</a></li>
    ...
    <tr>
      ...
      <td>2007-09-16</td>
      <td>Geprogrammeerde Celdood</td>
      <td>The Great Conflict Side A</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cybergrind" | relative_url }}">cybergrind</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cyberpunk" | relative_url }}">cyberpunk</a></li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Choronzon</td>
      <td>Procession of Underworld Multitudes (Radio Xeno EP)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Dead Red Velvet</td>
      <td>Full Moon Film - B sides</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
    ...
    <tr>
      ...
      <td>2013-04-02</td>
      <td>Xander Harris</td>
      <td>The New Dark Age of Love</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/idm" | relative_url }}">idm</a></li>
    ...
    <tr>
      ...
      <td>2013-12-21</td>
      <td>Caffeine Mit Cocaine</td>
      <td>One Black Coffee Please</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ebm" | relative_url }}">ebm</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro-industrial" | relative_url }}">electro-industrial</a></li>
    ...
    <tr>
      ...
      <td>2017-11-22</td>
      <td>Jadu Heart &amp; Mura Masa</td>
      <td>U Never Call Me</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>2019-12-20</td>
      <td>Valhall</td>
      <td>Ormens offer (Seeming remix)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electronic" | relative_url }}">dark electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Geprogrammeerde Celdood &amp; Radioactief Bejaardentehuis</td>
      <td>Destroy All Galaxies</td>
      <td>
        <ul>
