...
Liquid funk is a melodic subgenre of drum and bass that emerged in the early 2000s, characterized by smooth, soulful atmospheres and jazzy influences over fast breakbeats. It emphasizes musicality with warm basslines, uplifting pads, and often incorporates vocal samples or live instrumentation. The style became popular in underground club scenes for its more accessible, emotionally resonant approach to the typically hard-edged drum and bass sound.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2000-09</td>
      <td>Danny Byrd</td>
      <td>NHS22: Do It Again &#x2F; Dub It Again</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
    ...
    <tr>
      ...
      <td>2003-02-03</td>
      <td>E-Z Rollers</td>
      <td>Titles Of The Unexpected</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>NHS56: Billion Dollar Gravy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Ben Westbeech</td>
      <td>Welcome To The Best Years Of Your Life (Brownswood Recordings)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2008-02-22</td>
      <td>Various Artists</td>
      <td>Voyage - (Liquicity Presents)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-06-28</td>
      <td>Memro</td>
      <td>Homecoming EP - (Liquicity Presents)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-09-28</td>
      <td>Breakshift</td>
      <td>All the dreams you never had</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
    ...
    <tr>
      ...
      <td>2013</td>
      <td>Maduk</td>
      <td>Believe EP - (Liquicity Presents)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-01-21</td>
      <td>Hybrid Minds</td>
      <td>Meant to Be &#x2F; Unconditional</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Jareth</td>
      <td>Kaleidoscope (Hybrid Minds Remix)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
    ...
    <tr>
      ...
      <td>2014-07-07</td>
      <td>Jazz Cartel</td>
      <td>Jazzsticks X Creative Wax</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2014-10-21</td>
      <td>Fox Stevenson</td>
      <td>Knowhow (Liquicity Drum &amp; Bass 2017)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2015-06-15</td>
      <td>Maduk</td>
      <td>Maduk Summer Remixes (Liquicity Presents)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2017-09-22</td>
      <td>Pola &amp; Bryson</td>
      <td>This Time Last Year: The Remixes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
    ...
    <tr>
      ...
      <td>2017-11-03</td>
      <td>keeno</td>
      <td>All the Shimmering Things</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
    ...
    <tr>
      ...
      <td>2019-07-12</td>
      <td>Maduk</td>
      <td>Colours &#x2F; Still In Love [UKF10 x Liquicity]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Various Artists</td>
      <td>Forza Horizon 4: Hospital Soundtrack</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Various Artists</td>
      <td>Alchemy (Liquicity Presents)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/liquid-funk" | relative_url }}">liquid funk</a></li>
        </ul>
