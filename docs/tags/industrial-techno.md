...
Industrial techno merges the mechanical aggression of industrial music with techno&#39;s driving rhythms, creating a dark, uncompromising sound characterized by distorted synthesizers, metallic percussion, and relentless bass. Born from underground club culture, it emphasizes raw power and dystopian atmospheres over melody, evoking factory floors and post-apocalyptic landscapes. The style appeals to those seeking intense, physical dance music with an abrasive edge.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/power-electronics" | relative_url }}">power electronics</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/futurepop" | relative_url }}">futurepop</a> # 67</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rhythmic-noise" | relative_url }}">rhythmic noise</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/detroit-techno" | relative_url }}">detroit techno</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/detroit-techno" | relative_url }}">detroit techno</a> # 27</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/tribal-industrial" | relative_url }}">tribal industrial</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hard-techno" | relative_url }}">hard techno</a> # 51</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>2</td>
      <td>
          <img src="https://i.discogs.com/NiiujZNdV19lYuPOt1pG-7xhSQ_CqehbG5Rf7Q0Wku8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc3Mzc3/Ni0xMTYyNzUxNzUz/LmpwZWc.jpeg" alt="Cover for Pre Dawn &#x2F; Indoors" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-02-11</td>
      <td>Burial</td>
      <td>Pre Dawn &#x2F; Indoors</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-techno" | relative_url }}">industrial techno</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-industrial" | relative_url }}">ambient industrial</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-techno" | relative_url }}">dark techno</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2015-02-13</td>
      <td>Kerridge</td>
      <td>Always Offended Never Ashamed</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-techno" | relative_url }}">dark techno</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-beat" | relative_url }}">new beat</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>16</td>
      <td>
          <img src="https://i.discogs.com/MJhyPQXB_SCLh5l6UlSjvP-BJmaRGVXucO7p-wo1S48/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExMzU3/NDE0LTE1MTQ4OTAy/OTQtNjA1Ny5qcGVn.jpeg" alt="Cover for Confined in Hell" style="max-width:120px; height:auto;" />
      </td>
      <td>2017</td>
      <td>Nico Moreno</td>
      <td>Confined in Hell</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-beat" | relative_url }}">new beat</a> # 17</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/rhythmic-noise" | relative_url }}">rhythmic noise</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2019-04-01</td>
      <td>Tzusing</td>
      <td>In A Moment A Thousand Hits</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-techno" | relative_url }}">industrial techno</a></li>
        </ul>
    ...
    <tr>
      <td>5</td>
      <td>
          <img src="https://i.discogs.com/76CGeRQVV2OyR9RTVVeYWqHj8d5w-oM9ZxosOlCQWmE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzNzA4/MDMyLTE1NTk0Njky/MDQtMjkwNC5qcGVn.jpeg" alt="Cover for Purple Widow" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-05-24</td>
      <td>Nico Moreno</td>
      <td>Purple Widow</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/power-noise" | relative_url }}">power noise</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2019-12-08</td>
      <td>Vatican Shadow</td>
      <td>American Flesh For Violence</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-techno" | relative_url }}">industrial techno</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hard-techno" | relative_url }}">hard techno</a> # 44</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hard-techno" | relative_url }}">hard techno</a> # 50</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>37</td>
      <td>
          <img src="https://i.discogs.com/4dzsuUnc1nFc0fnaDiO68v6F-fthj7EHPiuXrtT70Os/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyNjUw/NzEwLTE1MzkzNTMx/MTctMzA3OC5wbmc.jpeg" alt="Cover for You Can&#39;t Stop The Movement" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-01-04</td>
      <td>Nico Moreno</td>
      <td>You Can&#39;t Stop The Movement</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-techno" | relative_url }}">industrial techno</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/techno" | relative_url }}">techno</a></li>
