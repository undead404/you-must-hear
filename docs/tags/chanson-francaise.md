...
Chanson française is a lyric-driven French music genre emphasizing poetic storytelling and emotional expression over complex instrumentation. Rooted in Parisian café culture, it blends literary sophistication with melodic accessibility, often addressing love, social issues, and everyday life. The style values vocal personality and wordplay, creating intimate connections between performer and audience.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 23</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1975</td>
      <td>Gérard Lenorman</td>
      <td>La Ballade Des Gens Heureux</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Debout sur le zinc</td>
      <td>Live à Cergy - 11.03.2003</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rock-fr" | relative_url }}">rock-fr</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Y&#39;a Des Cigales Dans La Fourmi</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Natasha St-Pier</td>
      <td>L&#39;instant d&#39;après</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004-02-17</td>
      <td>Jeanne Cherhal</td>
      <td>12 Fois Par An</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2006-08-01</td>
      <td>Serge Gainsbourg</td>
      <td>Monsieur Gainsbourg Originals</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Georges Brassens</td>
      <td>Les amoureux des bancs publics</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/chanson-francaise" | relative_url }}">chanson francaise</a></li>
        </ul>
      </td>
      <td>
        <ul>
