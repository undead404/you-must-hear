...
Last updated: <time datetime="2025-11-15T01:42:07.171Z">Sat Nov 15 2025 03:42:07 GMT+0200 (Eastern European Standard Time)</time>

### Description

Avant-folk blends traditional folk instrumentation with experimental techniques, creating unsettling yet intimate soundscapes. Emerging from 1960s counterculture and evolving through indie scenes, it challenges folk&#39;s conventions with dissonance, unconventional structures, and raw emotional intensity. The genre attracts artists exploring vulnerability through sonic experimentation.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Henry Flynt</td>
      <td>Back Porch Hillbilly Blues Volume 1</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
    ...
    <tr>
      ...
      <td>The Complete Guide to Insufficiency</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
    ...
    <tr>
      ...
      <td>2006-06-27</td>
      <td>Psalters</td>
      <td>The Divine Liturgy of the Wretched Exiles</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-rock" | relative_url }}">experimental rock</a></li>
    ...
    <tr>
      ...
      <td>2007-04-24</td>
      <td>Avey Tare &amp; Kría Brekkan</td>
      <td>Pullhair Rubeye</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Animal Collective</td>
      <td>Sung Tongs (Live at the Theatre at Ace Hotel)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-folk" | relative_url }}">progressive folk</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
    ...
    <tr>
      <td>10</td>
      <td>
          <img src="https://i.discogs.com/efC0BKpBF7kVcJcDaIvxlLDpZYqStUdPZPZx3UkDZSE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MTE1/NzEyLTE1NjgxMzQ4/NTQtMjAwMi5qcGVn.jpeg" alt="Cover for Valley Of The Sun" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-04-19</td>
      <td>Hayden Pedigo</td>
    ...
    <tr>
      ...
      <td>2020-02-18</td>
      <td>Priscilla Ermel</td>
      <td>Origens Da Luz</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
    ...
    <tr>
      <td>37</td>
      <td>
          <img src="https://i.discogs.com/R0eky-JE7D0oAyVmZjJOzdNsLwN9SOFHKBobYE64UX4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyMjMw/ODE0LTE2NDUzNDQz/MzAtMTEwNS5qcGVn.jpeg" alt="Cover for The Long Count" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-02-16</td>
      <td>Debit</td>
      <td>The Long Count</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Current 93</td>
      <td>If a City Is Set Upon a Hill</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/avant-folk" | relative_url }}">avant-folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neofolk" | relative_url }}">neofolk</a></li>
