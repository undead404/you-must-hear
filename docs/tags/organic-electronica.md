...
Organic electronica blends digital synthesis and processing with acoustic instruments, field recordings, and natural textures to create warmth within electronic music. This approach emerged from experimental composers seeking to humanize technology, emphasizing subtle imperfections and spontaneous elements over rigid machine precision. The sound bridges avant-garde composition with intimate, tactile qualities that feel handcrafted despite their electronic foundation.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1974</td>
      <td>Miche</td>
      <td>ca508 - Miche - Along Yurikamome</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Mikrophonie I and II, Telemusik</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2004-01-06</td>
      <td>Khonnor</td>
      <td>Live From Saint Johnsbury, Vermont</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2004-09-24</td>
      <td>V-trap</td>
      <td>Amphibian Vibes [TROORG#002]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>2005-01-09</td>
      <td>F master F</td>
      <td>La Onda Lúcida [TROORG#003]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>2005-08-24</td>
      <td>DJet</td>
      <td>Apart The Second [TROORG#006]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>2006-04-27</td>
      <td>BPill</td>
      <td>One For Baby, And One For Mommy [TROORG#009]</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>SALAKAPAKKA SOUND SYSTEM</td>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Naing Naing</td>
      <td>Reinforced concrete cracks</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Naing Naing</td>
      <td>Live in France, January 2009</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2011-06-30</td>
      <td>Dntel</td>
      <td>Clelia II [basic_sounds - bsc_011]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/american" | relative_url }}">american</a></li>
    ...
    <tr>
      ...
      <td>2012-08-02</td>
      <td>Pillars &amp; Tongues</td>
      <td>If Travel is Asked of Me</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/american" | relative_url }}">american</a></li>
    ...
    <tr>
      ...
      <td>2013-01-15</td>
      <td>Alessio Ballerini</td>
      <td>To Its Beginning To Its End</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musique-concrete" | relative_url }}">musique concrete</a></li>
    ...
    <tr>
      ...
      <td>2015-12-01</td>
      <td>Bite</td>
      <td>Calle Palma [bsc_064 - basicsounds.ca]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>2019-04</td>
      <td>verised naised</td>
      <td>Vikerkaar Leekides</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/organic-electronica" | relative_url }}">organic electronica</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>lelangir</td>
      <td>planet&#39;s end, planet&#39;s elegy</td>
      <td>
        <ul>
        </ul>
      </td>
