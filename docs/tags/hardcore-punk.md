...
Last updated: <time datetime="2025-11-14T01:47:25.676Z">Fri Nov 14 2025 03:47:25 GMT+0200 (Eastern European Standard Time)</time>

### Description

Hardcore punk is a subgenre of punk rock that originated in the late 1970s and early 1980s, primarily in the United States and the United Kingdom. It is characterized by its fast and aggressive sound, with loud and distorted guitars, heavy basslines, and fast, pounding drums. The lyrics often deal with political and social issues, with an emphasis on DIY culture, anti-authoritarianism, and rebellion. Hardcore punk bands also often have a strong DIY ethic, with many producing and distributing their own music independently. Notable bands in the hardcore punk scene include Black Flag, Bad Brains, Minor Threat, and Dead Kennedys.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>GBH</td>
      <td>City Baby Attacked by Rats</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1982-01-12</td>
      <td>Bad Religion</td>
      <td>How Could Hell Be Any Worse?</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1982-10</td>
      <td>Dead Kennedys</td>
      <td>Plastic Surgery Disasters</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/crossover-thrash" | relative_url }}">crossover thrash</a> # 58</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a> # 65</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/post-hardcore" | relative_url }}">post-hardcore</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1987-05</td>
      <td>Dead Kennedys</td>
      <td>Give Me Convenience or Give Me Death</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/crossover-thrash" | relative_url }}">crossover thrash</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/straight-edge" | relative_url }}">straight edge</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1994-07-22</td>
      <td>Reagan Youth</td>
      <td>A Collection of Pop Classics</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
    ...
    <tr>
      ...
      <td>1995-08-01</td>
      <td>AFI</td>
      <td>Answer That and Stay Fashionable</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/melodic-hardcore" | relative_url }}">melodic hardcore</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1997-11-11</td>
      <td>AFI</td>
      <td>Shut Your Mouth and Open Your Eyes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1999-05-18</td>
      <td>AFI</td>
      <td>Black Sails in the Sunset</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/skate-punk" | relative_url }}">skate punk</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a> # 97</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a> # 98</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2012-02-25</td>
      <td>Turnstile</td>
      <td>TURNSTILE LOVE CONNECTION</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-metal" | relative_url }}">alternative metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
    ...
    <tr>
      <td>52</td>
      <td>
          <img src="https://i.discogs.com/BIJeshFolSq4CBPXOLCrlbb9-n8zFynVcoW-IWj1oHM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTk2NTI3/MDMtMTYwMzk3Mzc5/NC04NjEzLmpwZWc.jpeg" alt="Cover for Modern Ruin" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-10-04</td>
      <td>Frank Carter &amp; The Rattlesnakes</td>
      <td>Modern Ruin</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/d-beat" | relative_url }}">d-beat</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
