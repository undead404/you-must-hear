...
Jamaican music encompasses the island&#39;s rich musical traditions, including reggae, ska, dancehall, and dub, characterized by offbeat rhythms, heavy bass, and socially conscious lyrics. Rooted in African and Caribbean influences, these genres emerged from Kingston&#39;s sound system culture and Rastafarian spirituality. The music&#39;s syncopated grooves and laid-back yet powerful energy have profoundly influenced global popular music.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1971</td>
      <td>The Pioneers</td>
      <td>Give And Take: The Best Of</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/roots-reggae" | relative_url }}">roots reggae</a></li>
    ...
    <tr>
      ...
      <td>1975</td>
      <td>King Tubby &amp; The Aggrovators</td>
      <td>Shalom Dub</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>Big Youth</td>
      <td>The Chanting Dread Inna Fine Style</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
    ...
    <tr>
      ...
      <td>1983</td>
      <td>I-Roy</td>
      <td>Original Deejay @ King Tubby&#39;s Studio</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1991-07-01</td>
      <td>The Jolly Boys</td>
      <td>Sunshine &#39;n&#39; Water</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
    ...
    <tr>
      ...
      <td>1999-06-08</td>
      <td>Max Romeo</td>
      <td>Open the Iron Gate 1973 - 1977</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Burning Spear</td>
      <td>Marcus Garvey&#x2F;Garvey&#39;s Ghost</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
    ...
    <tr>
      ...
      <td>2002-06</td>
      <td>Midnite</td>
      <td>Seek Knowledge Before Vengeance</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/roots-reggae" | relative_url }}">roots reggae</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Toots and The Maytals</td>
      <td>Sweet and Dandy - The best of...</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2004-03-24</td>
      <td>Monty Alexander with Ernest Ranglin</td>
      <td>Rocksteady</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
    ...
    <tr>
      ...
      <td>2011-06-21</td>
      <td>Vybz Kartel</td>
      <td>Kingston Story (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2016-04-29</td>
      <td>Paolo Baldini DubFiles</td>
      <td>At Song Embassy Papine Kingston 6</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dub" | relative_url }}">dub</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
