...
A jazz trio features three musicians—typically piano, bass, and drums—creating an intimate, conversational interplay where each voice remains distinctly audible. This format emphasizes spontaneous interaction and improvisation, allowing space for individual expression while maintaining tight ensemble cohesion. The stripped-down instrumentation highlights the pure essence of jazz dialogue, from contemplative ballads to energetic swing.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1956</td>
      <td>Jutta Hipp</td>
      <td>At The Hickory House Volume 1</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1957</td>
      <td>Phineas Newborn</td>
      <td>We Three [RVG Remaster]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1958</td>
      <td>Hampton Hawes Trio</td>
      <td>This Is Hampton Hawes, Vol. 2: The Trio</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano-jazz" | relative_url }}">piano jazz</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Portrait In Jazz</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano-jazz" | relative_url }}">piano jazz</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1966</td>
      <td>Bill Evans Trio</td>
      <td>The Last Waltz - The Final Recordings At Keystone Korner September 1980</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
    ...
    <tr>
      ...
      <td>1987</td>
      <td>Bill Evans Trio</td>
      <td>The Complete Live At The Village Vanguard 1961</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a></li>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Carl Perkins</td>
      <td>Introducing Carl Perkins</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Cabaret with The Tony Flannigan Trio</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mastersinger" | relative_url }}">mastersinger</a> # 61</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Beegie Adair Trio</td>
      <td>A Time for Love: Jazz Piano Romance</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Beegie Adair</td>
      <td>Days of Wine and Roses: Songs of Johnny Mercer</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/finland" | relative_url }}">finland</a> # 83</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Jonathan Kreisberg</td>
      <td>Nine Stories Wide</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a> # 16</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2004</td>
      <td>Beegie Adair</td>
      <td>Embraceable You: Romantic Songs of George Gershwin</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/lounge" | relative_url }}">lounge</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jazz-organ" | relative_url }}">jazz organ</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Beegie Adair</td>
      <td>The Frank Sinatra Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
    ...
    <tr>
      <td>50</td>
      <td>
          <img src="https://i.discogs.com/KXojgw7m4bCaOpJcFt2qyocVEeZfzEnRC7SxJ-ydBDk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ3NzA4/NjYtMTQ2ODY4MDE0/MC00NTkwLmpwZWc.jpeg" alt="Cover for Introducing The 3 Sounds" style="max-width:120px; height:auto;" />
      </td>
      <td>2010</td>
      <td>The Three Sounds</td>
      <td>Introducing The 3 Sounds</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-trio" | relative_url }}">jazz trio</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Beegie Adair</td>
      <td>The Good Life: A Jazz Piano Tribute To Tony Bennett</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2014-02-28</td>
      <td>Iiro Rantala String Trio</td>
      <td>Anyone with a Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-jazz" | relative_url }}">contemporary jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Dorothy Axelrod</td>
      <td>Somewhere in Romance</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td></td>
      <td>The Crimson Jazz Trio</td>
      <td>King Crimson Songbook, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
