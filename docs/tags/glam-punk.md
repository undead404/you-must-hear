...
Glam punk fuses the raw energy and rebellious spirit of punk rock with the theatrical flamboyance and androgynous aesthetics of glam rock. Born from the same gritty urban scenes that spawned both movements, it emphasizes outrageous fashion, sexual provocation, and unapologetic excess alongside aggressive guitars and sneering vocals. The style celebrates trashy glamour and deliberate bad taste as forms of anti-establishment expression.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/dark-folk" | relative_url }}">dark folk</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/folk-rock" | relative_url }}">folk rock</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/grunge" | relative_url }}">grunge</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/post-hardcore" | relative_url }}">post-hardcore</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/post-industrial" | relative_url }}">post-industrial</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/traditional" | relative_url }}">traditional</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1978</td>
      <td>Slaughter and the Dogs</td>
      <td>Do It Dog Style</td>
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>37</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5c041c51f72a7fb7039c56a3d0693d9e.png" alt="Cover for Storm the Gates of Heaven" style="max-width:120px; height:auto;" />
      </td>
      <td>1978</td>
      <td>Wayne County &amp; The Electric Chairs</td>
      <td>Storm the Gates of Heaven</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
    ...
    <tr>
      <td>39</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/f616e261e0f5fd3139737a0cefeed450.png" alt="Cover for Things Your Mother Never Told You" style="max-width:120px; height:auto;" />
      </td>
      <td>1979-02</td>
      <td>Wayne County &amp; The Electric Chairs</td>
      <td>Things Your Mother Never Told You</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
    ...
    <tr>
      <td>30</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/21550ee3349f93b36444233e5e7195b6.png" alt="Cover for Bangkok Shocks, Saigon Shakes, Hanoi Rocks" style="max-width:120px; height:auto;" />
      </td>
      <td>1981-02</td>
      <td>Hanoi Rocks</td>
      <td>Bangkok Shocks, Saigon Shakes, Hanoi Rocks</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/finland" | relative_url }}">finland</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>12</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/cd0ddf47e714927ccc3a6d057e25d061.png" alt="Cover for Dress For Excess" style="max-width:120px; height:auto;" />
      </td>
      <td>1988</td>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>The Voluptuous Horror of Karen Black</td>
      <td>A National Healthcare</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>Hollywood Teasze</td>
      <td>Glamdolls in Toyland</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
        </ul>
    ...
    <tr>
      <td>68</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/3032246052fd5785684e508bcd8fa73e.png" alt="Cover for Out of the Closet" style="max-width:120px; height:auto;" />
      </td>
      <td>1996</td>
      <td>Trash Brats</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/melbourne" | relative_url }}">melbourne</a> # 51</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/horror-punk" | relative_url }}">horror punk</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-jersey" | relative_url }}">new jersey</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>1</td>
      <td>
          <img src="https://i.discogs.com/D6RVRDAB-JIESiUkjN8kkjfIiEYpkWH11aph4Q8ChNo/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM4MDEx/Ni0xMTUzODM3MDUz/LmpwZWc.jpeg" alt="Cover for Scandanavian Leather" style="max-width:120px; height:auto;" />
      </td>
      <td>2003</td>
      <td>Turbonegro</td>
      <td>Scandanavian Leather</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>We R The Weirdoz!!!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/glam-rock" | relative_url }}">glam rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>31</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/e23ce12e33ee4d68a5df42593d996ba6.png" alt="Cover for The Witch&#39;s Dagger" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-08-23</td>
      <td>Veronica Lipgloss &amp; The Evil Eyes</td>
      <td>The Witch&#39;s Dagger</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Hollywood Groupies</td>
      <td>Punched By Millions Hit By None</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italy" | relative_url }}">italy</a></li>
    ...
    <tr>
      <td>88</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/e322c56030fedc15a0c092d7cfd8dfe1.png" alt="Cover for Whatever Happened To...The Complete Works Of" style="max-width:120px; height:auto;" />
      </td>
      <td>2007</td>
      <td>Soho Roses</td>
      <td>Whatever Happened To...The Complete Works Of</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-metal" | relative_url }}">glam metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
    ...
    <tr>
      <td>69</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/c90470be560cdeb5d6dc83687b370115.png" alt="Cover for A Trace of Love and Tears" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-03-06</td>
      <td>Jennyfer Star</td>
      <td>A Trace of Love and Tears</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sleaze-rock" | relative_url }}">sleaze rock</a></li>
    ...
    <tr>
      ...
      <td>2009-04-27</td>
      <td>Rachel Stamp</td>
      <td>Now I&#39;m Nailed to Your Bedroom Wall I&#39;ve Only Got Myself to Blame</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/england" | relative_url }}">england</a></li>
    ...
    <tr>
      ...
      <td>2009-06-15</td>
      <td>Sister</td>
      <td>Deadboys Making Noise [EP]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-metal" | relative_url }}">glam metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Superhorrorfuck</td>
      <td>Livingdeadstars</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-metal" | relative_url }}">glam metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
    ...
    <tr>
      <td>70</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/cff225997e0f447c8fba6f058b10e958.png" alt="Cover for The Love Has Gone" style="max-width:120px; height:auto;" />
      </td>
      <td>2011</td>
      <td>2nd District</td>
      <td>The Love Has Gone</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
    ...
    <tr>
      <td>99</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/049af4d7808f417f8764b5feb4642fda.png" alt="Cover for Modern Life Is Rubbish (Special Edition)" style="max-width:120px; height:auto;" />
      </td>
      <td>2012</td>
      <td>Blur</td>
    ...
    <tr>
      <td>84</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/511f58fe4569d59289f3124be7fdfe97.png" alt="Cover for Beautiful Murder" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-12-13</td>
      <td>Death Makes Pretty</td>
      <td>Beautiful Murder</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/horror-punk" | relative_url }}">horror punk</a></li>
    ...
    <tr>
      <td>80</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/3822e9ea0309c8982c85796a988b7c24.png" alt="Cover for Scream! Skercrows!!!" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-03-22</td>
      <td>Death Makes Pretty</td>
      <td>Scream! Skercrows!!!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/glam-punk" | relative_url }}">glam punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/horror-punk" | relative_url }}">horror punk</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Just Disney</td>
      <td>The Owl House Main Theme (From &quot;The Owl House&quot;)</td>
      <td>
        <ul>
