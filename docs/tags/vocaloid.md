...
Vocaloid is a genre built around singing synthesizer software, primarily from Japan, featuring digitally generated vocals with distinctive robotic-yet-expressive qualities. The music spans diverse styles from hyper-pop to rock, unified by its use of virtual singers like Hatsune Miku as the voice. Born from internet culture, it thrives through collaborative online communities where producers create songs for these digital personas.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Kira</td>
      <td>Why Does a Heart Break? (Flay! Remix)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Various Artists</td>
      <td>初音ミク「マジカルミライ」10th Anniversary OFFICIAL ALBUM</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Matsushita Shita Shita Ue Ue←→Ab</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/vocaloid" | relative_url }}">vocaloid</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/vocaloid" | relative_url }}">vocaloid</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
            ...
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/metalcore" | relative_url }}">metalcore</a></li>
            ...
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/vocaloid" | relative_url }}">vocaloid</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>初音ミクシンフォニー〜Miku Symphony 2019 オーケストラ ライブ</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/vocaloid" | relative_url }}">vocaloid</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2022-07-01</td>
      <td>Astrophysics</td>
      <td>The First Sound of The Future Past</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Utamonogatari Special Edition (Original Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
