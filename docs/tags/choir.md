...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1965</td>
      <td>The Mormon Tabernacle Choir</td>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>The Tsinandali Choir</td>
      <td>Table Songs Of Georgia</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>De Gouden Nachtegaaltjes</td>
      <td>De 25 Allermooiste Sinterklaasliedjes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
    ...
    <tr>
      ...
      <td>1999-04-20</td>
      <td>Brooklyn Tabernacle Choir</td>
      <td>High &amp; Lifted Up</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Langley Schools Music Project</td>
      <td>Innocence &amp; Despair</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/belgian" | relative_url }}">belgian</a> # 24</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>The Best of the Red Army Choir: the Definitive Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Candlelight Processional</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/christian" | relative_url }}">christian</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Various Artists</td>
      <td>iWorship A Total Christmas Worship Experience</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
    ...
    <tr>
      <td>96</td>
      <td>
          <img src="https://i.discogs.com/g9hPQXWpSjh344Yx7ZLA_6e5iEEHlAm6Drj1VnCgKmE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI4NjIx/MTctMTMwNDcxNTcz/NS5qcGVn.jpeg" alt="Cover for Light &amp; Gold" style="max-width:120px; height:auto;" />
      </td>
      <td>2010</td>
      <td>Eric Whitacre</td>
      <td>Light &amp; Gold</td>
    ...
    <tr>
      ...
      <td>2010-06-28</td>
      <td>The Choir</td>
      <td>Burning Like The Midnight Sun</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
    ...
    <tr>
      ...
      <td>2010-11-19</td>
      <td>Gregorian</td>
      <td>Christmas Chants and Visions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chillout" | relative_url }}">chillout</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
    ...
    <tr>
      ...
      <td>2011-01-01</td>
      <td>Les Petits Chanteurs de Saint-Marc</td>
      <td>Les Choristes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
    ...
    <tr>
      ...
      <td>2011-09-30</td>
      <td>Gregorian</td>
      <td>Masters Of Chant - Chapter 8</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-05-06</td>
      <td>Philippe Jaroussky</td>
      <td>Vivaldi: Nisi Dominus, Stabat Mater</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Like Shadows in Grey Rivers</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2014-03-04</td>
      <td>Huelgas Ensemble</td>
      <td>Vivarte: Matheus de Perusio - Virelais, Ballades, Caccia</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/orchestral" | relative_url }}">orchestral</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>Хор братии Валаамского монастыря</td>
      <td>Воскресения день</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>Stellenbosch University Choir</td>
      <td>Heavens&#39; flock</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
    ...
    <tr>
      ...
      <td>2021</td>
      <td>Grace Davidson</td>
      <td>Handel: Silete Venti, Gloria, Salve Regina – Vivaldi: Nulla in Mundo Pax Sincera</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>35</td>
      <td>
          <img src="https://i.discogs.com/DkrnCR-AQLB_djqZsjcIcgbCIwfEfANxTqP8_jGhNZU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTU2OTQ4/MS0xNTAxNjkzMDg2/LTgwMDYuanBlZw.jpeg" alt="Cover for Ultimate Pop Christmas" style="max-width:120px; height:auto;" />
      </td>
      <td>2023-12-08</td>
      <td>S Club 7</td>
      <td>Ultimate Pop Christmas</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2024-04-12</td>
      <td>Pykäri</td>
      <td>LOHDUTUS (feat. Ringa Manner)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choir" | relative_url }}">choir</a></li>
