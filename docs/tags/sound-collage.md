...
Last updated: <time datetime="2025-12-05T10:02:45.941Z">Fri Dec 05 2025 12:02:45 GMT+0200 (Eastern European Standard Time)</time>

### Description

Sound collage is an experimental music genre that assembles fragments of found sounds, samples, and field recordings into layered, abstract compositions. Emerging from avant-garde and electronic traditions, it emphasizes texture and atmosphere over conventional song structure. The result is often dreamlike and disorienting, blurring boundaries between music and ambient noise.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>Dreamies</td>
      <td>Auralgraphic Entertainment</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/japanoise" | relative_url }}">japanoise</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-electronic" | relative_url }}">experimental electronic</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Deux Filles</td>
      <td>Silence &amp; Wisdom (Remastered)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/rock-argentino" | relative_url }}">rock argentino</a> # 98</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/microsound" | relative_url }}">microsound</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/microsound" | relative_url }}">microsound</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mashup" | relative_url }}">mashup</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>63</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a9a8a9588693cdb5ce5efdb22572aef6.png" alt="Cover for In Rape Fantasy and Terror Sex We Trust" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-09</td>
      <td>Joan of Arc</td>
      <td>In Rape Fantasy and Terror Sex We Trust</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>John Fahey</td>
      <td>Requia And Other Compositions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sound-collage" | relative_url }}">sound collage</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Vibracathedral Orchestra</td>
      <td>Wisdom Thunderbolt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noise" | relative_url }}">noise</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/exotica" | relative_url }}">exotica</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>87</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/21c03b729a258168e6215f1446240155.png" alt="Cover for Edward Flex Presents: Do You Believe In Hawaii?" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-02-02</td>
      <td>James Ferraro</td>
      <td>Edward Flex Presents: Do You Believe In Hawaii?</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hypnagogic-pop" | relative_url }}">hypnagogic pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
    ...
    <tr>
      ...
      <td>2013</td>
      <td>Broadcast</td>
      <td>Study Series 04: Familiar Shapes and Noises</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/lo-fi" | relative_url }}">lo-fi</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sound-collage" | relative_url }}">sound collage</a></li>
    ...
    <tr>
      ...
      <td>2014-10-24</td>
      <td>Can</td>
      <td>Tago Mago (2011 Remastered)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-rock" | relative_url }}">experimental rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-trance" | relative_url }}">ambient trance</a> # 27</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 39</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/plunderphonics" | relative_url }}">plunderphonics</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/outsider-house" | relative_url }}">outsider house</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2022-04-16</td>
      <td>lilien rosarian</td>
      <td>every flower in my garden</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folktronica" | relative_url }}">folktronica</a></li>
    ...
    <tr>
      ...
      <td>2023-02-17</td>
      <td>TOXE</td>
      <td>The Story Of Leonora (OST)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-electronic" | relative_url }}">progressive electronic</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/electroacoustic" | relative_url }}">electroacoustic</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
