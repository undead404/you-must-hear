...
Last updated: <time datetime="2025-12-06T11:49:23.667Z">Sat Dec 06 2025 13:49:23 GMT+0200 (Eastern European Standard Time)</time>

### Description

Deutschpop refers to German-language pop music that emerged as a distinct movement in the 2000s, blending catchy melodies with introspective, poetic lyrics sung in German. The style ranges from upbeat indie-pop to melancholic rock, unified by its emphasis on linguistic authenticity and emotional storytelling. It represents a cultural shift where German artists embraced their native language in mainstream pop, creating accessible yet artistically ambitious music.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>23</td>
      <td>
          <img src="https://i.discogs.com/FCg0OM2R1PTcZjEjC7GxKmQfxFGI9Kz9MuQXvY2ie0g/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE4MDMw/MTk5LTE2MTY4NDUx/NzctMzAwNy5wbmc.jpeg" alt="Cover for B.A.R.T." style="max-width:120px; height:auto;" />
      </td>
      <td>1996</td>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a></li>
            ...
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/funk" | relative_url }}">funk</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/germany" | relative_url }}">germany</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/indie-rock" | relative_url }}">indie rock</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/new-rave" | relative_url }}">new rave</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/ska" | relative_url }}">ska</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/soul" | relative_url }}">soul</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/synthpop" | relative_url }}">synthpop</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/germany" | relative_url }}">germany</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/soul" | relative_url }}">soul</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/deutschpunk" | relative_url }}">deutschpunk</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/drum" | relative_url }}">drum</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/electronica" | relative_url }}">electronica</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
    ...
    <tr>
      <td>52</td>
      <td>
          <img src="https://i.discogs.com/5d4siKLtF2TS6nLiNHYrD_S6tRtyE1xBDDnNYGn0Bxs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI4NjM0/NDYtMTMwNDgzMzEy/Ny5qcGVn.jpeg" alt="Cover for Wir gehen schon mal vor!" style="max-width:120px; height:auto;" />
      </td>
      <td>1996-08-05</td>
      <td>Anna</td>
      <td>Wir gehen schon mal vor!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
        </ul>
    ...
    <tr>
      <td>66</td>
      <td>
          <img src="https://i.discogs.com/Kso1VZVTDvesggOgCXWnOrMnvzctG6-FBC8iJTV5Dis/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyNTUz/NTEtMTI3MjY0MDU5/NS5qcGVn.jpeg" alt="Cover for Eine einfache Lösung" style="max-width:120px; height:auto;" />
      </td>
      <td>1997</td>
      <td>Die Antwort</td>
      <td>Eine einfache Lösung</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      <td>32</td>
      <td>
          <img src="https://i.discogs.com/KEphHjDLVynmiMxZcdsCCCPM00KtaB36XFyRwnXxxy8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0OTEw/LTE1NzU0MDgzOTAt/ODQzMy5qcGVn.jpeg" alt="Cover for Milchmädchen" style="max-width:120px; height:auto;" />
      </td>
      <td>1999-07</td>
      <td>Charlotte</td>
      <td>Milchmädchen</td>
    ...
    <tr>
      <td>65</td>
      <td>
          <img src="https://i.discogs.com/FVxGcrbxaQz7a_Mweb3wHtFE5n93LX3IzMvCYDD6Rkw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTY0NjQ0/OC0xMzc0MzI3ODM4/LTIzNTAuanBlZw.jpeg" alt="Cover for Das Beste kommt noch" style="max-width:120px; height:auto;" />
      </td>
      <td>2004-02</td>
      <td>Staubkind</td>
      <td>Das Beste kommt noch</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>46</td>
      <td>
          <img src="https://i.discogs.com/UwtzATm7u8E8ZO2BJMo6wb231CfffwJePb6DO-Kyghc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTgwMzA2/MjgtMTQ1MzgwNTM2/MS05MjIzLmpwZWc.jpeg" alt="Cover for Alle Zeichen steh&#39;n auf Sieg" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Tobias Biedert</td>
      <td>Alle Zeichen steh&#39;n auf Sieg</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      <td>15</td>
      <td>
          <img src="https://i.discogs.com/Bipt1DhGL_1GfaxWQ7ecgs9E3BmbZcphBEmBwVvMRQ8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMxMzI1/NzEtMTMxNzI2NDcx/My5qcGVn.jpeg" alt="Cover for Ausgebrannt" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-10-07</td>
      <td>Staubkind</td>
      <td>Ausgebrannt</td>
    ...
    <tr>
      <td>72</td>
      <td>
          <img src="https://i.discogs.com/jKxfPQEwKVYGWkYS8xoFOOwg3JkCFWdNdraQulzefro/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTYyNDUx/MS0xMjIzNzQwNzQ5/LmpwZWc.jpeg" alt="Cover for At the discotheque" style="max-width:120px; height:auto;" />
      </td>
      <td>2006</td>
      <td>Popshoppers</td>
      <td>At the discotheque</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/electropop" | relative_url }}">electropop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            ...
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/drum" | relative_url }}">drum</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/dub" | relative_url }}">dub</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
        </ul>
      </td>
    ...
    <tr>
      <td>31</td>
      <td>
          <img src="https://i.discogs.com/-GuO-4bmmaYZBDqxAVAURLC6FbcCbcJQkGhtAahyDpo/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwOTAz/NTMzLTE2MzY0MDQx/ODYtNzk0My5qcGVn.jpeg" alt="Cover for Vom Selben Stern Live" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-06-15</td>
      <td>Ich + Ich</td>
      <td>Vom Selben Stern Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
        </ul>
    ...
    <tr>
      <td>67</td>
      <td>
          <img src="https://i.discogs.com/xe4ciJnwRRp22bYSwc7nt83SHZlbQKHT_vKwgtjfEpA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExMTc2/OTgtMTE5MzQyMzI3/MC5qcGVn.jpeg" alt="Cover for Ein Weihnachtsabend" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-10-12</td>
      <td>Staubkind</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a> # 93</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2008-04-21</td>
      <td>Juli Holz</td>
      <td>Tränen auf dem Dancefloor</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/electropop" | relative_url }}">electropop</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 84 / 100)"> <a href="{{ "/tags/funk" | relative_url }}">funk</a></li>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            ...
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/soul" | relative_url }}">soul</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/funk" | relative_url }}">funk</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a></li>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/techno" | relative_url }}">techno</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>11</td>
      <td>
          <img src="https://i.discogs.com/LW0WtqyAIxWmWqVwRBKcx1MA1QIWPc_iXu4i4-pIRKE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMyNTA3/NDUtMTMyMjQ4NzQ2/OS5qcGVn.jpeg" alt="Cover for Alles" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-08-06</td>
      <td>Wir sind Helden</td>
      <td>Alles</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a> # 65</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2010-11-25</td>
      <td>chillaholic</td>
      <td>Königin der Nacht (Part 1)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum" | relative_url }}">drum</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            ...
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/dub" | relative_url }}">dub</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/electropop" | relative_url }}">electropop</a></li>
    ...
    <tr>
      <td>1</td>
      <td>
          <img src="https://i.discogs.com/jnlq9IWNWJieLRix-z9AF-HgWeBviT2d_ql6S6KVOlc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMwODc3/OTUtMTMxNTE0Mzgw/Ny5qcGVn.jpeg" alt="Cover for Wartesaal" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-02-25</td>
      <td>Bosse</td>
      <td>Wartesaal</td>
    ...
    <tr>
      ...
      <td>2011-04-29</td>
      <td>EMMA6</td>
      <td>Soundtrack für dieses Jahr</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/bass" | relative_url }}">bass</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/dub" | relative_url }}">dub</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>Pläne Für Gestern</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronica" | relative_url }}">electronica</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/electropop" | relative_url }}">electropop</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/germany" | relative_url }}">germany</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/deutschpunk" | relative_url }}">deutschpunk</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/drum" | relative_url }}">drum</a></li>
            ...
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>85</td>
      <td>
          <img src="https://i.discogs.com/-BjK6lNSOeIQ4yCLEdll9GZsYUXXFPoexMggE-eX9rg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzNTU0/NjU2LTE1NTY0MTQ3/MTgtODcwOC5qcGVn.jpeg" alt="Cover for Kein Mann für eine Nacht" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-05-23</td>
      <td>Fabyán</td>
      <td>Kein Mann für eine Nacht</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
    ...
    <tr>
      <td>16</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/f2c9bc161e3a4febb02966ed4d15b6b7.png" alt="Cover for Freunde der Sonne" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-06-27</td>
      <td>Sun of a Gun</td>
      <td>Freunde der Sonne</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
    ...
    <tr>
      <td>89</td>
      <td>
          <img src="https://i.discogs.com/yRGxBFayZERy9S6TvN3mDUyD-YX2eHSpYgJZa2vDxZo/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTczMTA0/NTYtMTQzODU5MTYz/NC0yMzgwLmpwZWc.jpeg" alt="Cover for Human Mystery EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-09-27</td>
      <td>Venom218</td>
      <td>Human Mystery EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
    ...
    <tr>
      <td>25</td>
      <td>
          <img src="https://i.discogs.com/jLFTD8bGqe4mFFbzZdGVvAxxQIjOpcAizRQcLqwqBQM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM0NzE4/NDEtMTMzMTcwNjc2/MS5qcGVn.jpeg" alt="Cover for Kannst Du Mich Seh&#39;n" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-02-24</td>
      <td>Staubkind</td>
      <td>Kannst Du Mich Seh&#39;n</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      <td>2</td>
      <td>
          <img src="https://i.discogs.com/QJu6qF5sVLfGyVu-7PLWhsxCf8Cz8JAPxDXCib7zB3c/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM0NDYw/MDItMTMzMDY5OTk2/OC5qcGVn.jpeg" alt="Cover for Wir Sind Vorbei" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-03-09</td>
      <td>Enno Bunger</td>
      <td>Wir Sind Vorbei</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
        </ul>
    ...
    <tr>
      <td>80</td>
      <td>
          <img src="https://i.discogs.com/_zAhwqqNdHgzHsTr4pCd5BYuVjtnB9fpiCSbGtQFmmk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM3Mjk1/MzgtMTM0MjAzMDQ2/MS00OTc4LmpwZWc.jpeg" alt="Cover for So nah bei mir - EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-06-15</td>
      <td>Staubkind</td>
      <td>So nah bei mir - EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      <td>60</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6838fa616c6f3c5d2fcbd178bd44364a.png" alt="Cover for Staubkind (Bonus Track Version)" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-06-29</td>
      <td>Staubkind</td>
      <td>Staubkind (Bonus Track Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      <td>29</td>
      <td>
          <img src="https://i.discogs.com/UZdVItd7V4jzMKgDRM9-9VA8zx0ak-u-kNfpwo2aCs8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEwOTc3/MjI2LTE1MDc1NDQ5/OTctODE1MC5qcGVn.jpeg" alt="Cover for Love Season" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-08-22</td>
      <td>JS (Joerg Sommermeyer)</td>
      <td>Love Season</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson" | relative_url }}">chanson</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/male-vocalists" | relative_url }}">male vocalists</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/deutsche-schlager" | relative_url }}">deutsche schlager</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/folk-rock" | relative_url }}">folk rock</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/soft-rock" | relative_url }}">soft rock</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/classic-rock" | relative_url }}">classic rock</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a></li>
    ...
    <tr>
      <td>35</td>
      <td>
          <img src="https://i.discogs.com/mZlLJRBami8wAATZiUzSMUqSVTMEwLxTwi-odGredBQ/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM5MTQy/NDgtMTU0MzQwOTMz/MC04MzQxLmpwZWc.jpeg" alt="Cover for Das Chaos und die Ordnung WEB" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-09-28</td>
      <td>Die Orsons</td>
      <td>Das Chaos und die Ordnung WEB</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a></li>
    ...
    <tr>
      <td>57</td>
      <td>
          <img src="https://i.discogs.com/0bYca2GJZXfAaMjNcK181P8-CVZYnK-wUjs82gZdlB8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQwNzE3/ODItMTM1NDI4NDk3/MC02MjgxLmpwZWc.jpeg" alt="Cover for Nur ein Tag &#x2F; Unendlich sein" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-10-26</td>
      <td>Staubkind</td>
      <td>Nur ein Tag &#x2F; Unendlich sein</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      <td>81</td>
      <td>
          <img src="https://i.discogs.com/eg-DQXybofbLxiwmx5PQRahlTPH0a8zCof4AL0RP15s/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExMDI1/NDE2LTE1MDg0ODAw/MzMtOTcwMy5qcGVn.jpeg" alt="Cover for 2008" style="max-width:120px; height:auto;" />
      </td>
      <td>2013</td>
      <td>Dirt Floor</td>
      <td>2008</td>
    ...
    <tr>
      <td>87</td>
      <td>
          <img src="https://i.discogs.com/HZiD4zo_4bZu1jbp0PXQMuIDRplq4S3ksJAA1EUk3p0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTUwMjE1/MDItMTM4MjM1ODQ2/Ny05NzQ2LnBuZw.jpeg" alt="Cover for Freunde" style="max-width:120px; height:auto;" />
      </td>
      <td>2013</td>
      <td>Zuckerklub</td>
      <td>Freunde</td>
    ...
    <tr>
      <td>92</td>
      <td>
          <img src="https://i.discogs.com/goCbCWMFBaAJtQfpILE569qbpiI9zL1yXRCxaZdKwy4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE3ODU2/OTczLTE2MTU4Mjk4/NDItODI2NS5qcGVn.jpeg" alt="Cover for Lieder ohne mich" style="max-width:120px; height:auto;" />
      </td>
      <td>2013</td>
      <td>Roger Stein</td>
      <td>Lieder ohne mich</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chanson" | relative_url }}">chanson</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
    ...
    <tr>
      <td>98</td>
      <td>
          <img src="https://i.discogs.com/HLssBpbcypzHdUuiEpK02jHogi1c2TpUXcD_wFO5VHU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTYyOTE4/NjctMTQxNTcyOTU2/MC04MzYwLmpwZWc.jpeg" alt="Cover for Wo wir zu Hause sind: Akustik Tour – Live" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-08-02</td>
      <td>Staubkind</td>
      <td>Wo wir zu Hause sind: Akustik Tour – Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      ...
      <td>2014-07-18</td>
      <td>Staubkind</td>
      <td>Alles was ich bin (Deluxe Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      <td>41</td>
      <td>
          <img src="https://i.discogs.com/G9-XQMh80OJXpTvDttqjAVPwkJ2Y719dwk0gdrpJJ_w/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTU5MDIx/NjctMTQwNTg2MjYy/NS0yMDQ3LmpwZWc.jpeg" alt="Cover for Alles Was Ich Bin" style="max-width:120px; height:auto;" />
      </td>
      <td>2014-07-18</td>
      <td>Staubkind</td>
      <td>Alles Was Ich Bin</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      <td>82</td>
      <td>
          <img src="https://i.discogs.com/l4SLPWcT3du_DoSSmCyaJ9S-X5Jc9W01aH_SrQS6ToM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEwMTI2/NTM5LTE0OTIwOTEw/MDMtODI3OC5qcGVn.jpeg" alt="Cover for Poser E.P." style="max-width:120px; height:auto;" />
      </td>
      <td>2017-02-10</td>
      <td>Anna</td>
      <td>Poser E.P.</td>
    ...
    <tr>
      <td>36</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/39b8cd485df56081edb4283d2e605e41.png" alt="Cover for An jedem einzelnen Tag" style="max-width:120px; height:auto;" />
      </td>
      <td>2017-03-09</td>
      <td>Staubkind</td>
      <td>An jedem einzelnen Tag</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
    ...
    <tr>
      <td>71</td>
      <td>
          <img src="https://i.discogs.com/DqCJuzTbjnYdAd8xemkrLKNdtjvN2ynkz3Lz8zZpY8A/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExOTUx/Mzk0LTE1MzA0NDYx/MzUtMjY1NS5qcGVn.jpeg" alt="Cover for Hinter meinen Träumen" style="max-width:120px; height:auto;" />
      </td>
      <td>2018</td>
      <td>Staubkind</td>
      <td>Hinter meinen Träumen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/electronica" | relative_url }}">electronica</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/indie-rock" | relative_url }}">indie rock</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/bass" | relative_url }}">bass</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/deutschpunk" | relative_url }}">deutschpunk</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/deutschrock" | relative_url }}">deutschrock</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/drum" | relative_url }}">drum</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/electropop" | relative_url }}">electropop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/germany" | relative_url }}">germany</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/new-rave" | relative_url }}">new rave</a></li>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/schlager" | relative_url }}">schlager</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/ska" | relative_url }}">ska</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/soul" | relative_url }}">soul</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>97</td>
      <td>
          <img src="https://i.discogs.com/lNGKjxwVwOu_2S0b5F3bOBt0LZqwMqjpn0JaajhTnNw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI1NTk1/MTI4LTE2NzIyNTQ2/MzQtODM2Mi5qcGVn.jpeg" alt="Cover for Nur wegen dir" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-04-15</td>
      <td>Blonder Bengel</td>
      <td>Nur wegen dir</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Dr Song</td>
      <td>sehr gute schlechte Musik</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Jim Pandzko feat. Jan Böhmermann</td>
      <td>Menschen Leben Tanzen Welt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschpop" | relative_url }}">deutschpop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Kassette, die Magnetband</td>
      <td>Last FM Spezial</td>
      <td>
        <ul>
        </ul>
      </td>
