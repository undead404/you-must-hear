...
Last updated: <time datetime="2025-10-18T20:18:09.091Z">Sat Oct 18 2025 23:18:09 GMT+0300 (Eastern European Summer Time)</time>

### Description

2-step is a rhythmic approach originating from UK garage that features syncopated, shuffling drum patterns with distinctive skip-like beats instead of straight four-on-the-floor kicks. The sound creates an infectious groove through off-kilter percussion and typically pairs with soulful vocals, warm basslines, and garage-influenced production. Originally emerging in late &#39;90s London club culture, it has recently experienced a global revival through bedroom pop and modern R&amp;B reinterpretations.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1996-10-02</td>
      <td>Dub War</td>
      <td>Murderous Style &#x2F; Generation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-dubstep" | relative_url }}">post-dubstep</a> # 61</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Finally (Ghost Trax Remixes)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/uk-garage" | relative_url }}">uk garage</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Urban Shakedown</td>
      <td>Some Justice 2002 (Menta Rmxs)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/uk-garage" | relative_url }}">uk garage</a></li>
    ...
    <tr>
      <td>57</td>
      <td>
          <img src="https://i.discogs.com/NWbqbr0STFfKreDccX3RwzhaGFd7y0vq-mWpGb-RCiE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExNDA2/MzItMTU0ODYxMzU3/NC0zMDExLmpwZWc.jpeg" alt="Cover for Skreamizm, Volume 4" style="max-width:120px; height:auto;" />
      </td>
      <td>2007</td>
      <td>Skream</td>
      <td>Skreamizm, Volume 4</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/uk-hip-hop" | relative_url }}">uk hip hop</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2010-02-24</td>
      <td>Priscilla Angelique</td>
      <td>The Technologist (FREE Ringtones)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
    ...
    <tr>
      <td>4</td>
      <td>
          <img src="https://i.discogs.com/mVyjf877Owqt2t4eBnzC5i0eH38_xoFdcr5c57uLk-s/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzNzE5/OTktMTI4MDE2NjMx/MS5qcGVn.jpeg" alt="Cover for Out Of Ctrl EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-03-08</td>
      <td>Lostlojic</td>
      <td>Out Of Ctrl EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/future-garage" | relative_url }}">future garage</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-dubstep" | relative_url }}">post-dubstep</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010-10-28</td>
      <td>Priscilla Angelique</td>
      <td>Positive Digital Album Sampler (FREE)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/beatdown-hardcore" | relative_url }}">beatdown hardcore</a> # 47</li>
    ...
    <tr>
      <td>62</td>
      <td>
          <img src="https://i.discogs.com/b5Lq9ryqdzjPBW9qRbnupeDSju9oHyoxv04lpVVLw68/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE2NDgx/MTM2LTE2MDgwMDE0/OTgtODU2OS5wbmc.jpeg" alt="Cover for Misanthropy" style="max-width:120px; height:auto;" />
      </td>
      <td>2011</td>
      <td>Existence</td>
      <td>Misanthropy</td>
    ...
    <tr>
      <td>80</td>
      <td>
          <img src="https://i.discogs.com/3Vrmo131yYeVhGIEhxVsh7R1RbSAOxTzygPnGBCAZgA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ0Nzc3/MjYtMTM2NTk4Njky/MS05MDcwLmpwZWc.jpeg" alt="Cover for The Sixth Day" style="max-width:120px; height:auto;" />
      </td>
      <td>2011</td>
      <td>Desolated</td>
      <td>The Sixth Day</td>
    ...
    <tr>
      <td>26</td>
      <td>
          <img src="https://i.discogs.com/4h612J9flA1gAwrkxPoaGkp6r3QcsyYEkdqy-KXqqSk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMwMzUz/MzctMTMxMjcxNjg0/MC5qcGVn.jpeg" alt="Cover for Drink Drink, Fan Fan, Rub Rub" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-01-26</td>
      <td>Syncretic</td>
      <td>Drink Drink, Fan Fan, Rub Rub</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/moshcore" | relative_url }}">moshcore</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>89</td>
      <td>
          <img src="https://i.discogs.com/DLQybKxss6YUv8jdZF5Am9XdO3Cjl0BPq6NH3GX7c3I/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTU5MTEx/OTctMTU4MTg2NjYy/NC0xNjIxLmpwZWc.jpeg" alt="Cover for Kindred" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-02-12</td>
      <td>Burial</td>
      <td>Kindred</td>
    ...
    <tr>
      ...
      <td>2013-02-04</td>
      <td>Groove Chronicles</td>
      <td>Classics EP - Volume 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/uk-garage" | relative_url }}">uk garage</a></li>
    ...
    <tr>
      ...
      <td>2013-12-16</td>
      <td>Burial</td>
      <td>Burial LP-HDBLP001 Vinyl</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dubstep" | relative_url }}">dubstep</a></li>
    ...
    <tr>
      ...
      <td>2017-03-06</td>
      <td>Phelian</td>
      <td>LOST WITH YOU, BROKEN WITHOUT YOU</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://i.discogs.com/mo1Wn0GheN7oOkBhYqKrr6v3imhiBEdSAInkNQBg4SE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEwNjUx/MzEzLTE1MDY3MDg4/NDUtMjk5NS5qcGVn.jpeg" alt="Cover for Volume One" style="max-width:120px; height:auto;" />
      </td>
      <td>2017-08</td>
      <td>DUBTRAXX</td>
      <td>Volume One</td>
    ...
    <tr>
      ...
      <td>2018-02-28</td>
      <td>v+m</td>
      <td>i&#39;ve felt alone my entire life</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>2019-07-22</td>
      <td>Oli XL</td>
      <td>Rogue Intruder, Soul Enhancer</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>40</td>
      <td>
          <img src="https://i.discogs.com/gER1iih3M6dF-P319K_bRaw0NV8BOJBLz3vw7tge7cs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE4MzY4/MjYwLTE2MTg4NTAw/NTMtMzg0My5wbmc.jpeg" alt="Cover for Ladbroke Grove (Remix) [feat. General Levy &amp; Novelist] - Single" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-07-02</td>
      <td>AJ Tracey</td>
      <td>Ladbroke Grove (Remix) [feat. General Levy &amp; Novelist] - Single</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
    ...
    <tr>
      ...
      <td>2021-07-16</td>
      <td>Overmono</td>
      <td>fabric presents Overmono (Mixed)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>0000AK00</td>
      <td>Back to the Future Disco</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/2-step" | relative_url }}">2-step</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dubstep" | relative_url }}">dubstep</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Ruckspin, Visionz, Quantum Soul</td>
      <td>Give-Venus Project</td>
      <td>
        <ul>
        </ul>
      </td>
