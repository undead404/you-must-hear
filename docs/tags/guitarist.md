...
Last updated: <time datetime="2025-12-06T06:38:33.669Z">Sat Dec 06 2025 08:38:33 GMT+0200 (Eastern European Standard Time)</time>

### Description

The &quot;guitarist&quot; tag highlights music where the guitar takes center stage as the primary voice and creative force, spanning rock, jazz, folk, and blues traditions. These works showcase technical mastery, distinctive tone, and personal expression through the instrument, whether via virtuosic solos, innovative techniques, or signature playing styles. The tag represents a musician-focused approach where the guitarist&#39;s individual artistry defines the sound.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1972</td>
      <td>Jimi Hendrix</td>
      <td>Stages (disc 4: Atlanta &#39;70)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues-rock" | relative_url }}">blues rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
    ...
    <tr>
      ...
      <td>1973-03</td>
      <td>Joan Baez</td>
      <td>Where Are You Now, My Son?</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>7</td>
      <td>
          <img src="https://i.discogs.com/21nF6XpncgdqsJmSHm8KOCCirj4PwsCQB2nRpUN6onE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE2MTM3/MTgtMTM5OTc5OTIy/Ni00OTYyLmpwZWc.jpeg" alt="Cover for Blue" style="max-width:120px; height:auto;" />
      </td>
      <td>1987</td>
      <td>Terje Rypdal</td>
      <td>Blue</td>
    ...
    <tr>
      ...
      <td>Kiss You Kidnapped Charabanc</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/instrumental-rock" | relative_url }}">instrumental rock</a> # 1</li>
    ...
    <tr>
      <td>29</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/b3fa16e4b72d45d3a90f930699d4ea59.png" alt="Cover for Street Legal" style="max-width:120px; height:auto;" />
      </td>
      <td>1988</td>
      <td>Bob Dylan</td>
      <td>Street Legal</td>
    ...
    <tr>
      ...
      <td>1990-10-15</td>
      <td>Albert King</td>
      <td>Wednesday Night In San Francisco</td>
      <td>
        <ul>
    ...
    <tr>
      <td>40</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/da53b6e09c90c00f345359d634d75bf8.png" alt="Cover for I Still Do" style="max-width:120px; height:auto;" />
      </td>
      <td>1991</td>
      <td>Eric Clapton</td>
      <td>I Still Do</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/shred" | relative_url }}">shred</a> # 69</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/male-singer-songwriter" | relative_url }}">male singer songwriter</a> # 38</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Ron Wood</td>
      <td>Slide on Live: Plugged in and Standing</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues-rock" | relative_url }}">blues rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/british" | relative_url }}">british</a></li>
    ...
    <tr>
      ...
      <td>Drinkin TNT N Smokin Dynamite</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues" | relative_url }}">blues</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues-rock" | relative_url }}">blues rock</a></li>
    ...
    <tr>
      <td>14</td>
      <td>
          <img src="https://i.discogs.com/pecmDX-74clKS0C3eq-8W72LqzucnBh6e1kOh86vYUY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQzMjI5/MDktMTM2MTcyMzQx/OS05MDYyLmpwZWc.jpeg" alt="Cover for Amphibia" style="max-width:120px; height:auto;" />
      </td>
      <td>1996-04</td>
      <td>Patrick Rondat</td>
      <td>Amphibia</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>David Torn</td>
      <td>The David Torn Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/minneapolis" | relative_url }}">minneapolis</a> # 37</li>
    ...
    <tr>
      ...
      <td>1999-09-28</td>
      <td>Santana</td>
      <td>The Best of Instrumentals, Volume 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>45</td>
      <td>
          <img src="https://i.discogs.com/btuIiKGAnwDzjrvbJB5wl6vd_WFaqASKI0MmsLERlNY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc5NDk4/OC0xMzg0MTYxNjY4/LTQ3ODkuanBlZw.jpeg" alt="Cover for Star Fleet" style="max-width:120px; height:auto;" />
      </td>
      <td>2000</td>
      <td>Brian May</td>
      <td>Star Fleet</td>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Waking Vision Trio</td>
      <td>The Ancient Bloom</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Willie Nelson</td>
      <td>All The Songs I&#39;ve Loved Before</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/country" | relative_url }}">country</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
    ...
    <tr>
      ...
      <td>2001-04-11</td>
      <td>Jimi Hendrix</td>
      <td>Voodoo Child: The Jimi Hendrix Collection</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/minneapolis" | relative_url }}">minneapolis</a> # 48</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>79</td>
      <td>
          <img src="https://i.discogs.com/VTpDher-1HnLncQ4DSVh15tCjN9T3YuuOCHQoqjXlMM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc2Njkw/MDctMTQ0NjM0MDQ3/My02MjMxLmpwZWc.jpeg" alt="Cover for Rewind" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-11-02</td>
      <td>Michael Fix</td>
      <td>Rewind</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/karlsruhe" | relative_url }}">karlsruhe</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>22</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/0fe737551176477696312c4331c19251.png" alt="Cover for I stedet for en tatovering" style="max-width:120px; height:auto;" />
      </td>
      <td>2008</td>
      <td>Rasmus Nøhr</td>
      <td>I stedet for en tatovering</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/male-singer-songwriter" | relative_url }}">male singer songwriter</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009-06-09</td>
      <td>Gerry Joe Weise</td>
      <td>Blues Down Under</td>
      <td>
        <ul>
    ...
    <tr>
      <td>83</td>
      <td>
          <img src="https://i.discogs.com/EGFfJXVZPep7qnmged_oX39YZR_yV_GkgwE_Pnx-uYk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMwMTE5/OTI0LTE3MTA2NDM0/MjktNTYzOS5qcGVn.jpeg" alt="Cover for Whatever Happens (From upcoming new album)" style="max-width:120px; height:auto;" />
      </td>
      <td>2010</td>
      <td>Robert Lopata</td>
      <td>Whatever Happens (From upcoming new album)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
    ...
    <tr>
      ...
      <td>2010-09-17</td>
      <td>Santana</td>
      <td>Guitar Heaven: The Greatest Guitar Classics Of All Time</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
        </ul>
    ...
    <tr>
      <td>42</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/46c95ab22fc24449b8b181dfee454c9c.png" alt="Cover for Vintage Vinos" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-11-02</td>
    ...
    <tr>
      <td>19</td>
      <td>
          <img src="https://i.discogs.com/L91kNE_HizbmYyvhlaJyfSXozVhfJJRiPYJiNqHer5I/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI5NTM5/NzQtMTQzMDg3NjUy/Ni0xNDQyLmpwZWc.jpeg" alt="Cover for As Falls Wichitam, So Falls Wichita Falls" style="max-width:120px; height:auto;" />
      </td>
      <td>2011</td>
      <td>Pat Metheny</td>
      <td>As Falls Wichitam, So Falls Wichita Falls</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Koichi Hayakawa (2008 Remastered Edition)</td>
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>81</td>
      <td>
          <img src="https://i.discogs.com/JD6YSz-rbnpFJK8go08E-FCwxTSPgKvMB6ZX2ieZfdE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyNzA2/NTQ5LTE2NDg3MDk5/MDYtMjc3MC5qcGVn.jpeg" alt="Cover for Of Love &amp; Rain" style="max-width:120px; height:auto;" />
      </td>
      <td>2014</td>
      <td>Maris</td>
      <td>Of Love &amp; Rain</td>
    ...
    <tr>
      <td>27</td>
      <td>
          <img src="https://i.discogs.com/_xUgjGe0qU1eOKis6ntid0XgtMV4gs92VVFyKR4qXaY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExNDY3/ODM4LTE1MTY4NTQ3/NzAtNDIxNC5wbmc.jpeg" alt="Cover for low standards" style="max-width:120px; height:auto;" />
      </td>
      <td>2015</td>
      <td>I Am Strikes</td>
      <td>low standards</td>
    ...
    <tr>
      <td>18</td>
      <td>
          <img src="https://i.discogs.com/L91kNE_HizbmYyvhlaJyfSXozVhfJJRiPYJiNqHer5I/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI5NTM5/NzQtMTQzMDg3NjUy/Ni0xNDQyLmpwZWc.jpeg" alt="Cover for As Falls Wichita, So Falls Wichita Falls" style="max-width:120px; height:auto;" />
      </td>
      <td>2016</td>
      <td>Pat Metheny</td>
      <td>As Falls Wichita, So Falls Wichita Falls</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>Brian May</td>
      <td>Star Fleet Sessions (Deluxe)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Sweet and Lowdown Traditionals</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a></li>
            <li style="font-size: calc(1rem * 95.74468085106383 / 100)"> <a href="{{ "/tags/traditional" | relative_url }}">traditional</a></li>
            <li style="font-size: calc(1rem * 93.61702127659575 / 100)"> <a href="{{ "/tags/blues" | relative_url }}">blues</a></li>
            <li style="font-size: calc(1rem * 89.36170212765957 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 71.27659574468085 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 69.14893617021278 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>35</td>
      <td>
          <img src="https://i.discogs.com/lRkhzrjKUnRfAEpRNgI9eEuPg0JTgy_4rfdtrszWx5M/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyNDc1/NzczLTE1MzYwMzA0/MTItOTU2Ni5qcGVn.jpeg" alt="Cover for Family Business" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-08-03</td>
      <td>Dan Acosta</td>
    ...
    <tr>
      ...
      <td></td>
      <td>ZAILM Atoyanh</td>
      <td>Bifer Soli Veritas</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/fusion" | relative_url }}">fusion</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/norway" | relative_url }}">norway</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td></td>
      <td>The Removers</td>
      <td>Line Up In Another Space</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/norway" | relative_url }}">norway</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/norwegian" | relative_url }}">norwegian</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Hengky Supit</td>
      <td>Bila Engkau Ijinkan (Old Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/fusion" | relative_url }}">fusion</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/improvisation" | relative_url }}">improvisation</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Tony McManus And Alain Genty</td>
      <td>Singing Sands</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-guitar" | relative_url }}">acoustic guitar</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/norway" | relative_url }}">norway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/norwegian" | relative_url }}">norwegian</a></li>
            <li style="font-size: calc(1rem * 75.9493670886076 / 100)"> <a href="{{ "/tags/chillout" | relative_url }}">chillout</a></li>
            <li style="font-size: calc(1rem * 75.9493670886076 / 100)"> <a href="{{ "/tags/guitarist" | relative_url }}">guitarist</a></li>
            <li style="font-size: calc(1rem * 75.9493670886076 / 100)"> <a href="{{ "/tags/nu-jazz" | relative_url }}">nu jazz</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/fusion" | relative_url }}">fusion</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/soundtrack" | relative_url }}">soundtrack</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/norway" | relative_url }}">norway</a></li>
        </ul>
      </td>
      <td>
        <ul>
