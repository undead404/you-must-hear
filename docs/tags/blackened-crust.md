...
Last updated: <time datetime="2025-12-06T11:48:53.238Z">Sat Dec 06 2025 13:48:53 GMT+0200 (Eastern European Standard Time)</time>

### Description

Blackened crust fuses the raw, anarchic intensity of crust punk with black metal&#39;s atmospheric darkness and tremolo-picked guitar work. This hybrid sound emerged from underground DIY scenes where extreme metal and punk ethics intersected, creating bleak, aggressive music with environmental or anti-authoritarian themes. The result is a caustic blend of d-beat rhythms, blast beats, and tortured vocals shrouded in distortion.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Summon The Crows</td>
      <td>Scavengers Feast</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blackened-crust" | relative_url }}">blackened crust</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/crust" | relative_url }}">crust</a></li>
    ...
    <tr>
      ...
      <td>2010-10</td>
      <td>Endless Disease</td>
      <td>The End Of All Life</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blackened-crust" | relative_url }}">blackened crust</a></li>
    ...
    <tr>
      ...
      <td>2011-06</td>
      <td>Young and in the Way</td>
      <td>Torch Runner &#x2F; Young and in the Way Split 7&quot;</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blackened-crust" | relative_url }}">blackened crust</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/blackened-death-metal" | relative_url }}">blackened death metal</a></li>
    ...
    <tr>
      ...
      <td>2020-12-11</td>
      <td>Dispyt</td>
      <td>Under Tiden Jag Sålde Min Själ Till Satan</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blackened-crust" | relative_url }}">blackened crust</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Hopelorn</td>
      <td>Golden Fields, Black Wings</td>
      <td>
        <ul>
        </ul>
      </td>
