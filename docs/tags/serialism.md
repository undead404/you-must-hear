...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1951</td>
      <td>Anton Webern</td>
      <td>Chamber Music for Strings [Schoenberg Quartet]</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1957-10</td>
      <td>Karlheinz Stockhausen</td>
      <td>Freude (2. Stunde Aus Klang) For 2 Harps</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1959</td>
      <td>Mary Thomas</td>
      <td>Schoenberg: Pierrot Lunaire &#x2F; Serenade</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1967</td>
      <td>Alban Berg</td>
      <td>Webern conducts Berg: Violin Concerto</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>PENDERECKI: St. Luke Passion</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1972</td>
      <td>Karlheinz Stockhausen</td>
      <td>Donnerstard Aus Licht Cd 3</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>Karlheinz Stockhausen</td>
      <td>4 Helicopters &amp; String Quartet</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
    ...
    <tr>
      ...
      <td>1974</td>
      <td>Pierre Boulez</td>
      <td>Dialogue de l&#39;ombre double</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Lasalle Quartett</td>
      <td>Neue Wiener Schule: Die Streichquartette</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1983</td>
      <td>Karlheinz Stockhausen</td>
      <td>Donnerstag Aus Licht Cd 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
    ...
    <tr>
      ...
      <td>1985</td>
      <td>Roland Pontinen</td>
      <td>SCHOENBERG &#x2F; BERG: Piano Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>1989</td>
      <td>The California Ear Unit</td>
      <td>for Philip Guston</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/minimalism" | relative_url }}">minimalism</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Schonberg : Verklärte Nacht, 5 Orchestral Pieces &amp; Piano Works</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Karlheinz Stockhausen</td>
      <td>DONNERSTAG aus LICHT CD 3</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Schoenberg: Suite, Op.29; Wind Quintet, Op.26</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>The Lark Quartet</td>
      <td>Schoenberg &amp; Zemlinsky String Quartets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/string-quartet" | relative_url }}">string quartet</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/conductor" | relative_url }}">conductor</a> # 84</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Anton Webern: Complete Works: Op. 1 - Op. 31</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Various Artists</td>
      <td>20th Century Classics: Arnold Schoenberg</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Steffen Schleiermacher</td>
      <td>Piano Music of the Darmstadt School, Vol. 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Karlheinz Stockhausen</td>
      <td>CE: #1; Chöre Für Doris-Drei Lieder-Sonatine-Kreuzspiel</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Spooky Actions</td>
      <td>Spooky Actions, Music of Anton Webern</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>ZEMLINSKY : Symphony in B flat major</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Sir Simon Rattle</td>
      <td>Simon Rattle Edition: The Second Viennese School</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/conductor" | relative_url }}">conductor</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Pierre Boulez</td>
      <td>Pierre Boulez: Oeuvres complètes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-12-01</td>
      <td>Various Artists</td>
      <td>SCHOENBERG: Verklarte Nacht &#x2F; WEBERN: Selected Piano and Chamber Works</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Emanuele Arciuli</td>
      <td>Alban Berg - Anton Webern : Complete Piano Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Bruno Heinen Sextet</td>
      <td>Karlheinz Stockhausen Tierkreis</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2013</td>
      <td>Michele Marelli</td>
      <td>Karlheinz Stockhausen: Harlekin</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>LaSalle Quartet</td>
      <td>Neue Wiener Schule: Streichquartette</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2016</td>
      <td>Karlheinz Stockhausen</td>
      <td>Donnerstad Aus Licht Cd 4</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
    ...
    <tr>
      ...
      <td>Sciarrino: Complete Works for Violin &amp; Viola</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2018</td>
      <td>Daniel Barenboim</td>
      <td>Schönberg: Verklärte Nacht, Pelleas Und Melisande etc</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2021</td>
      <td>Anton Webern</td>
      <td>Webern: Symphony - Six Pieces for Large Orchestra</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/serialism" | relative_url }}">serialism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2021-09</td>
      <td>Garry Schyman</td>
      <td>Metamorphosis (Original Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>A Stochastic Portrait, part 2: Chamber Works</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/string-quartet" | relative_url }}">string quartet</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Royal Concertgebouw Orchestra, Anat Efraty, Daniele Gatti</td>
      <td>Berg: Drei Orchesterstücke - Symphonische Stücke aus der Oper: &quot;Lulu&quot;</td>
      <td>
        <ul>
        </ul>
      </td>
