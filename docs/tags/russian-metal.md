...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Agonia</td>
      <td>В предсмертном закате (Demo)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/shred" | relative_url }}">shred</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/russian-alternative" | relative_url }}">russian alternative</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Through the Eyes of a Mad</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2013-09-01</td>
      <td>Opera Fantasia</td>
      <td>Начало истории</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/russian-metal" | relative_url }}">russian metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/symphonic-power-metal" | relative_url }}">symphonic power metal</a></li>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Holy Dragons</td>
      <td>Dragon&#39;s Ballads&#x2F;Rock Ballads (1999)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hard-rock" | relative_url }}">hard rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
    ...
    <tr>
      ...
      <td>2014-04-05</td>
      <td>Ephemeral Ocean</td>
      <td>Honour in the Mask</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doom-metal" | relative_url }}">doom metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/melodic-death-metal" | relative_url }}">melodic death metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-rock" | relative_url }}">dark rock</a> # 96</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2019-09-20</td>
      <td>Holy Dragons</td>
      <td>House of the Winds (Eng, 1999)</td>
      <td>
        <ul>
        </ul>
      </td>
