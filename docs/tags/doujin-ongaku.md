...
Doujin ongaku refers to independent, self-published music originating from Japan&#39;s vibrant fan culture, often created by amateur or semi-professional artists outside the mainstream music industry. The sound spans diverse genres from intense rock and metal arrangements to electronic and experimental works, frequently drawing inspiration from video games, anime, and other pop culture sources. This music thrives in Japan&#39;s convention circuit and online communities, representing a grassroots creative movement where artistic freedom takes precedence over commercial considerations.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2009-10-11</td>
      <td>Unknown Dimension</td>
      <td>紅魔館にピアノなんかあったっけ？</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin" | relative_url }}">doujin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin-ongaku" | relative_url }}">doujin ongaku</a></li>
    ...
    <tr>
      ...
      <td>惨劇の血に赫く染まった愛と絶望の黒い死とが紡ぐ最期の物語</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin" | relative_url }}">doujin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin-ongaku" | relative_url }}">doujin ongaku</a></li>
    ...
    <tr>
      ...
      <td>2013-08-12</td>
      <td>DiGiTAL WiNG</td>
      <td>RAVER&#39;S NEST 1 TOHO RAVE PARTY</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dance" | relative_url }}">dance</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin-ongaku" | relative_url }}">doujin ongaku</a></li>
    ...
    <tr>
      ...
      <td>2013-12-30</td>
      <td>DiGiTAL WiNG</td>
      <td>RAVER&#39;S NEST 2 TOHO RAVE PARTY</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dance" | relative_url }}">dance</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin" | relative_url }}">doujin</a></li>
    ...
    <tr>
      ...
      <td>2015-02-18</td>
      <td>logical emotion</td>
      <td>Touhou Project pops arranged instruments 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin-ongaku" | relative_url }}">doujin ongaku</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
    ...
    <tr>
      ...
      <td>2015-12-30</td>
      <td>DiGiTAL WiNG</td>
      <td>RAVER&#39;S NEST 3 TOHO RAVE PARTY</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dance" | relative_url }}">dance</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin" | relative_url }}">doujin</a></li>
    ...
    <tr>
      ...
      <td>&quot;Activity&quot; Case:05 -Forgotten Paradise-</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doujin-ongaku" | relative_url }}">doujin ongaku</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2023-12-30</td>
      <td>magic red kids</td>
      <td>the cherry blossom tree</td>
      <td>
        <ul>
