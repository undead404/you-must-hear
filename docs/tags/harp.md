...
Last updated: <time datetime="2025-11-14T01:33:06.512Z">Fri Nov 14 2025 03:33:06 GMT+0200 (Eastern European Standard Time)</time>

### Description

The harp tag encompasses music prominently featuring the harp&#39;s distinctive plucked or strummed strings, producing ethereal, cascading tones that evoke elegance and tranquility. This sound spans classical compositions, Celtic folk traditions, contemporary art pop, and ambient new age music. The instrument&#39;s angelic quality lends itself to both intimate solo performances and lush orchestral arrangements.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1971</td>
      <td>Alan Stivell</td>
      <td>Renaissance Of The Celtic Harp</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1971</td>
      <td>Alan Stivell</td>
      <td>Renaissance de la harpe celtique</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Celtic Harp Airs And Dance Tunes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>1983</td>
      <td>Patrick Ball</td>
      <td>Celtic Harp 1: Music of Turlough O&#39;Carolan</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Midnight Clear Featuring Carly SImon</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Lori Pappajohn</td>
      <td>Celtic Harp Of Dreams</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
    ...
    <tr>
      <td>30</td>
      <td>
          <img src="https://i.discogs.com/xSbJ1yHpBISfCFEPLGcDEFd_KuUV81Bq6IcvOKGtXzs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MTcy/NDAtMTIxNzkzMTk1/OC5qcGVn.jpeg" alt="Cover for Music For Harp, Flute And Cello" style="max-width:120px; height:auto;" />
      </td>
      <td>1994</td>
      <td>Angels Of Venice</td>
      <td>Music For Harp, Flute And Cello</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Patrick Ball</td>
      <td>O&#39;Carolan&#39;s Dream: Celtic Harp Vol. 4</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
    ...
    <tr>
      <td>50</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/1ae08a8705ea519ea9d6aa8e9692a2f6.png" alt="Cover for The Celtic Harp Collection" style="max-width:120px; height:auto;" />
      </td>
      <td>1998</td>
      <td>Claire Hamilton</td>
      <td>The Celtic Harp Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/new-age" | relative_url }}">new age</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Total Overdrive</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 85.48387096774194 / 100)"> <a href="{{ "/tags/blues" | relative_url }}">blues</a></li>
            <li style="font-size: calc(1rem * 85.48387096774194 / 100)"> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a></li>
            <li style="font-size: calc(1rem * 85.48387096774194 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 85.48387096774194 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2005-02-22</td>
      <td>JS (Joerg Sommermeyer)</td>
      <td>Nel Cuore Romanzo Rock</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/jazz-rock" | relative_url }}">jazz rock</a></li>
            ...
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Sarah Marie Mullen</td>
      <td>The Wild Woods</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Rachel Hair</td>
      <td>Hubcaps and Potholes - Scottish, Irish and Original Harp Muisc</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2007-04</td>
      <td>Joanna Newsom</td>
      <td>Joanna Newsom &amp; the Ys Street Band E.P,</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Woodland</td>
      <td>Seasons in Elfland: Shadows</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/jazz-rock" | relative_url }}">jazz rock</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/soft-rock" | relative_url }}">soft rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Passaggio - Einaudi by Lavinia</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
    ...
    <tr>
      ...
      <td>2019</td>
      <td>Nadia Birkenstock</td>
      <td>Whispering Woods (Celtic Harp Solos)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic-folk" | relative_url }}">celtic folk</a></li>
    ...
    <tr>
      ...
      <td>DUSSEK &#x2F; WAGENSEIL &#x2F; KRUMPHOLTZ: Harp Concertos</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
    ...
    <tr>
      ...
      <td>2021-09-14</td>
      <td>Aryeh Frankfurter</td>
      <td>Celtic Harp&#x2F;O&#39;Carolan&#39;s Dream&#x2F;The Music of O&#39;Carolan</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harp" | relative_url }}">harp</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/strings" | relative_url }}">strings</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Jennifer Pratt-Walter</td>
      <td>Ancient Realms: Solo Celtic Harp</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Lori Pappajohn, Jill Whitman &amp; Ensemble</td>
      <td>Harp Dance</td>
      <td>
        <ul>
        </ul>
