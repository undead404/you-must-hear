...
Turkish rock blends Western rock instrumentation with distinctively Turkish melodies, minor scales, and emotional vocal delivery. Emerging in the 1960s and flourishing since the 1990s, it addresses themes of love, social issues, and personal struggle while maintaining Turkish linguistic and cultural identity. The genre ranges from alternative and grunge-influenced sounds to more pop-oriented rock, unified by its raw, passionate expression.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>Cem Karaca</td>
      <td>NERDE KALMIŞTIK</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a></li>
            <li style="font-size: calc(1rem * 91.11111111111111 / 100)"> <a href="{{ "/tags/turkish-rock" | relative_url }}">turkish rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Isigin Yansimasi</td>
      <td>Birdenbire</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/turkish-rock" | relative_url }}">turkish rock</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Barış Manço</td>
      <td>Estağfurullah...Ne Haddimize...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/turkish-rock" | relative_url }}">turkish rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2004-07-22</td>
      <td>Teoman</td>
      <td>Tuborg Pilsener Alive Teoman</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/turkish-rock" | relative_url }}">turkish rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>110</td>
      <td>Atomlarin Harika Dunyasi</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/turkish-rock" | relative_url }}">turkish rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 93</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2007-09-06</td>
      <td>Şebnem Ferah</td>
      <td>10 Mart 2007 İstanbul Konseri</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/turkish-rock" | relative_url }}">turkish rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2011</td>
      <td>Murat Yılmazyıldırım</td>
      <td>İksir İçtim Değiştim</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
