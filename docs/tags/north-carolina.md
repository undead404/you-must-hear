...
North Carolina&#39;s music scene reflects the state&#39;s geographic and cultural diversity, blending Appalachian folk traditions with punk, indie rock, and experimental sounds. The tag encompasses everything from mountain string bands to college town noise rock, unified by a DIY ethos and regional independence. This eclectic mix captures both rural storytelling traditions and urban creative communities across the Piedmont and coastal plains.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ccm" | relative_url }}">ccm</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-christian" | relative_url }}">contemporary christian</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/crossover-thrash" | relative_url }}">crossover thrash</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fiddle" | relative_url }}">fiddle</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>40</td>
      <td>
          <img src="https://i.discogs.com/E8DsY8NPrRFBM4uu39uFZ3SJ8X7Gq9C-FG4OGCMWsTo/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTcwNTc2/MS0xMTQ5OTcwNDk5/LmpwZWc.jpeg" alt="Cover for Snuggle Buddy" style="max-width:120px; height:auto;" />
      </td>
      <td>1995</td>
      <td>Pinko</td>
      <td>Snuggle Buddy</td>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>The Red Clay Ramblers</td>
      <td>The Red Clay Ramblers LIVE</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bluegrass" | relative_url }}">bluegrass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/fiddle" | relative_url }}">fiddle</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fiddle" | relative_url }}">fiddle</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2001</td>
      <td>Mr. Rozzi</td>
      <td>Mr. Rozzi Live at the dotmatrix project</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001-05-11</td>
      <td>The Dead Body Men</td>
      <td>The Art of Resistance</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>jimmy and the teasers</td>
      <td>Jimmy and the Teasers LIVE PIE</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/garage" | relative_url }}">garage</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/garage-rock" | relative_url }}">garage rock</a></li>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Véronique Diabolique</td>
      <td>Carte Postale EP</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>I&#39;m Sorry, What Was That? (Live In the Living Room)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2005-01-03</td>
      <td>Bascom Lamar Lunsford</td>
      <td>Ballads, Banjo Tunes, and Sacred Songs of Western North Carolina</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/avanthop" | relative_url }}">avanthop</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2008-09-16</td>
      <td>The Physics of Meaning</td>
      <td>Snake Charmer and Destiny at the Stroke of Midnight</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/avanthop" | relative_url }}">avanthop</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fiddle" | relative_url }}">fiddle</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2009-02-19</td>
      <td>Ryan Cox</td>
      <td>more fun than a cardboard box EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
    ...
    <tr>
      ...
      <td>2009-03-17</td>
      <td>Tomas Phillips, Chantale Laplante</td>
      <td>Chair Bell Floor</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/avanthop" | relative_url }}">avanthop</a> # 63</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>39</td>
      <td>
          <img src="https://i.discogs.com/UCiN-JRuP0WDEbWXchOqp3gQPyFFTIJbSyUDd0Tph44/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM2NzUy/NzUtMTMzOTg4Nzg4/My0yNzkwLmpwZWc.jpeg" alt="Cover for Escher EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-07-25</td>
      <td>Escher</td>
      <td>Escher EP</td>
    ...
    <tr>
      <td>38</td>
      <td>
          <img src="https://i.discogs.com/IykHyaX4RryzUXzl8M6j6sHxZd9BkoCfdxyxxXajeVk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQwNjA3/NzgtMTM1MzkyNjUw/Ny0xMzE0LmpwZWc.jpeg" alt="Cover for Music In General" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-11-14</td>
      <td>FS</td>
      <td>Music In General</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
    ...
    <tr>
      ...
      <td>2014-12-13</td>
      <td>ShamGrammar</td>
      <td>Progress In Works (produced by LoFi) [2006]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
        </ul>
    ...
    <tr>
      <td>89</td>
      <td>
          <img src="https://i.discogs.com/8iwLQDMvO_yVO7HGV7AvOTlQTfTE2POpPVsd80mj5Zw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTkwMzQy/OTEtMTQ3MzYyNTcx/OS00NTY1LmpwZWc.jpeg" alt="Cover for Autumn" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-09-02</td>
    ...
    <tr>
      ...
      <td>2016-10-12</td>
      <td>Rhett And Link</td>
      <td>Buddy System (Music from Season 1)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ghettotech" | relative_url }}">ghettotech</a> # 40</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2018</td>
      <td>Carolina Road</td>
      <td>Feels Like Heaven - Single</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/country" | relative_url }}">country</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a></li>
    ...
    <tr>
      <td>90</td>
      <td>
          <img src="https://i.discogs.com/jdjXjGfik4whsuUF2_TfEaFqPRdHkPkCuWENd4PKSiI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyNDg4/MDE5LTE1MzYyNjc4/MDYtMzE1OC5qcGVn.jpeg" alt="Cover for Easy Weapons" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-08-30</td>
      <td>Public Acid</td>
      <td>Easy Weapons</td>
