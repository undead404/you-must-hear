...
Italian folk music is a diverse collection of musical styles that have evolved across the Italian peninsula, reflecting Italy’s geographic position and its many separate cultures. The music embodies the spirit and history of its people, from the vibrant tarantella dances of Southern Italy to the soothing melodies of Northern lullabies. It presents a mix of influences, including Celtic and Slavic in the North, Greek, Arabic, and African in the South, and a combination of these elements in Central Italy.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1972</td>
      <td>Giorgio Gaber</td>
      <td>Dialogo tra un impegnato e un non so</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>1974</td>
      <td>Nuova Compagnia Di Canto Popolare</td>
      <td>Li sarracini adorano lu sole</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>I treni per Reggio Calabria</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Canzoniere delle Lame</td>
      <td>Scarpe nuove eppur bisogna andare</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>La Ciapa Rusa</td>
      <td>Ten da chent l&#39;archët che la sunada l&#39;e longa</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>1984</td>
      <td>Giovanna Marini</td>
      <td>Cantata per Pier Paolo Pasolini</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cantautori" | relative_url }}">cantautori</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1998-11-26</td>
      <td>Modena City Ramblers</td>
      <td>Raccolti: live acustico al Sisten Irish Pub</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>Le più belle canzoni di Pierangelo Bertoli</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Tenore Antonia Mesina Orgosolo</td>
      <td>Sos mazores</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethnic" | relative_url }}">ethnic</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Gruppo Folk Italiano - Coro A. Toscanini di Torino</td>
      <td>O BELLA CIAO, Canti Partigiani</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2004-01</td>
      <td>Modena City Ramblers</td>
      <td>IViva La Vida, Muera La Muerte!</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>L&#39;Arpeggiata</td>
      <td>La Tarantella: Antidotum Tarantulae</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-08-19</td>
      <td>Le Mondine</td>
      <td>La Marianna la va in campagna</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Khaossia</td>
      <td>La notte della Taranta 2005 Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethno" | relative_url }}">ethno</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
    ...
    <tr>
      ...
      <td>2012-03-19</td>
      <td>Tenores di Bitti</td>
      <td>Intonos (Four-part Vocal Plyphonies from Central Sardinia)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethnic" | relative_url }}">ethnic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
    ...
    <tr>
      ...
      <td>2012-10-23</td>
      <td>Canzoniere Grecanico Salentino</td>
      <td>Pizzica indiavolata</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rumba" | relative_url }}">rumba</a> # 51</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Tarantelas Festa Italiana</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>2019</td>
      <td>Giovanna Marini</td>
      <td>Cantata del secolo breve</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>Mara la Fatia - Storie di pizziche tarante e tarantelle</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Riccardo Tesi</td>
      <td>Sopra i tetti di Firenze</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/italian-folk" | relative_url }}">italian folk</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Martano</td>
      <td>Italian Treasury: Puglia - The Salento</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethno" | relative_url }}">ethno</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>I girasoli</td>
      <td>Il vero folklore italiano, Volume 9: L&#39;uva fogarina</td>
      <td>
        <ul>
        </ul>
      </td>
