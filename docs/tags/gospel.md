...
Last updated: <time datetime="2025-11-10T06:04:07.157Z">Mon Nov 10 2025 08:04:07 GMT+0200 (Eastern European Standard Time)</time>

### Description

Gospel music is a genre of Christian music that originated in African American churches in the United States in the early 20th century. It typically features strong vocals, often with a call-and-response structure, and is characterized by its use of religious themes and lyrics. Gospel music can be traced back to African American spirituals and hymns, and has since evolved to include various sub-genres such as traditional gospel, contemporary gospel, and gospel blues. The genre has had a significant influence on other musical styles, particularly soul and R&amp;B.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/pop-rock" | relative_url }}">pop rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/christian-rock" | relative_url }}">christian rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>Lungfish</td>
      <td>Talking Songs for Walking</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
        </ul>
    ...
    <tr>
      <td>5</td>
      <td>
          <img src="https://i.discogs.com/j505_bvmECZD3U0h7gUDCooSN5Yx-E8MiMFWuw63yOY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTk4NDM3/MTMtMTQ4NzI0Mjc2/NC0zNjgyLmpwZWc.jpeg" alt="Cover for James Morrison: Gospel Collection Volume One" style="max-width:120px; height:auto;" />
      </td>
      <td>1996</td>
      <td>James Morrison</td>
      <td>James Morrison: Gospel Collection Volume One</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
    ...
    <tr>
      ...
      <td>Wait for Me: The Best From Rebecca St. James</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004-09-21</td>
      <td>Ben Harper And The Blind Boys Of Alabama</td>
      <td>There Will Be A Light</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Sam Cooke</td>
      <td>The 2 Sides Of Sam Cooke</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gospel" | relative_url }}">gospel</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/soul" | relative_url }}">soul</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-christian" | relative_url }}">contemporary christian</a> # 67</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-christian" | relative_url }}">contemporary christian</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/blues" | relative_url }}">blues</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/worship" | relative_url }}">worship</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>54</td>
      <td>
          <img src="https://i.discogs.com/V1abIXjkVIXPUtAK6KRNfcDDwl6MCXWeB8_B9Ta2APs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTcwNjcx/ODItMTQzMjkzNTY3/MC0yNjA1LmpwZWc.jpeg" alt="Cover for Algiers" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-06-02</td>
      <td>Algiers</td>
      <td>Algiers</td>
