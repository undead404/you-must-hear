...
Sludgecore fuses the crushing slowness of sludge metal with hardcore punk&#39;s aggressive intensity, creating an abrasive sound marked by downtuned guitars, guttural vocals, and oppressive atmosphere. The style emerged from Southern US underground scenes, channeling bleakness and nihilism through punishing riffs and feedback-drenched production. It emphasizes raw emotional catharsis over technical precision.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Burmese</td>
      <td>Monkeys Tear Man To Shreds, Man Never Forgives Ape, Man Destroys Environment</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2000-02-17</td>
      <td>Cattle Press</td>
      <td>Hordes to Abolish the Divine</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Gospel Of The Future</td>
      <td>Forever dead EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-05-10</td>
      <td>Eyehategod</td>
      <td>Preaching the End-Time Message</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Eyehategod</td>
      <td>Dopesick [Remastered 2006]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Four Days To Burn</td>
      <td>SOUTHERN CORRUPTION</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Bone Dance</td>
      <td>I Have Lived Like an Animal, but I Will Die Like an Angel</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2011-08-02</td>
      <td>Brainoil</td>
      <td>Death of This Dry Season</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/crust" | relative_url }}">crust</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
    ...
    <tr>
      ...
      <td>Scatter The Ashes (Special Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
    ...
    <tr>
      ...
      <td>2012-12-20</td>
      <td>Skull Incision</td>
      <td>The Truth Tastes So Foul, Most Spit It Back Up</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2016-02-25</td>
      <td>Love Sex Machine</td>
      <td>FUCKING SNAKES</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomcore" | relative_url }}">doomcore</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
