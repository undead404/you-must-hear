...
Swing music is a style of jazz that became popular in the 1930s and 1940s. It is characterized by a strong rhythm section, usually consisting of piano, drums, and double bass, and a horn section that plays melody and harmony. Swing music is known for its energetic and danceable rhythms, and often features improvisation and solos from the musicians. Famous swing musicians include Benny Goodman, Duke Ellington, Count Basie, and Glenn Miller. The swing era had a significant impact on American popular music and culture, and its legacy can still be heard in modern jazz and other genres.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Yes I Can: Sammy Davis Jr. . .</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1961-01-03</td>
      <td>Frank Sinatra</td>
      <td>Sinatra&#39;s Swingin&#39; Session!!! and More</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
    ...
    <tr>
      ...
      <td>1962</td>
      <td>Frank Sinatra</td>
      <td>Sinatra Sings Great Songs From Great Britain</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1981</td>
      <td>Frank Sinatra &amp; Count Basie</td>
      <td>An Historic Musical First</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1986-10-09</td>
      <td>Bobby Darin</td>
      <td>The Ultimate Bobby Darin</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
    ...
    <tr>
      ...
      <td>When Harry Met Sally... Music From The Motion Picture</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
    ...
    <tr>
      ...
      <td>1994-06-21</td>
      <td>Fred Astaire</td>
      <td>Steppin&#39; Out: Astaire Sings</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>The Andrews Sisters</td>
      <td>The Andrews Sisters Greatest Hits</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003-03-04</td>
      <td>Cab Calloway</td>
      <td>The Early Years 1930-1934</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Michael Bublé</td>
      <td>Crazy Love (Special Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-01-16</td>
      <td>Frank Sinatra</td>
      <td>Romance: Songs From The Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Bobby Darin</td>
      <td>Hello Dolly To Goodbye Charlie</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/big-band" | relative_url }}">big band</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>2011-11-15</td>
      <td>Frank Sinatra</td>
      <td>Sinatra: Best of the Best</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/swing" | relative_url }}">swing</a></li>
    ...
    <tr>
      ...
      <td>2014-04-19</td>
      <td>Lake Street Dive</td>
      <td>What I&#39;m Doing Here&#x2F;Wedding Band</td>
      <td>
        <ul>
