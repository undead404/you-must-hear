...
Percussion encompasses music where drums, shakers, bells, and other struck or shaken instruments take center stage, creating rhythmic foundations that span from primal tribal beats to electronic soundscapes. This tag crosses all cultural boundaries, appearing in Afro-Cuban jazz, experimental electronic music, theatrical performances, and pop productions where rhythm drives the emotional impact. The focus is on texture, groove, and the physical sensation of beat-driven sound rather than melody or harmony.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1979</td>
      <td>Cults Percussion Ensemble</td>
      <td>Cults Percussion Ensemble</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/percussion" | relative_url }}">percussion</a></li>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>The Beat</td>
      <td>La Fiesta Mondiale De Percussion</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>Test Dept.</td>
      <td>The Unacceptable Face Of Freedom</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mambo" | relative_url }}">mambo</a> # 52</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2000-03-07</td>
      <td>Evelyn Glennie</td>
      <td>Shadow Behind the Iron Sun</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/percussion" | relative_url }}">percussion</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/japanoise" | relative_url }}">japanoise</a> # 42</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mambo" | relative_url }}">mambo</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Ruben van Rompaey</td>
      <td>Eastern Expressions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ethnic" | relative_url }}">ethnic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/percussion" | relative_url }}">percussion</a></li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Blue Man Group</td>
      <td>How To Be A Megastar Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/percussion" | relative_url }}">percussion</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Ustad Zakir Hussain</td>
      <td>Essence Of Rhythm</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/india" | relative_url }}">india</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/percussion" | relative_url }}">percussion</a></li>
    ...
    <tr>
      ...
      <td>2010-07-09</td>
      <td>Ted Kirkpatrick</td>
      <td>IN THE SHADOW OF THE MASTERS</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2013-03-04</td>
      <td>Kodo</td>
      <td>Kodo Vs. Yosuke Yamashita In Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/percussion" | relative_url }}">percussion</a></li>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>Magnetic Ensemble</td>
      <td>Dancing Alone - EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/animals" | relative_url }}">animals</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2022-08-05</td>
      <td>Mickey Hart &amp; Zakir Hussain</td>
      <td>Global Drum Project</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/percussion" | relative_url }}">percussion</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2022-10-14</td>
      <td>Bugge Wesseltoft &amp; Henrik Schwarz</td>
      <td>Wesseltoft Schwarz Duo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
