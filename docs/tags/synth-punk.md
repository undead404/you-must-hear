...
Last updated: <time datetime="2025-11-11T04:57:26.830Z">Tue Nov 11 2025 06:57:26 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>46</td>
      <td>
          <img src="https://i.discogs.com/Cy0sgIOrVSVTNFaX-cxB_IAutcavzf3iL6NAdOnJ6jI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTgzMTE0/OS0xMTYzMjQ2Mjk4/LmpwZWc.jpeg" alt="Cover for No Tears" style="max-width:120px; height:auto;" />
      </td>
      <td>1978</td>
      <td>Tuxedomoon</td>
      <td>No Tears</td>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Kitchen &amp; The Plastic Spoons</td>
      <td>Happy Funeral &amp; Fantastic (7&#39;&#39;)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/synth-punk" | relative_url }}">synth punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1981</td>
      <td>Nervous Gender</td>
      <td>Music from Hell</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/synth-punk" | relative_url }}">synth punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ebm" | relative_url }}">ebm</a> # 57</li>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Soft Cell</td>
      <td>Mutant Moments EP (40th Anniversay Remastered Edition)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1999</td>
      <td>Suicide</td>
      <td>The Second Album + the First Rehearsal Tapes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/synth-punk" | relative_url }}">synth punk</a></li>
    ...
    <tr>
      <td>11</td>
      <td>
          <img src="https://i.discogs.com/rIZuEy0CvBuIhNmObwbkTscOmSyy7Cx6Mp0b_q1ulYw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQzMTg0/MTMtMTM2MTgwODky/MC01NjU2LmpwZWc.jpeg" alt="Cover for Volt" style="max-width:120px; height:auto;" />
      </td>
      <td>2003-01-01</td>
      <td>Volt</td>
      <td>Volt</td>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Selfish Cunt</td>
      <td>No Wicked Heart Shall Prosper</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noise" | relative_url }}">noise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-punk" | relative_url }}">post-punk</a></li>
    ...
    <tr>
      ...
      <td>2009-02-02</td>
      <td>James Ferraro</td>
      <td>KFC City 3099: Pt.1 Toxic Spill</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/montreal" | relative_url }}">montreal</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>2</td>
      <td>
          <img src="https://i.discogs.com/emWR51VwUsMpHt_JUaS8VBLbtsxas67oPdKj3avP0VA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQwMjIx/OTQtMTM1MjY0ODky/OS0zNzI3LmpwZWc.jpeg" alt="Cover for Perfection Condition" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-10-10</td>
      <td>Branes</td>
      <td>Perfection Condition</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/art-punk" | relative_url }}">art punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/minimal-synth" | relative_url }}">minimal synth</a></li>
    ...
    <tr>
      ...
      <td>2013-05-21</td>
      <td>Dirty Beaches</td>
      <td>Drifters &#x2F; Love is The Devil</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2020</td>
      <td>sistema de entretenimiento</td>
      <td>Sistema de entretenimiento</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/synth-punk" | relative_url }}">synth punk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/digital-hardcore" | relative_url }}">digital hardcore</a> # 40</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/no-wave" | relative_url }}">no wave</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/digital-hardcore" | relative_url }}">digital hardcore</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
