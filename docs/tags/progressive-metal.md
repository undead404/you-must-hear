...
Last updated: <time datetime="2025-11-19T02:22:53.090Z">Wed Nov 19 2025 04:22:53 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 97 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a> # 97</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5dd7887ca697e85bc060a200a1d47eeb.png" alt="Cover for Ghost Reveries" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-08-26</td>
      <td>Opeth</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/melodic-death-metal" | relative_url }}">melodic death metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/industrial-metal" | relative_url }}">industrial metal</a> # 58</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 57.99999999999999 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-death-metal" | relative_url }}">progressive death metal</a> # 73</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>2</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6c4586413476e432b3eba2e74fcc096a.png" alt="Cover for Still Life (Remastered)" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-03-31</td>
      <td>Opeth</td>
      <td>Still Life (Remastered)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-death-metal" | relative_url }}">progressive death metal</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-death-metal" | relative_url }}">progressive death metal</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
            <li style="font-size: calc(1rem * 52 / 100)"> <a href="{{ "/tags/metalcore" | relative_url }}">metalcore</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>10</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/53ffca09136edfd47b57eec919e45efd.png" alt="Cover for Cognitive" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-02-15</td>
      <td>Soen</td>
      <td>Cognitive</td>
    ...
    <tr>
      <td>88</td>
      <td>
          <img src="https://i.discogs.com/MjtOr9LjElt45mJumtEEKoltCNOU40tlVQ1RUJCnjfk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ1OTc1/MTgtMTQxMDMwMTkz/My02NDcxLmpwZWc.jpeg" alt="Cover for Altered State" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-05-24</td>
      <td>TesseracT</td>
      <td>Altered State</td>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://i.discogs.com/YzfkyXZZTSkFPmpTLxUySqjehRmvkBzym5dUZ5PMGhs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTg2MDA3/ODMtMTQ3NjU2MjY4/Ny01MTg3LmpwZWc.jpeg" alt="Cover for Periphery III: Select Difficulty" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-07-22</td>
      <td>Periphery</td>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/djent" | relative_url }}">djent</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/djent" | relative_url }}">djent</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/metalcore" | relative_url }}">metalcore</a> # 74</li>
        </ul>
      </td>
    </tr>
    <tr>
