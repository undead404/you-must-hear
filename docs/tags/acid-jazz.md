...
Last updated: <time datetime="2025-12-05T13:05:45.914Z">Fri Dec 05 2025 15:05:45 GMT+0200 (Eastern European Standard Time)</time>

### Description

Acid jazz is a music genre that combines elements of jazz, funk, soul, and disco, often with a focus on improvisation and groove-based rhythms. The term &quot;acid jazz&quot; was first coined in the 1980s by DJs and record producers in the UK who were playing jazz-funk music with a more electronic and dance-oriented approach. Acid jazz became popular in the UK in the 1990s and was associated with the &quot;rare groove&quot; scene, which involved the rediscovery of obscure funk and soul records from the 1970s. Acid jazz often features live instrumentation, including saxophone, trumpet, bass, and drums, as well as electronic instruments such as synthesizers and drum machines. The genre has been influential in the development of other genres, including trip-hop and nu jazz.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1992-06-05</td>
      <td>Galliano</td>
      <td>A Joyful Noise Unto The Creator</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Cyndi Lauper</td>
      <td>Twelve Deadly Cyns...And Then Some</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
    ...
    <tr>
      ...
      <td>One Colour Just Reflects Anoth</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/61751d67ab4d35751aa29f279021e0bc.png" alt="Cover for Music Is Rotted One Note" style="max-width:120px; height:auto;" />
      </td>
      <td>1998-10-12</td>
      <td>Squarepusher</td>
      <td>Music Is Rotted One Note</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dub" | relative_url }}">dub</a> # 40</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/nu-jazz" | relative_url }}">nu jazz</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>The Donca Matic Singalongs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
    ...
    <tr>
      ...
      <td>2003-03-31</td>
      <td>Xploding Plastix</td>
      <td>The Benevolent Volume Lurkings EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/city-pop" | relative_url }}">city pop</a> # 35</li>
    ...
    <tr>
      ...
      <td>2003-09-24</td>
      <td>Koop</td>
      <td>Waltz for Koop: Alternative Takes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/downtempo" | relative_url }}">downtempo</a></li>
    ...
    <tr>
      ...
      <td>Tales From Beyond The Groove</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/funk-rock" | relative_url }}">funk rock</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2006</td>
      <td>Jamiroquai</td>
      <td>High Times: Singles 1992-2006 (Remastered)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/city-pop" | relative_url }}">city pop</a> # 47</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/vocal-jazz" | relative_url }}">vocal jazz</a> # 52</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/nu-jazz" | relative_url }}">nu jazz</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/venezuela" | relative_url }}">venezuela</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2014-10-03</td>
      <td>Bonobo</td>
      <td>Solid Steel Presents: It Came from the Sea</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/downtempo" | relative_url }}">downtempo</a></li>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>St. Germain</td>
      <td>From Detroit to St. Germain</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/city-pop" | relative_url }}">city pop</a> # 48</li>
    ...
    <tr>
      ...
      <td></td>
      <td>アトラスサウンドチーム</td>
      <td>Catherine &amp; Catherine Full Body Soundtrack Set</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acid-jazz" | relative_url }}">acid jazz</a></li>
        </ul>
