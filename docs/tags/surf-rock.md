...
Last updated: <time datetime="2025-11-19T20:46:06.850Z">Wed Nov 19 2025 22:46:06 GMT+0200 (Eastern European Standard Time)</time>

### Description

Surf rock is a subgenre of rock music that originated in Southern California in the early 1960s. It is characterized by electric guitars played with a distinctive clean, reverb-drenched sound, often featuring rapid tremolo picking, and accompanied by simple, driving rhythms typically provided by drums and electric bass. The genre takes its name from its association with surf culture and the beach lifestyle, and many of its most popular songs feature themes related to surfing, hot rod cars, and teenage romance. Some of the most well-known surf rock artists include Dick Dale, The Beach Boys, The Ventures, and The Surfaris.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/oldies" | relative_url }}">oldies</a> # 74</li>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>Shadowy Men On A Shadowy Planet</td>
      <td>Savvy Show Stoppers</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/surf-rock" | relative_url }}">surf rock</a></li>
        </ul>
    ...
    <tr>
      <td>25</td>
      <td>
          <img src="https://i.discogs.com/UYml7cPdzsTIqdSFQB0lLOeYQeloMmZYWyoIYIaiuZA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ0MTYx/MTMtMTM2NDYwMDcy/Mi0zMjc3LmpwZWc.jpeg" alt="Cover for Shut Down Volume 2" style="max-width:120px; height:auto;" />
      </td>
      <td>1989-08-30</td>
      <td>The Beach Boys</td>
      <td>Shut Down Volume 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/surf-rock" | relative_url }}">surf rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-06-11</td>
      <td>The Beach Boys</td>
      <td>Surfin&#39; Safari (Remastered)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/surf-rock" | relative_url }}">surf rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2015-03-02</td>
      <td>SoKo</td>
      <td>My Dreams Dictate My Reality</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/new-wave" | relative_url }}">new wave</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-punk" | relative_url }}">post-punk</a></li>
    ...
    <tr>
      ...
      <td>2016-09-19</td>
      <td>Sunflowers</td>
      <td>The Intergalactic Guide To Find The Red Cowboy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/garage-rock" | relative_url }}">garage rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/surf-rock" | relative_url }}">surf rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/exotica" | relative_url }}">exotica</a> # 91</li>
        </ul>
      </td>
    </tr>
    <tr>
