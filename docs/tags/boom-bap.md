...
Last updated: <time datetime="2025-11-14T04:28:00.692Z">Fri Nov 14 2025 06:28:00 GMT+0200 (Eastern European Standard Time)</time>

### Description

Boom bap is a style of hip-hop music characterized by hard-hitting drums, often made from samples of old funk and soul records, and prominent use of the snare and kick drum. The style originated in the early 1990s on the East Coast of the United States and became associated with artists like Wu-Tang Clan, Nas, and Mobb Deep. Boom bap often features gritty, sample-based production, and lyrically tends to focus on the harsh realities of urban life. The term &quot;boom bap&quot; itself is onomatopoeic, referring to the characteristic sound of the drum hits in the style.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>64</td>
      <td>
          <img src="https://i.discogs.com/K1Rz7teDLQ-8OX3E4GoM2zvYLXUCRhVpBLa-inDl9ss/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTg5NzU5/MTYtMTY1MTExNTEz/MS05NzcxLmpwZWc.jpeg" alt="Cover for C.R.O - ROCK" style="max-width:120px; height:auto;" />
      </td>
      <td>1980</td>
      <td>C.R.O</td>
      <td>C.R.O - ROCK</td>
    ...
    <tr>
      <td>51</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/591cc721328741153a1f3178cb7b4b73.png" alt="Cover for Only Built 4 Cuban Linx..." style="max-width:120px; height:auto;" />
      </td>
      <td>1995-08-01</td>
      <td>Raekwon</td>
      <td>Only Built 4 Cuban Linx...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rap" | relative_url }}">rap</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turntablism" | relative_url }}">turntablism</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2002</td>
      <td>Eminem</td>
      <td>The Eminem Show (Expanded Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boom-bap" | relative_url }}">boom bap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rap" | relative_url }}">rap</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jazz-hop" | relative_url }}">jazz hop</a> # 39</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010-02-15</td>
      <td>Freeway &amp; Jake One</td>
      <td>The Stimulus Package</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boom-bap" | relative_url }}">boom bap</a></li>
        </ul>
    ...
    <tr>
      <td>87</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/912260be169114f7f8f1668285d0ef8a.png" alt="Cover for Czarface Meets Metal Face" style="max-width:120px; height:auto;" />
      </td>
      <td>2015</td>
      <td>Czarface</td>
      <td>Czarface Meets Metal Face</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boom-bap" | relative_url }}">boom bap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
    ...
    <tr>
      ...
      <td>2016</td>
      <td>Kaydy Cain</td>
      <td>El Swing de Siempre. Eterno Tumbao</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boom-bap" | relative_url }}">boom bap</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/colombia" | relative_url }}">colombia</a> # 64</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/colombia" | relative_url }}">colombia</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>17</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a3b50fe6117bde242d096ea7a881a843.png" alt="Cover for Lost Kingz" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-01-31</td>
      <td>Tha God Fahim</td>
      <td>Lost Kingz</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/venezuela" | relative_url }}">venezuela</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turntablism" | relative_url }}">turntablism</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://i.discogs.com/cpYQHt8yHUWk4DQgy0fOtZcKTSjx2hu50V9QLXSrqRM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzOTA2/MzI0LTE2Nzc5NTI0/NzMtNTg2MS5wbmc.jpeg" alt="Cover for Jack In The Box" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-07-15</td>
      <td>J-Hope</td>
    ...
    <tr>
      ...
      <td>2023-10-31</td>
      <td>Your Old Droog</td>
      <td>YOD Presents: The Shining</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boom-bap" | relative_url }}">boom bap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
