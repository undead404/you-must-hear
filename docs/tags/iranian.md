...
Music with roots in Iran&#39;s rich cultural heritage, blending traditional Persian instruments like the tar and santur with diverse contemporary styles. The tag encompasses everything from classical Persian music&#39;s intricate melodic modes to modern fusion incorporating rock, electronic, and experimental elements. It reflects both the deep artistic traditions of Iranian culture and the innovative work of diaspora artists adapting their heritage to new sonic landscapes.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/persian" | relative_url }}">persian</a> # 23</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/iran" | relative_url }}">iran</a> # 31</li>
    ...
    <tr>
      ...
      <td>2011-12-01</td>
      <td>Kiosk</td>
      <td>Natijeh e Mozakerat (Outcome of Negotiations)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues" | relative_url }}">blues</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/iranian" | relative_url }}">iranian</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/persian" | relative_url }}">persian</a> # 40</li>
    ...
    <tr>
      <td>69</td>
      <td>
          <img src="https://i.discogs.com/tkalHhiK_Waey0wvmVWKfcuK68YKGqWsFdrlGTIbWK8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTk0MzM1/NDUtMTQ4MDUwNTc4/MS01MDEzLmpwZWc.jpeg" alt="Cover for Madman of God" style="max-width:120px; height:auto;" />
      </td>
      <td>2014</td>
      <td>Sussan Deyhim</td>
      <td>Madman of God</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/iranian" | relative_url }}">iranian</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/persian" | relative_url }}">persian</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/iran" | relative_url }}">iran</a> # 43</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/persian" | relative_url }}">persian</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/persian" | relative_url }}">persian</a> # 60</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/persian" | relative_url }}">persian</a> # 85</li>
