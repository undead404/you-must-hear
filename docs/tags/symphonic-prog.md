...
Last updated: <time datetime="2025-12-06T02:25:45.896Z">Sat Dec 06 2025 04:25:45 GMT+0200 (Eastern European Standard Time)</time>

### Description

Symphonic prog blends progressive rock&#39;s complexity with orchestral grandeur, featuring lush keyboard textures, intricate compositions, and dramatic shifts in tempo and mood. Emerging in the 1970s, it emphasized artistic ambition and classical music influences while maintaining rock&#39;s energy. The sound is characterized by epic song structures, theatrical atmospheres, and a cinematic quality that transforms rock into something more elaborate and emotionally sweeping.
...
<table>
  ...
  <tbody>
    <tr>
      <td>79</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/76b3b3858b714321da4b31bd573eb2dc.png" alt="Cover for Act One" style="max-width:120px; height:auto;" />
      </td>
      <td>1970</td>
      <td>Beggars Opera</td>
      <td>Act One</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/british-rock" | relative_url }}">british rock</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/psychedelic-rock" | relative_url }}">psychedelic rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 42</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1972-11</td>
      <td>Premiata Forneria Marconi</td>
      <td>Per un Amico</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
    ...
    <tr>
      <td>37</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/981295205b764a60b502451d4d9a6767.png" alt="Cover for Inside" style="max-width:120px; height:auto;" />
      </td>
      <td>1973</td>
      <td>Eloy</td>
      <td>Inside</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/symphonic-prog" | relative_url }}">symphonic prog</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-folk" | relative_url }}">progressive folk</a> # 22</li>
            <li> <a href="{{ "/tags/contemporary-folk" | relative_url }}">contemporary folk</a> # 50</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-folk" | relative_url }}">progressive folk</a> # 15</li>
            <li> <a href="{{ "/tags/contemporary-folk" | relative_url }}">contemporary folk</a> # 42</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1975-08</td>
      <td>Renaissance</td>
      <td>Scheherazade and other stories</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
        </ul>
    ...
    <tr>
      <td>99</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/8f88210090c42d42b2cba093e4023e3b.png" alt="Cover for Zora" style="max-width:120px; height:auto;" />
      </td>
      <td>1977</td>
      <td>Antonius Rex</td>
      <td>Zora</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/psychedelic-rock" | relative_url }}">psychedelic rock</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/symphonic-prog" | relative_url }}">symphonic prog</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 61 / 100)"> <a href="{{ "/tags/art-rock" | relative_url }}">art rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 69</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1983</td>
      <td>The Alan Parsons Project</td>
      <td>The Very Best Of The Alan Parsons Project</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/symphonic-prog" | relative_url }}">symphonic prog</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>30</td>
      <td>
          <img src="https://i.discogs.com/m01TVonR4RnslWYyYxEYai_ssC0Ro_Aq4jSIEVgeyU8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ5NDQ3/NDAtMTM4MDE5MjU0/NC05MjE3LmpwZWc.jpeg" alt="Cover for Modrý Vrch" style="max-width:120px; height:auto;" />
      </td>
      <td>1987</td>
      <td>Dežo Ursiny</td>
      <td>Modrý Vrch</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/symphonic-prog" | relative_url }}">symphonic prog</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/art-rock" | relative_url }}">art rock</a></li>
            ...
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/krautrock" | relative_url }}">krautrock</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/psychedelic-rock" | relative_url }}">psychedelic rock</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/symphonic-prog" | relative_url }}">symphonic prog</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 97</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Manfred Mann&#39;s Earth Band</td>
      <td>Nightingales and Bombers</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/art-rock" | relative_url }}">art rock</a></li>
    ...
    <tr>
      ...
      <td>1999-11-02</td>
      <td>Genesis</td>
      <td>The Carpet Crawlers 1999</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/symphonic-prog" | relative_url }}">symphonic prog</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/neo-prog" | relative_url }}">neo-prog</a> # 39</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a25b3350ef214355ba9e8d70bcd797f6.png" alt="Cover for Aqualung 40th Anniversary" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Jethro Tull</td>
      <td>Aqualung 40th Anniversary</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classic-rock" | relative_url }}">classic rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>5</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/3d2f791f3fed46dc9491473dba3d9255.png" alt="Cover for Wind And Wuthering" style="max-width:120px; height:auto;" />
      </td>
      <td>2007</td>
      <td>Genesis</td>
      <td>Wind And Wuthering</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>2007-01-30</td>
      <td>Emerson, Lake &amp; Palmer</td>
      <td>The Essential Emerson, Lake &amp; Palmer</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 74</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>The Fading Ghosts of Twilight</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a> # 35</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2020</td>
      <td>Frutería Toñi</td>
      <td>El Porvenir Está en las Huevas</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/canterbury-scene" | relative_url }}">canterbury scene</a> # 29</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2023-06-23</td>
      <td>Eloy</td>
      <td>The Best Of Eloy, Vol. 1 - The Early Days 1972-1975</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>94</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/e03c52dff6bef2b5d34705b8560e670e.png" alt="Cover for Harbour Century" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-04-05</td>
      <td>Eunuchs</td>
