...
Romania has a rich and diverse musical heritage that draws from various cultural influences, including Byzantine, Ottoman, Hungarian, and Roma traditions. Some of the most popular forms of traditional Romanian music include doina (a slow, melancholic ballad), hora (a fast, upbeat dance), and colinda (a Christmas carol). The country is also known for its classical music, with renowned composers such as George Enescu and Dinu Lipatti. In addition, Romania has contributed to the world of pop music with famous artists such as Inna and Alexandra Stan.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1981</td>
      <td>George Enescu</td>
      <td>ENESCU: Piano Quintet &#x2F; Piano Quartet No. 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>1981</td>
      <td>George Enescu</td>
      <td>ENESCU: String Octet, Op. 7 &#x2F; Dixtuor for Winds, Op. 14</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1983</td>
      <td>George Enescu</td>
      <td>ENESCU: Suites Nos. 1 and 2 &#x2F; Concert Overture</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/romania" | relative_url }}">romania</a></li>
    ...
    <tr>
      ...
      <td>1994-07-18</td>
      <td>Zoltan And His Gypsy Ensemble</td>
      <td>Gypsy Music From Hungary And Romania</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/romania" | relative_url }}">romania</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Horaţiu Rădulescu</td>
      <td>Intimate Rituals</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Strung Out String Band</td>
      <td>Moonshine &amp; Palinka</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/romania" | relative_url }}">romania</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-03-31</td>
      <td>The Amsterdams</td>
      <td>Electromagnetica</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/romania" | relative_url }}">romania</a></li>
    ...
    <tr>
      ...
      <td>2011-12-31</td>
      <td>Identitate</td>
      <td>If you can Hear, Then you can See</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>George Enescu</td>
      <td>ENESCU: Symphony No. 1 &#x2F; Sinfonia Concertante</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/romania" | relative_url }}">romania</a></li>
    ...
    <tr>
      ...
      <td>Romania: Festive Music from the Maramures Region</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/romania" | relative_url }}">romania</a></li>
    ...
    <tr>
      ...
      <td>2024-05-21</td>
      <td>Drakorathos</td>
      <td>Ode To The Majesty Of The Nightside</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/raw-black-metal" | relative_url }}">raw black metal</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Jezebel´s Tower</td>
      <td>Like every mother´s son</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td></td>
      <td>George Enescu</td>
      <td>ENESCU: Symphony No. 2 &#x2F; Vox Maris, Op. 31</td>
      <td>
        <ul>
        </ul>
      </td>
