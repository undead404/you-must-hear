...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/african" | relative_url }}">african</a> # 83</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>Various Artists</td>
      <td>20 Ways to Float Through Walls</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Cornershop</td>
      <td>Cornershop &amp; The Double &#39;O&#39; Groove Of</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-01-23</td>
      <td>Luiz Bonfá</td>
      <td>Amor! Fabulous Guitar Of Luiz Bonfa</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/france" | relative_url }}">france</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pakistani" | relative_url }}">pakistani</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
