...
Classical composer music refers to music composed by composers who lived from the mid-16th century to the present day and who created music within the Western art music tradition. This encompasses a wide range of styles and genres, including Baroque, Classical, Romantic, and Modernist, among others. Some of the most famous classical composers include Johann Sebastian Bach, Wolfgang Amadeus Mozart, Ludwig van Beethoven, Franz Schubert, Frederic Chopin, Richard Wagner, and Igor Stravinsky, to name just a few. Classical composer music has had a profound influence on Western music and continues to be performed and studied today.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 69</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1963</td>
      <td>Leoš Janáček</td>
      <td>Pièces pour piano (Hélène Couvert)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mass" | relative_url }}">mass</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1967</td>
      <td>Leoš Janáček</td>
      <td>Fiddler&#39;s Child, Taras Bulba (Czech Philharmonic Orchestra, Jiří Bělohlávek)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1968</td>
      <td>Leoš Janáček</td>
      <td>The Excursions of Mr.Brouček (BBC Symphony Orchestra, Jiří Bělohlávek)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1972</td>
      <td>Jan Dismas Zelenka</td>
      <td>Zelenka: Responsoria pro hebdomada sancta</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque" | relative_url }}">baroque</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>Leoš Janáček</td>
      <td>Sir Charles Mackerras conducts Janáček</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/czech" | relative_url }}">czech</a></li>
    ...
    <tr>
      ...
      <td>1975</td>
      <td>Leoš Janáček</td>
      <td>Complete Chamber &amp; Orchestral Works I</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
    ...
    <tr>
      ...
      <td>1975-02</td>
      <td>Bohuslav Martinů</td>
      <td>The Parables, Estampes, Overture, Rhapsody (Czech Philharmonic Orchestra - Jiří Bělohlávek)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1978</td>
      <td>Bohuslav Martinů</td>
      <td>Three Fragments and Suite From the Opera Juliette (Magdalena Kožená, Czech Philharmonic Orchestra, Sir Charles Mackerras)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1979</td>
      <td>Bohuslav Martinů</td>
      <td>Symphonies Nos.3 &amp; 4 (Bamberger Sinfoniker, Neeme Järvi)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Piano Works Vol.2 (Jitka Čechová)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-composer" | relative_url }}">classical composer</a></li>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>Bohuslav Martinů</td>
      <td>Symphonies Nos.5 &amp; 6 (Bamberger Sinfoniker, Neeme Järvi)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>JANÁČEK: Orchestral Works (cond.Jiří Bělohlávek)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/czech" | relative_url }}">czech</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/composer" | relative_url }}">composer</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/late-romantic" | relative_url }}">late romantic</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1988</td>
      <td>Leoš Janáček</td>
      <td>Complete Chamber &amp; Orchestral Works II</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
    ...
    <tr>
      ...
      <td>1989</td>
      <td>Antonín Dvořák</td>
      <td>Symphonic Poems (Czech Philharmonic Orchestra, Sir Charles Mackerras)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sonata" | relative_url }}">sonata</a> # 39</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>Antonín Dvořák</td>
      <td>Symphonies 8 &amp; 9 &quot;From The New World&quot;</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-composer" | relative_url }}">classical composer</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 35</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/classical-composer" | relative_url }}">classical composer</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Bohuslav Martinů</td>
      <td>Works Inspired by Jazz and Sport</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 74</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Antonín Vranický</td>
      <td>Concertante Quartets 1-3 (Martinů Quartet)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/classical-composer" | relative_url }}">classical composer</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/czech" | relative_url }}">czech</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Jan Křtitel Vaňhal</td>
      <td>Symphonies (London Mozart Players, Matthias Bamert)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>Leoš Janáček</td>
      <td>String Quartets (Pavel Haas Quartet)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>MARTINU: The Epic of Gilgamesh</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/czech" | relative_url }}">czech</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Organ Concertos Complete</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/czech-classical" | relative_url }}">czech classical</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2008-03-10</td>
      <td>Leoš Janáček</td>
      <td>The Excursions of Mr.Brouček (BBC Symphony Orchestra, Jiří Bělohlávek) - To the 15th Century</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/horn" | relative_url }}">horn</a> # 58</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sonata" | relative_url }}">sonata</a> # 76</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2013</td>
      <td>Otto Klemperer</td>
      <td>Bach: St.Matthew Passion</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-composer" | relative_url }}">classical composer</a></li>
    ...
    <tr>
      ...
      <td>2013-09-16</td>
      <td>Petr Eben</td>
      <td>Mutationes,Ten Chorale Preludes, Momenti d&#39;Organo, Hommage à Henry Purcell, Versetti (Halgeir Schiader)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Warsaw Concerto and Other Piano Concertos from the Movies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-composer" | relative_url }}">classical composer</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/soundtrack" | relative_url }}">soundtrack</a></li>
