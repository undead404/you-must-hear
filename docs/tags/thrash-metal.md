...
Last updated: <time datetime="2025-12-06T02:09:46.107Z">Sat Dec 06 2025 04:09:46 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/old-school-thrash-metal" | relative_url }}">old school thrash metal</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/old-school-thrash-metal" | relative_url }}">old school thrash metal</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/speed-metal" | relative_url }}">speed metal</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a> # 59</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/technical-thrash-metal" | relative_url }}">technical thrash metal</a> # 91</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/technical-thrash-metal" | relative_url }}">technical thrash metal</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1991-06-25</td>
      <td>Anthrax</td>
      <td>Attack Of The Killer B&#39;s</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/groove-metal" | relative_url }}">groove metal</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-thrash-metal" | relative_url }}">progressive thrash metal</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a> # 51</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stoner-metal" | relative_url }}">stoner metal</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/speed-metal" | relative_url }}">speed metal</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
