...
Chamber music emphasizes intimate, intricate arrangements originally designed for small ensemble performance in private spaces rather than concert halls. The tag encompasses both classical chamber works and contemporary indie artists who adopt similar approaches through delicate instrumentation, careful dynamics, and often orchestral elements like strings or woodwinds. It prioritizes nuanced interplay between musicians and creates an atmosphere of closeness and emotional depth.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Haydn: The Complete Symphonies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>VILLA-LOBOS: Chamber Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>Galliard Brass Ensemble</td>
      <td>Carols for Brass</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>Leoš Janáček</td>
      <td>Complete Chamber &amp; Orchestral Works</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/orchestral" | relative_url }}">orchestral</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1989</td>
      <td>Various Artists</td>
      <td>Музика за Плашење Деца и Нервирање Возрасни, II</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Brahms: Sonatas for Cello and Piano</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>John Ireland</td>
      <td>IRELAND: String Quartets Nos. 1 and 2 &#x2F; The Holy Boy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Quatuor Debussy</td>
      <td>Lekeu - Complete works for string quartet</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Christian Benda</td>
      <td>Martinu: Works For Cello And Piano, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Tõnu Kaljuste</td>
      <td>Schnittke: Psalms Of Repentance</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2000-02</td>
      <td>Kreutzer Quartet</td>
      <td>Reicha - Complete String Quartets, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2000-03-13</td>
      <td>Silver Mt Zion</td>
      <td>He Has Left Us Alone But Shafts Of Light Still Sometimes Grace The Corner Of Our Rooms...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>New Music Studium</td>
      <td>Poulenc: La Bal Masqué, Suite Française, Rapsodie Nègre, Le Bestiaire, Cocardes &amp; Aubade</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>The Galliard Ensemble</td>
      <td>Opus Number Zoo - Twentieth Century Wind Quintets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Ensemble MidtVest</td>
      <td>Holmboe: Chamber Music, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Battlefield: Bad Company OST</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2011-08</td>
      <td>Raphaël D. Hardy</td>
      <td>Looking at Them from the Top of the Hill</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2011-11-27</td>
      <td>McGuffin Electric</td>
      <td>Brightelephant</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
    ...
    <tr>
      ...
      <td>Burning Screams Holocaust</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
    ...
    <tr>
      ...
      <td>Kaija Saariaho: Chamber Works for Strings, Vol. 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Poetica: All Beauty Sleeps</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2018-11-12</td>
      <td>Reinhold Quartett</td>
      <td>Reinecke: Complete String Quartets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2019</td>
      <td>The Primrose Piano Quartet</td>
      <td>Brahms: The Piano Quartets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2021</td>
      <td>Paganini Ensemble Vienna</td>
      <td>Paganini: Quartets for Strings &amp; Guitar Nos. 1, 2 &amp; 9</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Holmboe - String Quartets, Vol.1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2021-07-25</td>
      <td>Melissa Grey</td>
      <td>Psychodrama: 13 Variations</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
    ...
    <tr>
      ...
      <td>Blue Silence: Complete Works for String Quartet</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chamber" | relative_url }}">chamber</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      ...
      <td>2022-09</td>
      <td>Rudersdal Chamber Players</td>
      <td>Ruders: Clarinet Quintet, Throne &amp; Piano Quartet</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2023-04</td>
      <td>Arcadia Quartet</td>
      <td>Weinberg - String Quartets, Volume 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td></td>
      <td>Various Artists</td>
      <td>Музика за Плашење Деца и Нервирање Возрасни</td>
      <td>
        <ul>
