...
Drumless is a minimalist hip-hop subgenre that strips away traditional drum patterns, relying instead on atmospheric samples, melodic loops, and sparse instrumentation. Emerging from underground rap in the 2010s, it creates an eerie, meditative sound that emphasizes lyricism and mood over conventional rhythm. The style reflects a DIY ethos and experimental approach to production.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1984</td>
      <td>Ron Carter &amp; Jim Hall</td>
      <td>Live at Village West</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Jim Hall</td>
      <td>Dedications &amp; Inspirations</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-guitar" | relative_url }}">jazz guitar</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chamber-jazz" | relative_url }}">chamber jazz</a> # 82</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Daft Punk</td>
      <td>Motherboard (Drumless Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/duo" | relative_url }}">duo</a> # 76</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010-11-01</td>
      <td>Anne Sofie Von Otter &amp; Brad Mehldau</td>
      <td>Love Songs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano-solo" | relative_url }}">piano solo</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2011</td>
      <td>Bill Frisell</td>
      <td>Sign of Life: Music for 858 Quartet</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-guitar" | relative_url }}">jazz guitar</a></li>
    ...
    <tr>
      ...
      <td>2011-01-01</td>
      <td>Archie Shepp &amp; Joachim Kühn</td>
      <td>Wo!man</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano-solo" | relative_url }}">piano solo</a> # 79</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2018</td>
      <td>Mach-Hommy</td>
      <td>Dollar Menu 3: DUMP GAWD EDITION</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
    ...
    <tr>
      ...
      <td>2018-08-18</td>
      <td>Hermit and the Recluse &amp; KA</td>
      <td>Orpheus vs. The Sirens</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/abstract-hip-hop" | relative_url }}">abstract hip hop</a></li>
    ...
    <tr>
      ...
      <td>2023-05-12</td>
      <td>Daft Punk</td>
      <td>Random Access Memories (Drumless Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2023-07-07</td>
      <td>Mach-Hommy</td>
      <td>Notorious Dump Legends, Vol. 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2024-09-06</td>
      <td>The Modest Jazz Trio</td>
      <td>Good Friday Blues</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-guitar" | relative_url }}">jazz guitar</a></li>
    ...
    <tr>
      ...
      <td>And Then You Pray For Me</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boom-bap" | relative_url }}">boom bap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a></li>
