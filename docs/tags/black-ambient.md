...
Black ambient music is a subgenre of ambient music that incorporates elements of black metal and other dark genres. It typically features slow, droning sounds with minimal melodies, heavy use of distortion and reverb, and a focus on creating a dark, foreboding atmosphere. The genre often explores themes related to darkness, nature, and the supernatural, and is often associated with occult or mystical themes. Some notable black ambient artists include Lustmord, Atrium Carceri, and Svarte Greiner.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Moëvöt</td>
      <td>Ézléýfbdréhtr Vépréùb Zùérfl Màzàgvàtre Érbbédréà</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
    ...
    <tr>
      ...
      <td>1994-04-01</td>
      <td>Abruptum</td>
      <td>In Umbra Malitiae Ambulabo, in Aeternum in Triumpho Tenebraum</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Terrorgoat</td>
      <td>Unholy Goatskull Rituals</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a></li>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Gormantatinus</td>
      <td>Sersavina Decan, Anden Plaust</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>What Do You Think of the Old God, We Call Him Judas?</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Neuntöter der Plage</td>
      <td>Breathe This Sickly Breath</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>2007-04-12</td>
      <td>Black Seas Of Infinity</td>
      <td>AMRITA - The Quintessence</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>2007-04</td>
      <td>Breath of Chaos</td>
      <td>They All Lay in Stone Houses</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-06</td>
      <td>Etheric Void</td>
      <td>Threnodies Of Death Ritual Rites</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
    ...
    <tr>
      ...
      <td>2007-09-01</td>
      <td>The True Werwolf</td>
      <td>Endless Journeys</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td>2010-06-18</td>
      <td>Soufferance</td>
      <td>Travels Into Several Remote Nations of the Mind</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
    ...
    <tr>
      ...
      <td>2010-10-27</td>
      <td>Dark Ages</td>
      <td>The Tractatus De Hereticis Et Sortilegiis</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-12-12</td>
      <td>Nyogtha</td>
      <td>Hymns To The Astral Planes...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
    ...
    <tr>
      ...
      <td>2011-04-08</td>
      <td>Gates Of Dawn</td>
      <td>Betwixt Guttered Columns</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a></li>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Evilnox</td>
      <td>The Land Of The Lost Souls...The Revival (Demo)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/darkwave" | relative_url }}">darkwave</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/pagan-metal" | relative_url }}">pagan metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2014-08-23</td>
      <td>Reverorum ib Malacht</td>
      <td>Emet Amen : The dark night of the faith</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-black-metal" | relative_url }}">ambient black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
    ...
    <tr>
      ...
      <td>2015-08-06</td>
      <td>Black Earth</td>
      <td>A Cryptic Howl of Morbid Truth</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>Evilnox</td>
      <td>Songs From Twilight Kingdom</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
    ...
    <tr>
      ...
      <td>2017-03-04</td>
      <td>Vampyric Bvrial</td>
      <td>Ordo Lux Sepulchrum</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-ambient" | relative_url }}">black ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Abruptum</td>
      <td>In Umbra Malitiae Ambulabo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
