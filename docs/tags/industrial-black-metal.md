...
Last updated: <time datetime="2025-12-06T11:55:25.659Z">Sat Dec 06 2025 13:55:25 GMT+0200 (Eastern European Standard Time)</time>

### Description

Industrial black metal fuses the raw aggression and tremolo-picked darkness of black metal with mechanical, distorted soundscapes drawn from industrial music. The style emerged in the mid-1990s as artists incorporated programmed drums, harsh electronic textures, and cold synthesizers into traditional black metal&#39;s misanthropic framework. This creates an oppressive, mechanized atmosphere that replaces organic bleakness with dystopian, machine-like intensity.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1996</td>
      <td>Mysticum</td>
      <td>In the Streams of Inferno</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cyber-metal" | relative_url }}">cyber metal</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dungeon-synth" | relative_url }}">dungeon synth</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
    ...
    <tr>
      <td>9</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/bfed54586aa236b310f980aacfe52895.png" alt="Cover for Thorns" style="max-width:120px; height:auto;" />
      </td>
      <td>2001-03-05</td>
      <td>Thorns</td>
      <td>Thorns</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 57.99999999999999 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2002-09</td>
      <td>Thee Maldoror Kollective</td>
      <td>New Era Viral Order</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Trollheim&#39;s Grott</td>
      <td>Bloodsoaked and Ill-Fated</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003-02-17</td>
      <td>Anaal Nathrakh</td>
      <td>When Fire Rains Down From the Sky, Mankind Will Reap as It Has Sown</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>The Ichneumon Method (And Less Welcome Techniques)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2004-11-13</td>
      <td>The Axis of Perdition</td>
      <td>Physical Illucinations in the Sewer of Xuchilbara (The Red God)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-03-28</td>
      <td>The Axis of Perdition</td>
      <td>Deleted Scenes from the Transition Hospital</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/french-black-metal" | relative_url }}">french black metal</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Terminal World Perspective</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010-01-18</td>
      <td>Blacklodge</td>
      <td>T&#x2F;ME [3rd Level Initiation &#x3D; Chamber of Downfall]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-metal" | relative_url }}">industrial metal</a></li>
    ...
    <tr>
      ...
      <td>2010-08-30</td>
      <td>Gorgonea Prima</td>
      <td>Black Coal Depression</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2011-05-05</td>
      <td>The Axis of Perdition</td>
      <td>Tenements (Of The Anointed Flesh)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012-05-01</td>
      <td>Dawn of Ashes</td>
      <td>Hollywood Made In Gehenna</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a> # 45</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2012-11-06</td>
      <td>Rage Nucléaire</td>
      <td>Unrelenting Fucking Hatred</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2015-04-27</td>
      <td>Kommandant</td>
      <td>The Architects Of Extermination</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/black-doom-metal" | relative_url }}">black doom metal</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2019-01-18</td>
      <td>Dawn of Ashes</td>
      <td>The Crypt Injection II (Non Serviam)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/aggrotech" | relative_url }}">aggrotech</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-electro" | relative_url }}">dark electro</a></li>
    ...
    <tr>
      ...
      <td>2021-03</td>
      <td>Abigor</td>
      <td>Time Is the Sulphur in the Veins of the Saint</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/industrial-black-metal" | relative_url }}">industrial black metal</a></li>
