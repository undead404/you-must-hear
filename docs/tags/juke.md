...
Juke is a frenetic, sample-heavy electronic music style born from Chicago&#39;s ghetto house scene, characterized by hyper-accelerated tempos around 160 BPM and chopped, stuttering vocal samples. The sound features relentless kick drum patterns, warped R&amp;B snippets, and an intensely physical energy designed for competitive footwork dancing. Its raw, lo-fi aesthetic and urgent rhythm create an aggressively playful sonic experience that bridges street culture and experimental club music.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/juke" | relative_url }}">juke</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>50</td>
      <td>
          <img src="https://i.discogs.com/0x78d7wbsFBgq5QX0vOg8xNzgRoE_amkvD8m5b44EJg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTY1NTcx/MzctMTQyMTk0MTg1/My03MTEyLmpwZWc.jpeg" alt="Cover for Get Melted" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-01-21</td>
      <td>Melt Unit</td>
      <td>Get Melted</td>
    ...
    <tr>
      ...
      <td>2015-06-05</td>
      <td>Drrty Pharms</td>
      <td>Life Sucks And Then You Cum</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/baroque" | relative_url }}">baroque</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bass" | relative_url }}">bass</a></li>
    ...
    <tr>
      ...
      <td>2015-09-07</td>
      <td>Captain Raveman</td>
      <td>内なる怪物 &#x2F; The Inner Monster</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/footwork" | relative_url }}">footwork</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumstep" | relative_url }}">drumstep</a> # 29</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-drum-and-bass" | relative_url }}">atmospheric drum and bass</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ireland" | relative_url }}">ireland</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ireland" | relative_url }}">ireland</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2021-04-23</td>
      <td>Various Artists</td>
      <td>Thee Alpha &amp; Thee Omega, Vol. IV</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2022-04-14</td>
      <td>Various Artists</td>
      <td>CRACK: A Lost Juke&#x2F;Footwork Compilation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/footwork" | relative_url }}">footwork</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/juke" | relative_url }}">juke</a></li>
    ...
    <tr>
      ...
      <td>2022-05-04</td>
      <td>The Bobfather</td>
      <td>Dance Into the RevolutionX2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/footwork" | relative_url }}">footwork</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/juke" | relative_url }}">juke</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bounce" | relative_url }}">bounce</a> # 52</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/footwork" | relative_url }}">footwork</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
