...
Noisegrind is a subgenre of extreme music that combines elements of noise music and grindcore. It typically features aggressive and fast-paced drumming, heavily distorted guitar riffs, and screamed or growled vocals, often with the addition of noise elements such as feedback, samples, and sound effects. Noisegrind bands often focus on creating a chaotic and abrasive sound, with little regard for traditional song structures or melodic content. The genre has its roots in the 1980s noise music scene and has since evolved into a distinct subgenre of extreme music.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1989-09-05</td>
      <td>Sore Throat</td>
      <td>Disgrace To The Corpse Of Sid</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1989-10-27</td>
      <td>Sore Throat</td>
      <td>Never Mind The Napalm Here&#39;s Sore Throat</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>W.B.I.</td>
      <td>Stichpimpulibockforzelorum</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1994-07</td>
      <td>Genital Masticator</td>
      <td>Me voy a cagar en tu puta madre</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>New York Against the Belzebu</td>
      <td>Are You Ready For Noise ?</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Final Exit</td>
      <td>Seasons Are Going and Going...</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>Machetazo</td>
      <td>Realmente Disfruto Comiendo Cadáveres</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/goregrind" | relative_url }}">goregrind</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Arsedestroyer</td>
      <td>Arsedestroyer &#x2F; Gore Beyond Necropsy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Enbilulugugal</td>
      <td>Cultivating The Devil Goat Vomit Harvest</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2006-06</td>
      <td>2 Minuta Dreka</td>
      <td>Kasumi Toilet &#x2F; Warsore</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
    ...
    <tr>
      ...
      <td>2008-07-24</td>
      <td>Anal Cunt</td>
      <td>Anal Cunt Old Stuff Part 3</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-11-26</td>
      <td>Ministrs</td>
      <td>Augļi ir domāti, lai tos izmantotu ārēji</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Enbilulugugal</td>
      <td>Goatfucked Demology: The Years of HellNoize</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>2011-09-08</td>
      <td>Alonso Lopez</td>
      <td>Segunda Violacion Sonora</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a></li>
    ...
    <tr>
      ...
      <td>2011-12-06</td>
      <td>Dethcentrik</td>
      <td>Why The Innocent Die Young</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Putrefactive decomposition of craneoencephalic and facial traumatic destruction</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2012-08-07</td>
      <td>Maläd</td>
      <td>eat pussy,not animals ep</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2012-10-31</td>
      <td>Enbilulugugal</td>
      <td>Frostfucked SaGoatan Blasphemies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>2013-10-10</td>
      <td>Maläd</td>
      <td>my life is winter hell ep</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
    ...
    <tr>
      ...
      <td>2013-12-18</td>
      <td>Kusari Gama Kill</td>
      <td>The Zombies EP (Kusari Gama Kill&#x2F;Sarkofachocrss88 7&quot; split)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
    ...
    <tr>
      ...
      <td>2014-01-27</td>
      <td>Bleed the Pigs</td>
      <td>Mortis Fatum EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>Eviscerorgasm</td>
      <td>A putrid moment of pestilence</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cybergrind" | relative_url }}">cybergrind</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/goregrind" | relative_url }}">goregrind</a></li>
    ...
    <tr>
      ...
      <td>2015-03-27</td>
      <td>Sore Throat</td>
      <td>Death To Capitalist Halmshaw</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2015-04-18</td>
      <td>Enbilulugugal</td>
      <td>Lard Curlyton&#39;z Greazy Chikken Fried Leftoverz</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a></li>
    ...
    <tr>
      ...
      <td>2015-10-25</td>
      <td>Enbilulugugal</td>
      <td>Fukken Fat As Fukkin Fukk</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a></li>
    ...
    <tr>
      ...
      <td>2016-02-09</td>
      <td>Enbilulugugal</td>
      <td>Lardmongers for Curlyton</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a></li>
    ...
    <tr>
      ...
      <td>2017-07-29</td>
      <td>Gorgonized Dorks</td>
      <td>Maximum Thrash &#x2F; Gorgonized Dorks</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a></li>
    ...
    <tr>
      ...
      <td>2017-11-04</td>
      <td>Chepang</td>
      <td>Live @ Rock N Roll Gas Station</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a></li>
    ...
    <tr>
      ...
      <td>2018-01-16</td>
      <td>Enbilulugugal</td>
      <td>Frostfucked Black Metal Goatsodomy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a></li>
    ...
    <tr>
      ...
      <td>2019</td>
      <td>Sermon Of Flames</td>
      <td>Heralds Of The Untruth</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2020-01-07</td>
      <td>Matyrboja</td>
      <td>Podarunok Pid Podushku Nahui</td>
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2021</td>
      <td>Gummo</td>
      <td>A Fresh Breath On The Neck</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
    ...
    <tr>
      ...
      <td>2021-10-12</td>
      <td>Not Safe For Whores</td>
      <td>Optional Suicide</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noise" | relative_url }}">noise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a></li>
    ...
    <tr>
      ...
      <td>2022-02-22</td>
      <td>Seven Headed Serpent</td>
      <td>Withering Storms Of Howling Death</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/harsh-noise-wall" | relative_url }}">harsh noise wall</a> # 16</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td></td>
      <td>Mounds of Decomposing Corpses</td>
      <td>War...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/goregrind" | relative_url }}">goregrind</a></li>
