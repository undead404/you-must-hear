...
Last updated: <time datetime="2025-11-19T20:40:44.876Z">Wed Nov 19 2025 22:40:44 GMT+0200 (Eastern European Standard Time)</time>

### Description

Viking metal is a subgenre of heavy metal music that draws its lyrical and visual inspiration from Norse mythology and Viking culture. Musically, viking metal typically incorporates elements of traditional Scandinavian folk music and black metal, with heavy use of distorted guitars, blast beats, and aggressive vocals. The genre originated in the late 1980s and early 1990s in Scandinavia, particularly in Norway and Sweden, and has since spread to other parts of the world. Some of the most well-known viking metal bands include Bathory, Enslaved, and Amon Amarth.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 80 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>50</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/04c0d85e0dab8a555bdf3bc6ef226437.png" alt="Cover for Till Fjälls" style="max-width:120px; height:auto;" />
      </td>
      <td>1998</td>
      <td>Vintersorg</td>
      <td>Till Fjälls</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1998-10-06</td>
      <td>Mithotyn</td>
      <td>King of the Distant Forest</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      <td>30</td>
      <td>
          <img src="https://i.discogs.com/TNCkMlnJWFdmgXEkxtCpLKRrVpaK4NeaSCeENSC1r0E/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQwNzA3/NS0xMzQyNjEyNDkz/LTEwMzEuanBlZw.jpeg" alt="Cover for Ödemarkens Son" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
      <td>Vintersorg</td>
      <td>Ödemarkens Son</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1999-04-26</td>
      <td>Mithotyn</td>
      <td>Gathered Around the Oaken Table</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2000-09-11</td>
      <td>Einherjer</td>
      <td>Norwegian Native Art</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/folk-metal" | relative_url }}">folk metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2005-11-25</td>
      <td>Falkenbach</td>
      <td>Heralding The Fireblade</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/folk-metal" | relative_url }}">folk metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2006-10-27</td>
      <td>Myrkgrav</td>
      <td>Trollskau, Skrømt og Kølabrenning</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pagan-metal" | relative_url }}">pagan metal</a> # 95</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/folk-metal" | relative_url }}">folk metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/folk-metal" | relative_url }}">folk metal</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>47</td>
      <td>
          <img src="https://i.discogs.com/-Mq3r0NMuFCjz2j5kCOI7iUKVDHGnF5fJ1sj-YOral0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIxNjc2/MTctMTQ4Njg0MDQ5/Mi0xMzk5LmpwZWc.jpeg" alt="Cover for Nattväsen" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-11-19</td>
      <td>Månegarm</td>
      <td>Nattväsen</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/folk-metal" | relative_url }}">folk metal</a> # 64</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/folk-metal" | relative_url }}">folk metal</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2013-11-29</td>
      <td>Falkenbach</td>
      <td>...Magni Blandinn Ok Megintiri...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/viking-metal" | relative_url }}">viking metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2020-05-01</td>
      <td>Æther Realm</td>
      <td>Redneck Vikings From Hell</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
