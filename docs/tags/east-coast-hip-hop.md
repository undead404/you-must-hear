...
Last updated: <time datetime="2025-12-06T06:47:45.871Z">Sat Dec 06 2025 08:47:45 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hardcore-rap" | relative_url }}">hardcore rap</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/east-coast" | relative_url }}">east coast</a> # 64</li>
    ...
    <tr>
      <td>95</td>
      <td>
          <img src="https://i.discogs.com/MWry8JgijBRbqO5CIKQreNCtGVFl0U0qrC1lSRybbn4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc5MDcw/MS0xNDU3NTA0ODc2/LTk5NjAuanBlZw.jpeg" alt="Cover for Smell The DA.I.S.Y." style="max-width:120px; height:auto;" />
      </td>
      <td>1996</td>
      <td>De La Soul</td>
      <td>Smell The DA.I.S.Y.</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-hip-hop" | relative_url }}">east coast hip hop</a></li>
        </ul>
    ...
    <tr>
      <td>81</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/0ac58841e718b7f49191947c33c33fce.png" alt="Cover for ElCamino 2" style="max-width:120px; height:auto;" />
      </td>
      <td>1997</td>
      <td>Elcamino</td>
      <td>ElCamino 2</td>
    ...
    <tr>
      ...
      <td>The Psycho-social, Chemical, Biological, And Electro-magnetic Manipulation Of Human Consiousness</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/conscious-hip-hop" | relative_url }}">conscious hip hop</a> # 14</li>
    ...
    <tr>
      <td>98</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/12098b07c2774f8ccf8fa2f7b5b832e3.png" alt="Cover for Black On Both Sides" style="max-width:120px; height:auto;" />
      </td>
      <td>1999-10-12</td>
      <td>Mos Def</td>
    ...
    <tr>
      <td>22</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/aebedce2388134b65744ab78d58d9e45.png" alt="Cover for Willennium" style="max-width:120px; height:auto;" />
      </td>
      <td>1999-11-16</td>
      <td>Will Smith</td>
      <td>Willennium</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-hip-hop" | relative_url }}">east coast hip hop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/pop-rap" | relative_url }}">pop rap</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>7</td>
      <td>
          <img src="https://i.discogs.com/oxGQMmM5LfY9Iz1bPqz1f79z0Z7tv4Z0yDqDMG2ECJE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ0MTMz/My0xMzc5ODQ3MDg5/LTk2MDAuanBlZw.jpeg" alt="Cover for The Blueprint" style="max-width:120px; height:auto;" />
      </td>
      <td>2001-09-11</td>
      <td>JAY Z</td>
      <td>The Blueprint</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/turntablism" | relative_url }}">turntablism</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>30</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5de1881985334258853f628825d1310e.png" alt="Cover for Born Sinner (Deluxe Version)" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-06-14</td>
      <td>J. Cole</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cloud-rap" | relative_url }}">cloud rap</a> # 95</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2013-12-04</td>
      <td>A$AP Mob</td>
      <td>Trillmatic (feat. A$AP Nast &amp; Method Man)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/boom-bap" | relative_url }}">boom bap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-hip-hop" | relative_url }}">east coast hip hop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 22</li>
    ...
    <tr>
      <td>18</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/7b3f826eb7bcf8e6d7557415b38c0075.png" alt="Cover for Honor Killed the Samurai" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-08-13</td>
      <td>Ka</td>
      <td>Honor Killed the Samurai</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/abstract-hip-hop" | relative_url }}">abstract hip hop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-hip-hop" | relative_url }}">east coast hip hop</a></li>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>wiki</td>
      <td>No Mountains in Manhattan</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/abstract-hip-hop" | relative_url }}">abstract hip hop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-hip-hop" | relative_url }}">east coast hip hop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dancehall" | relative_url }}">dancehall</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-hip-hop" | relative_url }}">east coast hip hop</a></li>
            <li style="font-size: calc(1rem * 74 / 100)"> <a href="{{ "/tags/gangsta-rap" | relative_url }}">gangsta rap</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 5</li>
            ...
            <li> <a href="{{ "/tags/gangsta-rap" | relative_url }}">gangsta rap</a> # 50</li>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/8a296b98a901719596490253c16958a5.png" alt="Cover for Meet the Woo" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-07-26</td>
      <td>Pop Smoke</td>
      <td>Meet the Woo</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 16</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 13</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 6</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 3</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/plugg" | relative_url }}">plugg</a> # 54</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chicago-house" | relative_url }}">chicago house</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>5</td>
      <td>
          <img src="https://i.discogs.com/mlhjHrLPb0h1ixRThI-WE0nJPrmOaTZycF_oz2j9fl4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI1ODMx/Mjk3LTE2NzQyNTAx/NDgtODM3Ni5qcGVn.jpeg" alt="Cover for Like..?" style="max-width:120px; height:auto;" />
      </td>
      <td>2023-01-20</td>
      <td>ICE SPICE</td>
      <td>Like..?</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/footwork" | relative_url }}">footwork</a> # 47</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pluggnb" | relative_url }}">pluggnb</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>47</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/08a487ae19df073f1ec2050a6b3b9da6.png" alt="Cover for NO HANDS" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-06-07</td>
      <td>Joey Valence &amp; Brae</td>
      <td>NO HANDS</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/conscious-hip-hop" | relative_url }}">conscious hip hop</a> # 40</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pluggnb" | relative_url }}">pluggnb</a> # 45</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>73</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/92e4c48b48fa3ef080c7ff057b694fb7.png" alt="Cover for Cozy Tapes: Vol. 1 Friends -" style="max-width:120px; height:auto;" />
      </td>
      <td></td>
      <td>A$AP Mob</td>
      <td>Cozy Tapes: Vol. 1 Friends -</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drumless" | relative_url }}">drumless</a> # 29</li>
    ...
    <tr>
      <td>4</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5e6d3480d2dea6a0d317ea8abbb8e9db.png" alt="Cover for Like..?" style="max-width:120px; height:auto;" />
      </td>
      <td></td>
      <td>Ice Spice</td>
      <td>Like..?</td>
    ...
    <tr>
      ...
      <td></td>
      <td>A$AP Rocky</td>
      <td>LONG.LIVE.A$AP (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cloud-rap" | relative_url }}">cloud rap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/east-coast-hip-hop" | relative_url }}">east coast hip hop</a></li>
