...
Comedy music is a genre of music that is intended to be humorous or satirical in nature. It often incorporates elements of other musical genres, such as rock, pop, country, or hip hop, and features lyrics that are clever, witty, or absurd. Comedy music can take many forms, ranging from novelty songs and parodies to musical skits and comedy albums. Some notable examples of comedy musicians include &quot;Weird Al&quot; Yankovic, Spike Jones, Tom Lehrer, and Flight of the Conchords.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1965</td>
      <td>Tom Lehrer</td>
      <td>That Was The Year That Was</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 35</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 16</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>Foxtrot Uniform Charlie Kilo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-11-13</td>
      <td>Dane Cook</td>
      <td>Rough Around The Edges - Live From Madison Square Garden</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Spongebob Squarepants - Original Theme Highlights</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/soundtrack" | relative_url }}">soundtrack</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stand-up" | relative_url }}">stand-up</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2014-10</td>
      <td>Logan Paul</td>
      <td>Help Me Help You (feat. Why Don&#39;t We)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2016</td>
      <td>BBC Radio 4</td>
      <td>Friday Night Comedy from BBC Radio 4</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>The Unauthorized Bash Brothers Experience</td>
      <td>The Unauthorized Bash Brothers Experience</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
