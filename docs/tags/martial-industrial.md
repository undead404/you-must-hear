...
Martial industrial combines militaristic percussion, neoclassical orchestration, and industrial atmospherics to evoke themes of warfare, historical conflict, and authoritarian aesthetics. The sound features marching rhythms, sampled speeches, bombastic horns, and dark ambient textures that create cinematic, propaganda-like soundscapes. Emerging from post-industrial and neofolk scenes, it explores controversial imagery and European history with deliberate provocation.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Aux petits Enfants de France</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
    ...
    <tr>
      ...
      <td>1992-10-12</td>
      <td>Non</td>
      <td>In The Shadow Of The Sword</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>The Moon Lay Hidden Beneath a Cloud</td>
      <td>The Smell of Blood but Victory</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003-05</td>
      <td>Dernière Volonté</td>
      <td>Les Blessures de L&#39;ombre</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
    ...
    <tr>
      ...
      <td>2005-10-24</td>
      <td>Storm of Capricorn</td>
      <td>Retours des Tranchees</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
    ...
    <tr>
      ...
      <td>2008-10</td>
      <td>Phragments</td>
      <td>Earth Shall Not Cover Their Blood</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>A Martyrium Of White Roses</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-11-11</td>
      <td>Rome</td>
      <td>Die Aesthetik Der Herrschaftsfreiheit - Band 1 (Aufbruch or A Cross of Wheat)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
    ...
    <tr>
      ...
      <td>2013</td>
      <td>Rome</td>
      <td>Hate Us and See If We Mind</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/martial-industrial" | relative_url }}">martial industrial</a></li>
        </ul>
