...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1957</td>
      <td>Red Garland</td>
      <td>Red Garland&#39;s Piano</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/cool-jazz" | relative_url }}">cool jazz</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/classical" | relative_url }}">classical</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/classical" | relative_url }}">classical</a> # 56</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano-rock" | relative_url }}">piano rock</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1998-05-04</td>
      <td>Tori Amos</td>
      <td>From the Choirgirl Hotel</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 55.00000000000001 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Yiruma</td>
      <td>First Love (Yiruma Piano Collection)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
        </ul>
    ...
    <tr>
      <td>28</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/19e634f2f0aacce136850e4dd6a7b0e1.png" alt="Cover for I Giorni" style="max-width:120px; height:auto;" />
      </td>
      <td>2001</td>
      <td>Ludovico Einaudi</td>
      <td>I Giorni</td>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ef3b0a6ae9c8db082d93809c5cd7cf81.png" alt="Cover for Vrioon" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-12-09</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/adult-contemporary" | relative_url }}">adult contemporary</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>36</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/2632f946b20c4104be3d9c0b7b767a56.png" alt="Cover for An Accidental Memory in the Case of Death" style="max-width:120px; height:auto;" />
      </td>
      <td>2004-05-04</td>
      <td>Eluvium</td>
      <td>An Accidental Memory in the Case of Death</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      <td>95</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/bc76159bebd64ebd88671004606e07ff.png" alt="Cover for On Your Shore" style="max-width:120px; height:auto;" />
      </td>
      <td>2004-08-10</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano-rock" | relative_url }}">piano rock</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006-09-12</td>
      <td>Emily Haines &amp; The Soft Skeleton</td>
      <td>Knives Don&#39;t Have Your Back</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>2006-10-20</td>
      <td>Ben Folds</td>
      <td>supersunnyspeedgraphic, the lp</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/classical" | relative_url }}">classical</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>71</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/52cbd36d2cd74193bbbb75bd6d177592.png" alt="Cover for Unreleased (EP)" style="max-width:120px; height:auto;" />
      </td>
      <td>2017-01-20</td>
      <td>Maddi Jane</td>
      <td>Unreleased (EP)</td>
    ...
    <tr>
      <td>75</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6cc079d934119b17dee759b63ad82149.png" alt="Cover for Don&#39;t Kill My Vibe (Acoustic Versions)" style="max-width:120px; height:auto;" />
      </td>
      <td>2017-04-21</td>
      <td>Sigrid</td>
      <td>Don&#39;t Kill My Vibe (Acoustic Versions)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>If Beale Street Could Talk (Original Motion Picture Score)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/london" | relative_url }}">london</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
