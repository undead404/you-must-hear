...
Polska refers to music originating from or strongly associated with Poland, encompassing diverse genres from hip-hop and rock to pop and folk traditions. The tag captures Polish-language lyrics and cultural sensibilities that reflect the nation&#39;s contemporary urban experience and artistic heritage. Music under this tag often blends modern production with distinctly Polish melodic and lyrical approaches.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1972</td>
      <td>Various Artists</td>
      <td>25 lat listy przebojów Trójki: 2005</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polish" | relative_url }}">polish</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polska" | relative_url }}">polska</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/poland" | relative_url }}">poland</a> # 84</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>51</td>
      <td>
          <img src="https://i.discogs.com/GorvCvhcA8a8eo0P3pu84CTDnv1o4P4aXATGxrd_1SM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MzMy/NDYtMTIxOTMxOTE0/MC5qcGVn.jpeg" alt="Cover for Infernal SS" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-06</td>
      <td>Infernal War</td>
      <td>Infernal SS</td>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Wirone&#x2F;Hawuer</td>
      <td>Woda w proszku, sztućce instant i kurczak w aerozolu</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Poeci Upadłego Pokolenia</td>
      <td>Międzyosiedlowy Tandem Z Bracikiem Na Ramie</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2006-12-18</td>
      <td>Ich Troje</td>
      <td>Siedem grzechów głównych</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polska" | relative_url }}">polska</a></li>
    ...
    <tr>
      ...
      <td>2008-06-01</td>
      <td>Polish The Sounds</td>
      <td>02 - The best is yet to come</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-dance" | relative_url }}">alternative dance</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      ...
      <td>2008-12-24</td>
      <td>Adam Brożyński</td>
      <td>Across the Sky of Imagination</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/poland" | relative_url }}">poland</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>17</td>
      <td>
          <img src="https://i.discogs.com/0jmRIN9NAwZ5kWYMbVjG8JDyrmbTcQXU5zWaQ0ae2gc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE5ODY5/NDEtMTI1Njg5ODU1/MS5qcGVn.jpeg" alt="Cover for [ATAR-PHI-006]" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-10-30</td>
      <td>steal 4 ram</td>
      <td>[ATAR-PHI-006]</td>
    ...
    <tr>
      <td>11</td>
      <td>
          <img src="https://i.discogs.com/z7nQjjWJpBeoYfMbzvgOEaKCrQyzwcIOfFqIeyDBZz0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI2NDAy/ODctMTI5NDUyNDE2/MS5qcGVn.jpeg" alt="Cover for W Zasięgu Ręki EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2010</td>
      <td>Koncept</td>
      <td>W Zasięgu Ręki EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polska" | relative_url }}">polska</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/polski-hip-hop" | relative_url }}">polski hip hop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/poland" | relative_url }}">poland</a> # 74</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Overcolored</td>
      <td>CORVUS CORONE CORNIX E.P.</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/poland" | relative_url }}">poland</a></li>
    ...
    <tr>
      ...
      <td>2011-12-03</td>
      <td>N-Noiz</td>
      <td>Refleksje i Refrakcje (Reflections and Refractions)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin" | relative_url }}">berlin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/poland" | relative_url }}">poland</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/polski" | relative_url }}">polski</a> # 65</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/grime" | relative_url }}">grime</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/poland" | relative_url }}">poland</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>19</td>
      <td>
          <img src="https://i.discogs.com/oFAqRHnM0uKWyFgifK86DI4CitpItc-_dfYl64S0BhA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0NTA2/OTAzLTE1NzU5MzE2/MjgtOTYzNy5qcGVn.jpeg" alt="Cover for Trudne Energie, Proste Rozwiązania EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-03-20</td>
      <td>Jan LF Strach</td>
      <td>Trudne Energie, Proste Rozwiązania EP</td>
      <td>
        <ul>
        </ul>
      </td>
