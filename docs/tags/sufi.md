...
Sufi music is a genre of devotional music inspired by the works of Sufi poets like Rumi, Hafiz, Bulleh Shah, Amir Khusrow, and Khwaja Ghulam Farid. It is often used as an expression of devotion to God and as a means to connect the physical and spiritual aspects of the listener or performer. The best-known form of Sufi music is Qawwali, commonly found in South Asia, but it also includes other forms like the music central to the Sema ceremony of the whirling dervishes, and the West African Gnawa.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish" | relative_url }}">turkish</a> # 58</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Master Musicians of Jajouka feat. Bachir Attar</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sufi" | relative_url }}">sufi</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/arabic" | relative_url }}">arabic</a> # 60</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Manish Vyas &amp; Dina Awwad</td>
      <td>Sufi Splendor - Music for Whirling Meditation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sufi" | relative_url }}">sufi</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003-01-01</td>
      <td>Abida Parveen</td>
      <td>The Best Of Abida Parveen</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/asia" | relative_url }}">asia</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sufi" | relative_url }}">sufi</a></li>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Marzieh</td>
      <td>Elaheh Naz - Persian Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/farsi" | relative_url }}">farsi</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/iran" | relative_url }}">iran</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ethno" | relative_url }}">ethno</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Omar Faruk Tekbilek</td>
      <td>KEANE, Brian &#x2F; TEKBILEK, Omar Faruk: Fire Dance</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/sufi" | relative_url }}">sufi</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2008-10-20</td>
      <td>Lowkey</td>
      <td>Long Live Palestine Parts 1 &amp; 2</td>
      <td>
        <ul>
