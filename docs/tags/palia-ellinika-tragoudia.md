...
“Palia Ellinika Tragoudia” or “Old Greek Songs” is a genre that encompasses a rich variety of Greek music from the past. This genre is often characterized by its emotional depth and lyrical themes, which often revolve around love, hardship, and the Greek way of life. The music is typically melodic, with traditional Greek instruments like the bouzouki providing a distinctive sound. Notable artists in this genre include legends like Dimitris Mitropanos and Stelios Kazantzidis.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1926</td>
      <td>Marika Papagika</td>
      <td>The Further the Flame, the Worse It Burns Me</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1935</td>
      <td>Στελλάκης Περπινιάδης</td>
      <td>Τσακωτό Τον Έπιασε &#x2F; Παντρεύομαι Για Το Γινάτι Σου</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>1938-04</td>
      <td>Μάρκος Βαμβακάρης</td>
      <td>Μια γαλανομάτα στην Αθήνα &#x2F; Νόστιμο τρελλό μικρό μου</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>1968</td>
      <td>Alba, Aris and the Olympics</td>
      <td>Στη Μαμά Μου Θα Το Πω &#x2F; Δεν Έχω Καρδιά</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1972</td>
      <td>Various Artists</td>
      <td>Rebetika, Smyrneika &amp; Dimotika Vol.2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>Various Artists</td>
      <td>Secret Museum Of Mankind Vol. 2: Ethnic Music Classics: 1925-48</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Various Artists</td>
      <td>Ta Elafra Tou &#39;40 (Authenic 78 Rpm Recordings)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>Various Artists</td>
      <td>Απαγορευμένα Ρεμπέτικα - Forbidden Rebetika</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>1989</td>
      <td>Various Artists</td>
      <td>25 Female Voices (78 Rmp Recordings 1946-1959)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Various Artists</td>
      <td>Middle War Songs In Athens Vol.1</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Various Artists</td>
      <td>Argentine tangos &amp; Greek Rebetika &#x2F; Music of Outlaws &#x2F; Recordings 1924 -1944</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Various Artists</td>
      <td>Misirlou - The Route of the Song from the 20&#39;s to 50&#39;s, on 78 rpm Records</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Various Artists</td>
      <td>I Istoria Tou Rebetikou Ke Tou Laikou Tragoudiou No 9</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Various Artists</td>
      <td>To What Strange Place : The Music of The Ottoman-American Diaspora, 1916 - 1929</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Trio Belcanto</td>
      <td>Paramythenia Zografia (Recordings 1957-1961)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Various Artists</td>
      <td>Glykeia Stanbul (Authentic Greek Recordings 1926 - 1964)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Various Artists</td>
      <td>Armenians , Jews , Turks &amp; Gypsies - Oldest Known Recordings</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2008-10-04</td>
      <td>Various Artists</td>
      <td>Chronicle of Greek Light Song (To Elafro Tragoudi) , 1954</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2010-12-01</td>
      <td>Various Artists</td>
      <td>Giati Glyko Mou Sweet Heart (Greeks in USA) [1927-1950 78 RPM Recordings)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/palia-ellinika-tragoudia" | relative_url }}">palia ellinika tragoudia</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Danai</td>
      <td>As Erhosoun Gia Ligo (Authentic 78 rpm Recordings 1946-1957), Vol. 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2022-04-14</td>
      <td>Various Artists</td>
      <td>Songs From the Greek Movies: 1950-1962, Vol. 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Various Artists</td>
      <td>The Outlaws in Rebetiko Song Recordings 1931-1957</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greece" | relative_url }}">greece</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/greece" | relative_url }}">greece</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Marika Ninou</td>
      <td>Marika Ninou, Megala Rempetika</td>
      <td>
        <ul>
        </ul>
      </td>
