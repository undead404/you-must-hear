...
C-pop, or Chinese popular music, encompasses contemporary pop music from Mainland China, Taiwan, and Hong Kong, blending Western pop influences with traditional Chinese musical elements. The genre features Mandarin and Cantonese vocals over modern production styles ranging from ballads to dance-pop and R&amp;B. C-pop has grown into a major force in Asian entertainment, reflecting Chinese urban youth culture while maintaining distinct regional characteristics across Greater China.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/c-pop" | relative_url }}">c-pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/k-pop" | relative_url }}">k-pop</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/c-pop" | relative_url }}">c-pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2012-04-09</td>
      <td>EXO-M</td>
      <td>The 2nd Mini Album &#x60;上瘾 (Overdose)&#x60;</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/c-pop" | relative_url }}">c-pop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2017-07-21</td>
      <td>Exo</td>
      <td>THE WAR - The 4th Album (Chinese Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/c-pop" | relative_url }}">c-pop</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2022-12-06</td>
      <td>Lexie Liu</td>
      <td>THE HAPPY STAR</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/c-pop" | relative_url }}">c-pop</a></li>
    ...
    <tr>
      ...
      <td>2022-12-28</td>
      <td>WAYV</td>
      <td>Kick Back - The 3rd Mini Album</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/c-pop" | relative_url }}">c-pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rnb" | relative_url }}">rnb</a></li>
