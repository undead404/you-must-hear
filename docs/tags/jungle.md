...
Last updated: <time datetime="2025-11-16T17:39:18.547Z">Sun Nov 16 2025 19:39:18 GMT+0200 (Eastern European Standard Time)</time>

### Description

Jungle is a fast-paced electronic music genre that emerged from UK rave culture in the early 1990s, characterized by rapid breakbeats (typically 160-180 BPM) and heavy basslines. The genre blends elements of reggae, dancehall, and hip-hop with chopped-up drum samples creating a frenetic, energetic sound. Jungle became a cornerstone of British underground club culture and influenced countless electronic music styles that followed.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1996-10-14</td>
      <td>Art of Noise</td>
      <td>The Drum and Bass Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jungle" | relative_url }}">jungle</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jump-up" | relative_url }}">jump up</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2002</td>
      <td>Skep</td>
      <td>Sade Like A Tattoo (Skep&#39;s Jungle Edit)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jungle" | relative_url }}">jungle</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/psybient" | relative_url }}">psybient</a> # 81</li>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Ape Escape</td>
      <td>Ape Escape Originape Soundtracks &#x2F; サルゲッチュ・オリジサル・サウンドトラック</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jungle" | relative_url }}">jungle</a></li>
    ...
    <tr>
      <td>50</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/094db51cd6cd3470e92aa2ac003e7a06.png" alt="Cover for the crane" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-06-10</td>
      <td>Source Direct</td>
      <td>the crane</td>
    ...
    <tr>
      ...
      <td>2018</td>
      <td>Chase &amp; Status</td>
      <td>Delete &#x2F; Big Man Skank (VIP)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jungle" | relative_url }}">jungle</a></li>
    ...
    <tr>
      ...
      <td>2019-03-08</td>
      <td>Sully</td>
      <td>Soundboy Don&#39;t Push Your Luck &#x2F; 368ft High &amp; Rising</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jungle" | relative_url }}">jungle</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/phonk" | relative_url }}">phonk</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
