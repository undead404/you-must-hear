...
Last updated: <time datetime="2025-12-05T12:30:49.304Z">Fri Dec 05 2025 14:30:49 GMT+0200 (Eastern European Standard Time)</time>

### Description

Deutschrap is German-language hip-hop that emerged in the 1990s, blending American rap influences with distinctly German lyrical themes and cultural references. The genre ranges from aggressive gangsta rap and battle-focused wordplay to satirical, humorous storytelling and experimental sounds. It has become Germany&#39;s most popular youth music genre, reflecting urban life, social issues, and German identity through hard-hitting beats and clever rhyme schemes.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>1019</td>
      <td>Dagobert Duck (feat. Lucio101 &amp; Nizi19)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/austria" | relative_url }}">austria</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2006-12-01</td>
      <td>Sido</td>
      <td>Ich &amp; meine Maske (Premium Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>2007-09-14</td>
      <td>Bass Sultan Hengzt</td>
      <td>Der Schmetterlingseffekt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/concert" | relative_url }}">concert</a> # 8</li>
    ...
    <tr>
      ...
      <td>2009-12-19</td>
      <td>Kollegah</td>
      <td>Jung Brutal Gutaussehend 3</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-02-26</td>
      <td>Die Atzen</td>
      <td>Die Atzen Praesentieren Atzen Musik Vol.2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-12-24</td>
      <td>Alligatoah</td>
      <td>Schlaftabletten, Rotwein V</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://i.discogs.com/O5bRlUwUfkv3rXUVzgHiEw_0K1ALDBBjN1xYE3XMVlE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzNzEx/MzE1LTE1NTk1MjU5/MDItODU4MC5qcGVn.jpeg" alt="Cover for Hyat" style="max-width:120px; height:auto;" />
      </td>
      <td>2013</td>
      <td>Capo</td>
      <td>Hyat</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german" | relative_url }}">german</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2013-08-02</td>
      <td>Alligatoah</td>
      <td>Triebwerke (Premium Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>2014-09-26</td>
      <td>257ers</td>
      <td>Boomshakkalakka (Spotify Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>2014-12-05</td>
      <td>Trailerpark</td>
      <td>Crackstreet Boys 3 (Bonus Tracks Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2015-12-11</td>
      <td>Kollegah</td>
      <td>Zuhaltertape X-Mas Edition</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschrap" | relative_url }}">deutschrap</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>5</td>
      <td>
          <img src="https://i.discogs.com/yMd7Q_IjF1O0vE4BqBHCCWf0TK5XrzuSCqjya6ZY6yE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExOTUx/NDQwLTE1Mjk2Njg0/NTItMzg3My5wbmc.jpeg" alt="Cover for 1220" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-05-04</td>
      <td>Yung Hurn</td>
      <td>1220</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-rap" | relative_url }}">german rap</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Kool Savas feat. Moe Mitchell</td>
    ...
    <tr>
      ...
      <td>Jung, Brutal, Gutaussehend</td>
      <td>
        <ul>
        </ul>
      </td>
