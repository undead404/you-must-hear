...
The &quot;america&quot; tag encompasses music created by artists from or strongly associated with the United States, reflecting the country&#39;s diverse musical landscape rather than a single genre. It spans everything from folk and rock to hip-hop and experimental compositions, unified by American cultural themes, perspectives, or origins. This broad tag captures the eclectic spirit of American music-making across decades and styles.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/patriotic" | relative_url }}">patriotic</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1969-05</td>
      <td>Harry Partch</td>
      <td>The World of Harry Partch</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-america" | relative_url }}">latin america</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-instrumental" | relative_url }}">contemporary instrumental</a> # 38</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Studies for Player Piano Vol. I</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/china" | relative_url }}">china</a> # 53</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/lds" | relative_url }}">lds</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/honky-tonk" | relative_url }}">honky tonk</a> # 40</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/363240cdb8ac458895f90c6addb027a8.png" alt="Cover for History: America&#39;s Greatest Hits" style="max-width:120px; height:auto;" />
      </td>
      <td>2001</td>
      <td>America</td>
      <td>History: America&#39;s Greatest Hits</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 61 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chicago" | relative_url }}">chicago</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-america" | relative_url }}">latin america</a> # 65</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/san-francisco" | relative_url }}">san francisco</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>The Unreleased Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/american" | relative_url }}">american</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a> # 83</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Master P</td>
      <td>America&#39;s Most Luved Bad Guy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-america" | relative_url }}">latin america</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/lobit" | relative_url }}">lobit</a> # 95</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2009-06-17</td>
      <td>Anya Marina</td>
      <td>Daytrotter Session - 6&#x2F;17&#x2F;2009</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/american" | relative_url }}">american</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/american-classical" | relative_url }}">american classical</a> # 95</li>
        </ul>
      </td>
    </tr>
    <tr>
