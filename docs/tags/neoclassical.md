...
Last updated: <time datetime="2025-11-19T20:37:20.822Z">Wed Nov 19 2025 22:37:20 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 7</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 19</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 38</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/composer" | relative_url }}">composer</a> # 20</li>
    ...
    <tr>
      <td>46</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/9a389f277a5a5b1ee5e098a46a97609d.png" alt="Cover for Lantern" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Clogs</td>
      <td>Lantern</td>
    ...
    <tr>
      <td>9</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/995137ae19f7413781af91acbb51a3ab.png" alt="Cover for Shining Silver Skies" style="max-width:120px; height:auto;" />
      </td>
      <td>2006-05</td>
      <td>Ashram</td>
      <td>Shining Silver Skies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 17</li>
            <li> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a> # 74</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006-11-03</td>
      <td>Die Verbannten Kinder Evas</td>
      <td>Dusk And Void Became Alive</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/austrian" | relative_url }}">austrian</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 61</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 30</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 28</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 45</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/composer" | relative_url }}">composer</a> # 40</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/minimalism" | relative_url }}">minimalism</a> # 47</li>
    ...
    <tr>
      <td>57</td>
      <td>
          <img src="https://i.discogs.com/CUfz9zO5FDEn-SquG2Df8-7QqCbd58lAWYuViFDHVgE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwMzk0/NTQtMTI2MDE5NzY1/Ni5qcGVn.jpeg" alt="Cover for Silent Like Water" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-12-06</td>
      <td>Evgeny Grinko</td>
      <td>Silent Like Water</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 18</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 15</li>
            <li> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a> # 47</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 6</li>
    ...
    <tr>
      <td>87</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/b29d823300e245bec5221b0b9a9a0da9.png" alt="Cover for Narrow" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-02-10</td>
      <td>Soap&amp;Skin</td>
      <td>Narrow</td>
    ...
    <tr>
      ...
      <td>2012-05-28</td>
      <td>Arcana</td>
      <td>As Bright As A Thousand Suns</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 20</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 29</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 42</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 32</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 13</li>
    ...
    <tr>
      <td>15</td>
      <td>
          <img src="https://i.discogs.com/s14L-gJVgGIP4Spo2jMcnLwq9UGDGM-IkJtUMHPgp8A/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc0NDE5/MDgtMTQ0MTU3NDQz/OS02MDY0LmpwZWc.jpeg" alt="Cover for Slow Meadow" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-08-21</td>
      <td>Slow Meadow</td>
      <td>Slow Meadow</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-electronic" | relative_url }}">ambient electronic</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 2</li>
    ...
    <tr>
      <td>76</td>
      <td>
          <img src="https://i.discogs.com/KM0VM3Yap-tiAIXTuVifOhCjJrZbMs-Ec8zhmmL8naU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyNTg3/ODg0LTE1MzgxNDM2/NTQtNTMzNS5qcGVn.jpeg" alt="Cover for Qi" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-09-28</td>
      <td>Phildel</td>
      <td>Qi</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
