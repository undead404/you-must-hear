...
Flamenco is a passionate Spanish art form combining guitar, vocals, and dance that originated in Andalusia. The music features intricate fingerstyle guitar work, rhythmic hand claps, and emotionally intense singing. It blends Romani, Moorish, and Spanish influences into a dramatic, soulful sound.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1971</td>
      <td>Paco de Lucía</td>
      <td>Dos Guitarras Flamencas En America Latina</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>Lole Y Manuel</td>
      <td>Nuevo Dia Lo Mejor De Lole Y Manuel</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1995-03-28</td>
      <td>Gipsy Kings</td>
      <td>The Best of the Gipsy Kings</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Sabicas</td>
      <td>The Greatest Flamenco Guitarist</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Las cartas sobre la mesa</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2011-09-05</td>
      <td>Diego El Cigala</td>
      <td>Cigala &amp; Tango (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
        </ul>
