...
Last updated: <time datetime="2025-12-06T12:55:09.170Z">Sat Dec 06 2025 14:55:09 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>66</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ab4165a3e1eba569945252f95e0b14bd.png" alt="Cover for Innocence of Those Who Perished" style="max-width:120px; height:auto;" />
      </td>
      <td>2017</td>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ab2e793276fadd30630a0c73ecc4dd11.png" alt="Cover for Another 24 Hours" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-10-28</td>
      <td>Various Artists</td>
      <td>Another 24 Hours</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/fastcore" | relative_url }}">fastcore</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fastcore" | relative_url }}">fastcore</a> # 75</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gorenoise" | relative_url }}">gorenoise</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/goregrind" | relative_url }}">goregrind</a> # 2</li>
            <li> <a href="{{ "/tags/harsh-noise" | relative_url }}">harsh noise</a> # 2</li>
            <li> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/noisegrind" | relative_url }}">noisegrind</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
