...
Cuban music blends African rhythms with Spanish melodies, creating infectious dance styles like son, salsa, and rumba. Born from the island&#39;s rich cultural mix, it features syncopated percussion, brass sections, and call-and-response vocals. The genre emphasizes complex polyrhythms and improvisation rooted in both European and Afro-Caribbean traditions.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mambo" | relative_url }}">mambo</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1968</td>
      <td>La Lupe</td>
      <td>Reina de La Cancion Latina</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>las Voces Románticas De Cuba</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Various Artists</td>
      <td>The Stars Of The Buena Vista</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cantautor" | relative_url }}">cantautor</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 96</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Y los Piratas del Flamenco</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/afro-cuban" | relative_url }}">afro-cuban</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Lo Mejor de Roberto Torres, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1993-09-10</td>
      <td>Toto La Momposina y Sus Tambores</td>
      <td>La Candela Viva</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>Perez Prado &amp; His Orchestra</td>
      <td>King of Mambo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-jazz" | relative_url }}">latin jazz</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>introducing... Rubén González</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1998-07-20</td>
      <td>Marc Ribot Y Los Cubanos Postizos</td>
      <td>Marc Ribot y Los Cubanos Postizos</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/afro-cuban" | relative_url }}">afro-cuban</a> # 12</li>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Benny Moré</td>
      <td>Me Gusta Mas El Son -The Originals</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-jazz" | relative_url }}">latin jazz</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 23</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 83</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Introducing... Ruben Gonzalez</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Eliades Ochoa</td>
      <td>Estrellas de Cuba: Eliades Ochoa</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
    ...
    <tr>
      ...
      <td>2003-01-28</td>
      <td>Ry Cooder &amp; Manuel Galbán</td>
      <td>Mambo Sinuendo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Lissy Álvarez</td>
      <td>Cuba Le Canta A Serrat - Vol. 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-jazz" | relative_url }}">latin jazz</a> # 37</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/afro-cuban" | relative_url }}">afro-cuban</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/afro-cuban" | relative_url }}">afro-cuban</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-jazz" | relative_url }}">latin jazz</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 59</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Various Artists</td>
      <td>Afro Cuban Roots Presents... 75 Years Of Cuban Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cuban" | relative_url }}">cuban</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cuba" | relative_url }}">cuba</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
