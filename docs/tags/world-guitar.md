...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/shred" | relative_url }}">shred</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Andrew White</td>
      <td>The Heart of the Celtic Guitar</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world-guitar" | relative_url }}">world guitar</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006-06-06</td>
      <td>Carlos Pacheco Torres</td>
      <td>Música Para Cuarteto De Cuerda Y Cuadro Flamenco</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2007</td>
      <td>Miguel de la Bastide</td>
      <td>Flamenco: Fire And Grace</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/flamenco" | relative_url }}">flamenco</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world-guitar" | relative_url }}">world guitar</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2011-12-26</td>
      <td>Taco Town</td>
      <td>No Entiendo (Spanish Guitar Lounge del Mar)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world-guitar" | relative_url }}">world guitar</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2016</td>
      <td>Tierra Negra</td>
      <td>Latin Guitar Summer Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world-guitar" | relative_url }}">world guitar</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2017-06-26</td>
      <td>Calido</td>
      <td>Ibiza Chill Guitars: Baleaic Sounds del Mar</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world-guitar" | relative_url }}">world guitar</a></li>
    ...
    <tr>
      ...
      <td>2022-04-14</td>
      <td>Various Artists</td>
      <td>Spanish Heart, Latin Soul</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2024-11-03</td>
      <td>Kim Chung</td>
      <td>Giac mong vuon hoa (Sueno en la floresta)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world-guitar" | relative_url }}">world guitar</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rumba" | relative_url }}">rumba</a> # 98</li>
        </ul>
      </td>
    </tr>
    <tr>
