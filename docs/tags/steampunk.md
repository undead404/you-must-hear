...
Steampunk music blends Victorian-era aesthetics with modern electronic and rock elements, creating a theatrical sound that evokes industrial machinery, clockwork mechanisms, and 19th-century adventure. The style often features accordion, strings, and synthesizers alongside dramatic vocals that tell stories of airships, mad scientists, and alternate histories. It&#39;s the sonic equivalent of brass goggles and steam engines—nostalgic yet futuristic, whimsical yet dark.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Age of steam 13 (44 songs about the Moon)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>The Fine Arts Brass Ensemble</td>
      <td>Sherlock Holmes Meets Dr. Who</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Dr. Steel</td>
      <td>Dr. Steel II: Eclectic Boogaloo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
    ...
    <tr>
      ...
      <td>2001-06</td>
      <td>Ben Houge</td>
      <td>Arcanum: Of Steamworks &amp; Magick Obscura</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Chris Vrenna</td>
      <td>American McGee&#39;s Alice OST</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003-09-15</td>
      <td>The Dubliners</td>
      <td>The Dubliners with Luke Kelly</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/musique-concrete" | relative_url }}">musique concrete</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2007</td>
      <td>Life Toward Twilight</td>
      <td>I Swear By All The Flowers</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
    ...
    <tr>
      ...
      <td>2007-12</td>
      <td>Unextraordinary Gentlemen</td>
      <td>5 Tales From God-Only-Knows</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Deadly Nightshade Botanical Society</td>
      <td>Clockwork Dreams</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
        </ul>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/1ff7f507e5e31a1818a468722dcdc740.png" alt="Cover for Lost Horizons" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-03-01</td>
      <td>Abney Park</td>
      <td>Lost Horizons</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/orchestra" | relative_url }}">orchestra</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2009-10-30</td>
      <td>Steam Powered Giraffe</td>
      <td>Album One</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Now That&#39;s What I Call Steampunk! Volume 1</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2010-10-01</td>
      <td>Vernian Process</td>
      <td>Behold the Machine (demos) 2008</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Marquis of Vaudeville</td>
      <td>The Great Promenade of Fools &amp; Ghosts</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/waltz" | relative_url }}">waltz</a> # 93</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2011-12-09</td>
      <td>Steam Powered Giraffe</td>
      <td>Live At The Globe of Yesterday&#39;s Tomorrow</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>2012-03-12</td>
      <td>The Men That Will Not Be Blamed For Nothing</td>
      <td>This May Be The Reason Why The Men That Will Not Be Blamed For Nothing Cannot Be Killed By Conventional Weapons</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
    ...
    <tr>
      ...
      <td>Once Upon A Time (In Space)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
    ...
    <tr>
      ...
      <td>2012-10-15</td>
      <td>Jill Tracy</td>
      <td>Silver Smoke, Star of Night (In the Shadow of Christmas)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2013</td>
      <td>Abney Park</td>
      <td>Ranch Hand Robbie and the Wasteland Wranglers - Off The Grid</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a> # 79</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2014-10-08</td>
      <td>Steam Powered Giraffe</td>
      <td>Live at Walter Robotics Expo 2013</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a> # 39</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Ooky Spooky (2021 Stereo Mix)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cabaret" | relative_url }}">cabaret</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-cabaret" | relative_url }}">dark cabaret</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>China Steamengine</td>
      <td>Uusi Aikakausi</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/steampunk" | relative_url }}">steampunk</a></li>
