...
Hebrew music encompasses songs performed in the Hebrew language, spanning traditional Jewish liturgical chants, modern Israeli pop, and contemporary fusion styles. The tag reflects diverse cultural expressions from religious devotional music to secular innovations that blend Middle Eastern instrumentation with electronic, rock, and folk elements. This category bridges ancient spiritual traditions with modern musical experimentation across the global Jewish diaspora and Israeli culture.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Rabbi Shlomo Carlebach Sings</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jewish" | relative_url }}">jewish</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
    ...
    <tr>
      ...
      <td>1977</td>
      <td>Roy D.S.</td>
      <td>Day Of Judgement-Yom Kippur War Song</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jewish" | relative_url }}">jewish</a></li>
    ...
    <tr>
      ...
      <td>1985</td>
      <td>Ilan Virtzberg</td>
      <td>משני צדי הכדור - Both Sides Of The Spere (1985)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/israel" | relative_url }}">israel</a></li>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>2 Live Jews</td>
      <td>As Kosher As They Wanna Be</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jewish" | relative_url }}">jewish</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Various Artists</td>
      <td>23 Most Famous Israeli Folk Songs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/jewish" | relative_url }}">jewish</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>כנסיית השכל</td>
      <td>Knesiyat hasechel (The Mind Church)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2022-12-09</td>
      <td>Infected Mushroom</td>
      <td>La Trib Ani Utruch (Infected Mushroom Remix)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td></td>
      <td>The Hoodska Explosive</td>
      <td>The Misleading</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dance" | relative_url }}">dance</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
