...
Last updated: <time datetime="2025-12-06T04:12:46.096Z">Sat Dec 06 2025 06:12:46 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 65.38461538461539 / 100)"> <a href="{{ "/tags/progressive-pop" | relative_url }}">progressive pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>99</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/b3a49efa7d2a4d139feea254444f8151.png" alt="Cover for Tweedles!" style="max-width:120px; height:auto;" />
      </td>
      <td>1986</td>
      <td>The Residents</td>
      <td>Tweedles!</td>
    ...
    <tr>
      <td>96</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/d34c7ac9fd23bb217482419de4dd49e3.png" alt="Cover for サイエンスの幽霊" style="max-width:120px; height:auto;" />
      </td>
      <td>1990-05-25</td>
      <td>平沢進</td>
      <td>サイエンスの幽霊</td>
    ...
    <tr>
      <td>51</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/c467f7aa83f4be3c08ed057acdff57d8.png" alt="Cover for Intruders" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
      <td>The Residents</td>
      <td>Intruders</td>
    ...
    <tr>
      <td>97</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/491f52d46f5b453db397d035544fe903.png" alt="Cover for Captain Easychord" style="max-width:120px; height:auto;" />
      </td>
      <td>2001-07</td>
      <td>Stereolab</td>
      <td>Captain Easychord</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-pop" | relative_url }}">progressive pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/avantgarde-pop" | relative_url }}">avantgarde pop</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/michigan" | relative_url }}">michigan</a> # 12</li>
            <li> <a href="{{ "/tags/indie-pop" | relative_url }}">indie pop</a> # 75</li>
            <li> <a href="{{ "/tags/indie-rock" | relative_url }}">indie rock</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>94</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/67b088db863f4b248286476a195bd684.png" alt="Cover for The Girl with the Dragon Tattoo" style="max-width:120px; height:auto;" />
      </td>
      <td>2009</td>
      <td>Karen O</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/asia" | relative_url }}">asia</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2013-04-30</td>
      <td>Pretty &amp; Nice</td>
      <td>Golden Rules for Golden People</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-pop" | relative_url }}">progressive pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/asian-rock" | relative_url }}">asian rock</a> # 38</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/comedy-rock" | relative_url }}">comedy rock</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chamber-jazz" | relative_url }}">chamber jazz</a> # 30</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/avantgarde-pop" | relative_url }}">avantgarde pop</a> # 73</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-cabaret" | relative_url }}">dark cabaret</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkish-rock" | relative_url }}">turkish rock</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
