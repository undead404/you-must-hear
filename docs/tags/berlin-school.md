  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/progressive-electronic" | relative_url }}">progressive electronic</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Free System Projekt</td>
      <td>Pointless Reminder</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Jim Kirkwood</td>
      <td>They Walk Amongst the Stars like Giants</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
    ...
    <tr>
      ...
      <td>FRKWYS Vol. 7: Borden, Ferraro, Godin, Halo &amp; Lopatin</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Jim Kirkwood</td>
      <td>In the Deep Places of the World</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-electronic" | relative_url }}">ambient electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Jim Kirkwood</td>
      <td>Voices from the Edge of Night</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
    ...
    <tr>
      ...
      <td>2009-10</td>
      <td>Jim Kirkwood</td>
      <td>Morningstar-Part2 The World Behind the Mirror</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-electronic" | relative_url }}">ambient electronic</a></li>
    ...
    <tr>
      ...
      <td>2011-12-31</td>
      <td>WMRI</td>
      <td>Currents Across the Time</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Jim Kirkwood</td>
      <td>Rituals of Intelligent Design</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-electronic" | relative_url }}">ambient electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
    ...
    <tr>
      ...
      <td>2015-11-13</td>
      <td>Kurt Stenzel</td>
      <td>Jodorowsky&#39;s Dune (Original Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/krautrock" | relative_url }}">krautrock</a></li>
    ...
    <tr>
      ...
      <td>2024-08</td>
      <td>Suzanne Ciani</td>
      <td>Buchla Concert At Galeria Bonino New York April 1974</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/berlin-school" | relative_url }}">berlin school</a></li>
