...
Solo piano features a single pianist performing without accompaniment, creating intimate and expressive soundscapes that range from classical compositions to contemporary new age and ambient works. The stripped-down format highlights the instrument&#39;s full dynamic range and emotional depth, offering listeners a direct connection to the performer&#39;s artistry. This tag encompasses both virtuosic performances and minimalist meditative pieces across multiple genres and eras.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1979</td>
      <td>McCoy Tyner</td>
      <td>Warsaw Concert 1991</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/jazz-piano" | relative_url }}">jazz piano</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>David Nevue</td>
      <td>In the Soft Light of Grace</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/new-age" | relative_url }}">new age</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Tim Callicrate</td>
      <td>Serenade From Tahoe II</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Meditations of the Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Gershwin Plays Gershwin - The Piano Rolls</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Liz Story</td>
      <td>Welcome Home: The Best Of Liz Story</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/new-age" | relative_url }}">new age</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Edvard Grieg</td>
      <td>Peer Gynt Suites 1 &amp; 2, Lyric Suite etc.</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2002-09-09</td>
      <td>George Winston</td>
      <td>Night Divides the Day: The Music of the Doors</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Dr. John</td>
      <td>All by Hisself: Live at the Lonestar</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2004-12-04</td>
      <td>Piano Love Songs</td>
      <td>Piano Love Songs: Classic Easy Listening Instrumental Piano Music</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>Home To Oblivion: An Elliott Smith Tribute</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Thoughts and Dreams: Solo Piano</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>2007-11-05</td>
      <td>Ludovico Einaudi</td>
      <td>Ludovico Einaudi: Divenire</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Lebensessenz</td>
      <td>Tu, deorum hominumque tyranne, Amor</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>David Nevue</td>
      <td>Revelation: Solo Piano for Prayer &amp; Worship</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/meditation" | relative_url }}">meditation</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a></li>
    ...
    <tr>
      ...
      <td>2011-02-08</td>
      <td>Christopher Ferreira</td>
      <td>The Piano Pieces</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>2011-12-09</td>
      <td>Yiruma</td>
      <td>The Best - Reminiscent 10th Anniversary</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/solo-piano" | relative_url }}">solo piano</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Atlas - Roberto Cacciapaglia Collection</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2020</td>
      <td>Louis Landon</td>
      <td>Classic Pop Rock Solo Piano</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Jon Dahlander</td>
      <td>Piano Landscapes: Solo Piano, Vol. 2</td>
      <td>
        <ul>
        </ul>
      </td>
