...
Last updated: <time datetime="2025-12-06T05:38:16.639Z">Sat Dec 06 2025 07:38:16 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/brooklyn" | relative_url }}">brooklyn</a> # 50</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/underground-rap" | relative_url }}">underground rap</a> # 41</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/underground-rap" | relative_url }}">underground rap</a> # 84</li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>East Coast Avengers</td>
      <td>See The Bars EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-rap" | relative_url }}">hardcore rap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/alternative-hip-hop" | relative_url }}">alternative hip hop</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/alternative-rap" | relative_url }}">alternative rap</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/rap" | relative_url }}">rap</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/rap-metal" | relative_url }}">rap metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/east-coast" | relative_url }}">east coast</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/swedish-black-metal" | relative_url }}">swedish black metal</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/italian" | relative_url }}">italian</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Рем Дигга и Black Market</td>
      <td>Убитые параграфы</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-rap" | relative_url }}">hardcore rap</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/underground-hip-hop" | relative_url }}">underground hip-hop</a></li>
