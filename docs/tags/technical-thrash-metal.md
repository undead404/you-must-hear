...
Last updated: <time datetime="2025-12-06T06:45:55.166Z">Sat Dec 06 2025 08:45:55 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1989</td>
      <td>Deathrow</td>
      <td>Deception Ignored (2018 Remaster)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/metal" | relative_url }}">metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/technical-thrash-metal" | relative_url }}">technical thrash metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007-06-11</td>
      <td>Negligence</td>
      <td>Options Of A Trapped Mind</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/technical-thrash-metal" | relative_url }}">technical thrash metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012-09-25</td>
      <td>Revocation</td>
      <td>Scion Av Presents: Revocation &quot;Teratogensis&quot;</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/technical-thrash-metal" | relative_url }}">technical thrash metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-thrash-metal" | relative_url }}">progressive thrash metal</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/technical-death-metal" | relative_url }}">technical death metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2016-08-08</td>
      <td>Cryptic Shift</td>
      <td>Beyond The Celestial Realms</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/technical-thrash-metal" | relative_url }}">technical thrash metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
    ...
    <tr>
      ...
      <td>2016-11-10</td>
      <td>Xoth</td>
      <td>Invasion of the Tentacube</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/technical-death-metal" | relative_url }}">technical death metal</a></li>
        </ul>
    ...
    <tr>
      <td>74</td>
      <td>
          <img src="https://i.discogs.com/vzxRcYbcxErcF1dJ9JgGp7XOZpb3XIm5gxnyEJjncDg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzNTcy/OTU1LTE2NTc0MTQ4/MDUtNjgwMy5qcGVn.jpeg" alt="Cover for Τρωθησομένη" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-12-07</td>
      <td>Ὁπλίτης</td>
      <td>Τρωθησομένη</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/death-thrash-metal" | relative_url }}">death-thrash metal</a> # 45</li>
        </ul>
      </td>
    </tr>
    <tr>
