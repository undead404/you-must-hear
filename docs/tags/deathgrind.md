...
Deathgrind is an extreme metal fusion combining death metal&#39;s heavy brutality with grindcore&#39;s chaotic speed and intensity. Characterized by blast beats, guttural vocals, and brief explosive songs, it emerged in the late 1980s underground scene. The genre pushes sonic extremity to its limits through relentless aggression and technical precision.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1999-05</td>
      <td>Aborted</td>
      <td>The Purity Of Perversion</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
    ...
    <tr>
      <td>8</td>
      <td>
          <img src="https://i.discogs.com/5dlK-8dp5tZie4sk53ya4aH2_ss7VqXds9cK6xDBOUM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTY4MjAx/OS0xMzQzNDEwODg2/LTQxNjYuanBlZw.jpeg" alt="Cover for We Came For the Dead!!!" style="max-width:120px; height:auto;" />
      </td>
      <td>2002</td>
      <td>Ghoul</td>
      <td>We Came For the Dead!!!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>2002-01-21</td>
      <td>Lock Up</td>
      <td>Hate Breeds Suffering</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>77</td>
      <td>
          <img src="https://i.discogs.com/ezU0DdeYGTgkDLv61xyPL21QRqYSy_0EYklux57JC1c/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEwMzE4/NTctMTU4ODQ3MDk5/Ni00NDEyLmpwZWc.jpeg" alt="Cover for Fused Together in Revolving Doors" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-03-19</td>
      <td>The Red Chord</td>
      <td>Fused Together in Revolving Doors</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
    ...
    <tr>
      ...
      <td>2004-08</td>
      <td>Bodies In the Gears of the Apparatus</td>
      <td>Simian Hybrid Prototype</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Sublime Cadaveric Decomposition</td>
      <td>Inventory of Fixtures</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>Omega Drunk on the Blood of Alpha</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
    ...
    <tr>
      <td>54</td>
      <td>
          <img src="https://i.discogs.com/vcQ1lfgQJZ50JF7wr6IF3Ju2b5o6x-_TqGoc_MyXLKg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1MzMy/NzAtMTM4MzIzMjYy/Ni05MjY3LmpwZWc.jpeg" alt="Cover for Traitors" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-09-24</td>
      <td>Misery Index</td>
      <td>Traitors</td>
    ...
    <tr>
      ...
      <td>Corpus In Extremis: Analysing Necrocriticism</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-11-26</td>
      <td>Milking the Goatmachine</td>
      <td>Seven..A Dinner For One</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
    ...
    <tr>
      ...
      <td>2011-07-01</td>
      <td>Lock Up</td>
      <td>Necropolis Transparent</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2011-11-07</td>
      <td>Slaughterbox</td>
      <td>The Ubiquity of Subjugation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/technical-death-metal" | relative_url }}">technical death metal</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
    ...
    <tr>
      <td>35</td>
      <td>
          <img src="https://i.discogs.com/0TVzpBtEuMWkTlS66Diy1ecHAj2kKpTrm8BkHIPL4Fw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTczMTE1/MDktMTQ1MzIzNjQz/MS0yMjUwLmpwZWc.jpeg" alt="Cover for Suicide Euphoria" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-08-04</td>
      <td>Pissgrave</td>
      <td>Suicide Euphoria</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://i.discogs.com/qmy-EiPwr6PN3hq-IRWcifOLJiKZEE-bSf-dgIiqnr4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTcxNzAy/NTQtMTYwMTUwODk5/MS00MjM5LmpwZWc.jpeg" alt="Cover for The Anthropocene Extinction" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-08-07</td>
      <td>Cattle Decapitation</td>
    ...
    <tr>
      ...
      <td>2016</td>
      <td>Vulvodynia</td>
      <td>Finis Omnium Ignorantiam</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
    ...
    <tr>
      <td>48</td>
      <td>
          <img src="https://i.discogs.com/DHKuRjZOSsHbuO0h87spvIDJnOip8zGczJLKLnlTybA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTkxOTAy/MDAtMTQ3NjM2NDY4/Ny03OTQ0LmpwZWc.jpeg" alt="Cover for Decline" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-10-28</td>
      <td>Vermin Womb</td>
      <td>Decline</td>
    ...
    <tr>
      <td>13</td>
      <td>
          <img src="https://i.discogs.com/Ap3PAFC-If1UmMEiqJ_fcAMmfPyIbN7UjUw_uBaOmsU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM4MzE1/NC0xMTA2MTUyMzY2/LmpwZw.jpeg" alt="Cover for Anatomy Is Destiny &#x2F; Live In Japan" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-01-22</td>
      <td>Exhumed</td>
      <td>Anatomy Is Destiny &#x2F; Live In Japan</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
    ...
    <tr>
      <td>63</td>
      <td>
          <img src="https://i.discogs.com/qJJ1M-WsO58wOOKqDT0C5WOcRd1WBQA867TY_rAaVy0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyMzUy/MjE1LTE2ODE1ODE0/NzAtOTY2OC5qcGVn.jpeg" alt="Cover for Gore 2.0" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-07-08</td>
    ...
    <tr>
      ...
      <td>2019-06-14</td>
      <td>Serpent Of Gnosis</td>
      <td>As I Drink From The Infinite Well Of Inebriation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/grindcore" | relative_url }}">grindcore</a></li>
    ...
    <tr>
      ...
      <td>2021-02-19</td>
      <td>Gravesend</td>
      <td>Methods Of Human Disposal</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathgrind" | relative_url }}">deathgrind</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>10 TO THE CHEST</td>
      <td>SPLIT THE FUCK OPEN</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/brutal-death-metal" | relative_url }}">brutal death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
