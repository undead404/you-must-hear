...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The Best of George Gershwin</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Various Artists</td>
      <td>Grey Gardens - The Musical</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Various Artists</td>
      <td>Only Heaven: A Musical Work by Ricky Ian Gordon (World Premiere Recording)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>Joseph and the Amazing Technicolor Dreamcoat (1991 London Revival Cast)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>John Adams</td>
      <td>Adams: I Was Looking at the Ceiling and Then I Saw the Sky</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>1998-11-10</td>
      <td>Original Broadway Cast</td>
      <td>25th Annual Putnam County Spelling Bee</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Various Artists</td>
      <td>We Will Rock You: Cast Album</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Various Artists</td>
      <td>This Ordinary Thursday: The Songs of Georgia Stitt</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-05-10</td>
      <td>Stephen Sondheim</td>
      <td>Sondheim Sings: Volume I (1962-1972)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>2005-05-10</td>
      <td>Stephen Sondheim</td>
      <td>Sondheim Sings, Vol. 1: 1962-1972</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2005-07-26</td>
      <td>Billy Porter</td>
      <td>At the Corner of Broadway + Soul</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>2005-10</td>
      <td>John Adams</td>
      <td>I WAS LOOKING AT THE CEILING AND THEN I SAW THE SKY</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Various Artists</td>
      <td>My Life With Albertine (World Premiere Recording)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>2008-09-30</td>
      <td>Stephen Sondheim</td>
      <td>The Frogs &#x2F; Evening Primrose</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Fred Hersch</td>
      <td>Fred Hersch Plays Rodgers &amp; Hammerstein</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>2010-12-01</td>
      <td>Various Artists</td>
      <td>Fine and Dandy (World Premiere Recording)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>2016-01-06</td>
      <td>Stephen Sondheim</td>
      <td>The Frogs &amp; Evening Primrose (Studio Cast)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>2017-03-03</td>
      <td>Various Artists</td>
      <td>Assassins: The Broadway Cast Recording</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2019-06-07</td>
      <td>Original Broadway Cast Of Aint Too Proud</td>
      <td>Ain&#39;t Too Proud: The Life And Times Of The Temptations (Original Broadway Cast Recording)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
    ...
    <tr>
      ...
      <td>Say My Name! (The Unauthorised &#39;Breaking Bad&#39; Parody Musical) [Original Cast Recording]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Various Artists</td>
      <td>The Songs of West Side Story</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>2023-11-09</td>
      <td>Reneé Rapp</td>
      <td>Mean Girls (Music From The Motion Picture)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Hannibal The Musical: Act 1</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Original Off-Broadway Cast of Zombie Prom</td>
      <td>Zombie Prom (Original Off-Broadway Cast)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
