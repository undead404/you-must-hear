...
Sludge music is a heavy and aggressive style of music that originated in the late 1980s and early 1990s in the United States. It is often characterized by its slow and heavily distorted sound, with a focus on heavy, crushing riffs, aggressive vocals, and a raw, unpolished production style. Sludge music is often associated with the Southern United States, particularly Louisiana, and takes influences from various genres such as doom metal, hardcore punk, and noise rock. Some of the most notable sludge bands include Eyehategod, Crowbar, and Acid Bath.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Eyehategod</td>
      <td>In The Name Of Suffering</td>
      <td>
        <ul>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 61</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stoner-rock" | relative_url }}">stoner rock</a> # 20</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a> # 6</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a> # 92</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2000-09-19</td>
      <td>Eyehategod</td>
      <td>Confederacy Of Ruined Lives</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>34</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/be30266c9604238b1ae69c0e688a721f.png" alt="Cover for SGNL&gt;05" style="max-width:120px; height:auto;" />
      </td>
      <td>2001-03-06</td>
      <td>Isis</td>
      <td>SGNL&gt;05</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Eyehategod</td>
      <td>In The Name Of The Suffering</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005-02-08</td>
      <td>Crowbar</td>
      <td>Lifesblood for the Downtrodden</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>37</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/0f8b5a8d81634c7687b9fe2abe2d1f0e.png" alt="Cover for Hippie Killer" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-06-20</td>
      <td>Bongripper</td>
      <td>Hippie Killer</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a> # 7</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Behind the Blackest Tears</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-11-26</td>
      <td>Blindead</td>
      <td>Affliction XXIX II MXMVI</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-04-20</td>
      <td>Belzebong</td>
      <td>Sonic Scapes &amp; Weedy Grooves</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013-08-08</td>
      <td>Rosetta</td>
      <td>The Anaesthete</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 68 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5b3994a0bcb791f7a1623212fcb3823b.png" alt="Cover for Paradise Gallows" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-07-08</td>
      <td>Inter Arma</td>
      <td>Paradise Gallows</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
    ...
    <tr>
      <td>98</td>
      <td>
          <img src="https://i.discogs.com/N_T5ctodO0Gdj6WUhNbuFcEr_hQpGiB0d5br3ax6TCA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzNzQ0/NTgyLTE2NTY2MTk4/ODUtOTcwMC5qcGVn.jpeg" alt="Cover for Páthos" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-07-01</td>
      <td>conjurer</td>
      <td>Páthos</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 1</li>
        </ul>
      </td>
    </tr>
  </tbody>
