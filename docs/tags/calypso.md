...
Calypso is a rhythmic Caribbean music style originating in Trinidad and Tobago, characterized by syncopated beats, call-and-response vocals, and witty, often satirical lyrics commenting on social and political issues. The sound features steel drums, percussion, and melodic guitar patterns that create an infectious, danceable groove rooted in African and Caribbean traditions. Its playful yet pointed storytelling tradition has influenced numerous tropical and world music styles while maintaining its distinctive island flavor.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Calypsos From Trinidad - 1930s</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1953</td>
      <td>The Percentie Brothers</td>
      <td>Putumayo Presents: Calypso</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1959-10</td>
      <td>Harry Belafonte</td>
      <td>Belafonte at Carnegie Hall</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
    ...
    <tr>
      ...
      <td>1961</td>
      <td>Harry Belafonte</td>
      <td>Jump Up Calypso + The Midnight Special</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1963</td>
      <td>Macbeth the Great</td>
      <td>Calypso At Midnight, 1946 - Alan Lomax Collection</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1965</td>
      <td>Lord Kitchener</td>
      <td>Legacy of a Calypsonian 1967-1971</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1972</td>
      <td>Various Artists</td>
      <td>Calypso Carnival (1935 - 1939)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Bakra Bata</td>
      <td>Steel Drums, Percussion and Flute</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Jamaican Steel Band</td>
      <td>Steel Drums Of Trinidad</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Love Is All I Had: A Tribute to the Queen of Jamaica</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-10-04</td>
      <td>Harry Belafonte</td>
      <td>The Essential Harry Belafonte</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-10-05</td>
      <td>Mighty Sparrow</td>
      <td>First Flight: Early Calypsos from the Emory Cook Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2013</td>
      <td>Banda Calypso</td>
      <td>O melhor da Banda Calypso</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
    ...
    <tr>
      ...
      <td>2016-11</td>
      <td>Roaring Lion</td>
      <td>Calypso Island Greats Of The 1930s</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2019</td>
      <td>Joelma</td>
      <td>Ep 1: Ao Vivo em Ipojuca - PE</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>The Abtomatic Meisterzinger Mambo Chic</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Various Artists</td>
      <td>netBloc Vol. 2: DRM killed the music-product machine</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/calypso" | relative_url }}">calypso</a></li>
