...
Deep ambient music is a genre of ambient music that is typically characterized by its minimalistic and immersive qualities, with an emphasis on creating a deep and meditative atmosphere. The music often features a slow tempo, sparse textures, and long, sustained notes, which combine to create a hypnotic and contemplative listening experience. The use of various electronic and acoustic instruments, including synthesizers, drones, and field recordings, is also common in deep ambient music, as is the use of effects such as reverb and delay to create an expansive and spacious sound. The genre is often associated with new age and meditation practices, and is intended to provide a sonic space for listeners to explore their inner thoughts and emotions.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Mundanes</td>
      <td>kids: dying in this endless oil war is totally &quot;da bomb&quot;!!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chillout" | relative_url }}">chillout</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Various Artists</td>
      <td>Intelligent Toys 4 (Sutemos019)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1998-05</td>
      <td>Oöphoi</td>
      <td>Aquos - The Complete Drones</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sacred" | relative_url }}">sacred</a> # 23</li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>I.corax</td>
      <td>from gOLDem flesh to silverb ONE</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Sostrah Tinnitus</td>
      <td>L&#39;odore del ramo spezzato</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deep-ambient" | relative_url }}">deep ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-11</td>
      <td>Hammock</td>
      <td>The Sleepover Series, Vol. 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2005-12</td>
      <td>Alio Die &amp; Festina Lente</td>
      <td>Il sogno di un piano veneziano a Parigi</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>2006-05-11</td>
      <td>Cerebral Sound Propagation</td>
      <td>Advanced Sleeping Techniques 101</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>Echoes from an Engulfed Cathedral</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deep-ambient" | relative_url }}">deep ambient</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fantasy-ambient" | relative_url }}">fantasy ambient</a> # 35</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/lattice" | relative_url }}">lattice</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010-12-28</td>
      <td>Le Berger</td>
      <td>Expeditions on the Grayscale (one tiny, two medium and a grand one)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>South American Beauty Culture</td>
      <td>South American Beauty Culture</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/space-ambient" | relative_url }}">space ambient</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/deep-ambient" | relative_url }}">deep ambient</a></li>
    ...
    <tr>
      ...
      <td>2013-04-20</td>
      <td>Oöphoi &amp; Ran Kirlian</td>
      <td>The Physics of Heaven</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deep-ambient" | relative_url }}">deep ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-instrumental" | relative_url }}">contemporary instrumental</a> # 76</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-electronic" | relative_url }}">ambient electronic</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2023-05-05</td>
      <td>AgonyOST</td>
      <td>Des Larmes Et Des Saints</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deep-ambient" | relative_url }}">deep ambient</a></li>
    ...
    <tr>
      ...
      <td>2023-12-01</td>
      <td>ASC</td>
      <td>Trans-Neptunian Objects 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Sylvie Walder and Phillip Wilkerson</td>
      <td>Transience</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/space-ambient" | relative_url }}">space ambient</a></li>
            <li style="font-size: calc(1rem * 65 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
        </ul>
      </td>
      <td>
