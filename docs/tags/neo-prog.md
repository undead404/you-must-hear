...
Neo-prog revitalizes 1970s progressive rock&#39;s ambitious song structures and conceptual storytelling through a modern lens, emerging in the 1980s as both homage and evolution. The sound balances theatrical drama with accessible melodies, featuring lush synthesizers, intricate instrumental passages, and emotionally charged vocals that reject punk&#39;s minimalism. It spans from polished arena-ready epics to experimental avant-garde explorations, united by a commitment to musical complexity and narrative depth.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1983-03-13</td>
      <td>Marillion</td>
      <td>Script For A Jester&#39;s Tear</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>Ataraxia</td>
      <td>Adolescence of an Ancient Warrior</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neo-prog" | relative_url }}">neo-prog</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
    ...
    <tr>
      ...
      <td>1991</td>
      <td>Edith</td>
      <td>A Space Between Ever And Never</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1992</td>
      <td>Grace</td>
      <td>The Poet, The Piper and the Fool</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1994-03-28</td>
      <td>Primitive Instinct</td>
      <td>Floating Tangibility</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neo-prog" | relative_url }}">neo-prog</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Fifth Season</td>
      <td>Journey Through An Open Mind</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neo-prog" | relative_url }}">neo-prog</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a></li>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>KingBathmat</td>
      <td>Fantastic Freak Show Carnival</td>
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/space-rock" | relative_url }}">space rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2005-05-30</td>
      <td>Miocene</td>
      <td>A Perfect Life With a View of the Swamp</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Ten Silver Drops</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/neo-prog" | relative_url }}">neo-prog</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>A Beautiful Lie [Instrumentals]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
    ...
    <tr>
      ...
      <td>2008-09-10</td>
      <td>Marillion</td>
      <td>Happiness is the Road, Volume 1: Essence</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Stellar Vector</td>
      <td>A Flock of Cowards</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rock" | relative_url }}">alternative rock</a></li>
    ...
    <tr>
      ...
      <td>2014-10-04</td>
      <td>Encircled</td>
      <td>The Gun Has Replaced The Handshake</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neo-prog" | relative_url }}">neo-prog</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/england" | relative_url }}">england</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/funk-rock" | relative_url }}">funk rock</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/jazz-rock" | relative_url }}">jazz rock</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/neo-prog" | relative_url }}">neo-prog</a></li>
        </ul>
      </td>
      <td>
