...
Last updated: <time datetime="2025-12-04T14:34:23.409Z">Thu Dec 04 2025 16:34:23 GMT+0200 (Eastern European Standard Time)</time>

### Description

Harsh noise is an experimental music genre characterized by extreme distortion, feedback, and abrasive sound textures that reject traditional melody and rhythm. Emerging from industrial and avant-garde scenes, it challenges conventional listening by using raw sonic chaos as artistic expression. The genre prioritizes intense, confrontational soundscapes created through manipulated electronics and amplification.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/japanoise" | relative_url }}">japanoise</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/japanoise" | relative_url }}">japanoise</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/japanoise" | relative_url }}">japanoise</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/japanoise" | relative_url }}">japanoise</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rhythmic-noise" | relative_url }}">rhythmic noise</a> # 35</li>
    ...
    <tr>
      ...
      <td>2002-11-25</td>
      <td>Masami Akita &amp; Russell Haswell</td>
      <td>Satanstornade</td>
      <td>
        <ul>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/duo" | relative_url }}">duo</a> # 58</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Terrestrial Tones</td>
      <td>Oboroed &#x2F; Circus Lives</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harsh-noise" | relative_url }}">harsh noise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Twodeadsluts Onegoodfuck</td>
      <td>twodeadsluts onegoodfuck</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harsh-noise" | relative_url }}">harsh noise</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/tribal" | relative_url }}">tribal</a> # 96</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-noise" | relative_url }}">experimental noise</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2009-01-27</td>
      <td>Merzbow</td>
      <td>Suzume: 13 Japanese Birds Pt. 1</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harsh-noise" | relative_url }}">harsh noise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/noise-punk" | relative_url }}">noise punk</a> # 16</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Suicide Notes For Acoustic Guitar</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harsh-noise" | relative_url }}">harsh noise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-05</td>
      <td>Column of Heaven</td>
      <td>Ecstatically Embracing All That We Habitually Suppress</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harsh-noise" | relative_url }}">harsh noise</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noise" | relative_url }}">noise</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-noise" | relative_url }}">ambient noise</a> # 16</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gorenoise" | relative_url }}">gorenoise</a> # 83</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2018-03-07</td>
      <td>Pseudocommando</td>
      <td>A Home Beneath The Floorboards</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/harsh-noise" | relative_url }}">harsh noise</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
