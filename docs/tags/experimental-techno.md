...
Experimental techno pushes electronic dance music beyond the club, deconstructing rigid four-on-the-floor rhythms with abstract textures, glitchy electronics, and unconventional song structures. Artists blur boundaries between ambient soundscapes, IDM, and industrial noise while maintaining techno&#39;s mechanical pulse. The result is cerebral yet physical music that challenges dancefloor expectations.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Mundanes</td>
      <td>Mishap Records! the world leader in specialized stupid shit!</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Bite The Sound That Feeds You</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakbeat" | relative_url }}">breakbeat</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-techno" | relative_url }}">experimental techno</a></li>
    ...
    <tr>
      ...
      <td>1994-11-25</td>
      <td>Willi</td>
      <td>Disturb light TaPeD in Reduced</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-techno" | relative_url }}">experimental techno</a></li>
    ...
    <tr>
      ...
      <td>2005-04-16</td>
      <td>Andrey Kiritchenko</td>
      <td>[mn002] scatter stars</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-techno" | relative_url }}">experimental techno</a></li>
    ...
    <tr>
      ...
      <td>2007-11-29</td>
      <td>miteigi nemoto</td>
      <td>Roboclub B1-66ER EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-techno" | relative_url }}">experimental techno</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-01-17</td>
      <td>Craque</td>
      <td>[gruen025] Density Operator</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-electronic" | relative_url }}">experimental electronic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-techno" | relative_url }}">experimental techno</a></li>
    ...
    <tr>
      ...
      <td>2008-03-19</td>
      <td>Orvonton</td>
      <td>ca112 - Orvonton - Remitente</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient-techno" | relative_url }}">ambient techno</a></li>
    ...
    <tr>
      ...
      <td>2009-08-24</td>
      <td>Neil Landstrumm</td>
      <td>Bambaataa Eats His Breakfast</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dubstep" | relative_url }}">dubstep</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/experimental-techno" | relative_url }}">experimental techno</a></li>
    ...
    <tr>
      ...
      <td>2011-04-11</td>
      <td>Upside Down Umbrella</td>
      <td>Fantastic &amp; Tangible</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2015-02-23</td>
      <td>Född Död</td>
      <td>Studie I Närhet, Längtan Och Besvikelse</td>
      <td>
        <ul>
        </ul>
      </td>
