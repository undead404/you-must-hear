...
Gypsy music blends Romani musical traditions with jazz, folk, and Eastern European influences, featuring passionate violin, accordion, and acoustic guitar. The genre emphasizes virtuosic improvisation, minor-key melodies, and driving rhythms that evoke both celebration and melancholy. Its sound ranges from Django Reinhardt&#39;s swing jazz to modern indie interpretations with punk energy.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Djangology (feat. Stéphane Grappelli)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gypsy" | relative_url }}">gypsy</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gypsy-jazz" | relative_url }}">gypsy jazz</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/klezmer" | relative_url }}">klezmer</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/musical" | relative_url }}">musical</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/klezmer" | relative_url }}">klezmer</a> # 51</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gypsy-jazz" | relative_url }}">gypsy jazz</a> # 13</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/brass" | relative_url }}">brass</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Ekrem &amp; Gypsy Groovz</td>
      <td>Rivers Of Happiness</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gypsy" | relative_url }}">gypsy</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Alexander Fedoriouk</td>
      <td>The Art of the Cimbalom</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gypsy" | relative_url }}">gypsy</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/klezmer" | relative_url }}">klezmer</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gypsy-jazz" | relative_url }}">gypsy jazz</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gypsy-jazz" | relative_url }}">gypsy jazz</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005-08-09</td>
      <td>Gogol Bordello</td>
      <td>Gypsy Punks: Underdog World Strike</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/romania" | relative_url }}">romania</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2009-10-16</td>
      <td>Mahala Raï Banda</td>
      <td>Gypsy Beats and Balkan Bangers</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gypsy" | relative_url }}">gypsy</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
    ...
    <tr>
      ...
      <td>2011-11-11</td>
      <td>Freak Fandango Orchestra</td>
      <td>Tales of a Dead Fish</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gypsy" | relative_url }}">gypsy</a></li>
        </ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Café Chill Lounge Club</td>
      <td>I Love Paris! Classic Gypsy Swing &amp; French Accordion Jazz</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/gypsy" | relative_url }}">gypsy</a></li>
        </ul>
