...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano" | relative_url }}">piano</a> # 93</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bristol" | relative_url }}">bristol</a> # 49</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a> # 29</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bristol" | relative_url }}">bristol</a> # 48</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bristol" | relative_url }}">bristol</a> # 6</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-york-city" | relative_url }}">new york city</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/north-carolina" | relative_url }}">north carolina</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/turkey" | relative_url }}">turkey</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/christian-rap" | relative_url }}">christian rap</a> # 69</li>
        </ul>
      </td>
    </tr>
    <tr>
