...
National Socialist music refers to music that promotes or expresses the ideals, beliefs, and principles of National Socialism, a far-right political ideology associated with Nazi Germany. This type of music is often characterized by its explicit racism, antisemitism, and glorification of fascist or Nazi ideology. It has been associated with various sub-genres of music, including neo-Nazi punk, neo-Nazi metal, and neo-folk. It is widely condemned and considered to be hate music, and many countries have taken measures to ban or restrict its dissemination.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hungary" | relative_url }}">hungary</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/britain" | relative_url }}">britain</a> # 69</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2001-10</td>
      <td>Der Stürmer</td>
      <td>The Blood Calls for W.A.R.!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rechtsrock" | relative_url }}">rechtsrock</a> # 91</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2002</td>
      <td>Landser</td>
      <td>Endlösung - The Early Years</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deutschland" | relative_url }}">deutschland</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
    ...
    <tr>
      ...
      <td>2003-09</td>
      <td>Seigneur Voland</td>
      <td>Seigneur Voland - Final Stand</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/national-socialist" | relative_url }}">national socialist</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/russian-black-metal" | relative_url }}">russian black metal</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/britain" | relative_url }}">britain</a> # 56</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hatecore" | relative_url }}">hatecore</a> # 40</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hatecore" | relative_url }}">hatecore</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/french-black-metal" | relative_url }}">french black metal</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>ХОРСС</td>
      <td>Ненависть прошлого. Гнев настоящего. Правосудие будущего</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hatecore" | relative_url }}">hatecore</a></li>
    ...
    <tr>
      ...
      <td>2014-01-18</td>
      <td>Intolerant</td>
      <td>Snow Stained with the Blood of Traitors</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/national-socialist" | relative_url }}">national socialist</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rechtsrock" | relative_url }}">rechtsrock</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/black-death-metal" | relative_url }}">black death metal</a> # 93</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2016-07-01</td>
      <td>Phosphore Blanc</td>
      <td>M​.​W​.​O. (Modern World Obliterator)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-death-metal" | relative_url }}">black death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/epic-black-metal" | relative_url }}">epic black metal</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rechtsrock" | relative_url }}">rechtsrock</a> # 53</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rechtsrock" | relative_url }}">rechtsrock</a> # 52</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2018-03-31</td>
      <td>The Wampyric Specter</td>
      <td>A Dark Quest Ιn Τhe Name Οf Death</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2020-07-22</td>
      <td>Blood Libel</td>
      <td>Museums of Gas and Mirrors</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/national-socialist" | relative_url }}">national socialist</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
