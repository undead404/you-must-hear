...
Last updated: <time datetime="2025-11-23T10:32:12.448Z">Sun Nov 23 2025 12:32:12 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 68</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 39</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 14</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-rock" | relative_url }}">post-rock</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 60</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/avant-garde-metal" | relative_url }}">avant-garde metal</a> # 59</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
            <li style="font-size: calc(1rem * 82 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 12</li>
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 96</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/post-rock" | relative_url }}">post-rock</a> # 73</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/crust" | relative_url }}">crust</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>33</td>
      <td>
          <img src="https://i.discogs.com/zmzjEHj-WrRvNX09udqctcwJyVbbAdmpXe0DMQwJy5E/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE3OTAw/MTYtMTI1MjUzNDY3/Ni5qcGVn.jpeg" alt="Cover for Ephemeral" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-06-06</td>
      <td>Pelican</td>
      <td>Ephemeral</td>
    ...
    <tr>
      <td>43</td>
      <td>
          <img src="https://i.discogs.com/faYt0vl9OOeRDp15ml5Qt8gKUmnv-PxuuR-GS0NJP94/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE4NzYz/MzktMTI0OTQ5ODQz/NS5qcGVn.jpeg" alt="Cover for Infinity" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-07</td>
      <td>Jesu</td>
      <td>Infinity</td>
    ...
    <tr>
      <td>49</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/38c816a5926642b89f7d8735238be9aa.png" alt="Cover for Geneva" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-10-20</td>
      <td>Russian Circles</td>
      <td>Geneva</td>
    ...
    <tr>
      <td>67</td>
      <td>
          <img src="https://i.discogs.com/LSLC_pywRfs2nvt_W3zCFlpEgLu0QmzcTme69ILo2f8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTU4Mzg3/NTItMTU3MTg0Mzg0/Mi00OTQ4LmpwZWc.jpeg" alt="Cover for Panopticon (Remastered)" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-01-22</td>
      <td>Isis</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-rock" | relative_url }}">post-rock</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/instrumental-rock" | relative_url }}">instrumental rock</a> # 40</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-rock" | relative_url }}">post-rock</a> # 41</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/shoegaze" | relative_url }}">shoegaze</a> # 3</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>83</td>
      <td>
          <img src="https://i.discogs.com/emcGPKOv3kDxBz7DhT2ys8_HO9sD5bRO_sB0lMpAtFA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTg4NTE3/NTgtMTQ3MDE4NTg2/My04NTI1LmpwZWc.jpeg" alt="Cover for Guidance" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-08-05</td>
      <td>Russian Circles</td>
      <td>Guidance</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/blackgaze" | relative_url }}">blackgaze</a> # 95</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>59</td>
      <td>
          <img src="https://i.discogs.com/dNDbO6p0mwdYPNNW6GhLE6iV3k4Qz1bisz4Uk41zfOQ/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MTQ5/NDUyLTE1NzAzNzU2/NDItMjA5OC5qcGVn.jpeg" alt="Cover for A Dawn to Fear" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-09-20</td>
      <td>Cult of Luna</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/shoegaze" | relative_url }}">shoegaze</a> # 16</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mathcore" | relative_url }}">mathcore</a> # 36</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/blackgaze" | relative_url }}">blackgaze</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
