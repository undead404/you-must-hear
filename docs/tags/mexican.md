...
Last updated: <time datetime="2025-12-05T12:35:21.135Z">Fri Dec 05 2025 14:35:21 GMT+0200 (Eastern European Standard Time)</time>

### Description

Mexican music encompasses diverse regional styles from Mexico including mariachi&#39;s brass and string orchestras, norteño&#39;s accordion-driven ballads, and contemporary rock en español. The genre reflects Mexico&#39;s rich cultural heritage, blending indigenous, Spanish, and modern influences with lyrics often addressing love, social issues, and national identity. From traditional folk to modern fusion, it features rhythmic complexity and passionate vocal delivery.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Cartagena! Curro Fuentes &amp; The Big Band Cumbia and Descarga Sound Of Colombia 1962 - 72 (Soundway Records)</td>
      <td>
        <ul>
    ...
    <tr>
      <td>5</td>
      <td>
          <img src="https://i.discogs.com/FlJuXH3WZGkB2uQ2sNv357jDMEMFaan0uvjx1-vZoM4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc2NjYy/NzctMTQ0NjI5NTg2/Ny0zNjgzLmpwZWc.jpeg" alt="Cover for Los Tres Caballeros" style="max-width:120px; height:auto;" />
      </td>
      <td>1967</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/male-singer-songwriter" | relative_url }}">male singer songwriter</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/orchestra" | relative_url }}">orchestra</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Oneness: Silver Dreams - Golden Reality</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-rock" | relative_url }}">latin rock</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/espanol" | relative_url }}">espanol</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/rock-en-espanol" | relative_url }}">rock en espanol</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/latin-rock" | relative_url }}">latin rock</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1995</td>
      <td>Selena</td>
      <td>Como Te Quiero Yo A Ti (Regional Mexican Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
        </ul>
    ...
    <tr>
      <td>69</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/69c1005751d64323c39584a76dc4fe58.png" alt="Cover for Antes Que Ver El Sol" style="max-width:120px; height:auto;" />
      </td>
      <td>1995</td>
      <td>Dulce María</td>
      <td>Antes Que Ver El Sol</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
    ...
    <tr>
      ...
      <td>1996-05-07</td>
      <td>Maldita Vecindad Y Los Hijos Del Quinto Patio</td>
      <td>Baile De Máscaras</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a></li>
    ...
    <tr>
      <td>11</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/24683c330f02d7d026e7f173d37449a9.png" alt="Cover for ¿Dónde Jugarán Las Niñas?" style="max-width:120px; height:auto;" />
      </td>
      <td>1997-08-26</td>
      <td>Molotov</td>
      <td>¿Dónde Jugarán Las Niñas?</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      <td>9</td>
      <td>
          <img src="https://i.discogs.com/ad9ze8KjPD22ttl_W9_ChqsA-3cvCIf0G9CnvUINCek/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMzMjQx/MTYtMTYxNDU2MDkw/OC05NTQ5LmpwZWc.jpeg" alt="Cover for Libres Y Locos" style="max-width:120px; height:auto;" />
      </td>
      <td>1998</td>
      <td>El Gran Silencio</td>
      <td>Libres Y Locos</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latino" | relative_url }}">latino</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>21</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a051bcce6cdceb199eafa82a4ad064a5.png" alt="Cover for Like La Leyenda" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
      <td>Like</td>
      <td>Like La Leyenda</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
    ...
    <tr>
      <td>64</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/2d2972eda28c4d2acd661db166d84e06.png" alt="Cover for Frida (Original Motion Picture Soundtrack)" style="max-width:120px; height:auto;" />
      </td>
      <td>2000</td>
      <td>Elliot Goldenthal</td>
      <td>Frida (Original Motion Picture Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latino" | relative_url }}">latino</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Aurora</td>
      <td>Cure For Me (feat. Silvana Estrada) [Live]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rapcore" | relative_url }}">rapcore</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Brujeria</td>
      <td>The Mexecutioner! - The Best of Brujeria</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/espanol" | relative_url }}">espanol</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>10</td>
      <td>
          <img src="https://i.discogs.com/JrcdivZ3yjjvYxPWxpGQSsIiLiplfH_R3lIN2i83g38/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTk0NzA5/NjgtMTU0NjQwNTE0/Mi0xNDY0LmpwZWc.jpeg" alt="Cover for Unplugged" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
      <td>Maná</td>
      <td>Unplugged</td>
    ...
    <tr>
      <td>24</td>
      <td>
          <img src="https://i.discogs.com/vV0dJ1jKMU75qCLVd8Q0ks9ks3r-FoUyua6KCVcW6pM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTkxODYw/OTktMTQ3NjI4Nzg4/MC0yMTQ2LmpwZWc.jpeg" alt="Cover for Tres Veces Tres" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
      <td>Panteón Rococó</td>
      <td>Tres Veces Tres</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-techno" | relative_url }}">experimental techno</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>8</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/90a8d4f98ca24f478964e56d1ccb3820.png" alt="Cover for Con Todo Respeto" style="max-width:120px; height:auto;" />
      </td>
      <td>2004-10-21</td>
      <td>Molotov</td>
      <td>Con Todo Respeto</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/rock-en-espanol" | relative_url }}">rock en espanol</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/latin-rock" | relative_url }}">latin rock</a> # 66</li>
    ...
    <tr>
      ...
      <td>...And the Jellyfish Parade</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      <td>29</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/1d23d8c920556b9a8cbdc301ad149b0b.png" alt="Cover for Indeleble" style="max-width:120px; height:auto;" />
      </td>
      <td>2006-04-06</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/spanish" | relative_url }}">spanish</a> # 72</li>
            <li> <a href="{{ "/tags/ballad" | relative_url }}">ballad</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>25</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/f8ca86520bd473808b55cbb21b0f5e21.png" alt="Cover for Ayudame Hit Pack" style="max-width:120px; height:auto;" />
      </td>
      <td>2007</td>
      <td>Paulina Rubio</td>
      <td>Ayudame Hit Pack</td>
      <td>
        <ul>
    ...
    <tr>
      <td>20</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/deea995c243c815f9a2e51eeaad74495.png" alt="Cover for Mexican Spaghetti Western" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-04-10</td>
      <td>Chingon</td>
      <td>Mexican Spaghetti Western</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>2007-07-10</td>
      <td>RBD</td>
      <td>Celestial (International Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-pop" | relative_url }}">latin pop</a></li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>Gloria Trevi</td>
      <td>Una Rosa Blu (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
    ...
    <tr>
      <td>80</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a51c9c313cb820ab1b777d7ee637ac2b.png" alt="Cover for Lunada" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-01-01</td>
      <td>Thalía</td>
      <td>Lunada</td>
    ...
    <tr>
      <td>32</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/c68b57394c8c2a4e9d3a3a38ea35bf7d.png" alt="Cover for Mediocre" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-02-19</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/rock-en-espanol" | relative_url }}">rock en espanol</a> # 39</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Negro Y Azul: The Ballad of Heisenberg (From &quot;Breaking Bad&quot; TV Series)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin" | relative_url }}">latin</a> # 58</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/rock-en-espanol" | relative_url }}">rock en espanol</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ranchera" | relative_url }}">ranchera</a> # 1</li>
    ...
    <tr>
      <td>34</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/bd756f2e0acd4ee3b1c4de40d7fa723b.png" alt="Cover for Extranjera Segunda Parte" style="max-width:120px; height:auto;" />
      </td>
      <td>2011</td>
      <td>Dulce María</td>
      <td>Extranjera Segunda Parte</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>22</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/d8d6beb14b721d73451f03a1e76d1799.png" alt="Cover for Sueño Electro II" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-09-06</td>
      <td>Belanova</td>
      <td>Sueño Electro II</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
    ...
    <tr>
      <td>27</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/047dcb4b4bec556441d9fb0e7d25ad6b.png" alt="Cover for Adicta" style="max-width:120px; height:auto;" />
      </td>
      <td>2016</td>
      <td>Maite Perroni</td>
      <td>Adicta</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-rock" | relative_url }}">spanish rock</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>45</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/2682116d8eacc40dc29fe3d2b57346f5.png" alt="Cover for Origen" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-10-21</td>
      <td>Dulce María</td>
      <td>Origen</td>
    ...
    <tr>
      <td>4</td>
      <td>
          <img src="https://i.discogs.com/kOijNwqhZ8pEwmIblsC5V2ekBt1AXRYYSpxjsrRbeCM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMxMDUy/MTc3LTE3MTkyOTE4/OTYtNDMzNC5qcGVn.jpeg" alt="Cover for Sigan Hablando" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-12-28</td>
      <td>Fuerza Regida</td>
      <td>Sigan Hablando</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexican" | relative_url }}">mexican</a></li>
    ...
    <tr>
      <td>17</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a148d49bc16c4a69ad02d04478d5d956.png" alt="Cover for Why You?" style="max-width:120px; height:auto;" />
      </td>
      <td></td>
      <td>Siddhartha</td>
      <td>Why You?</td>
