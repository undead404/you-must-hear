...
Tech house is a electronic dance music genre that blends the rhythmic groove of house music with the mechanical, minimalist elements of techno. Emerging in the 1990s club scene, it features stripped-down beats, subtle basslines, and crisp percussion designed for late-night dancefloors. The sound prioritizes functional, hypnotic repetition over melody, creating an understated yet driving energy.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The Sound Of The Ninth Season (Invaders)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1999-04-19</td>
      <td>Fatboy Slim</td>
      <td>Right Here, Right Now (CamelPhat Remix)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>86</td>
      <td>
          <img src="https://i.discogs.com/UT-4qYiC_56GVTCBtduQbfHE8Qv4bdUTROMbMT-17_8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzNjg4/OC0xMTE2MzIyNTc4/LmpwZw.jpeg" alt="Cover for Typerope EP" style="max-width:120px; height:auto;" />
      </td>
      <td>2003</td>
      <td>Mathew Jonson</td>
      <td>Typerope EP</td>
    ...
    <tr>
      ...
      <td>2008-03-10</td>
      <td>deadmau5</td>
      <td>SATRN &#x2F; COASTED &#x2F; FALL (Remixes)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/tech-house" | relative_url }}">tech house</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-04</td>
      <td>Junior Boys</td>
      <td>No Kinda Man (Body Language Exclusive Track)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/house" | relative_url }}">house</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/tech-house" | relative_url }}">tech house</a></li>
    ...
    <tr>
      <td>88</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/7693d886a598418ab8fe817d242ca76f.png" alt="Cover for Tarantula" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-04-22</td>
      <td>Pleasurekraft</td>
      <td>Tarantula</td>
    ...
    <tr>
      <td>61</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/d1869cf2622749a3ac013fdc619ce62b.png" alt="Cover for DJ-KiCKS" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-10</td>
      <td>Apparat</td>
      <td>DJ-KiCKS</td>
    ...
    <tr>
      ...
      <td>2012-12-20</td>
      <td>Solomun</td>
      <td>International Hustle &#x2F; Explicit</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/tech-house" | relative_url }}">tech house</a></li>
        </ul>
    ...
    <tr>
      <td>89</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/2e47dc78bce3484c8d2190db23accad3.png" alt="Cover for Elements of Light" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-01-15</td>
      <td>Pantha du Prince &amp; The Bell Laboratory</td>
      <td>Elements of Light</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
    ...
    <tr>
      <td>35</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/921098e0bd2894a84fc5c0e3c12814e0.png" alt="Cover for Sweat" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-10-28</td>
      <td>Karma Fields</td>
      <td>Sweat</td>
    ...
    <tr>
      ...
      <td>2018-04-27</td>
      <td>Moby</td>
      <td>We Are All Made of Stars (remixes)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/downtempo" | relative_url }}">downtempo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
