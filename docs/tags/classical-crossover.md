...
Classical crossover blends orchestral instruments and classical music techniques with contemporary genres like pop, electronic, and rock. The genre makes classical music more accessible to mainstream audiences while maintaining sophisticated musical arrangements. It often features string instruments, piano, and vocals paired with modern production and beats.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>16</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/c2e163f9c21e49ec5c800195dc698dda.png" alt="Cover for Il Volo" style="max-width:120px; height:auto;" />
      </td>
      <td>1974</td>
      <td>Il Volo</td>
      <td>Il Volo</td>
    ...
    <tr>
      ...
      <td>1983</td>
      <td>Die 12 Cellisten der Berliner Philharmoniker</td>
      <td>Angel Dances</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td>Come un cammello in una grondaia</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/opera" | relative_url }}">opera</a> # 79</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a> # 26</li>
            ...
            <li> <a href="{{ "/tags/composer" | relative_url }}">composer</a> # 63</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>46</td>
      <td>
          <img src="https://i.discogs.com/qogo9XQf79MlNEgtkVZIGNVmciWxjM7Oz-6AQVa_PfU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI3MTYy/NTkxLTE2ODQ4MDg5/NDMtNDM4My5wbmc.jpeg" alt="Cover for Voice of an Angel" style="max-width:120px; height:auto;" />
      </td>
      <td>1998-11-09</td>
    ...
    <tr>
      <td>19</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ed7e1e5f106bb6b8c36801ba48066dda.png" alt="Cover for Turning" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
      <td>Suzanne Ciani</td>
      <td>Turning</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/opera" | relative_url }}">opera</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>18</td>
      <td>
          <img src="https://i.discogs.com/Yw-w9OI91LLnR0MOoYHiVUl_snL-l4A92Xc64cmCfJ4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzMzE4/NjgtMTIxMDMzMTYw/MC5qcGVn.jpeg" alt="Cover for Enchantment" style="max-width:120px; height:auto;" />
      </td>
      <td>2001-10-09</td>
      <td>Charlotte Church</td>
      <td>Enchantment</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/opera" | relative_url }}">opera</a> # 74</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/poetry" | relative_url }}">poetry</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>11</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/473abf93345f4fd6cfcce906634810da.png" alt="Cover for Shine" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-10-12</td>
      <td>Bond</td>
      <td>Shine</td>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Emma Shapplin</td>
      <td>El Concierto de Caesarea</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/new-age" | relative_url }}">new age</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>53</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/b8a8c76edf767653089320e8a4d7dede.png" alt="Cover for Closer Limited ed" style="max-width:120px; height:auto;" />
      </td>
      <td>2003-11-11</td>
      <td>Josh Groban</td>
      <td>Closer Limited ed</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
        </ul>
    ...
    <tr>
      <td>49</td>
      <td>
          <img src="https://i.discogs.com/pmYWwVf0OQtO0HaH1BLLSAskXBixOMhgwlaN_2h1CMM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ3OTMw/NzktMTM3NTcwNjkw/Mi01NzY1LmpwZWc.jpeg" alt="Cover for I Believe My Heart" style="max-width:120px; height:auto;" />
      </td>
      <td>2004-11-22</td>
      <td>Keedie</td>
      <td>I Believe My Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/opera" | relative_url }}">opera</a></li>
    ...
    <tr>
      <td>39</td>
      <td>
          <img src="https://i.discogs.com/A3Ofqr65v08RbftGlT-2cqXMaeYXS5YVuUVVqh5zX0M/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0ODQ5/OTA3LTE1ODI3ODgy/NjEtODA0Ny5qcGVn.jpeg" alt="Cover for To Drive the Cold Winter Away" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Silverwood Quartet</td>
      <td>To Drive the Cold Winter Away</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/symphonic-power-metal" | relative_url }}">symphonic power metal</a> # 76</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/world-fusion" | relative_url }}">world fusion</a> # 50</li>
            <li> <a href="{{ "/tags/neoclassical-darkwave" | relative_url }}">neoclassical darkwave</a> # 57</li>
            <li> <a href="{{ "/tags/poetry" | relative_url }}">poetry</a> # 61</li>
    ...
    <tr>
      <td>20</td>
      <td>
          <img src="https://i.discogs.com/_NdQ5-TkCIFGlQ3ULIWWs3pvNA2t4XeW4hd_a33JxAc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyMTgz/ODYzLTE1Mjk5NzE5/NTEtOTg1OS5qcGVn.jpeg" alt="Cover for Mission: Impossible III (Music from the Original Motion Picture Soundtrack)" style="max-width:120px; height:auto;" />
      </td>
      <td>2006</td>
      <td>Michael Giacchino</td>
      <td>Mission: Impossible III (Music from the Original Motion Picture Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      <td>30</td>
      <td>
          <img src="https://i.discogs.com/Q5uPC7YmWjTosTlvai_asMUJXknkjdnmBFu6nGLqpZo/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzNDky/NzYwLTE1NTUyMzk2/ODAtOTYzMi5qcGVn.jpeg" alt="Cover for Eton Path" style="max-width:120px; height:auto;" />
      </td>
      <td>2006</td>
      <td>Corner Stone Cues</td>
      <td>Eton Path</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/world-fusion" | relative_url }}">world fusion</a> # 57</li>
            <li> <a href="{{ "/tags/neoclassical-darkwave" | relative_url }}">neoclassical darkwave</a> # 58</li>
            <li> <a href="{{ "/tags/poetry" | relative_url }}">poetry</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>15</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/1960d61e82c469ffee9daf5c15161414.png" alt="Cover for All Angels" style="max-width:120px; height:auto;" />
      </td>
      <td>2006-11-13</td>
      <td>All Angels</td>
      <td>All Angels</td>
    ...
    <tr>
      <td>35</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/301cee0d1a564a16b8e8ecda0b49eee9.png" alt="Cover for From My Heart" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-03-06</td>
      <td>Giorgia Fumanti</td>
      <td>From My Heart</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/opera" | relative_url }}">opera</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dream-folk" | relative_url }}">dream folk</a> # 49</li>
    ...
    <tr>
      <td>47</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/f07ef72deed99bd1e59e6f54631a0dce.png" alt="Cover for Sacred Arias" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-10-20</td>
      <td>Katherine Jenkins</td>
      <td>Sacred Arias</td>
    ...
    <tr>
      <td>44</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a092ff145f1ce9b9ddedcda044be50fe.png" alt="Cover for A Winter Symphony" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-10-29</td>
      <td>Sarah Brightman</td>
      <td>A Winter Symphony</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
        </ul>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/opera" | relative_url }}">opera</a> # 57</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/neoclassical-darkwave" | relative_url }}">neoclassical darkwave</a> # 63</li>
            <li> <a href="{{ "/tags/world-fusion" | relative_url }}">world fusion</a> # 70</li>
            <li> <a href="{{ "/tags/avant-pop" | relative_url }}">avant-pop</a> # 89</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/dream-folk" | relative_url }}">dream folk</a></li>
            ...
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/neofolk" | relative_url }}">neofolk</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/poetry" | relative_url }}">poetry</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/poetry" | relative_url }}">poetry</a> # 42</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ethnic" | relative_url }}">ethnic</a> # 80</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/neomedieval" | relative_url }}">neomedieval</a> # 36</li>
            <li> <a href="{{ "/tags/medieval-folk" | relative_url }}">medieval folk</a> # 45</li>
            ...
            <li> <a href="{{ "/tags/electroacoustic" | relative_url }}">electroacoustic</a> # 90</li>
    ...
    <tr>
      ...
      <td>The Cold Embrace Of Fear</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/symphonic-power-metal" | relative_url }}">symphonic power metal</a></li>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/epic-metal" | relative_url }}">epic metal</a> # 67</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-instrumental" | relative_url }}">contemporary instrumental</a> # 60</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>42</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/e73d12c2d90645d49e0f6fbb6f3ea691.png" alt="Cover for Stirling Strings" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-09-25</td>
      <td>Lindsey Stirling</td>
      <td>Stirling Strings</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/classical" | relative_url }}">classical</a> # 12</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/classical-piano" | relative_url }}">classical piano</a> # 43</li>
            <li> <a href="{{ "/tags/ukraine" | relative_url }}">ukraine</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2014</td>
      <td>Lindsey Stirling</td>
      <td>Shatter Me (Deluxe Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/medieval-ambient" | relative_url }}">medieval ambient</a> # 12</li>
            ...
            <li> <a href="{{ "/tags/poetry" | relative_url }}">poetry</a> # 76</li>
    ...
    <tr>
      <td>21</td>
      <td>
          <img src="https://i.discogs.com/u5H32qfyFhgXOLanUpW4C3iDaXVHaJR2pfyyit7-Ywk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExODcy/ODQxLTE1MjM4Nzc5/MzgtNjk5NS5qcGVn.jpeg" alt="Cover for Ori and the Will of the Wisps (Original Soundtrack Recording)" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-03-09</td>
      <td>Gareth Coker</td>
      <td>Ori and the Will of the Wisps (Original Soundtrack Recording)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      <td>48</td>
      <td>
          <img src="https://i.discogs.com/PVuQj3ECwg4lNpJwQhSz6SzNrJOtQhCXciIJGDlA__Q/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE5NDIw/MDA5LTE2MjU3NTAx/MDktMTI5Mi5qcGVn.jpeg" alt="Cover for Quadrasonic" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-01-15</td>
      <td>Escala</td>
      <td>Quadrasonic</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-instrumental" | relative_url }}">contemporary instrumental</a> # 1</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a> # 43</li>
    ...
    <tr>
      <td>6</td>
      <td>
          <img src="https://i.discogs.com/7t6EesxYw9Ip8wOecL1xXvqSm6SQ9B2bs5fALBhUuNk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExMDQ4/Mjc4LTE1MDg4ODM1/OTktODY5Ny5qcGVn.jpeg" alt="Cover for Warmer In The Winter (Deluxe Edition)" style="max-width:120px; height:auto;" />
      </td>
      <td>2017</td>
      <td>Lindsey Stirling</td>
      <td>Warmer In The Winter (Deluxe Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td>2018-02-23</td>
      <td>Federico Albanese</td>
      <td>By the Deep Sea</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      <td>7</td>
      <td>
          <img src="https://i.discogs.com/iWkYHoBS60v1faCKBrbfTdqmzaMjwG5dEBTaNdyOE7M/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEzMDk2/MTE0LTE1NDc5OTA5/NjYtMTIwNC5qcGVn.jpeg" alt="Cover for Evolution" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-08-31</td>
    ...
    <tr>
      ...
      <td>2019-07-17</td>
      <td>Deep Purple</td>
      <td>IN CONCERT WITH THE LONDON SYMPHONY ORCHESTRA CONDUCTED BY PAUL MANN</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hard-rock" | relative_url }}">hard rock</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/progressive-rock" | relative_url }}">progressive rock</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/symphonic-rock" | relative_url }}">symphonic rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>52</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/9abd0167cd2ba2dd8c7f8931ac0b93a9.png" alt="Cover for Binary" style="max-width:120px; height:auto;" />
      </td>
      <td>2020</td>
      <td>Mark Petrie</td>
      <td>Binary</td>
    ...
    <tr>
      <td>27</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/934b8b28a0de6fa5cc0da540aedd1412.png" alt="Cover for Simply Three" style="max-width:120px; height:auto;" />
      </td>
      <td>2021</td>
      <td>Simply Three</td>
      <td>Simply Three</td>
    ...
    <tr>
      <td>29</td>
      <td>
          <img src="https://i.discogs.com/7kJ-CYWjZnheK-Ig5M9wiuz0-9WX_I1MwbxV6o5rLi4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE4OTA2/ODg5LTE2MjI1MzQw/NTgtNTgwNC5qcGVn.jpeg" alt="Cover for I&#39;ll Be Your Hero" style="max-width:120px; height:auto;" />
      </td>
      <td>2021-06-04</td>
      <td>Rhapsody of Fire</td>
    ...
    <tr>
      <td>40</td>
      <td>
          <img src="https://i.discogs.com/6FP__nqUrsShXCtbRmf5FeagJwGtid8kxWRqyuTo7ww/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzMzM0/MTYxLTE2NTMzNTU3/NDktMzYxMS5qcGVn.jpeg" alt="Cover for Truth" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-05-06</td>
      <td>Alexis Ffrench</td>
      <td>Truth</td>
    ...
    <tr>
      ...
      <td>Legends, Myths and Lavender</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/one-man-band" | relative_url }}">one man band</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2023-11-17</td>
      <td>Simon Franglen</td>
      <td>Avatar: The Way of Water (Original Motion Picture Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      <td>12</td>
      <td>
          <img src="https://i.discogs.com/kdW-RGlU0Zl91SN-hziAsj3fUt8bRP3wpj_yRHsFYlE/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMxOTcw/MjUtMTMyMDA3NDQx/My5qcGVn.jpeg" alt="Cover for AWAKENING" style="max-width:120px; height:auto;" />
      </td>
      <td>2024</td>
      <td>Tony Ann</td>
      <td>AWAKENING</td>
    ...
    <tr>
      ...
      <td></td>
      <td>Chadwick Himsl</td>
      <td>The Light Shines in the Darkness</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>井上一平</td>
      <td>TVアニメ「ブルーピリオド」オリジナル・サウンドトラック</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical-crossover" | relative_url }}">classical crossover</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
