...
Last updated: <time datetime="2025-12-05T12:43:41.504Z">Fri Dec 05 2025 14:43:41 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/jazz-fusion" | relative_url }}">jazz fusion</a> # 76</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 2</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/world-guitar" | relative_url }}">world guitar</a> # 6</li>
            <li> <a href="{{ "/tags/flamenco-guitar" | relative_url }}">flamenco guitar</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/electric-guitar" | relative_url }}">electric guitar</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fingerstyle-guitar" | relative_url }}">fingerstyle guitar</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/flamenco-guitar" | relative_url }}">flamenco guitar</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/tango" | relative_url }}">tango</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/alternative-folk" | relative_url }}">alternative folk</a> # 45</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish-guitar" | relative_url }}">spanish guitar</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/classical-guitar" | relative_url }}">classical guitar</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>23</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/88820a7746bb4390c386ac2f8ec7e309.png" alt="Cover for Dreamcatcher" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
      <td>Andy McKee</td>
      <td>Dreamcatcher</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fingerstyle-guitar" | relative_url }}">fingerstyle guitar</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>82</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/14adc0488fda4ab6ac2309fdfa8da978.png" alt="Cover for Metamorpheus" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-03-28</td>
      <td>Steve Hackett</td>
      <td>Metamorpheus</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/acoustic-rock" | relative_url }}">acoustic rock</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fingerstyle-guitar" | relative_url }}">fingerstyle guitar</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/unplugged" | relative_url }}">unplugged</a> # 76</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fingerstyle-guitar" | relative_url }}">fingerstyle guitar</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/guitar-virtuoso" | relative_url }}">guitar virtuoso</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/acoustic-blues" | relative_url }}">acoustic blues</a> # 30</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/arcade-fire" | relative_url }}">arcade fire</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fingerstyle-guitar" | relative_url }}">fingerstyle guitar</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-instrumental" | relative_url }}">contemporary instrumental</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/fingerstyle-guitar" | relative_url }}">fingerstyle guitar</a> # 52</li>
        </ul>
      </td>
    </tr>
    <tr>
