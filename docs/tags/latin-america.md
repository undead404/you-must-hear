...
Latin America encompasses the diverse musical traditions spanning from Mexico to Argentina, blending Indigenous, African, and European influences into distinctive regional styles. The tag captures everything from Brazilian samba and forró to Colombian cumbia and Argentine rock, unified by Spanish and Portuguese lyrics and characteristic rhythmic patterns. This music reflects the vibrant cultural identity of the continent through passionate vocals, dance-oriented beats, and a mix of traditional and contemporary production.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/chilean" | relative_url }}">chilean</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1974</td>
      <td>Various Artists</td>
      <td>Latinas: Women of Latin America</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/america" | relative_url }}">america</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/brazilian-rock" | relative_url }}">brazilian rock</a> # 47</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>ALBUM</td>
      <td>Quantization Proclamation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a></li>
    ...
    <tr>
      ...
      <td>1991</td>
      <td>Yawar</td>
      <td>El Mundo de Los Beatles en el Perú</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-america" | relative_url }}">latin america</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>Various Artists</td>
      <td>The Rough Guide to Mambo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-america" | relative_url }}">latin america</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/world" | relative_url }}">world</a></li>
    ...
    <tr>
      ...
      <td>Calcinha Preta, Vol. 13 (Ao Vivo)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/live-recording" | relative_url }}">live recording</a> # 65</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/puerto-rico" | relative_url }}">puerto rico</a> # 38</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>95</td>
      <td>
          <img src="https://i.discogs.com/lWXbDzTBCR1frl6Dywmnnvl3JH-RvrZ_So0Zd3fa2Go/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTEyMTcw/NDg1LTE1Mjk3MTM4/ODQtMTUyNS5qcGVn.jpeg" alt="Cover for Hoje à Noite, Vol. 11 (Inéditas e ao Vivo)" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
      <td>Calcinha Preta</td>
      <td>Hoje à Noite, Vol. 11 (Inéditas e ao Vivo)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2004-02-16</td>
      <td>Sandra Luna</td>
      <td>The Rough Guide To Tango Nuevo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-america" | relative_url }}">latin america</a></li>
    ...
    <tr>
      <td>8</td>
      <td>
          <img src="https://i.discogs.com/l_pTbJFHGIslheS7Wlm61cqRUHiCHK4CAGiVsfzbus4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MDI0/MzkwLTE1NjYzMDYy/MDEtNjQxNC5qcGVn.jpeg" alt="Cover for Cabiosile" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Papo Record</td>
      <td>Cabiosile</td>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Various Artists</td>
      <td>The Rough Guide to Samba</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/brazil" | relative_url }}">brazil</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-america" | relative_url }}">latin america</a></li>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Willie Colon &amp; Hector Lavoe</td>
      <td>Guisando</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/live-recording" | relative_url }}">live recording</a> # 61</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>1</td>
      <td>
          <img src="https://i.discogs.com/Rko7ilYt3ZitFHb9efJlbqaEXs6akSEKl1V2mhCG-2w/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTUwNDQ5/NzktMTM4Mjk5NDA5/Ni0yNzMyLmpwZWc.jpeg" alt="Cover for Umbra" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-03-15</td>
      <td>Vate</td>
      <td>Umbra</td>
    ...
    <tr>
      ...
      <td>2017-03-03</td>
      <td>Various Artists</td>
      <td>Nortec Collective: The Tijuana Sessions, Volume 1</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2023-10-26</td>
      <td>tepeyac usto</td>
      <td>That Dissappearing Thing</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>El Grupo Jatari</td>
      <td>El Grupo Jatari: Folk Music Of Argentina, Bolivia, Chile, Ecuador, Peru And Venezuela</td>
      <td>
        <ul>
        </ul>
      </td>
