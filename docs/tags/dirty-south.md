...
Last updated: <time datetime="2025-11-24T23:48:37.360Z">Tue Nov 25 2025 01:48:37 GMT+0200 (Eastern European Standard Time)</time>

### Description

Dirty South is a subgenre of hip-hop that originated in the southern United States, particularly in the cities of Atlanta, Houston, and Memphis, during the 1990s. It is characterized by heavy beats, slow and gritty rhythms, and synthesized melodies, often featuring heavy bass lines, 808 drum machines, and chopped and screwed vocal samples. The lyrics often center around themes of street life, drug dealing, violence, and southern pride, and are delivered in a slow, drawling style that is typical of the region. Some of the most well-known Dirty South artists include Outkast, UGK, Lil Wayne, and T.I.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2001-11-06</td>
      <td>Petey Pablo</td>
      <td>Diary of a Sinner: 1st Entry</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dirty-south" | relative_url }}">dirty south</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003-09-29</td>
      <td>OutKast</td>
      <td>Speakerboxx&#x2F;The Love Below</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dirty-south" | relative_url }}">dirty south</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/funk" | relative_url }}">funk</a></li>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Young Buck</td>
      <td>Straight Outta Cashville</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dirty-south" | relative_url }}">dirty south</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/dirty-south" | relative_url }}">dirty south</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/memphis" | relative_url }}">memphis</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Killa Kyleon</td>
      <td>Natural Born Killa 2.0 Reloaded</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dirty-south" | relative_url }}">dirty south</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2017-10-27</td>
      <td>Big K.R.I.T.</td>
      <td>4eva Is a Mighty Long Time</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2021-05-01</td>
      <td>Ace Hood</td>
      <td>DJ Khaled Presents Ace Hood Gutta</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dirty-south" | relative_url }}">dirty south</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
