...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Beauty And The Breakdown</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/emoviolence" | relative_url }}">emoviolence</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
