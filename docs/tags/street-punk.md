...
Street punk is a raw, aggressive form of punk rock that emerged from working-class urban communities in the late 1970s and early 1980s. The music features fast, stripped-down guitar riffs, shouted vocals, and anthemic choruses focused on social rebellion and street life. It emphasizes authenticity, DIY ethics, and a confrontational attitude that rejects mainstream commercialism.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1981-05-04</td>
      <td>The Exploited</td>
      <td>Punks Not Dead</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>The Varukers</td>
      <td>Deadly Games (The History)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Eskorbuto</td>
      <td>Ya No Quedan Mas Cojones</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/spanish" | relative_url }}">spanish</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Deadline</td>
      <td>More to It Than Meets the Eye</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
    ...
    <tr>
      ...
      <td>When The Punks Go Marching In</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/british" | relative_url }}">british</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>Rancid</td>
      <td>BYO Split Series Volume III</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1996-06-04</td>
      <td>Total Chaos</td>
      <td>Anthems From The Alleyway</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Karcer</td>
      <td>Wschod Jest Pelen Slonca</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Sham 69</td>
      <td>The Punk Singles Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/british" | relative_url }}">british</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>The Casualties</td>
      <td>The Early Years: 1990-1995</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
    ...
    <tr>
      <td>81</td>
      <td>
          <img src="https://i.discogs.com/Md8rns6qNj_ynDkoHea4wZPrJP458kPdk1Srspoc6_I/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ2NDc0/NjMtMTM3MDk4MDM4/My00MzI1LmpwZWc.jpeg" alt="Cover for What the Fuck Will Change" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
      <td>A Global Threat</td>
      <td>What the Fuck Will Change</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>The Virus</td>
      <td>Still Fighting for a Future</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
    ...
    <tr>
      <td>79</td>
      <td>
          <img src="https://i.discogs.com/AitMZFsshmgGZpl3X8TF4E8QLw8s1KBPYjpZ4DcJxc8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExODY5/Njg1LTE1MjM4MTM0/MjgtODY5Ni5qcGVn.jpeg" alt="Cover for Stay Out of Order" style="max-width:120px; height:auto;" />
      </td>
      <td>2000</td>
      <td>The Casualties</td>
      <td>Stay Out of Order</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
    ...
    <tr>
      <td>87</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/285cb1367f294738bd9301cdd6ef8dfe.png" alt="Cover for Hlaskover Rock" style="max-width:120px; height:auto;" />
      </td>
      <td>2000</td>
      <td>The Analogs</td>
      <td>Hlaskover Rock</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>GBH</td>
      <td>City Baby Attacked By Rats (Expanded Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/celtic-punk" | relative_url }}">celtic punk</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>The Unseen</td>
      <td>Complete Singles Collection 1994-2000</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
    ...
    <tr>
      <td>84</td>
      <td>
          <img src="https://i.discogs.com/YFdP8MaJ5rt8hDVx9EHDQZcRB5rBKgfVq6uv_bgkhcY/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIwMDg3/OTMtMTMwMzk1OTUy/MC5qcGVn.jpeg" alt="Cover for Nowhere to Hide" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-05-28</td>
      <td>The Virus</td>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Envidia Kotxina</td>
      <td>Asi en la tierran komo en el zielo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/spanish" | relative_url }}">spanish</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://i.discogs.com/4eBi8MXBY-m2MbwayWpAFv5tpyNX4Blbn9SD2lxxIY0/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTExMDUy/MDAtMTE5MjM4MjU1/MC5qcGVn.jpeg" alt="Cover for Savin&#39; Hill" style="max-width:120px; height:auto;" />
      </td>
      <td>2003</td>
      <td>Street Dogs</td>
      <td>Savin&#39; Hill</td>
    ...
    <tr>
      ...
      <td>Finding Freedom in Hopelessness</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
        </ul>
    ...
    <tr>
      <td>91</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6fb6440e9fc840ce8b628f2c852e28bd.png" alt="Cover for Under Attack" style="max-width:120px; height:auto;" />
      </td>
      <td>2006-08-22</td>
      <td>The Casualties</td>
      <td>Under Attack</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/boston" | relative_url }}">boston</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-zealand" | relative_url }}">new zealand</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-zealand" | relative_url }}">new zealand</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/deutschpunk" | relative_url }}">deutschpunk</a> # 56</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2018-06-22</td>
      <td>Street Dogs</td>
      <td>Stand for Something or Die for Nothing</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/punk-rock" | relative_url }}">punk rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/street-punk" | relative_url }}">street punk</a></li>
