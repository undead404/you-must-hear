...
German thrash metal emerged in the 1980s as an aggressive counterpart to the American Bay Area scene, characterized by raw production, militaristic precision, and darker lyrical themes often addressing war and social decay. The sound features relentless speed, razor-sharp riffing, and harsh, shouted vocals delivered with Teutonic intensity. This style helped establish Germany as thrash metal&#39;s second global epicenter alongside the United States.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Death In Action</td>
      <td>Just for Our Sake</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/death-metal" | relative_url }}">death metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2006-04-26</td>
      <td>Tankard</td>
      <td>Stone Cold Sober (Bonus Track Edition)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/metal" | relative_url }}">metal</a></li>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Mortal Infinity</td>
      <td>District Destruction</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a></li>
    ...
    <tr>
      ...
      <td>2019-12-08</td>
      <td>Sodom</td>
      <td>In the Sign of Evil + Obsessed by Cruelty</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/thrash-metal" | relative_url }}">thrash metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2020-03-27</td>
      <td>Reactory</td>
      <td>Metal Hammer Maximum Metal Vol. 201</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/german-thrash-metal" | relative_url }}">german thrash metal</a></li>
