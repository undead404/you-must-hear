...
Last updated: <time datetime="2025-12-09T05:18:29.485Z">Tue Dec 09 2025 07:18:29 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>84</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/9af244740e6ec6dbec420eb3c2f7373a.png" alt="Cover for Aries" style="max-width:120px; height:auto;" />
      </td>
      <td>1993-06-22</td>
      <td>Luis Miguel</td>
      <td>Aries</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latino" | relative_url }}">latino</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/cumbia" | relative_url }}">cumbia</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/reggaeton" | relative_url }}">reggaeton</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/mexico" | relative_url }}">mexico</a> # 19</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/spanish" | relative_url }}">spanish</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/world-fusion" | relative_url }}">world fusion</a> # 6</li>
            <li> <a href="{{ "/tags/latin-jazz" | relative_url }}">latin jazz</a> # 12</li>
            <li> <a href="{{ "/tags/salsa" | relative_url }}">salsa</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bachata" | relative_url }}">bachata</a> # 2</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/bachata" | relative_url }}">bachata</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/latin-rap" | relative_url }}">latin rap</a> # 6</li>
            <li> <a href="{{ "/tags/chile" | relative_url }}">chile</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/brazilian-pop" | relative_url }}">brazilian pop</a> # 22</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/swing" | relative_url }}">swing</a> # 20</li>
            <li> <a href="{{ "/tags/spanish" | relative_url }}">spanish</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pop-latino" | relative_url }}">pop latino</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pop-latino" | relative_url }}">pop latino</a> # 16</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pop-latino" | relative_url }}">pop latino</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/reggaeton" | relative_url }}">reggaeton</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
