...
Last updated: <time datetime="2025-12-05T17:09:30.437Z">Fri Dec 05 2025 19:09:30 GMT+0200 (Eastern European Standard Time)</time>

### Description

NYHC (New York Hardcore) is an aggressive, street-level punk subgenre that emerged from 1980s New York City, characterized by rapid-fire rhythms, shouted vocals, and occasional metal influences. The sound emphasizes raw energy, breakdowns, and confrontational lyrics about urban struggle, unity, and working-class resilience. It&#39;s defined by its intense live shows and the bridge it built between hardcore punk and heavy metal.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/crossover-thrash" | relative_url }}">crossover thrash</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/punk-revival" | relative_url }}">punk revival</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1987</td>
      <td>Token Entry</td>
      <td>From Beneath The Streets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1989-05</td>
      <td>Sick of It All</td>
      <td>Blood, Sweat, and No Tears</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>8</td>
      <td>
          <img src="https://i.discogs.com/yA7GXgiDyq1uEUZlOZUv2B5lVYytejseZHYb4FgTuJI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1MzAw/NDItMTM4NDkwMDk5/OS01MjEzLmpwZWc.jpeg" alt="Cover for Brightside" style="max-width:120px; height:auto;" />
      </td>
      <td>1989-11</td>
      <td>Killing Time</td>
      <td>Brightside</td>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Warzone</td>
      <td>Old School To New School</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1994</td>
      <td>Warzone</td>
      <td>Don&#39;t Forget the Struggle Don&#39;t Forget the Streets - Open Your Eyes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1994-05-24</td>
      <td>Biohazard</td>
      <td>State of the World Address</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>25 Ta Life</td>
      <td>Friendship, Loyalty, Commitment</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Sworn Enemy</td>
      <td>Integrity Defines Strength</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/metalcore" | relative_url }}">metalcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
    ...
    <tr>
      ...
      <td>2004-10-19</td>
      <td>Sick of It All</td>
      <td>Outtakes For The Outcast</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Neglect</td>
      <td>The Complete Don Fury Sessions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/metalcore" | relative_url }}">metalcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/russia" | relative_url }}">russia</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>District 9</td>
      <td>Schoolahardknox Revisited</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>What We Feel</td>
      <td>What We Feel &amp; Last Hope - Split CD</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
    ...
    <tr>
      ...
      <td>2008</td>
      <td>H2O</td>
      <td>CBGB OMFUG Masters:Live August 19, 2002 - The Bowery Collection</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009-03-24</td>
      <td>25 Ta Life</td>
      <td>Strength Integrity Brotherhood</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
    ...
    <tr>
      <td>1</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/68177b23391345939fa2a0eeb176da33.png" alt="Cover for Deal With The Devil" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-12-08</td>
      <td>Backtrack</td>
    ...
    <tr>
      <td>12</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a1a36c28941b401ddca921def1d6042d.png" alt="Cover for Empire" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-10-12</td>
      <td>Madball</td>
      <td>Empire</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Warzone</td>
      <td>Don&#39;t Forget The Struggle Don&#39;t Forget The Streets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nyhc" | relative_url }}">nyhc</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/metallic-hardcore" | relative_url }}">metallic hardcore</a> # 27</li>
        </ul>
      </td>
    </tr>
    <tr>
