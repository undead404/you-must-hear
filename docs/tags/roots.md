...
Roots music encompasses authentic reggae and dub sounds that emerged from Jamaica in the 1960s-70s, characterized by heavy bass lines, steady one-drop rhythms, and socially conscious lyrics. The genre emphasizes spiritual themes, often drawing from Rastafarian culture, while addressing social justice, unity, and liberation. Its organic, stripped-down production style celebrates traditional instrumentation and raw vocal delivery that captures the essence of Caribbean musical heritage.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1973</td>
      <td>The Silvertones</td>
      <td>Trojan Box Set: Roots (3 Of 3)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Strictly The Best Vol. 36</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/roots" | relative_url }}">roots</a></li>
    ...
    <tr>
      ...
      <td>The Very Best of Toots and the Maytals</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jamaica" | relative_url }}">jamaica</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
    ...
    <tr>
      ...
      <td>Rastaman Vibration (Deluxe Edition)</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2002-08-13</td>
      <td>Burning Spear</td>
      <td>The Best Of Burning Spear</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/roots" | relative_url }}">roots</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Various Artists</td>
      <td>Uncut: 2005.02 - The Devil&#39;s Music (Keith Richards&#39; Selection of Blues, Soul and R&amp;B Classics)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/roots" | relative_url }}">roots</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ragga" | relative_url }}">ragga</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2008-10-28</td>
      <td>Roxanne Potvin</td>
      <td>No Love for the Poisonous</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues" | relative_url }}">blues</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Conil</td>
      <td>Strange Part Of The Country</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/americana" | relative_url }}">americana</a></li>
    ...
    <tr>
      ...
      <td>It Was Written &#x2F; Flashing Lights</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2013-11-27</td>
      <td>Augustus Pablo</td>
      <td>Dub, Reggae And Roots From The Melodica King</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2015-09-25</td>
      <td>Desmond Dekker</td>
      <td>Israelites: The Best Of Desmond Dekker</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/roots" | relative_url }}">roots</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/new-jersey" | relative_url }}">new jersey</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>James Call!</td>
      <td>sickness cartridges rain from the aero-blimps. they&#39;re handing out leaflets calling the infections &quot;happiness&quot; and &quot;beauty.&quot;</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Swan Bwoy [Fyahbwoy]</td>
      <td>Ni Chance Ni Try...</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/reggae" | relative_url }}">reggae</a></li>
        </ul>
