...
Last updated: <time datetime="2025-11-23T11:19:56.826Z">Sun Nov 23 2025 13:19:56 GMT+0200 (Eastern European Standard Time)</time>

### Description

Deathcore is a subgenre of heavy metal music that blends elements of death metal and metalcore. It typically features aggressive and brutal vocals, downtuned guitars, heavy drumming, and often employs breakdowns and chugging riffs. The lyrics often focus on themes of violence, anger, and nihilism. Some notable bands in the deathcore genre include Suicide Silence, Carnifex, Whitechapel, and Job for a Cowboy. The genre has gained a strong following within the metal community, and has evolved and diversified over time to incorporate elements of other genres such as black metal, slam, and progressive metal.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>This Is What the Edge of Your Seat Was Made For</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 58</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-deathcore" | relative_url }}">progressive deathcore</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2008-04-14</td>
      <td>Annotations of an Autopsy</td>
      <td>Before The Throne of Infection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-06-20</td>
      <td>Carnifex</td>
      <td>The Diseased And The Poisoned</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2008-07-27</td>
      <td>Chelsea Grin</td>
      <td>Chelsea Grin Self-titled EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-deathcore" | relative_url }}">progressive deathcore</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/nintendocore" | relative_url }}">nintendocore</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2018</td>
      <td>gulch</td>
      <td>Burning Desire to Draw Last Breath</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/deathcore" | relative_url }}">deathcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/technical-deathcore" | relative_url }}">technical deathcore</a> # 4</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-deathcore" | relative_url }}">progressive deathcore</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
