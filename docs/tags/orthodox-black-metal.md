...
Orthodox black metal refers to a dark, atmospheric style that adheres strictly to the raw, anti-religious aesthetics and lo-fi production values established by the genre&#39;s second wave in the early 1990s. The music emphasizes tremolo-picked guitars, blast beats, shrieked vocals, and an uncompromising devotion to occult or explicitly anti-Christian themes. It rejects commercialization and mainstream influences, maintaining black metal&#39;s original transgressive spirit.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Si Monumentum Requires, Circumspice</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>The Vision of Fadinng Mankind</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>A.M.S.G.</td>
      <td>The principle of evil becomes the ideal of the Promethean</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-02-02</td>
      <td>Kerasphorus</td>
      <td>Cloven Hooves at the Holocaust Dawn</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blackened-death-metal" | relative_url }}">blackened death metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Balmog</td>
      <td>Testimony of the Abominable</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
    ...
    <tr>
      ...
      <td>2012-11-23</td>
      <td>Sapientia</td>
      <td>Through the First Sphere of Saturnus</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blackened-death-metal" | relative_url }}">blackened death metal</a></li>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Devil&#39;s Emissary</td>
      <td>Evangelic Decimation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2014-03-07</td>
      <td>Svartidauði</td>
      <td>The Synthesis of Whore and Beast</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/atmospheric-black-metal" | relative_url }}">atmospheric black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
    ...
    <tr>
      ...
      <td>2014-10-31</td>
      <td>Thy Darkened Shade</td>
      <td>Liber Lvcifer I: Khem Sedjet</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
    ...
    <tr>
      ...
      <td>2015-09</td>
      <td>Aryan Art</td>
      <td>Хармония - Вечност - Вселена</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-black-metal" | relative_url }}">post-black metal</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
    ...
    <tr>
      ...
      <td>2015-10-30</td>
      <td>Grey Heaven Fall</td>
      <td>Черная мудрость</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
    ...
    <tr>
      ...
      <td>2016-12-21</td>
      <td>Blood Moon</td>
      <td>Through The Scarlet Veil</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
    ...
    <tr>
      ...
      <td>2019-02-01</td>
      <td>Watain</td>
      <td>Stellar Descension Infernal In Budapest</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
    ...
    <tr>
      ...
      <td>2019-05-24</td>
      <td>Deathspell Omega</td>
      <td>The Furnaces of Palingenesia</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2020-04-10</td>
      <td>Ascension</td>
      <td>With Burning Tongues [Demo]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/orthodox-black-metal" | relative_url }}">orthodox black metal</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Dark Funeral</td>
      <td>Where Shadows Forever Reign</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
        </ul>
