...
Last updated: <time datetime="2025-12-04T07:15:45.898Z">Thu Dec 04 2025 09:15:45 GMT+0200 (Eastern European Standard Time)</time>

### Description

Postclassical music is a term used to describe contemporary classical music that draws on diverse musical styles and techniques, and often incorporates elements from popular music, world music, and electronic music. This genre emerged in the late 20th century as a reaction against the rigid stylistic constraints of modernism and seeks to explore new sounds, textures, and forms. Postclassical music can be experimental, genre-bending, and challenging to define, and includes works by composers such as John Adams, Philip Glass, Steve Reich, Arvo Pärt, and Michael Nyman, among others.
...
<table>
  ...
  <tbody>
    <tr>
      <td>67</td>
      <td>
          <img src="https://i.discogs.com/p2TzC0Yof4tEFo9_f9qi2fCRgC0pQaqB2BbXfyWGzqw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMyMjE0/OTYtMTMyNjQwNTA4/OS5qcGVn.jpeg" alt="Cover for Tabula Rasa" style="max-width:120px; height:auto;" />
      </td>
      <td>1984</td>
      <td>Arvo Pärt</td>
      <td>Tabula Rasa</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/4ef20fc231b4449c8979e48c8c8365b2.png" alt="Cover for The Black Book of Capitalism" style="max-width:120px; height:auto;" />
      </td>
      <td>2000</td>
      <td>Sylvain Chauveau</td>
      <td>The Black Book of Capitalism</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/7c52ebb659cf4e8eb85d4f0cbf9edd21.png" alt="Cover for Nocturne Impalpable" style="max-width:120px; height:auto;" />
      </td>
      <td>2001</td>
      <td>Sylvain Chauveau</td>
      <td>Nocturne Impalpable</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a> # 83</li>
    ...
    <tr>
      <td>79</td>
      <td>
          <img src="https://i.discogs.com/CBQV_SzgHAL7Pnq9O4hNrMUOZX8HvTwSgzljK54iVuU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0NTc5/NS0xNjQ0ODUwMjk2/LTY4MzkuanBlZw.jpeg" alt="Cover for Un Autre Decembre" style="max-width:120px; height:auto;" />
      </td>
      <td>2003-03-10</td>
      <td>Sylvain Chauveau</td>
      <td>Un Autre Decembre</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/minimal-piano" | relative_url }}">minimal piano</a> # 92</li>
            <li> <a href="{{ "/tags/experimental-ambient" | relative_url }}">experimental-ambient</a> # 97</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/minimal-piano" | relative_url }}">minimal piano</a> # 93</li>
            <li> <a href="{{ "/tags/experimental-ambient" | relative_url }}">experimental-ambient</a> # 98</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Max Richter</td>
      <td>Blue Notebooks</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 68 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>70</td>
      <td>
          <img src="https://i.discogs.com/l6dHqtd_GzSIAKAdTvxUcIlHGGm4ZGvTJ5LHUQbFo9o/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI0NTgz/Ni0xMTM4MDY4MTM5/LmpwZWc.jpeg" alt="Cover for Max Richter: Blue Notebooks" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
      <td>Max Richter</td>
      <td>Max Richter: Blue Notebooks</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/composer" | relative_url }}">composer</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Ludovico Einaudi</td>
      <td>Ludovico Einaudi: Le onde</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2006-10-09</td>
      <td>Jóhann Jóhannsson</td>
      <td>The Sun&#39;s Gone Dim And The Sky&#39;s Turned Black</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/piano" | relative_url }}">piano</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>75</td>
      <td>
          <img src="https://i.discogs.com/oPX13dnh3q2BNa5jWrvSucJ6MJU8VcmkjWK6bSWyn48/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI0NDQ2/NzUtMTI4NDQxMjYz/MS5qcGVn.jpeg" alt="Cover for Runner" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-04-16</td>
      <td>Dustin O&#39;Halloran</td>
      <td>Runner</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/minimal-piano" | relative_url }}">minimal piano</a> # 69</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/minimal-piano" | relative_url }}">minimal piano</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano" | relative_url }}">piano</a> # 7</li>
    ...
    <tr>
      <td>61</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/565bb0d6a50ca5942aeb1bcb450e31a2.png" alt="Cover for Sketches" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-11-12</td>
      <td>Library Tapes</td>
      <td>Sketches</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 84 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a> # 53</li>
            <li> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a> # 79</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2008-08-25</td>
      <td>Max Richter</td>
      <td>24 Postcards in Full Colour</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 84 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a> # 48</li>
    ...
    <tr>
      <td>66</td>
      <td>
          <img src="https://i.discogs.com/pA57ztko35TcJXn-FZJx5WlnUx3wDAOeWfdEnhCTmNw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0ODUw/ODUtMTMxMzIwODc3/Ny5qcGVn.jpeg" alt="Cover for Volker Bertelmann: Ferndorf" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-09-22</td>
      <td>Hauschka</td>
      <td>Volker Bertelmann: Ferndorf</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      <td>45</td>
      <td>
          <img src="https://i.discogs.com/ALjZNkyZKJOrFGt8wuDGguerWvUdIsxoXJtHDZncvr8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0ODA0/MTUtMTQ5MTc5MTgx/OS05NDY0LmpwZWc.jpeg" alt="Cover for Fordlandia" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-11-03</td>
      <td>Jóhann Jóhannsson</td>
      <td>Fordlandia</td>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Jóhann Jóhannsson</td>
      <td>And in the endless pause there came the sound of bees</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 89.79591836734694 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a> # 73</li>
            <li> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>85</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/faeeb1769db8488ba039828772250832.png" alt="Cover for Henry May Long" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-03-09</td>
      <td>Max Richter</td>
      <td>Henry May Long</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/composer" | relative_url }}">composer</a> # 61</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>68</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ace379789a8240c2a87ff541c9de9afa.png" alt="Cover for Book Of Leaves" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-09-22</td>
      <td>Rachel Grimes</td>
      <td>Book Of Leaves</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      <td>46</td>
      <td>
          <img src="https://i.discogs.com/JF394FiYm0qxBcVtsbQGgiGd1vNa3yHYR9KPkmda228/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ1MjYy/NDctMTM3MTE5ODgy/MS0xNjU2LmpwZWc.jpeg" alt="Cover for …And They Have Escaped The Weight Of Darkness" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-05-07</td>
      <td>Ólafur Arnalds</td>
      <td>…And They Have Escaped The Weight Of Darkness</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 68 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>44</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/f46c7b8adf50f9f4de0afd8cf1c8b3e9.png" alt="Cover for Famous Places" style="max-width:120px; height:auto;" />
      </td>
      <td>2010-08-24</td>
      <td>Goldmund</td>
      <td>Famous Places</td>
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2010-10-16</td>
      <td>Hauschka</td>
      <td>Salon Des Amateurs Remixes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a> # 18</li>
    ...
    <tr>
      <td>99</td>
      <td>
          <img src="https://i.discogs.com/HX65WzDISIurtOf9F4Q86yAYPX0qLwxZoj4KHSULHHA/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI3MzY3/MTgtMTI5ODczMzEw/My5qcGVn.jpeg" alt="Cover for Dustin O&#39;Halloran: Lumiere" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-02-28</td>
      <td>Dustin O&#39;Halloran</td>
      <td>Dustin O&#39;Halloran: Lumiere</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      <td>89</td>
      <td>
          <img src="https://i.discogs.com/EQ-5LeRZA6L-jnD33lCyNSMPExdzMkAqLi-6TYFQdEU/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI5MjU3/MTktMTMxMzIyODE5/NS5qcGVn.jpeg" alt="Cover for Small Reality" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-06</td>
      <td>Ex Confusion</td>
      <td>Small Reality</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-ambient" | relative_url }}">experimental-ambient</a> # 77</li>
            <li> <a href="{{ "/tags/minimal-ambient" | relative_url }}">minimal ambient</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>74</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ec0e979828094c0ca81f82dfd425f82a.png" alt="Cover for The Monarch And The Viceroy" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-06</td>
      <td>Carlos Cipa</td>
      <td>The Monarch And The Viceroy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>78</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/de752810c55c467d9436b365de651266.png" alt="Cover for Another Happy Day" style="max-width:120px; height:auto;" />
      </td>
      <td>2013</td>
      <td>Ólafur Arnalds</td>
    ...
    <tr>
      <td>87</td>
      <td>
          <img src="https://i.discogs.com/TB_4N60AnrOYUxHnG7ofu_MKD4dueMMWvLAEKlowcl4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQyNDY1/NzgtMTM3NTEyMjg1/MS03OTIxLmpwZWc.jpeg" alt="Cover for Explorer&#39;s Club: 7. Belfast- Reykjavik" style="max-width:120px; height:auto;" />
      </td>
      <td>2013</td>
      <td>Hauschka</td>
      <td>Explorer&#39;s Club: 7. Belfast- Reykjavik</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      ...
      <td>2013-01-21</td>
      <td>Ludovico Einaudi</td>
      <td>In A Time Lapse</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/piano" | relative_url }}">piano</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>53</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ae30fa34ed7a4f91cf29416435bc5549.png" alt="Cover for Broadchurch" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-04-12</td>
      <td>Ólafur Arnalds</td>
      <td>Broadchurch</td>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/minimal-piano" | relative_url }}">minimal piano</a> # 98</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>42</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/188813088e9c4b48cb4e2655c0da62bb.png" alt="Cover for Atomos VII" style="max-width:120px; height:auto;" />
      </td>
      <td>2014-04-29</td>
      <td>A Winged Victory for the Sullen</td>
      <td>Atomos VII</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a> # 87</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>90</td>
      <td>
          <img src="https://i.discogs.com/hkZ_m4gqaU-fHbJdHsXT75QNDmewkfLHfmNHljuuo7Y/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc2MTI3/NDktMTY3MzEwNzg1/Ni0zMTM5LmpwZWc.jpeg" alt="Cover for Lights in the Sky" style="max-width:120px; height:auto;" />
      </td>
      <td>2014-08-19</td>
      <td>Peter Gregson</td>
    ...
    <tr>
      <td>31</td>
      <td>
          <img src="https://i.discogs.com/SilXH2gZiNTaBA5I5EqFGd25pnJU4ZJnvESzehakrBc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTc5ODEy/NTItMTQ1Mjg3MTc5/NC0zNDAxLmpwZWc.jpeg" alt="Cover for Screws Reworked" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-01-15</td>
      <td>Nils Frahm</td>
      <td>Screws Reworked</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      <td>83</td>
      <td>
          <img src="https://i.discogs.com/sBai7pEMnYvI73gKlDmJQcIzgNciKr-IPRmLeWwYXMc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTg0MDYy/NTMtMTQ2MDk4OTU2/MS0xNDg4LmpwZWc.jpeg" alt="Cover for The Poet" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-04-29</td>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 93.61702127659575 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>69</td>
      <td>
          <img src="https://i.discogs.com/kZU8xPLor5mEcJY40SU7-c78TWuQlxtbTyxRIWJhIYg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTg4OTk3/OTItMTQ3MTA4MDUy/OC00OTU4LmpwZWc.jpeg" alt="Cover for Raddir (Island Songs III)" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-08-12</td>
      <td>Ólafur Arnalds</td>
      <td>Raddir (Island Songs III)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
    ...
    <tr>
      ...
      <td>2018-02-02</td>
      <td>Jóhann Jóhannsson</td>
      <td>The Theory of Everything (Original Motion Picture Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a> # 9</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 98 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>64</td>
      <td>
          <img src="https://i.discogs.com/qsmHcV3S3XFcGEXdr19-wya5x5vS1wrKF67mjKGCmsw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1Mzk5/NTQ1LTE1OTA5MDky/MDQtNDk5NS5qcGVn.jpeg" alt="Cover for Copenhagen Dreams - Music from the film" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-04-05</td>
      <td>Jóhann Jóhannsson</td>
      <td>Copenhagen Dreams - Music from the film</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/postclassical" | relative_url }}">postclassical</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>33</td>
      <td>
          <img src="https://i.discogs.com/LHbfy81af-ZdefyTxKOBPBxMoZ52GmsFv7QJKL831xg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE3NzE4/ODY1LTE2MTUwNDI0/NDctOTkxNC5qcGVn.jpeg" alt="Cover for 2 Tracks from EUSA" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-10-21</td>
      <td>Yann Tiersen</td>
      <td>2 Tracks from EUSA</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/neoclassical" | relative_url }}">neoclassical</a></li>
