...
Industrial hardcore is a subgenre of electronic dance music that combines elements of industrial and hardcore techno. It is characterized by aggressive, distorted beats, dark and dystopian themes, and heavy use of sampling, often taken from industrial and noise music. The genre originated in the Netherlands in the late 1990s and has since spread to other parts of Europe. Some notable industrial hardcore artists include Promo, D-Passion, Ophidian, and Nosferatu.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gabber" | relative_url }}">gabber</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/techno-industrial" | relative_url }}">techno-industrial</a> # 82</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Towards A New Deconstruction</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Various Artists</td>
      <td>We Are Civil Servants United! Split</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/digital-hardcore" | relative_url }}">digital hardcore</a></li>
    ...
    <tr>
      ...
      <td>2009-11-07</td>
      <td>Shyft</td>
      <td>Rise of the New Industrial EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012-07-26</td>
      <td>The Outside Agency &amp; Ophidian</td>
      <td>The Disputed Kings of Industrial</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2016-03-04</td>
      <td>Tymon</td>
      <td>Rituals Of Distortion: Chapter 1</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rawstyle" | relative_url }}">rawstyle</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2016-08-12</td>
      <td>Tymon</td>
      <td>Rituals of Distortion: Chapter 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2022-01-28</td>
      <td>Revel</td>
      <td>WRONG IS RIGHT (Water Spirit Remix)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>The Blood Of Defeat</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/noise" | relative_url }}">noise</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/industrial" | relative_url }}">industrial</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/power-electronics" | relative_url }}">power electronics</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/german" | relative_url }}">german</a></li>
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/industrial-hardcore" | relative_url }}">industrial hardcore</a></li>
        </ul>
      </td>
      <td>
        <ul>
