...
Showtune music, also known as musical theatre music, refers to music written for stage productions, including Broadway musicals, West End productions, and other theatrical productions. Showtunes often feature a combination of music, lyrics, and choreography to tell a story or convey a specific message. The music in showtunes can range from ballads and romantic songs to upbeat dance numbers and comedic tunes. Some popular composers of showtune music include Andrew Lloyd Webber, Stephen Sondheim, and Rodgers and Hammerstein.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Stan Rogers: a matter of heart</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Guys and Dolls (1992 Broadway Revival Cast)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>Marni Nixon</td>
      <td>Marni Nixon Sings Classic Kern</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical-theater" | relative_url }}">musical theater</a></li>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Jonathan Larson</td>
      <td>&quot;Seasons Of Love&quot; - From The Motion Picture RENT</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Nathan Lane, Matthew Broderick</td>
      <td>The Producers - Original Broadway Cast</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>The Rocky Horror Show (2000 Broadway Revival Cast)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
    ...
    <tr>
      ...
      <td>2003</td>
      <td>Various Artists</td>
      <td>The Rocky Horror Picture Show: The Anniversary Edition (disc 2: Frank &#39;N&#39; Furter&#39;s Rare Experiments)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
    ...
    <tr>
      ...
      <td>2010-12-01</td>
      <td>Various Artists</td>
      <td>Falling In Love Is Wonderful: Broadway&#39;s Greatest Love Duets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>Richard O&#39;Brien</td>
      <td>The Rocky Horror Show (Original Roxy Cast)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/broadway" | relative_url }}">broadway</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
    ...
    <tr>
      ...
      <td>2018-05-11</td>
      <td>Foxes and Peppers</td>
      <td>Blfc: A Musical Tail</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/musical" | relative_url }}">musical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/showtune" | relative_url }}">showtune</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/hollywood" | relative_url }}">hollywood</a> # 47</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>Brent Barrett, Jenn Harris and Company</td>
      <td>Silence! - The Musical</td>
      <td>
        <ul>
        </ul>
