...
Last updated: <time datetime="2025-12-05T05:04:53.576Z">Fri Dec 05 2025 07:04:53 GMT+0200 (Eastern European Standard Time)</time>

### Description

NSBM stands for National Socialist Black Metal, which is a subgenre of black metal that incorporates fascist or far-right political ideologies into its music and imagery. This type of music is controversial and has been criticized for promoting extremist and hateful ideologies. Many in the metal community reject NSBM and its associated beliefs.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>54</td>
      <td>
          <img src="https://i.discogs.com/Cb9YnX4ioIw_OgROfQ28lBa5yl_-VCUUhjJjK6dPJUI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTMwOTE5/Ny0xMzE2MzU5OTkx/LmpwZWc.jpeg" alt="Cover for The Third Reich n&#39; Roll" style="max-width:120px; height:auto;" />
      </td>
      <td>1976-02</td>
      <td>The Residents</td>
      <td>The Third Reich n&#39; Roll</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rabm" | relative_url }}">rabm</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/usbm" | relative_url }}">usbm</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pagan-black-metal" | relative_url }}">pagan black metal</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rabm" | relative_url }}">rabm</a> # 22</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Fire Burns in Our Hearts</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/goregrind" | relative_url }}">goregrind</a> # 26</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/national-socialist" | relative_url }}">national socialist</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>14</td>
      <td>
          <img src="https://i.discogs.com/gCeNzgUo641CZ1TL8mVXBTDpBzBuOoDnTV8rxERpfhc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM4NjUz/Ni0xMjkyMzYxOTM3/LmpwZWc.jpeg" alt="Cover for The Eyes of the Beast" style="max-width:120px; height:auto;" />
      </td>
      <td>2001</td>
      <td>Astrofaes</td>
      <td>The Eyes of the Beast</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
        </ul>
    ...
    <tr>
      <td>1</td>
      <td>
          <img src="https://i.discogs.com/uThF0SNedcFsR-SyqpH5qq2qS8mUbGWQJeyGvk8vmlk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTM4NjU1/Ni0xNTA5NjI5MTcw/LTY2MTUuanBlZw.jpeg" alt="Cover for Heritage" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-07</td>
      <td>Astrofaes</td>
      <td>Heritage</td>
    ...
    <tr>
      <td>25</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/92809cf72bb34528abd07c290f9a6828.png" alt="Cover for Totenlieder" style="max-width:120px; height:auto;" />
      </td>
      <td>2003</td>
      <td>Absurd</td>
      <td>Totenlieder</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/germany" | relative_url }}">germany</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/gorenoise" | relative_url }}">gorenoise</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rabm" | relative_url }}">rabm</a> # 1</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/germany" | relative_url }}">germany</a> # 73</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>44</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/d329f12beaa04a73ca7e897374068508.png" alt="Cover for Grimmige Volksmusik" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-12-24</td>
      <td>Absurd</td>
      <td>Grimmige Volksmusik</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
    ...
    <tr>
      <td>28</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/fbd3f24d05d28e6a256a8cb2c6fa559c.png" alt="Cover for Paris" style="max-width:120px; height:auto;" />
      </td>
      <td>2006-08-21</td>
      <td>Paris Hilton</td>
      <td>Paris</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/paris" | relative_url }}">paris</a> # 9</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2006-08</td>
      <td>Der Stürmer</td>
      <td>A Banner Greater than Death</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/greek" | relative_url }}">greek</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/greek" | relative_url }}">greek</a> # 84</li>
    ...
    <tr>
      <td>64</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/23d1b6b47cd14d41bf9685583d4552dd.png" alt="Cover for Still Da Baddest" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-04-01</td>
      <td>Trina</td>
      <td>Still Da Baddest</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hip-hop" | relative_url }}">hip-hop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/dark-electro" | relative_url }}">dark electro</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rabm" | relative_url }}">rabm</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>24</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a755ccdecc29457cb990eed211e9954a.png" alt="Cover for By The Wing Of Black" style="max-width:120px; height:auto;" />
      </td>
      <td>2012</td>
      <td>M8L8TH</td>
      <td>By The Wing Of Black</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/goregrind" | relative_url }}">goregrind</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/pagan-black-metal" | relative_url }}">pagan black metal</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rechtsrock" | relative_url }}">rechtsrock</a> # 2</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/rabm" | relative_url }}">rabm</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>61</td>
      <td>
          <img src="https://i.discogs.com/s8Jm6aGMk9EuQxXmk6pERccOqKyP92kIDF9uAUeWGmg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0NTQ4/MDc5LTE1NzY4Mjk4/MDUtNDY3OC5qcGVn.jpeg" alt="Cover for FACTS" style="max-width:120px; height:auto;" />
      </td>
      <td>2019-09-06</td>
      <td>Tom MacDonald</td>
      <td>FACTS</td>
    ...
    <tr>
      <td>97</td>
      <td>
          <img src="https://i.discogs.com/PHJD2PhhVwZOCsJftx5rspUFcO9mlJKAJd4G0JjEawc/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE2NDMy/MTYxLTE2MDc3MTAy/NjItNDAyOS5qcGVn.jpeg" alt="Cover for Die Very Rough" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-06-25</td>
      <td>Mario Judah</td>
    ...
    <tr>
      <td>60</td>
      <td>
          <img src="https://i.discogs.com/kVoIXzyPEN89ilFahZzhgO0vEr7dvKzD7aVxZWELjjM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE2MzMy/ODEzLTE2MDcxMTUz/OTUtOTk1NC5qcGVn.jpeg" alt="Cover for Melinoë" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-12-18</td>
      <td>Akhlys</td>
      <td>Melinoë</td>
    ...
    <tr>
      <td>11</td>
      <td>
          <img src="https://i.discogs.com/tXIlJsaRQd3w6gKDiVtycjPPDQ4IhtxW1Rw6GwpLK3A/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI0ODc4/NDg2LTE3MDI0NTk2/MTctNTk1OS5qcGVn.jpeg" alt="Cover for Midnights [Clean]" style="max-width:120px; height:auto;" />
      </td>
      <td>2022</td>
      <td>Taylor Swift</td>
      <td>Midnights [Clean]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/israel" | relative_url }}">israel</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/rac" | relative_url }}">rac</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/israel" | relative_url }}">israel</a> # 10</li>
            <li> <a href="{{ "/tags/rac" | relative_url }}">rac</a> # 67</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/israel" | relative_url }}">israel</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/rac" | relative_url }}">rac</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/goregrind" | relative_url }}">goregrind</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Twinkle Twinkle Little Star &amp; More Kids Songs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nsbm" | relative_url }}">nsbm</a></li>
