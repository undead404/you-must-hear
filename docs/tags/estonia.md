...
Estonian music refers to the music of Estonia, a small country in Northern Europe. Estonian music has a rich and diverse history, with influences from traditional folk music, classical music, and contemporary styles. One of the most important forms of traditional Estonian music is runic singing, which involves singing ancient folk songs called regilaulud. In addition to traditional music, Estonia is known for its composers, such as Arvo Pärt, who is known for his minimalist, meditative style, and Veljo Tormis, who incorporated traditional Estonian folk songs into his compositions. Estonian music has also produced notable performers in other genres, including pop singer Kerli and electronic musician Uku Kuut.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Sola Muusika 2005 Musictrade Showcase</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>Various Artists</td>
      <td>Kelder EP &quot;Audiokäärid&quot; KLDR001</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 97</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2001</td>
      <td>Идеальные люди</td>
      <td>Выполнимое задание</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/estonia" | relative_url }}">estonia</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 68</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 66</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 33</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 14</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 20</li>
    ...
    <tr>
      ...
      <td>2010-01-11</td>
      <td>Egobomber</td>
      <td>Fall of Planet Esoteria EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electro" | relative_url }}">electro</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronica" | relative_url }}">electronica</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 83</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 64</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/estonian" | relative_url }}">estonian</a> # 96</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2013-08-13</td>
      <td>Goebbels and the Plasmamammoths</td>
      <td>More Morphine EP</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2015-08-01</td>
      <td>Velly Joonas</td>
      <td>Stopp, seisku aeg! &#x2F; Käes on aeg</td>
      <td>
        <ul>
        </ul>
      </td>
