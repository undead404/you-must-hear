...
Last updated: <time datetime="2025-12-06T21:25:17.607Z">Sat Dec 06 2025 23:25:17 GMT+0200 (Eastern European Standard Time)</time>

### Description

J-rock is Japanese rock music that blends Western rock influences with distinctively Japanese pop sensibilities and production styles. Emerging in the 1960s and evolving through decades, it ranges from psychedelic experimentalism to polished pop-rock. The genre often features melodic vocals, intricate arrangements, and a theatrical visual aesthetic.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2002-04-03</td>
      <td>ELLEGARDEN</td>
      <td>Don&#39;t Trust Anyone But Us</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      <td>29</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/1bf4e6661eea136a26f426c8d953f868.png" alt="Cover for Houkai Amplifier" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-11-25</td>
      <td>ASIAN KUNG-FU GENERATION</td>
      <td>Houkai Amplifier</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6f68e5904e648e943c183e7073e1cd5b.png" alt="Cover for ファンクラブ" style="max-width:120px; height:auto;" />
      </td>
      <td>2006-03-15</td>
      <td>ASIAN KUNG-FU GENERATION</td>
      <td>ファンクラブ</td>
    ...
    <tr>
      <td>31</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/1ca577cbedd71d04b7c2b131106ebdcd.png" alt="Cover for ワールド ワールド ワールド" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-03-05</td>
      <td>ASIAN KUNG-FU GENERATION</td>
      <td>ワールド ワールド ワールド</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Lisa</td>
      <td>Akai Wana (Who Loves It?) &#x2F; ADAMAS</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
        </ul>
    ...
    <tr>
      <td>52</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5d5f497b2f2bd3e86cd72be417dbbaa2.png" alt="Cover for Ambivalent Symphony" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-10-21</td>
      <td>exist†trace</td>
      <td>Ambivalent Symphony</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
    ...
    <tr>
      ...
      <td>Ho-Kago Tea Time II (From &quot;K-On!!&quot;)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
    ...
    <tr>
      <td>98</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ae016bc9f8d04ce7cc11048393e3219a.png" alt="Cover for 残響リファレンス" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-05-10</td>
      <td>ONE OK ROCK</td>
      <td>残響リファレンス</td>
    ...
    <tr>
      ...
      <td>2015-06-03</td>
      <td>My Dead Girlfriend</td>
      <td>hades (the nine stages of change at the deceased remains)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      <td>6</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/b48cc50ccc4acf4b0d4677d1e17e4a51.png" alt="Cover for Shingeki no Kiseki" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-07-23</td>
      <td>Linked Horizon</td>
      <td>Shingeki no Kiseki</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/math-rock" | relative_url }}">math rock</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/city-pop" | relative_url }}">city pop</a> # 24</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>影森みちる(CV:諸星すみれ)、Shin Sakiura feat. AAAMYY、日渡なずな(CV:長縄まりあ)、mabanua</td>
      <td>アニメ『BNA ビー・エヌ・エー』Complete album</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-rock" | relative_url }}">j-rock</a></li>
