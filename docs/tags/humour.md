...
Humour is a diverse music genre centered on comedic, satirical, or absurdist themes rather than a specific sound. Artists use wit, parody, or unconventional performances to entertain and provoke, spanning styles from children&#39;s songs to punk provocations. The genre prioritizes clever lyrics and theatrical delivery over musical conventions.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Music From The Penguin Cafe</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1982</td>
      <td>Bourvil</td>
      <td>A Bicyclette&#x2F;Disques Pathe</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/electric-guitar" | relative_url }}">electric guitar</a> # 13</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/liedermacher" | relative_url }}">liedermacher</a> # 51</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Les Wriggles</td>
      <td>Justice Avec Des Saucisses</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Les Wriggles</td>
      <td>Les Wriggles Partent En Live</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
    ...
    <tr>
      ...
      <td>2004-11-16</td>
      <td>François Pérusse</td>
      <td>Les 2 Minutes Du Peuple</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/soft-rock" | relative_url }}">soft rock</a> # 46</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2012-04-11</td>
      <td>Pen of Chaos</td>
      <td>Le Donjon de Naheulbeuk Saison 1</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2020</td>
      <td>Karliene</td>
      <td>The Ballad of Anne Boleyn</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>2020-04-10</td>
      <td>Helmut Fritz</td>
      <td>ça m&#39;énerve - pack spécial Virginmega</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
        </ul>
