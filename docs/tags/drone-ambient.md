...
Drone ambient is a subgenre of ambient music that emphasizes the use of sustained or repeated sounds, often generated through electronic or acoustic means. The sounds may be produced using synthesizers, guitars, or other instruments, and are often manipulated or processed to create a sense of immersion or hypnotic effect. The music tends to be slow-paced and meditative, with an emphasis on texture and atmosphere rather than melody or rhythm. Drone ambient is often associated with themes of nature, mysticism, and spirituality.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Velehentor</td>
      <td>...Из Мрака Могил. Каменные Колодцы Вечности</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Mathias Grassow &amp; Klaus Wiese</td>
      <td>Mercurius</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>MGR</td>
      <td>Wavering on the Cresting Heft</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a></li>
    ...
    <tr>
      ...
      <td>2007-07-13</td>
      <td>Aidan Baker</td>
      <td>I Will Always And Forever Hold You In My Heart And Mind</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2007-08-13</td>
      <td>Mathias Grassow &amp; Thomas Weiss</td>
      <td>Outland</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a></li>
    ...
    <tr>
      ...
      <td>2008-07-22</td>
      <td>Celer</td>
      <td>Discourses Of The Withered</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2009-11-01</td>
      <td>Sequences</td>
      <td>Vespertine: A Tragedy In Several Tones Of Grey</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dark-ambient" | relative_url }}">dark ambient</a></li>
    ...
    <tr>
      ...
      <td>2011-12</td>
      <td>Tomas Weiss &amp; Mathias Grassow</td>
      <td>Quiet Calling III</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a></li>
        </ul>
    ...
    <tr>
      <td>51</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/e46595c7c9c343a2befb63f3f6665cc3.png" alt="Cover for Travels" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-01-11</td>
    ...
    <tr>
      ...
      <td>2013-12-16</td>
      <td>Hakobune</td>
      <td>Looping Around the Forest I Thought I Remembered</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>ухушуху</td>
      <td>длинные песни приятные слуху</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
    ...
    <tr>
      ...
      <td>2019-02-01</td>
      <td>Cosmin TRG</td>
      <td>hope this finds you well</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>EnVain III : Voices of the Night</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-ambient" | relative_url }}">drone ambient</a></li>
