...
Real screamo is an emotionally raw subgenre of hardcore punk that emerged in the 1990s, characterized by passionate shrieked vocals, dynamic shifts between quiet introspection and explosive intensity, and deeply personal lyrics about pain and catharsis. The sound emphasizes authenticity and emotional vulnerability over commercial appeal, distinguishing it from mainstream bands incorrectly labeled as screamo. It thrives in underground DIY scenes where intimate performances create visceral connections between musicians and audiences.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1998</td>
      <td>Orchid</td>
      <td>Orchid&#x2F;Encyclopedia of American Traitors</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Yaphet Kotto</td>
      <td>The Killer was in the Government Blankets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/screamo" | relative_url }}">screamo</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>In&#x2F;Humanity</td>
      <td>Violent Resignation: The Great American Teenage Suicide Rebellion 1992-1998</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Yaphet Kotto</td>
      <td>Syncopated Synthetic Laments For Love</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/noisecore" | relative_url }}">noisecore</a> # 75</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>The Death of Anna Karina</td>
      <td>The Death of Anna Karina</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/screamo" | relative_url }}">screamo</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Off Minor</td>
      <td>The Heat Death Of The Universe</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/screamo" | relative_url }}">screamo</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Document #13: Pyramids In Cloth</td>
      <td>
        <ul>
    ...
    <tr>
      <td>92</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/b39609198b38430fb54a86dfa856ba1a.png" alt="Cover for Discography" style="max-width:120px; height:auto;" />
      </td>
      <td>2003</td>
      <td>The Spirit of Versailles</td>
      <td>Discography</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>Left Hand Cuts The Right</td>
      <td>You Breathed Like Winter</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-hardcore" | relative_url }}">post-hardcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      <td>64</td>
      <td>
          <img src="https://i.discogs.com/89Yn7APJO_hEn6ARfZ0dr_vcejKIVqYm9C48zAry1J8/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ1MTg1/NTctMTM2NzE2NDUy/My0yMTEyLmpwZWc.jpeg" alt="Cover for Quantice Never Crashed" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
    ...
    <tr>
      ...
      <td>A Collection of Songs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/screamo" | relative_url }}">screamo</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>91</td>
      <td>
          <img src="https://i.discogs.com/m94AQUpCBQ_KGhnbok1Gs3BbS_0sHrgncrPLf2Cxp5w/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE5NDM3/NzYtMTI1NDI0MDcy/MS5qcGVn.jpeg" alt="Cover for Welcome the Plague Year" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
      <td>Welcome the Plague Year</td>
      <td>Welcome the Plague Year</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/skramz" | relative_url }}">skramz</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Index for Potential Suicide</td>
      <td>&quot;Sex, Violence, Whatever&quot;: The Complete Recordings</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      <td>61</td>
      <td>
          <img src="https://i.discogs.com/H61LpdJnTD9VayxSPhfggcbOVdgWKORtVrfimbykRtM/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIzNTU0/MTEtMTQxODQ4MDkx/MS00ODA0LmpwZWc.jpeg" alt="Cover for Fieldtrips and Friendships" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-03</td>
      <td>I Spoke</td>
      <td>Fieldtrips and Friendships</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Swallow! Swallow! Splinter!</td>
      <td>demo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      <td>71</td>
      <td>
          <img src="https://i.discogs.com/26U2hCCewiVRGwY3-hGqmeZCyxpVq-rWV7wX72fNllo/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI3NDI4/MzItMTI5OTAwMTQ3/Ny5wbmc.jpeg" alt="Cover for The First Five Years" style="max-width:120px; height:auto;" />
      </td>
      <td>2007</td>
      <td>Ampere</td>
      <td>The First Five Years</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
        </ul>
    ...
    <tr>
      <td>66</td>
      <td>
          <img src="https://i.discogs.com/tzjgccIUlKRcFDqdsVLzvP1e_uZ5RRcjMHvBNL29hVg/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI0MTg4/Nzg5LTE2NjAzOTUy/NjktNTM2NS5qcGVn.jpeg" alt="Cover for Summers" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-09-01</td>
      <td>We Were Skeletons</td>
      <td>Summers</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Beau Navire</td>
      <td>Suffix&#x2F;Beau Navire Split</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-hardcore" | relative_url }}">post-hardcore</a></li>
    ...
    <tr>
      ...
      <td>This Is Not an Erect, All-Red Neon Body</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Old Gray</td>
      <td>Old Gray&#x2F;Girl Scouts Split</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/screamo" | relative_url }}">screamo</a></li>
    ...
    <tr>
      ...
      <td>För Alltid Var Bara Något Vi Sa</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
    ...
    <tr>
      ...
      <td>2013-06-03</td>
      <td>Gillian Carter</td>
      <td>Lost Ships Sinking With The Sunset</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-rock" | relative_url }}">post-rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://i.discogs.com/r-ZNdH0dowd-WRy5yG4pS5ZLh6NRAAg1Z0cpZW7ZC6M/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTgyMTk5/OTEtMTQ1NzM3ODg1/Ni00MDE4LmpwZWc.jpeg" alt="Cover for Dreams Of Suffocation" style="max-width:120px; height:auto;" />
      </td>
      <td>2016</td>
      <td>Gillian Carter</td>
      <td>Dreams Of Suffocation</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/post-rock" | relative_url }}">post-rock</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/real-screamo" | relative_url }}">real screamo</a></li>
    ...
    <tr>
      ...
      <td>2016-04-01</td>
      <td>BEAST JESUS</td>
      <td>In Various States of Disassembly</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ukraine" | relative_url }}">ukraine</a> # 10</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2018</td>
      <td>La Dispute</td>
      <td>The Castle Builders (10th Anniversary)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore" | relative_url }}">hardcore</a></li>
    ...
    <tr>
      ...
      <td>Your Arms Are My Cocoon (Deluxe Edition)</td>
      <td>
        <ul>
