...
Latin rock fuses rock instrumentation and energy with Latin American musical traditions like salsa, cumbia, and bolero. The genre emerged in the 1960s, blending electric guitars and drums with Latin percussion, Spanish lyrics, and Caribbean rhythms. It represents a cultural bridge between Anglo-American rock and Latino identity.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Donde Hay Música (Spanish Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
    ...
    <tr>
      ...
      <td>1997-03-11</td>
      <td>Santana</td>
      <td>Live At The Fillmore - 1968</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-rock" | relative_url }}">latin rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>La Marcha Del Golazo Solitario</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-rock" | relative_url }}">latin rock</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 68 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007-03-27</td>
      <td>Ozomatli</td>
      <td>Don&#39;t Mess With The Dragon</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2009-06-30</td>
      <td>Santana</td>
      <td>The Woodstock Experience</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin" | relative_url }}">latin</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/latin-rock" | relative_url }}">latin rock</a></li>
