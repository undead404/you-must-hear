...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/old-school-heavy-metal" | relative_url }}">old-school heavy metal</a> # 86</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a> # 26</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1980-10-03</td>
      <td>Diamond Head</td>
      <td>Lightning to the Nations</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1980-11-21</td>
      <td>Iron Maiden</td>
      <td>Iron Maiden (2015 Remaster)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nwobhm" | relative_url }}">nwobhm</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nwobhm" | relative_url }}">nwobhm</a></li>
            <li style="font-size: calc(1rem * 85 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/british-rock" | relative_url }}">british rock</a> # 73</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a> # 64</li>
            <li> <a href="{{ "/tags/speed-metal" | relative_url }}">speed metal</a> # 74</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/old-school-heavy-metal" | relative_url }}">old-school heavy metal</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/nwobhm" | relative_url }}">nwobhm</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/old-school-heavy-metal" | relative_url }}">old-school heavy metal</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1985</td>
      <td>Blitzkrieg</td>
      <td>A Time of Changes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
            <li style="font-size: calc(1rem * 73 / 100)"> <a href="{{ "/tags/nwobhm" | relative_url }}">nwobhm</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>100</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/34490fa0102242d5954e913e65865aaa.png" alt="Cover for British Standard Approved" style="max-width:120px; height:auto;" />
      </td>
      <td>1985</td>
      <td>Demon</td>
    ...
    <tr>
      ...
      <td>1986-09-29</td>
      <td>Iron Maiden</td>
      <td>Somewhere in Time (2015 - Remaster)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/old-school-heavy-metal" | relative_url }}">old-school heavy metal</a> # 45</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/english" | relative_url }}">english</a> # 48</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/modern-rock" | relative_url }}">modern rock</a> # 100</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/hatecore" | relative_url }}">hatecore</a> # 14</li>
            <li> <a href="{{ "/tags/gorenoise" | relative_url }}">gorenoise</a> # 18</li>
            ...
            <li> <a href="{{ "/tags/cybergrind" | relative_url }}">cybergrind</a> # 57</li>
            <li> <a href="{{ "/tags/finnish-black-metal" | relative_url }}">finnish black metal</a> # 58</li>
            <li> <a href="{{ "/tags/swedish-death-metal" | relative_url }}">swedish death metal</a> # 66</li>
            ...
            <li> <a href="{{ "/tags/war-metal" | relative_url }}">war metal</a> # 77</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/traditional-heavy-metal" | relative_url }}">traditional heavy metal</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>74</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6b33fb4109844024ae520016b50cf505.png" alt="Cover for The Time Lord" style="max-width:120px; height:auto;" />
      </td>
      <td>2004</td>
      <td>Pagan Altar</td>
      <td>The Time Lord</td>
    ...
    <tr>
      ...
      <td>2006-04-11</td>
      <td>Judas Priest</td>
      <td>The Essential Judas Priest</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/heavy-metal" | relative_url }}">heavy metal</a></li>
        </ul>
    ...
    <tr>
      <td>85</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/a6d352527ec4a76455161c1b162d27a9.png" alt="Cover for Heavy Metal Bulldozer" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-03-13</td>
      <td>Metalucifer</td>
      <td>Heavy Metal Bulldozer</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/nwobhm" | relative_url }}">nwobhm</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/groove-metal" | relative_url }}">groove metal</a> # 32</li>
    ...
    <tr>
      <td>14</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/2e52d3d9374294d5bdc818c36efb9928.png" alt="Cover for MONEY" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-03-29</td>
      <td>Money</td>
      <td>MONEY</td>
