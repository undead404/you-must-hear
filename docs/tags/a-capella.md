...
A capella refers to vocal music performed without instrumental accompaniment, where singers create all sounds using only their voices. This tradition spans from sacred choral works and barbershop quartets to contemporary pop arrangements, showcasing human vocal versatility across cultures. Performers often layer harmonies, create percussive effects through beatboxing, and mimic instruments to produce rich, full soundscapes.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>An Evening With Wild Man Fischer</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1977</td>
      <td>The King&#39;s Singers</td>
      <td>The King&#39;s Singers Madrigal History Tour</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Antoine Brumel - Missa Et ecce terrae motus (The Earthquake Mass)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
    ...
    <tr>
      ...
      <td>1985</td>
      <td>The King&#39;s Singers</td>
      <td>Watching the White Wheat</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1986</td>
      <td>The King&#39;s Singers</td>
      <td>The King&#39;s Christmas Collection</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1988</td>
      <td>The Tallis Scholars</td>
      <td>Heinrich Isaac - Missa de Apostolis</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
    ...
    <tr>
      ...
      <td>Dunstaple: Musician to the Plantagenets</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Paul Hillier</td>
      <td>Home To Thanksgiving - Songs of Thanks and Praise</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>1999-03-23</td>
      <td>Melanesian choirs: The Blessed Islands</td>
      <td>Chants from The Thin Red Line</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Grazyna Auguscik &amp; Urszula Dudziak</td>
      <td>To i hola</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
    ...
    <tr>
      ...
      <td>2001</td>
      <td>Chanticleer</td>
      <td>Christmas with Chanticleer</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
    ...
    <tr>
      ...
      <td>2002</td>
      <td>Cosmic Voices from Bulgaria</td>
      <td>Orthodox Chant</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2003-04-22</td>
      <td>Adachi Tomomi Royal Chorus</td>
      <td>Yo</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Tonic Sol-fa</td>
      <td>Something For the Rest of Us</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/christian" | relative_url }}">christian</a></li>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>St. Petersburg Optina Pustyn Male Choir</td>
      <td>St. Petersburg Optina Pustyn Male Choir: Russia&#39;s Most Beautiful Songs</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Vokalgruppe VIP</td>
      <td>Voces In Paradiso</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/a-capella" | relative_url }}">a capella</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/choral" | relative_url }}">choral</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Russian Men Choir</td>
      <td>The hymns, marches and songs of Russian Imperial army</td>
      <td>
        <ul>
        </ul>
      </td>
