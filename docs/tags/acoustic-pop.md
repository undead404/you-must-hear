...
Acoustic pop blends the accessible melodies and contemporary song structures of mainstream pop with the organic warmth of acoustic instruments like guitars and pianos. This style emphasizes intimacy and authenticity, stripping away heavy production to showcase vocals and songwriting in a more personal, unadorned setting. It appeals to listeners seeking the catchiness of pop music delivered with a relaxed, coffeehouse sensibility.
...
<table>
  ...
  <tbody>
    <tr>
      <td>29</td>
      <td>
          <img src="https://i.discogs.com/uzfTZWxpHvvYNY7kc1NXA2NNii5bW1TWilV250FnsE4/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyNzMz/MTUtMTU1MzMzNDE5/Ni05OTI4LmpwZWc.jpeg" alt="Cover for your problems are mine" style="max-width:120px; height:auto;" />
      </td>
      <td>1972</td>
      <td>Dom</td>
      <td>your problems are mine</td>
      <td>
        <ul>
    ...
    <tr>
      <td>33</td>
      <td>
          <img src="https://i.discogs.com/IGt6UBccCZEj6nxVtvKT3NSx7EIq6_bft9TQuAoQq8I/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1NTA4/NzgtMTI3Njk3MDMx/Ny5qcGVn.jpeg" alt="Cover for love does not need time" style="max-width:120px; height:auto;" />
      </td>
      <td>1992</td>
      <td>Paul Eckert</td>
      <td>love does not need time</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
    ...
    <tr>
      ...
      <td>2002-02-26</td>
      <td>Norah Jones</td>
      <td>Come Away With Me (Remastered 2022)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/blues" | relative_url }}">blues</a></li>
    ...
    <tr>
      ...
      <td>2003-06-25</td>
      <td>[+] Hori</td>
      <td>The Twilight Saga: Eclipse (Original Motion Picture Soundtrack) [Deluxe]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
    ...
    <tr>
      <td>5</td>
      <td>
          <img src="https://i.discogs.com/VIoSYOYVqm-aeEnGzVWWmstc9A5MW2pyUri8PxXoDeQ/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ1NTgz/MDctMTM2ODMyOTU5/OC0zOTc0LmpwZWc.jpeg" alt="Cover for Leva-me Para Casa" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Lúcia Moniz</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/brasileira" | relative_url }}">brasileira</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://i.discogs.com/0KjHl8mhQorol5ftJDPVb0HMwetFRH1HSWodqLANX1o/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTkxNzg1/NDUtMTQ3NjE0NzQz/NC05MTk5LmpwZWc.jpeg" alt="Cover for Fall Forever" style="max-width:120px; height:auto;" />
      </td>
      <td>2007</td>
      <td>Nate Schierman</td>
      <td>Fall Forever</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>The Tacticians</td>
      <td>London&#39;s Alright 7</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/duet" | relative_url }}">duet</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>95</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/c32cfbcc20314adcacb78d880ce86d10.png" alt="Cover for Comme si de rien n&#39;était" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-07-11</td>
      <td>Carla Bruni</td>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-indie" | relative_url }}">experimental indie</a> # 53</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/american-idol" | relative_url }}">american idol</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2013-04-22</td>
      <td>Ghostnotes</td>
      <td>Crossroads (demos of forthcoming album)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
    ...
    <tr>
      ...
      <td>2013-12-29</td>
      <td>Little Mix</td>
      <td>Love (Sweet Love) (Acoustic Version)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
    ...
    <tr>
      ...
      <td>2021-11-17</td>
      <td>ANAVITÓRIA</td>
      <td>Não Passa Vontade</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/mpb" | relative_url }}">mpb</a></li>
            <li style="font-size: calc(1rem * 53 / 100)"> <a href="{{ "/tags/brazilian" | relative_url }}">brazilian</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2023-02-17</td>
      <td>Madilyn</td>
      <td>the internet made me do it (the comment songs)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-rock" | relative_url }}">acoustic rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/organic-electronica" | relative_url }}">organic electronica</a> # 50</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 51 / 100)"> <a href="{{ "/tags/mpb" | relative_url }}">mpb</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td></td>
      <td>Timmy Lives In My House</td>
      <td>Timmy Lives In My House ep</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/folk" | relative_url }}">folk</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/mpb" | relative_url }}">mpb</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Mae Martin &amp; Lindsey Walsh</td>
      <td>Higher</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
    ...
    <tr>
      ...
      <td></td>
      <td>Hannah&#39;s Yard</td>
      <td>I Want to Know What Love Is (Acoustic)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic-pop" | relative_url }}">acoustic pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/singer-songwriter" | relative_url }}">singer-songwriter</a></li>
