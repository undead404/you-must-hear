...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1972</td>
      <td>Johannes Ciconia</td>
      <td>Sotto L&#39;imperio del Possente Prince: Hommage Music of the 14th and Early 15th Century</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>The Gordon Highlanders</td>
      <td>The Military Band Pipes And Drums Of The Gordon Highlanders</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>1991</td>
      <td>Victoria Police Pipe Band</td>
      <td>Live in the Rockies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/scottish" | relative_url }}">scottish</a></li>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Leo Rowsome</td>
      <td>Classics of Irish Piping</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>Caledonian Heritage Pipes &amp; Drums</td>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>The Lowland Band</td>
      <td>The Spirit Of Scotland</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>2010</td>
      <td>Saor Patrol</td>
      <td>The Stomp (Scottish Pipes and Drums Untamed)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>2010-10-15</td>
      <td>Red Hot Chilli Pipers</td>
      <td>Rockin&#39; the 6 Nations - Live at Murrayfield Stadium</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Saor Patrol</td>
      <td>Saor Patrol Two Headed Dog</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>2014-08-08</td>
      <td>Adrian Von Ziegler</td>
      <td>The Celtic Collection II</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>Pirates of the Carribeann Theme</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/celtic" | relative_url }}">celtic</a></li>
    ...
    <tr>
      ...
      <td>The Best Bagpipe Moments Ever</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/bagpipes" | relative_url }}">bagpipes</a></li>
        </ul>
