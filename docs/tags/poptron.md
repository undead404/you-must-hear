...
Last updated: <time datetime="2025-11-11T04:55:46.449Z">Tue Nov 11 2025 06:55:46 GMT+0200 (Eastern European Standard Time)</time>

### Description

Poptron blends electronic production with pop songcraft, characterized by shimmering synths, driving beats, and anthemic melodies that emerged from the late 2000s indie-electronic scene. The genre balances accessibility with experimental textures, drawing from French house, dream pop, and modern electronic music to create euphoric yet sophisticated soundscapes. Its polished production and emotive vocals appeal to both mainstream pop audiences and electronic music enthusiasts.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a> # 44</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/noise" | relative_url }}">noise</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 60 / 100)"> <a href="{{ "/tags/miami-bass" | relative_url }}">miami bass</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/miami-bass" | relative_url }}">miami bass</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/miami-bass" | relative_url }}">miami bass</a> # 90</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1988</td>
      <td>Diamanda Galás</td>
      <td>The Divine Punishment &amp; Saint of the Pit</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            ...
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/k-pop" | relative_url }}">k-pop</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/korean" | relative_url }}">korean</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 54 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/humour" | relative_url }}">humour</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/idol" | relative_url }}">idol</a> # 39</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 93.87755102040816 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 93.87755102040816 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 93.87755102040816 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 93.87755102040816 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 93.87755102040816 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 93.87755102040816 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
            <li style="font-size: calc(1rem * 93.87755102040816 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 91.30434782608695 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 91.30434782608695 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 89.13043478260869 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
            <li style="font-size: calc(1rem * 89.13043478260869 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 85.86956521739131 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 85.86956521739131 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 85.86956521739131 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 85.86956521739131 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 85.86956521739131 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 82.6086956521739 / 100)"> <a href="{{ "/tags/female-vocalists" | relative_url }}">female vocalists</a></li>
            <li style="font-size: calc(1rem * 79.34782608695652 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/humour" | relative_url }}">humour</a> # 76</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a> # 15</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 90 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            ...
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/idol" | relative_url }}">idol</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 75 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 94 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/humour" | relative_url }}">humour</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/power-metal" | relative_url }}">power metal</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/humour" | relative_url }}">humour</a> # 38</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1997</td>
      <td>GG Allin</td>
      <td>freaks, faggots, drunks and junkies</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/idol" | relative_url }}">idol</a> # 13</li>
            <li> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/miami-bass" | relative_url }}">miami bass</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/idol" | relative_url }}">idol</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/miami-bass" | relative_url }}">miami bass</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/australian" | relative_url }}">australian</a> # 69</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/crunk" | relative_url }}">crunk</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/miami-bass" | relative_url }}">miami bass</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2011-09-13</td>
      <td>Seeds Of Iblis</td>
      <td>Jihad against Islam</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/black-metal" | relative_url }}">black metal</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/ambient" | relative_url }}">ambient</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/christian" | relative_url }}">christian</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/dance" | relative_url }}">dance</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/easy-listening" | relative_url }}">easy listening</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/hebrew" | relative_url }}">hebrew</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/jewish" | relative_url }}">jewish</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 87.77777777777777 / 100)"> <a href="{{ "/tags/rock" | relative_url }}">rock</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/australian" | relative_url }}">australian</a> # 20</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/french-indie" | relative_url }}">french indie</a> # 25</li>
            <li> <a href="{{ "/tags/parisienne" | relative_url }}">parisienne</a> # 37</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/ethereal" | relative_url }}">ethereal</a></li>
            ...
            <li style="font-size: calc(1rem * 64 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/ambient-electronic" | relative_url }}">ambient electronic</a> # 91</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/pop" | relative_url }}">pop</a></li>
            <li style="font-size: calc(1rem * 92 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            ...
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/comedy" | relative_url }}">comedy</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/gothic-metal" | relative_url }}">gothic metal</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/symphonic-metal" | relative_url }}">symphonic metal</a></li>
            <li style="font-size: calc(1rem * 86 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/gothic-rock" | relative_url }}">gothic rock</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            ...
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/emocore" | relative_url }}">emocore</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2015-06-30</td>
      <td>King Dude</td>
      <td>Songs of Flesh &amp; Blood - In The Key of Light</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/trap" | relative_url }}">trap</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2017-03-24</td>
      <td>Diamanda Galás</td>
      <td>At Saint Thomas The Apostle Harlem</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/emo" | relative_url }}">emo</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/visual-kei" | relative_url }}">visual kei</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/j-pop" | relative_url }}">j-pop</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/japanese" | relative_url }}">japanese</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/poptron" | relative_url }}">poptron</a></li>
            <li style="font-size: calc(1rem * 59 / 100)"> <a href="{{ "/tags/art-pop" | relative_url }}">art pop</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/miami-bass" | relative_url }}">miami bass</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/parisienne" | relative_url }}">parisienne</a> # 54</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/folktronica" | relative_url }}">folktronica</a> # 13</li>
    ...
    <tr>
      ...
      <td>2021-09-26</td>
      <td>Guinevere Laurent</td>
      <td>Starlight Reservoir, It Was Strange</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/vocaloid" | relative_url }}">vocaloid</a> # 62</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2022-12-19</td>
      <td>Bonnie Banane</td>
      <td>Mauvaise Foi - A COLORS SHOW</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative" | relative_url }}">alternative</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-rnb" | relative_url }}">alternative rnb</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gothic-pop" | relative_url }}">gothic pop</a> # 31</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/neoclassical-darkwave" | relative_url }}">neoclassical darkwave</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
