...
Microtonal music uses intervals smaller than the standard half-steps found on a piano, dividing octaves into more than twelve notes to explore unusual scales and tunings. This approach creates otherworldly, sometimes dissonant sounds that can range from subtly exotic to dramatically alien, challenging Western ears accustomed to conventional pitch relationships. Found across experimental classical, avant-garde metal, and electronic music, it represents both ancient non-Western traditions and modern sonic exploration.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 79 / 100)"> <a href="{{ "/tags/microtonal" | relative_url }}">microtonal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Giacinto Scelsi</td>
      <td>Œuvre intégrale pour chœur et orchestre symphonique</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/microtonal" | relative_url }}">microtonal</a></li>
    ...
    <tr>
      ...
      <td>Who&#39;s Been Rocking My Dream-Boat?</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/microtonal" | relative_url }}">microtonal</a></li>
    ...
    <tr>
      ...
      <td>2006</td>
      <td>Alois Hába</td>
      <td>String Quartets Vol.2 (Stamic Quartet)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/microtonal" | relative_url }}">microtonal</a></li>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>David Fiuczynski</td>
      <td>Flam! Blam! Pan-Asian MicroJam!</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2012-06-02</td>
      <td>Sean Archibald</td>
      <td>Sean but not Heard</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drum-and-bass" | relative_url }}">drum and bass</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/electronic" | relative_url }}">electronic</a></li>
