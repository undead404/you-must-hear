...
Last updated: <time datetime="2025-12-06T05:22:58.164Z">Sat Dec 06 2025 07:22:58 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    <tr>
      <td>1</td>
      <td>
          <img src="https://i.discogs.com/ukMAcgZENLRXwigpQvkr0jcF1t1XSrBW_tp_Y5xeXRw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQ0NjUy/NTUtMTQ0OTI2OTY2/NS0xOTQ1LmpwZWc.jpeg" alt="Cover for Peer Gynt" style="max-width:120px; height:auto;" />
      </td>
      <td>1957</td>
      <td>Edvard Grieg</td>
      <td>Peer Gynt</td>
    ...
    <tr>
      ...
      <td>Bach: The Goldberg Variations, BWV 988 (1981 Gould Remaster)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1967</td>
      <td>Jean Sibelius</td>
      <td>SIBELIUS: Piano Music, Vol. 4</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/baroque" | relative_url }}">baroque</a> # 29</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/baroque" | relative_url }}">baroque</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>101 Famous Classical Masterpieces Volume 5</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1977</td>
      <td>Ludwig van Beethoven</td>
      <td>Beethoven: Piano Sonatas Nos. 8, 14 and 23</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1984</td>
      <td>Gabriel Fauré</td>
      <td>Requiem &amp; Cantique de Jean Racine - Cambridge Singers City of London Sinfonia John Rutter</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a> # 17</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>Klavierwerke: Clair de Lune</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/baroque" | relative_url }}">baroque</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>16</td>
      <td>
          <img src="https://i.discogs.com/mHZ_pbGCWjxgogPfTVJA68VJJnzC25ZM4fYN_KugSgs/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1NDE4/MDUzLTE1OTEyMTMw/NDAtOTg2MS5qcGVn.jpeg" alt="Cover for Piano Concerto" style="max-width:120px; height:auto;" />
      </td>
      <td>1985</td>
      <td>Maurice Ravel</td>
    ...
    <tr>
      ...
      <td>Symphonie Fantastique op.14</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/baroque" | relative_url }}">baroque</a> # 94</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphony" | relative_url }}">symphony</a> # 53</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/orchestral" | relative_url }}">orchestral</a> # 84</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>2</td>
      <td>
          <img src="https://i.discogs.com/Mxhr-LOMw7-sqZQcR7ScMYCbToxLgz0iSlG0HlV0Fkk/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE1OTY5/MTYwLTE2MDExMTIy/NzItMjU3Ni5qcGVn.jpeg" alt="Cover for Vivaldi" style="max-width:120px; height:auto;" />
      </td>
      <td>1992</td>
      <td>Antonio Vivaldi</td>
      <td>Vivaldi</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/opera" | relative_url }}">opera</a> # 55</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1993</td>
      <td>Wolfgang Amadeus Mozart</td>
      <td>Requiem (Herbert von Karajan)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/lieder" | relative_url }}">lieder</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>1994</td>
      <td>Franz Liszt</td>
      <td>Liszt: Scherzo and March &#x2F; 3 Liebestraume &#x2F; Berceuse</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>Saint-saens: Symphony No. 3 &#x2F; Piano Concerto No. 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>John Williams</td>
      <td>Star Wars: A New Hope (Original Motion Picture Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/requiem" | relative_url }}">requiem</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Frédéric Chopin</td>
      <td>Chopin: Complete Nocturnes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Carl Orff</td>
      <td>Carmina Burana (Chicago Symphony Orchestra feat. conductor: James Levine)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/symphony" | relative_url }}">symphony</a> # 8</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/choral" | relative_url }}">choral</a> # 5</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/baroque" | relative_url }}">baroque</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>11</td>
      <td>
          <img src="https://i.discogs.com/XciKUBnCzDMZxW100SUbP9esFFNn6p7HasuzoUnnJYw/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTkwODkz/MjEtMTQ3NTEzNTk3/OS05OTUwLmpwZWc.jpeg" alt="Cover for Romeo and Juliet" style="max-width:120px; height:auto;" />
      </td>
      <td>1997</td>
    ...
    <tr>
      ...
      <td>1998-11-09</td>
      <td>Vanessa-Mae</td>
      <td>The Original Four Seasons And The Devil&#39;s Trill Sonata</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/instrumental" | relative_url }}">instrumental</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/animals" | relative_url }}">animals</a> # 97</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2004</td>
      <td>John Williams</td>
      <td>Star Wars: The Empire Strikes Back (Original Motion Picture Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/soundtrack" | relative_url }}">soundtrack</a></li>
    ...
    <tr>
      <td>6</td>
      <td>
          <img src="https://i.discogs.com/hZggMDpIxxvAdnKE24GH68p1pOkm6TJ2X_fTGqTLG_c/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTU3ODM5/NzQtMTQwMjU2MzQ1/Ny00OTM0LmpwZWc.jpeg" alt="Cover for Vivaldi: The Four Seasons" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Antonio Vivaldi</td>
    ...
    <tr>
      ...
      <td>2005</td>
      <td>Frédéric Chopin</td>
      <td>Chopin: Nocturnes (Volume 1)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/finnish" | relative_url }}">finnish</a> # 81</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2011</td>
      <td>Franz Liszt</td>
      <td>Liszt: Dreams of Love; Consolations; Sonnets of Petrarca; Rigoletto Paraphrase</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/piano" | relative_url }}">piano</a></li>
    ...
    <tr>
      ...
      <td>2012</td>
      <td>Claude Debussy</td>
      <td>Debussy: Children&#39;s Corner, Suite Bergamasque, Images</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/lullabies" | relative_url }}">lullabies</a> # 99</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/contemporary-jazz" | relative_url }}">contemporary jazz</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/orchestral" | relative_url }}">orchestral</a> # 7</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>La La Land (Original Motion Picture Score)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/jazz" | relative_url }}">jazz</a></li>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>John Williams</td>
      <td>Star Wars: Revenge Of The Sith (Original Motion Picture Soundtrack)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2018</td>
      <td>Howard Shore</td>
      <td>The Lord of the Rings - Return of the King [Complete Recordings]</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/soundtrack" | relative_url }}">soundtrack</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/piano" | relative_url }}">piano</a> # 42</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>The Gadfly - Five Days - Five Nights</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2020</td>
      <td>Dmitri Shostakovich</td>
      <td>Shostakovich: Jazz Suites Nos. 1 - 2 &#x2F; The Bolt &#x2F; Tahiti Trot</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2023-02-02</td>
      <td>Claude Debussy</td>
      <td>The Ultimate Most Relaxing Classics For Kids In The Universe</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      <td>15</td>
      <td>
          <img src="https://i.discogs.com/0qRBmhLVkC24tJXa7XnZATQuA1CYs2HBeLGuhXmGkJI/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTI2ODM4/OTUzLTE2ODIxMzI1/MzQtOTM1Mi5qcGVn.jpeg" alt="Cover for Debussy: Clair de Lune and Other Piano Favourites" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-02-23</td>
      <td>Claude Debussy</td>
    ...
    <tr>
      ...
      <td></td>
      <td>Modest Petrovich Mussorgsky</td>
