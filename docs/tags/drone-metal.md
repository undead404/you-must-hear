...
Last updated: <time datetime="2025-12-04T10:42:51.387Z">Thu Dec 04 2025 12:42:51 GMT+0200 (Eastern European Standard Time)</time>

### Description

Drone metal is an extreme subgenre that emphasizes sustained, heavily distorted guitar tones and minimal rhythmic progression, creating immersive walls of sound. Emerging from doom metal and experimental music scenes in the 1990s, it strips away traditional song structures in favor of lengthy, meditative compositions that explore texture and atmosphere. The genre cultivates an intense, almost ritualistic listening experience through sheer volume and sonic density.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1991-10-01</td>
      <td>Earth</td>
      <td>Extra-Capsular Extraction</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/drone" | relative_url }}">drone</a> # 43</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doom-metal" | relative_url }}">doom metal</a></li>
            <li style="font-size: calc(1rem * 81 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 82</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 73</li>
    ...
    <tr>
      <td>8</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5bcc802d5aeb7b43187fd053c6db3f56.png" alt="Cover for Body of Light" style="max-width:120px; height:auto;" />
      </td>
      <td>2003-08-26</td>
      <td>Halo</td>
      <td>Body of Light</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 34</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 11</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 38</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2005-04-19</td>
      <td>Asva</td>
      <td>Futurists Against The Ocean</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/doom-metal" | relative_url }}">doom metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2005-06-15</td>
      <td>Nadja</td>
      <td>Bliss Torn From Emptiness</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2005-10-17</td>
      <td>Nadja</td>
      <td>Truth Becomes Death</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
            <li style="font-size: calc(1rem * 77 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 52</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/experimental-metal" | relative_url }}">experimental metal</a> # 92</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/funeral-doom-metal" | relative_url }}">funeral doom metal</a> # 80</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
            <li style="font-size: calc(1rem * 72 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2009-04-28</td>
      <td>Nadja</td>
      <td>When I See The Sun Always Shines On Tv</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
        </ul>
    ...
    <tr>
      <td>62</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/dbb43f1097084840a9b7727971719ad5.png" alt="Cover for Monoliths and dimensions" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-05-26</td>
      <td>Sunn O)))</td>
    ...
    <tr>
      <td>63</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/f3ea64241cee4d818cdf295023d6ed13.png" alt="Cover for Disconnected" style="max-width:120px; height:auto;" />
      </td>
      <td>2009-07-24</td>
      <td>Greymachine</td>
      <td>Disconnected</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
            <li style="font-size: calc(1rem * 65.47619047619048 / 100)"> <a href="{{ "/tags/industrial-metal" | relative_url }}">industrial metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/black-noise" | relative_url }}">black noise</a> # 6</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>The Witch Must Be Killed</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
    ...
    <tr>
      ...
      <td>2010-05-17</td>
      <td>Menace Ruine</td>
      <td>Union of Irreconcilables</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
            <li style="font-size: calc(1rem * 62 / 100)"> <a href="{{ "/tags/drone" | relative_url }}">drone</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2010-07-27</td>
      <td>The Body</td>
      <td>All The Waters Of The Earth Turn To Blood</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2011-09-27</td>
      <td>The Body &amp; Braveyoung</td>
      <td>Nothing Passes</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/drone-metal" | relative_url }}">drone metal</a></li>
        </ul>
    ...
    <tr>
      <td>15</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/6abed757cedd4ba582e2173d2576b1a7.png" alt="Cover for Reflection of the Negative" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-04-16</td>
      <td>Cough, Windhand</td>
      <td>Reflection of the Negative</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/doomgaze" | relative_url }}">doomgaze</a> # 4</li>
    ...
    <tr>
      <td>12</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ad7334b9f41b2b915985b9f2d46a3a94.png" alt="Cover for Somme" style="max-width:120px; height:auto;" />
      </td>
      <td>2020-04-08</td>
      <td>Somme</td>
      <td>Somme</td>
    ...
    <tr>
      <td>64</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/2fc6a07708da4ffcfdb55cd2d02e3d03.png" alt="Cover for To Be Cruel" style="max-width:120px; height:auto;" />
      </td>
      <td>2023-06-30</td>
      <td>Khanate</td>
      <td>To Be Cruel</td>
