...
Last updated: <time datetime="2025-12-04T07:06:31.095Z">Thu Dec 04 2025 09:06:31 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1991-09-26</td>
      <td>Crowbar</td>
      <td>Obedience Thru Suffering</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/grunge" | relative_url }}">grunge</a> # 23</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 96 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>83</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/63ce81c3559f99a5570af0a42e9a699e.png" alt="Cover for Crowbar" style="max-width:120px; height:auto;" />
      </td>
      <td>1993-10-12</td>
      <td>Crowbar</td>
      <td>Crowbar</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/crust" | relative_url }}">crust</a> # 25</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/southern-metal" | relative_url }}">southern metal</a> # 7</li>
            <li> <a href="{{ "/tags/stoner-metal" | relative_url }}">stoner metal</a> # 93</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 88 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 12</li>
    ...
    <tr>
      ...
      <td>1996</td>
      <td>Harvey Milk</td>
      <td>Courtesy And Good Will Toward Men</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1996-11-12</td>
      <td>Acid Bath</td>
      <td>Paegan Terrorism Tactics</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
    ...
    <tr>
      <td>96</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/56879d27e2cc23cb4e75d1b295f4d094.png" alt="Cover for The Aftermath" style="max-width:120px; height:auto;" />
      </td>
      <td>1999</td>
      <td>Dystopia</td>
      <td>The Aftermath</td>
    ...
    <tr>
      ...
      <td>2000-01-25</td>
      <td>Eyehategod</td>
      <td>Southern Discomfort</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 70 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2001-08-21</td>
      <td>Crowbar</td>
      <td>Sonic Excess in Its Purest Form</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a> # 59</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>66</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/08cf7659b34c496b838d92fbff5e0990.png" alt="Cover for Use Once And Destroy" style="max-width:120px; height:auto;" />
      </td>
      <td>2002-05-21</td>
      <td>Superjoint Ritual</td>
      <td>Use Once And Destroy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 53</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>32</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/8a5f2ee5b10183df032ad7fd6c39a39a.png" alt="Cover for Sixteen Tons" style="max-width:120px; height:auto;" />
      </td>
      <td>2003-01-24</td>
      <td>Weedeater</td>
      <td>Sixteen Tons</td>
    ...
    <tr>
      <td>3</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/346277ae81077e0cf6e80fba62cac02f.png" alt="Cover for Sewn Mouth Secrets &amp; A String of Lies" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Soilent Green</td>
    ...
    <tr>
      <td>25</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/17fde3496c5745128502f1b891bbb4a2.png" alt="Cover for III" style="max-width:120px; height:auto;" />
      </td>
      <td>2005</td>
      <td>Cursed</td>
      <td>III</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>59</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/4d509416a8604e34ce03f71b7db94bf1.png" alt="Cover for To Walk A Middle Course" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-03-23</td>
      <td>Kylesa</td>
      <td>To Walk A Middle Course</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
    ...
    <tr>
      <td>9</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/4c67bde8636f4ba7ba946edbb8b5b856.png" alt="Cover for Demos: 1993-1996" style="max-width:120px; height:auto;" />
      </td>
      <td>2005-12-06</td>
      <td>Acid Bath</td>
      <td>Demos: 1993-1996</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/progressive-metal" | relative_url }}">progressive metal</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>75</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ee5e375f4b284ab1b320a8fa7ee43f36.png" alt="Cover for Time Will Fuse Its Worth" style="max-width:120px; height:auto;" />
      </td>
      <td>2006-10-31</td>
      <td>Kylesa</td>
      <td>Time Will Fuse Its Worth</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
    ...
    <tr>
      <td>93</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/09ec3969d5234f72a720e71631633c1c.png" alt="Cover for Dystopia" style="max-width:120px; height:auto;" />
      </td>
      <td>2008-02-10</td>
      <td>Dystopia</td>
      <td>Dystopia</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 13</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/atmospheric-sludge-metal" | relative_url }}">atmospheric sludge metal</a> # 91</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2009-03-17</td>
      <td>Kylesa</td>
      <td>Static Tensions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
            <li style="font-size: calc(1rem * 56.99999999999999 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/stoner-metal" | relative_url }}">stoner metal</a></li>
            <li style="font-size: calc(1rem * 67 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>8</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/10bcd5015026229276baed9816ebfde3.png" alt="Cover for Invernal" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-01-01</td>
      <td>Black Cobra</td>
      <td>Invernal</td>
    ...
    <tr>
      ...
      <td>The Song Remains Not The Same</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/southern-metal" | relative_url }}">southern metal</a> # 5</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>An Ache for the Distance</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/psychedelic-metal" | relative_url }}">psychedelic metal</a> # 28</li>
    ...
    <tr>
      <td>71</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/ee7ebcc4084b41869a86a0b21f1990b0.png" alt="Cover for Set the Dial" style="max-width:120px; height:auto;" />
      </td>
      <td>2011-10-25</td>
      <td>Black Tusk</td>
      <td>Set the Dial</td>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/stoner-metal" | relative_url }}">stoner metal</a> # 18</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>54</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/4d9d4179954b4e13bbe4085685ef2a39.png" alt="Cover for Dead Set On Living" style="max-width:120px; height:auto;" />
      </td>
      <td>2012-04-16</td>
      <td>Cancer Bats</td>
      <td>Dead Set On Living</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/hardcore-punk" | relative_url }}">hardcore punk</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 37</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>2013-09-17</td>
      <td>SubRosa</td>
      <td>More Constant Than The Gods</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doom-metal" | relative_url }}">doom metal</a></li>
        </ul>
    ...
    <tr>
      <td>90</td>
      <td>
          <img src="https://i.discogs.com/a7Q6wSMX2Ml2GulajE2WWR4gmkZ7hBGSbsj-Z-gpM5c/rs:fit/g:sm/q:40/h:150/w:150/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTkwOTM3/NTEtMTQ3NDY2Mjg4/OS04MzQ2LmpwZWc.jpeg" alt="Cover for May Our Chambers Be Full" style="max-width:120px; height:auto;" />
      </td>
      <td>2013-11-07</td>
      <td>Emma Ruth Rundle</td>
      <td>May Our Chambers Be Full</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
        </ul>
    ...
    <tr>
      <td>72</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/cd2dccda35844501c5427ecad691c191.png" alt="Cover for Heathen" style="max-width:120px; height:auto;" />
      </td>
      <td>2014-02-25</td>
      <td>Thou</td>
      <td>Heathen</td>
    ...
    <tr>
      <td>18</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/46028d88356c44b1c44056248b2bb837.png" alt="Cover for Death Mask" style="max-width:120px; height:auto;" />
      </td>
      <td>2014-04-29</td>
      <td>Lord Mantis</td>
      <td>Death Mask</td>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/sludgecore" | relative_url }}">sludgecore</a> # 20</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>45</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/3d48092e669742cec2698227fdf7fb67.png" alt="Cover for The Deal" style="max-width:120px; height:auto;" />
      </td>
      <td>2015-02-17</td>
      <td>Sumac</td>
      <td>The Deal</td>
    ...
    <tr>
      <td>28</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/5ed2940d463346cbd97f44d040d51901.png" alt="Cover for Ode to the Flame" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-04-15</td>
      <td>Mantar</td>
      <td>Ode to the Flame</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/post-metal" | relative_url }}">post-metal</a> # 49</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>6</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/e2d19bdbac4d3e2eff3ecb6fed1d55bf.png" alt="Cover for The Serpent Only Lies" style="max-width:120px; height:auto;" />
      </td>
      <td>2016-10-28</td>
      <td>Crowbar</td>
      <td>The Serpent Only Lies</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/metal" | relative_url }}">metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge" | relative_url }}">sludge</a></li>
    ...
    <tr>
      <td>81</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/625f10565ea566cc68ab946b32f6cf14.png" alt="Cover for Only Self" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-08-24</td>
      <td>Jesus Piece</td>
      <td>Only Self</td>
    ...
    <tr>
      <td>33</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/91596778caa8bb40da3ddd6233be88f6.png" alt="Cover for Unfold the God Man" style="max-width:120px; height:auto;" />
      </td>
      <td>2018-09-01</td>
      <td>Psychonaut</td>
      <td>Unfold the God Man</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-metal" | relative_url }}">alternative metal</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/powerviolence" | relative_url }}">powerviolence</a> # 24</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>12</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/cc32f3b98d8cf5f7630eba960fa9d31a.png" alt="Cover for Evidence Of Immortality" style="max-width:120px; height:auto;" />
      </td>
      <td>2022-08-19</td>
      <td>Conan</td>
      <td>Evidence Of Immortality</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/doom-metal" | relative_url }}">doom metal</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/sludge-metal" | relative_url }}">sludge metal</a></li>
    ...
    <tr>
      <td>51</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/309be15f988b7a41aaa26c8240f2dae3.png" alt="Cover for Umbilical" style="max-width:120px; height:auto;" />
      </td>
      <td>2024-05-31</td>
      <td>Thou</td>
      <td>Umbilical</td>
