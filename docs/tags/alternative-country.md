...
Last updated: <time datetime="2025-11-26T20:09:37.965Z">Wed Nov 26 2025 22:09:37 GMT+0200 (Eastern European Standard Time)</time>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/gothic-country" | relative_url }}">gothic country</a> # 88</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li> <a href="{{ "/tags/gothic-country" | relative_url }}">gothic country</a> # 89</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gothic-country" | relative_url }}">gothic country</a> # 71</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/memphis" | relative_url }}">memphis</a> # 93</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>78</td>
      <td>
          <img src="https://lastfm.freetls.fastly.net/i/u/34s/103b435c5f5e47695f99b0d2d3922d28.png" alt="Cover for Daisy Sessions" style="max-width:120px; height:auto;" />
      </td>
      <td>2007-04-30</td>
      <td>Brand New</td>
      <td>Daisy Sessions</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/alternative-country" | relative_url }}">alternative country</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/country" | relative_url }}">country</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gothic-country" | relative_url }}">gothic country</a> # 28</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/psychobilly" | relative_url }}">psychobilly</a> # 67</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/banjo" | relative_url }}">banjo</a> # 67</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/southern-rock" | relative_url }}">southern rock</a> # 19</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/psychobilly" | relative_url }}">psychobilly</a> # 70</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/folk-rock" | relative_url }}">folk rock</a> # 72</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/roots-rock" | relative_url }}">roots rock</a> # 3</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/outlaw-country" | relative_url }}">outlaw country</a> # 32</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gothic-country" | relative_url }}">gothic country</a> # 77</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/honky-tonk" | relative_url }}">honky tonk</a> # 39</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/gothic-country" | relative_url }}">gothic country</a> # 78</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/throwaway-grrls" | relative_url }}">throwaway grrls</a> # 53</li>
        </ul>
      </td>
    </tr>
    <tr>
