...
Impressionism in music emphasizes atmosphere, color, and mood over traditional structure, using unconventional scales, unresolved harmonies, and delicate textures to evoke images and emotions. Originating in late 19th-century France as a parallel to the visual arts movement, it broke from Romantic-era conventions to capture fleeting moments and sensory experiences. The style creates dreamlike, shimmering soundscapes that suggest rather than directly state, prioritizing tone and ambiance.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1955</td>
      <td>The Louisville Orchestra</td>
      <td>Français Moderne Premieres 2 - Francis Poulenc, André Jolivet, Henri Sauguet, Charles Koechlin, Marcel Grandjany &amp; Ernest Guiraud</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1957</td>
      <td>New York Philharmonic Orchestra</td>
      <td>Mozart: Symphonies Nos. 36 &amp; 40 - Roussel: Symphony No. 3</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>Debussy: La Mer, Le Martyre de saint Sébastien</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>Walter Gieseking plays Debussy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1963</td>
      <td>Maurice Ravel</td>
      <td>Ravel: Complete Orchestral Works</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
    ...
    <tr>
      ...
      <td>1980</td>
      <td>Erik Satie</td>
      <td>Satie: The Complete Solo Piano Music</td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>1984</td>
      <td>Pascal Rogé</td>
      <td>Satie: 3 Gymnopédies &amp; other piano works</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
    ...
    <tr>
      ...
      <td>1987</td>
      <td>Patricia Escudero</td>
      <td>Satie Sonneries</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
    ...
    <tr>
      ...
      <td>Boieldieu &#x2F; Saint-Saëns &#x2F; Tailleferre &#x2F; Ravel: Harp Concertos</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
    ...
    <tr>
      ...
      <td>1990</td>
      <td>Erik Satie</td>
      <td>Œuvres pour piano (Séléction)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
    ...
    <tr>
      ...
      <td>1992-11-17</td>
      <td>Erik Satie</td>
      <td>Piano Works (Daniel Varsano, Philippe Entremont)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1995</td>
      <td>Reinbert de Leeuw</td>
      <td>Satie: Gnossiennes, Gymnopédies, Etc.</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1997</td>
      <td>Yo-Yo Ma</td>
      <td>Nature at Play: J.S. Bach&#39;s Cello Suite No. 1 (Live from the Great Smoky Mountains) - EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Claude Debussy</td>
      <td>The World Of Claude Debussy</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>1999</td>
      <td>Claude Debussy</td>
      <td>Debussy: The Composer as Pianist (1904, 1913)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>1999-07-07</td>
      <td>浜渦正志</td>
      <td>Piano Pieces &quot;SF2&quot; ~ Rhapsody on a Theme of SaGa FRONTIER 2</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
    ...
    <tr>
      ...
      <td>2000</td>
      <td>Paul Jacobs</td>
      <td>Debussy: Preludes for Piano, Books I &amp; II</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2000-01-21</td>
      <td>植松伸夫</td>
      <td>Piano Collections: Final Fantasy VIII</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>The Complete Piano Works</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
    ...
    <tr>
      ...
      <td>2007</td>
      <td>Yo-Yo Ma</td>
      <td>Nature at Play: J.S. Bach&#39;s Cello Suite No. 1 (Live from the Great Smoky Mountains)</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2010-12-24</td>
      <td>Herr Twiggs</td>
      <td>Marzipan und Mutterfleisch</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/acoustic" | relative_url }}">acoustic</a></li>
    ...
    <tr>
      ...
      <td>2014</td>
      <td>Erik Satie</td>
      <td>Satie: 3 Gymnopédies; 6 Gnossiennes etc.</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>Antonii Baryshevskyi</td>
      <td>Boulanger: Hymne au soleil</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/french" | relative_url }}">french</a></li>
    ...
    <tr>
      ...
      <td>2015</td>
      <td>Erik Satie</td>
      <td>The Complete Ballets of Erik Satie (Maurice Abravanel, Utah Symphony Orchestra)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>In Memoriam Lili Boulanger</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2017</td>
      <td>Eric Satie</td>
      <td>La belle excentrique, en habit de cheval, morceau en forme de poire (1866-1925)</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Koki Fujimoto</td>
      <td>The Complete Works for Solo Guitar by Toru Takemitsu vol. 1</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/classical" | relative_url }}">classical</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/contemporary-classical" | relative_url }}">contemporary classical</a></li>
    ...
    <tr>
      ...
      <td>2023-02-02</td>
      <td>Claude Debussy</td>
      <td>Debussy for Daydreaming: Music To Caress Your Innermost Thoughts</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/impressionism" | relative_url }}">impressionism</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2024-02-23</td>
      <td>Claude Debussy</td>
      <td>Debussy: Préludes, Books 1 &amp; 2</td>
      <td>
        <ul>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td></td>
      <td>Lyon National Orchestra</td>
      <td>Debussy: Orchestral Works, Vol. 6</td>
      <td>
        <ul>
        </ul>
      </td>
