...
Dancecore is an energetic, high-intensity tag encompassing uptempo electronic music designed to keep bodies moving with relentless beats and euphoric melodies. It blends elements from hardcore techno, happy hardcore, and commercial dance-pop, emphasizing maximum energy over genre purity. The sound ranges from abrasive and chaotic to candy-sweet and accessible, united by its uncompromising commitment to dancefloor momentum.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li style="font-size: calc(1rem * 56.00000000000001 / 100)"> <a href="{{ "/tags/speedcore" | relative_url }}">speedcore</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>2007-05-07</td>
      <td>Negrobeat</td>
      <td>Rataxes... Are you kidding? EP</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2009</td>
      <td>Various Artists</td>
      <td>Black Market Sound Murderer</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cybergrind" | relative_url }}">cybergrind</a></li>
    ...
    <tr>
      ...
      <td>2010-01-16</td>
      <td>DJ GAY&#39;S ANATOMY</td>
      <td>Nu E D Dax För Litta Romance Up In Dis Mthrfckr</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dancecore" | relative_url }}">dancecore</a></li>
    ...
    <tr>
      ...
      <td>2010-03-26</td>
      <td>Sinead O&#39;Connick Jr.</td>
      <td>Non-Stop Zapping</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dancecore" | relative_url }}">dancecore</a></li>
    ...
    <tr>
      ...
      <td>2010-04-10</td>
      <td>Huysman</td>
      <td>Metaphonic Glitch And Green Notes In The Wonderland Of Shit</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dancecore" | relative_url }}">dancecore</a></li>
    ...
    <tr>
      ...
      <td>2010-05-01</td>
      <td>The Captain Kirk on LSD Experience</td>
      <td>Dancecore From Outer Space</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/cybergrind" | relative_url }}">cybergrind</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dancecore" | relative_url }}">dancecore</a></li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/speedcore" | relative_url }}">speedcore</a> # 85</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/speedcore" | relative_url }}">speedcore</a> # 21</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2012-12-25</td>
      <td>Andoromeda</td>
      <td>Tribute to the bastards of X&#39;MAS</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/chiptune" | relative_url }}">chiptune</a></li>
    ...
    <tr>
      ...
      <td>2013-05-07</td>
      <td>Fat Frumos</td>
      <td>BORN! LIVE! FUCK! DIE!</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/rave" | relative_url }}">rave</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/speedcore" | relative_url }}">speedcore</a></li>
        </ul>
      </td>
      <td>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> <a href="{{ "/tags/happy-hardcore" | relative_url }}">happy hardcore</a> # 12</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2016-09-08</td>
      <td>PENILE NIGGER FUCKER</td>
      <td>Great Green Death</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dancecore" | relative_url }}">dancecore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2022-05-02</td>
      <td>GulloHack</td>
      <td>I stole anime openings and taped amen breaks on them</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dancecore" | relative_url }}">dancecore</a></li>
        </ul>
    ...
    <tr>
      ...
      <td>2022-05-19</td>
      <td>LANIc0re</td>
      <td>HIGH BPM LOLI KICKS</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/jungle" | relative_url }}">jungle</a></li>
            <li style="font-size: calc(1rem * 66 / 100)"> <a href="{{ "/tags/speedcore" | relative_url }}">speedcore</a></li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>2023</td>
      <td>Various Artists</td>
      <td>Dance Corps 4 - Return To Planet Dancecore</td>
      <td>
        <ul>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/breakcore" | relative_url }}">breakcore</a></li>
            <li style="font-size: calc(1rem * 100 / 100)"> <a href="{{ "/tags/dancecore" | relative_url }}">dancecore</a></li>
